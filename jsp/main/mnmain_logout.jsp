   ...
   /* This function used to make pulldown menu only */
    function fwLoadMenus() {
		...
		/* Employee > Training > Training Activities */
            ...
            fw_menu_tmp_training_activity.addMenuItem("Training Plan", "location='<%=String.valueOf(approot)%>/employee/training/training_plan_list.jsp'");
        ...
        fw_menu_5.hideOnMouseOut=true;
            ...
            fw_menu_6_10.addMenuItem("Special & Unpaid Leave", "location='<%=String.valueOf(approot)%>/employee/leave/leave_sp_unp_list.jsp'");  
			...
			fw_menu_6_12.addMenuItem("List Of Absences Reason ", "location='<%=String.valueOf(approot)%>/report/employee/list_absence_reason.jsp'");
