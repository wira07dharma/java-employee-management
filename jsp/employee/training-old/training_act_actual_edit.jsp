                                    ...
                                    <form name="fractual" method="post" action="">
                                      ...
                                      <table width="100%" cellspacing="1" cellpadding="1" >
                                        ...
                                        <tr> 
                                          ...
                                          <td  width="86%"  valign="top" align="left"> 
                                            <%=ControlDate.drawDateWithStyle(FrmTrainingActivityActual.fieldNames[FrmTrainingActivityActual.FRM_FIELD_DATE], (trainingActivityActual.getDate()==null) ? new Date() : trainingActivityActual.getDate(), 1, -1, "formElemen", "")%> 
