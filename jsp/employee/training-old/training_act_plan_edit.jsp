...
%>
--%>
<% int  appObjCode = 1;//AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_TRAINING, AppObjInfo.OBJ_TRAINING_ACTIVITIES); %>
<%@ include file = "../../main/checkuser.jsp" %>
<%
/* Check privilege except VIEW, view is already checked on checkuser.jsp as basic access*/
...
<%
	...
	//out.println("trainingActivityPlan : "+trainingActivityPlan.getDepartmentId());
	
	if(depOID!=0){
		trainingActivityPlan.setDepartmentId(depOID);
	}

	whereClause = PstTrainingDept.fieldNames[PstTrainingDept.FLD_DEPARTMENT_ID]+"="+trainingActivityPlan.getDepartmentId();
	orderClause = "";
                                      ...
                                      <table width="100%" cellspacing="2" cellpadding="0" >
                                        ...
                                        <tr align="left"> 
                                          ...
                                          <td  width="85%"  valign="top"> 
                                            ...
                                            %>
                                            <%=ControlCombo.draw(FrmTrainingActivityPlan.fieldNames[FrmTrainingActivityPlan.FRM_FIELD_DEPARTMENT_ID], "Select ...", select_departmentid, deptValue, deptKey, "onChange=\"javascript:cmdChangeDept()\"", "formElemen")%></td>
                                        </tr>
                                        <tr align="left"> 
                                          <td width="2%"  valign="top"  >&nbsp;</td>
                                          <td width="13%"  valign="top" nowrap  >Date</td>
                                          <td  width="85%"  valign="top"> <%=ControlDate.drawDateMY(FrmTrainingActivityPlan.fieldNames[FrmTrainingActivityPlan.FRM_FIELD_DATE], (trainingActivityPlan.getDate()==null) ? new Date() : trainingActivityPlan.getDate(),"MMM", "formElemen", 1,-1)%> </td>
                                        </tr>
                                        <tr align="left"> 
                                          <td width="2%"  valign="top"  >&nbsp;</td>
                                          ...
                                          <td  width="85%"  valign="top"> 
                                            <% 
															...
															/*if(trainingActivityPlan.getDepartmentId()==0){
																Vector trainingV = PstTraining.list(0,0, "", null);
																for (int i = 0; i < trainingV.size(); i++) {
																		Training trn = (Training)trainingV.get(i);
															...
															//}
                                                        %>
                                            <%= ControlCombo.draw(FrmTrainingActivityPlan.fieldNames[FrmTrainingActivityPlan.FRM_FIELD_TRAINING_ID],"formElemen",null, ""+trainingActivityPlan.getTrainingId(), dept_value, dept_key, " onkeydown=\"javascript:fnTrapKD()\"") %> * <%=frmTrainingActivityPlan.getErrorMsg(FrmTrainingActivityPlan.FRM_FIELD_TRAINING_ID)%></td>
                                        </tr>
                                        <!--tr align="left"> 
                                          <td width="2%"  valign="top"  >&nbsp;</td>
                                          <td width="13%"  valign="top" nowrap  >Program</td>
                                          <td  width="85%"  valign="top"> 
                                            <input type="text" name="<%=FrmTrainingActivityPlan.fieldNames[FrmTrainingActivityPlan.FRM_FIELD_PROGRAM]%>" value="<%=trainingActivityPlan.getProgram()%>" class="formElemen" size="50">
                                            * <%=frmTrainingActivityPlan.getErrorMsg(FrmTrainingActivityPlan.FRM_FIELD_PROGRAM)%></td>
                                        </tr-->
                                        <tr align="left"> 
                                          <td width="2%"  valign="top"  >&nbsp;</td>
