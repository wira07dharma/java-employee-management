...
<script language="JavaScript">
    ...
    function cmdSearch(){
            ...
            document.frmsrcemployee.action="achieve_list.jsp";
            document.frmsrcemployee.submit();
    }
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" --> 
                  Employee &gt; Special Achievement &gt; Employee Search<!-- #EndEditable --> 
                  </strong></font> </td>
        </tr>
        <tr> 
          <td>
							...
							sec_value.add("0");
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      <td width="17%" height="21" nowrap>Commencing 
                                                        Date</td>
                                                      <td width="83%"><%=ControlDate.drawDateWithStyle(frmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_START_COMMENC], srcEmployee.getStartCommenc(), 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%> 
                                                        &nbsp;to&nbsp; <%=ControlDate.drawDateWithStyle(frmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_END_COMMENC], srcEmployee.getEndCommenc(), 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%></td>
                                                    </tr>
                                                    <tr align="left" valign="top"> 
