...
%>
--%>
<% int  appObjCode = 1;//AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_TRAINING, AppObjInfo.OBJ_TRAINING_HISTORY); %>
<%@ include file = "../../main/checkuser.jsp" %>
<%
/* Check privilege except VIEW, view is already checked on checkuser.jsp as basic access*/
                                          ...
                                          <td colspan="2" align="left" nowrap valign="top"  > 
                                            <table width="98%" border="0" cellpadding="1" cellspacing="1" class="listgen">
                                              ...
                                              <tr class="listgensell"> 
                                                ...
                                                <td width="21%"><%=Formater.formatDate(trHis.getStartDate(), "dd-MM-yy")%> &nbsp;//&nbsp; <%=Formater.formatDate(trHis.getEndDate(), "dd-MM-yy")%></td>
                                                <td width="8%"> 
                                                  <div align="center"><%=trHis.getDuration()%></div>
                                                </td>
                                                <td width="16%"><%=trHis.getTrainer()%></td>
                                                <td width="26%"><%=trHis.getRemark()%></td>
                                              </tr>
                                              <%	}
											  }else{%>
                                              <tr class="listgensell"> 
                                                <td colspan="6">no training history 
                                                  available ....</td>
                                              </tr>
                                              <%}%>
                                            </table>
