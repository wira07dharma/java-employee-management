		...
		if(objectClass != null && objectClass.size()>0){
			for (int i = 0; i < objectClass.size(); i++) {
				...
				if(actuals != null && actuals.size()>0){
					...
					actHour = Integer.parseInt(""+actuals.get(1));
					actTrainees = Integer.parseInt(""+actuals.get(2));
				}
				...
				lstData.add(rowx);
				lstLinkData.add(String.valueOf(trainingActivityPlan.getOID())+"','"+trainingActivityPlan.getProgram());
			}
		}else{
			rowx = new Vector();
	...
	public String drawList(Vector objectClass, Department department){
		...
		if(objectClass != null && objectClass.size()>0){
			for (int i = 0; i < objectClass.size(); i++) {
				...
				lstLinkData.add(String.valueOf(trainingActivityPlan.getOID())+"','"+topic);
			}
		}else{
			rowx = new Vector();
			rowx.add("&nbsp"+department.getDepartment());
...
<%
    ...
    */
    if((iCommand==Command.FIRST)||(iCommand==Command.NEXT)||(iCommand==Command.PREV)||(iCommand==Command.LAST)||(iCommand==Command.LIST)){
        ...
        //out.println("<br>start = "+ start);
        listDepartment = PstDepartment.list(start,limit,"","");
    }
%>
<!-- End of Jsp Block -->
<html>
