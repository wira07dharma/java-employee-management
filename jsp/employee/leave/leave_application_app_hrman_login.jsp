...
long managerOid = FRMQueryString.requestLong(request, FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_HR_MAN_APPROVAL]);
...
{
%>
	<jsp:forward page="leave_application_edit.jsp"> 
	<jsp:param name="command" value="<%=Command.EDIT%>" />	
	<jsp:param name="start" value="<%=start%>" />
	<jsp:param name="hidden_leave_application_id" value="<%=oidLeaveApplication%>" />
	<jsp:param name="hidden_hr_man_authorize" value="<%=hrManAuthorize%>" />					
	<jsp:param name="hr_man_id" value="<%=managerOid%>" />						
	</jsp:forward>	
<%
}
%>
...
function cmdLogin()	
{
  document.frm_leave_application.command.value="<%=Command.SUBMIT%>"; 
  document.frm_leave_application.action = "leave_application_app_hrman_login.jsp";
  document.frm_leave_application.submit();
}


function cmdBackToEditor(oidLeaveApplication, hrManAuthorize, managerOid)	  
{
  document.frm_leave_application.command.value="<%=Command.EDIT%>"; 
  document.frm_leave_application.hidden_leave_application_id.value=oidLeaveApplication; 
  document.frm_leave_application.hidden_hr_man_authorize.value=hrManAuthorize; 
  document.frm_leave_application.<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_HR_MAN_APPROVAL]%>.value=managerOid;       
  ...
  <tr>
    <td valign="middle" align="left">
      <form name="frm_leave_application" action="" onsubmit="window.status=''">
	    ...
	    <input type="hidden" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_HR_MAN_APPROVAL]%>" value="<%=managerOid%>">		
