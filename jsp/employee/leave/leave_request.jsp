...
<%-- 
    ...
    Created on : Mar 22, 2009, 9:21:45 AM
    Author     : bayu
--%>
            ...
            {                
                for(int i=0; i<ids.size(); i++) 
                {
                    ...
                    if(saved && !approved){ 
                        ...
                        rowx.add("<a href=\"javascript:cmdEditDates('" + oidEmployee + "','" + oidLeave +"','" + ids.get(i) + "','" + cats.get(i) + "','" + dayEligible + "')\">Add AL</a> <BR> <a href=\"javascript:cmdEditDates('" + oidEmployee + "','" + oidLeave +"','" + ids.get(i) + "','" + cats.get(i) + "','" + dayEligible + "')\">Add LL</a> <BR> <a href=\"javascript:cmdEditDates('" + oidEmployee + "','" + oidLeave +"','" + ids.get(i) + "','" + cats.get(i) + "','" + dayEligible + "')\">Add DP</a>");
                    }else{
                        rowx.add("");  
                    }    
                    lstData.add(rowx);                      
