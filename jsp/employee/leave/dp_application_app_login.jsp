...
long managerOid = FRMQueryString.requestLong(request, FrmDpApplication.fieldNames[FrmDpApplication.FRM_FLD_APPROVAL_ID]);
...
{
%>
	<jsp:forward page="dp_application_edit.jsp"> 
	<jsp:param name="command" value="<%=Command.EDIT%>" />	
	<jsp:param name="start" value="<%=start%>" />
	<jsp:param name="hidden_dp_application_id" value="<%=oidDpApplication%>" />
	<jsp:param name="hidden_dep_head_authorize" value="<%=depHeadAuthorize%>" />					
	<jsp:param name="manager_id" value="<%=managerOid%>" />						
	</jsp:forward>	
<%
}
%>
...
function cmdLogin()	
{
  document.frm_dp_application.command.value="<%=Command.SUBMIT%>"; 
  document.frm_dp_application.action = "dp_application_app_login.jsp";
  document.frm_dp_application.submit();
}


function cmdBackToEditor(oidDpApplication, depHeadAuthorize, managerOid)	
{
  document.frm_dp_application.command.value="<%=Command.EDIT%>"; 
  document.frm_dp_application.hidden_dp_application_id.value=oidDpApplication; 
  document.frm_dp_application.hidden_dep_head_authorize.value=depHeadAuthorize; 
  document.frm_dp_application.<%=FrmDpApplication.fieldNames[FrmDpApplication.FRM_FLD_APPROVAL_ID]%>.value=managerOid;       
  ...
  <tr>
    <td valign="middle" align="left">
      <form name="frm_dp_application" action="" onsubmit="window.status=''">
	    ...
	    <input type="hidden" name="<%=FrmDpApplication.fieldNames[FrmDpApplication.FRM_FLD_APPROVAL_ID]%>" value="<%=managerOid%>">		
