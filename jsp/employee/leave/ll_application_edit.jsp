...
int maxApporval = leaveConfig.getMaxApproval(lLAppMain.getEmployeeId());
...
*/
    ...
    if(iCommand == Command.SAVE && oidLLAppMain>0){
        try{
            lLAppMain = PstLLAppMain.fetchExc(oidLLAppMain);
        }catch(Exception ex){}
        if(isApprove1){
            Date dateApprove = FRMQueryString.requestDate(request, FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL_DATE]);
            lLAppMain.setApprovalId(approvedId1);
            lLAppMain.setApprovalDate(dateApprove);
            isApprove1 = false;
        }else if(isApprove2){
            Date dateApprove = FRMQueryString.requestDate(request, FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL2_DATE]);
            lLAppMain.setApproval2Id(approvedId2);
            lLAppMain.setApproval2Date(dateApprove);
            isApprove1 = false;
        }else if(isApprove3){
            Date dateApprove = FRMQueryString.requestDate(request, FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL3_DATE]);
            lLAppMain.setApproval3Id(approvedId3);
            lLAppMain.setApproval3Date(dateApprove);
            isApprove1 = false;
        }
        ...
        switch(maxApporval){
            case 1: 
                if(lLAppMain.getApprovalId()>0){
                    lLAppMain.setApproval2Id(lLAppMain.getApprovalId());
                    lLAppMain.setApproval3Id(lLAppMain.getApprovalId());
                    lLAppMain.setApproval2Date(lLAppMain.getApprovalDate());
                    lLAppMain.setApproval3Date(lLAppMain.getApprovalDate());
                }
                break;
            case 2: 
                if(lLAppMain.getApproval2Id()>0){
                    lLAppMain.setApproval3Id(lLAppMain.getApproval2Id());
                    lLAppMain.setApproval3Date(lLAppMain.getApproval2Date());
                }
                break;
        }
    ...
    if(iCommand == Command.DELETE & iErrCode==CtrlLLAppMain.RSLT_OK){
         ...
         /* EXECUTE ACTION COMMAND */
            ...
            %>
                <jsp:forward page="ll_application_list.jsp">
...
function cmdCancel()
{
	...
	document.frm_ll_application.action="ll_application_edit.jsp";
...
function cmdBack()
{
	...
	document.frm_ll_application.action="ll_application_list.jsp";
	document.frm_ll_application.submit();
}

//--------------- Calendar  -------------------------------
function getThn(){
            <%=ControlDatePopup.writeDateCaller("frm_ll_application",FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL_DATE])%>
            <%=ControlDatePopup.writeDateCaller("frm_ll_application",FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL2_DATE])%>
            <%=ControlDatePopup.writeDateCaller("frm_ll_application",FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL3_DATE])%>
}
...
function checkApproval(index)
{
	...
	var empApprovalSelected = 0;
        if(index==1){
            empApprovalSelected = document.frm_ll_application.<%=FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL_ID]%>.value;
        }
        if(index==2){
            empApprovalSelected = document.frm_ll_application.<%=FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL2_ID]%>.value;
        }
        if(index==3){
            empApprovalSelected = document.frm_ll_application.<%=FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL3_ID]%>.value;
        }
	if(empLoggedIn != 0)
	{
		if(empApprovalSelected != 0)
		{
			...
			{
				document.frm_ll_application.command.value="<%=String.valueOf(Command.LIST)%>";
				document.frm_ll_application.indexApproval.value=index;
				document.frm_ll_application.oidDevHead.value=empApprovalSelected;
				document.frm_ll_application.action="leave_application_app_login_ll.jsp";
				document.frm_ll_application.submit();  		
			}else{
                          /*  if(index==1){
                                document.frm_ll_application.isApprove1.value = "true";
                            }   		
                            if(index==2){
                                document.frm_ll_application.isApprove2.value = "true";
                            }   		
                            if(index==3){
                                document.frm_ll_application.isApprove3.value = "true";
                            }   */	
                        }
		}
		else
		{
			alert('Please choose an authorized manager to approve this LL Application ...');    					
		}
	}
	else
	{
            ...
            if(index==1){
		document.frm_ll_application.<%=FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL_ID]%>.value = "0";
            }   		
            if(index==2){
		document.frm_ll_application.<%=FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL2_ID]%>.value = "0";
            }   		
            if(index==3){
		document.frm_ll_application.<%=FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL3_ID]%>.value = "0";
            }   		
	}
}
...
//-------------- script control line -------------------
	function MM_swapImgRestore() { approvedId//v3.0
                                                ...
                                                <td> 
                                                  <table width="100%" border="0">
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="2%">:</td>
                                                      <td width="38%"><b>
                                                          <%=Formater.formatDate(lLAppMain.getSubmissionDate(), "MMMM dd, yyyy")%>
                                                       </b></td>
                                                    </tr>
                                                  </table>
                                                </td>
                                                              ...
                                                              <td valign="top"> 
                                                                <table width="100%" border="0" bgcolor="#F9FCFF">
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <td  width="83%" ><b>
                                                                          <%=Formater.formatDate(lLAppMain.getStartDate(), "MMMM dd, yyyy")%>
                                                                      </b></td>
                                                                  </tr>
                                                                  <tr>
                                                                      <td width="15%" >
                                                                      ...
                                                                      <td  width="83%" ><b>
                                                                          <%=Formater.formatDate(lLAppMain.getEndDate(), "MMMM dd, yyyy")%>
                                                                      </b></td>
                                                                  </tr>
                                                                  <tr>
                                                                      ...
                                                                      <td  width="83%" ><b>
                                                                          ...
                                                                          %>
                                                                          <input type="hidden" name="<%=FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_REQUEST_QTY]%>" value="<%=String.valueOf(lLAppMain.getRequestQty())%>">
                                                                          <!--input type="text" name="NO_DAYS_REQ" value="<%//=String.valueOf(valReq)%>" readonly='true'-->
                                                                          <%=String.valueOf(valReq)%>
                                                                      </b></td>
                                                                  </tr>
                                                                </table>
                                                              </td>
                                                      ...
                                                      <td valign="top"> 
                                                        <table width="100%" border="0" bgcolor="#F9FCFF">
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td width="23%" ><b>
                                                                  <%=Formater.formatDate(lLAppMain.getSubmissionDate(), "MMMM dd, yyyy")%>
                                                                  <%//=ControlDatePopup.writeDate(FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_SUBMISSION_DATE],(lLAppMain.getSubmissionDate()==null ? new Date() : lLAppMain.getSubmissionDate()))%>
                                                              </b></td>
                                                          </tr>
                                                          <!--Dept Head-->
                                                          <%
                                                          if(lLAppMain.getOID()>0 && maxApporval>=1){
                                                          %>
                                                          <tr>
                                                              ...
                                                              <td width="60%" ><b>
                                                                  ...
                                                                  <%												  
                                                                      if(lLAppMain.getOID()!=0)
                                                                      {
                                                                              ...
                                                                              String selectedApproval = ""+lLAppMain.getApprovalId();
                                                                              if(approvedId1>0){
                                                                              ...
                                                                              out.println(ControlCombo.draw(FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL_ID], null, selectedApproval, divHeadValue, divHeadKey, strAttribute));														  
                                                                      }
                                                                  }											  		  
                                                              %>
                                                              ...
                                                              <td width="23%" ><b>
                                                                    <%=ControlDatePopup.writeDate(FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL_DATE],(lLAppMain.getApprovalDate()==null ? new Date() : lLAppMain.getApprovalDate()))%>
                                                                  <%--if(lLAppMain.getApprovalId()>0){%>
                                                                  <%}--%>
                                                            </b></td>
                                                          </tr>
                                                          ...
                                                          <!--Exc Prod-->
                                                          <%
                                                          if(lLAppMain.getApprovalId()>0 && maxApporval>= 2){
                                                          %>
                                                          <tr>
                                                              ...
                                                              <% 
                                                                  ...
                                                                  <%}else{%>
                                                                  <%												  
                                                                      if(lLAppMain.getOID()>0 && lLAppMain.getApprovalId()>0)
                                                                          {
                                                                                  Vector divHeadKey = new Vector(1,1);
                                                                                  Vector divHeadValue = new Vector(1,1);
                                                                                  ...
                                                                                  String selectedApproval = ""+lLAppMain.getApproval2Id();
                                                                                  if(approvedId2>0){
                                                                                 ...
                                                                                 // vectPositionLvl1.add(""+PstPosition.LEVEL_SECRETARY);
                                                                                  ...
                                                                                  out.println(ControlCombo.draw(FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL2_ID], null, selectedApproval, divHeadValue, divHeadKey, strAttribute));														  
                                                                          }					
                                                                  }											  		  
                                                              %>
                                                              ...
                                                              <td width="23%" ><b>
                                                                   <%=ControlDatePopup.writeDate(FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL2_DATE],(lLAppMain.getApproval2Date()==null ? new Date() : lLAppMain.getApproval2Date()))%>
                                                                  <%--if(lLAppMain.getApproval2Id()>0){%>
                                                                  <%}--%>
                                                              </b></td>
                                                          </tr>
                                                          ...
                                                          <!--Prod Talent-->
                                                          <%
                                                          if(lLAppMain.getApproval2Id()>0 && maxApporval>=3){
                                                          %>
                                                          <tr>
                                                              ...
                                                              <td width="60%" ><b>
                                                                  ...
                                                                  %>
                                                                          ...
                                                                          <%}else{%>
                                                                          <%												  
                                                                             if(lLAppMain.getOID()>0 && lLAppMain.getApproval2Id()>0)
                                                                                  {
                                                                                          Vector divHeadKey = new Vector(1,1);
                                                                                          Vector divHeadValue = new Vector(1,1);
                                                                                          ...
                                                                                          String selectedApproval = ""+lLAppMain.getApproval3Id();
                                                                                          if(approvedId3>0){
                                                                                         ...
                                                                                         // vectPositionLvl1.add(""+PstPosition.LEVEL_SECRETARY);
                                                                                          ...
                                                                                          out.println(ControlCombo.draw(FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL3_ID], null, selectedApproval, divHeadValue, divHeadKey, strAttribute));														  
                                                                                  }
                                                                          }												  		  
                                                                      %>
                                                              </b></td>
                                                              <td width="23%" ><b>
                                                                    <%=ControlDatePopup.writeDate(FrmLLAppMain.fieldNames[FrmLLAppMain.FRM_FLD_APPROVAL3_DATE],(lLAppMain.getApproval3Date()==null ? new Date() : lLAppMain.getApproval3Date()))%>
                                                                  <%--if(lLAppMain.getApproval3Id()>0){--%>
                                                                  <%--}--%>
                                                              </b></td>
                                                          </tr>                                                          
