...
<% int  appObjCode = 1;//AppObjInfo.composeObjCode(AppObjInfo.G1_SECRETARY , AppObjInfo.G2_SECRETARY_GENERAL   , AppObjInfo.OBJ_SG_LEAVE_DP   	); %>
                                                ...
                                                <td width="97%"> 
                                                  <table border="0" cellspacing="2" cellpadding="2" width="52%">
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="51%"><%= ControlCombo.draw(frmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_ORDER],"formElemen",null, ""+srcEmployee.getOrderBy(), FrmSrcEmployee.getOrderValue(), FrmSrcEmployee.getOrderKey(), " onkeydown=\"javascript:fnTrapKD()\"") %> 
                                                      </td>
                                                      <td width="5%">&nbsp;</td>
