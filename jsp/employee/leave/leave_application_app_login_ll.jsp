...
if(loggedInSuccess)
{
    switch(indexApproval){
        case 1: 
            %>
                <jsp:forward page="ll_application_edit.jsp"> 
                <jsp:param name="command" value="<%=Command.EDIT%>" />	
                <jsp:param name="start" value="<%=start%>" />
                <jsp:param name="oidLLAppMain" value="<%=oidLLAppMain%>" />
...
function cmdLogin()	
{
  ...
  document.frm_leave_application.action = "leave_application_app_login_ll.jsp";
...
function cmdBackToEditor(oidLeaveApplication, depHeadAuthorize, managerOid)	
{
  ...
  document.frm_leave_application.action = "ll_application_edit.jsp";
  document.frm_leave_application.submit();
}
