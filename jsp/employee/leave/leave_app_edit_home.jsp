...
<%-- 
    Document   : leave_app_edit_home
    Created on : May 8, 2010, 11:02:25 AM
    Author     : root
--%>
...
<%!
 ...
 static final int STATUS_LEAVE_UNPAID_LEAVE = 2;       
    ...
    public Vector drawListAnnualLeave(Vector vectorAlStockTaken,int indexAlGet, long oidEmployee, long oidLeave, int docStatus){
            ...
            try{
                alManagement = PstAlStockManagement.fetchExc(oidLeave);
            }catch(Exception e){
            ...
            */
            ...
            eligbleDay = SessLeaveApplication.getAlEligbleDay(oidEmployee); 
        ...
        public Vector drawListLongLeave(Vector vectorLlStockTaken,long oidEmployee, long oidLeave, int indexLlget, int docStatus){
        ...
        public Vector drawListDPLeave(Vector vectorDpStockTaken, long oidEmployee, long oidLeave,int indexDpGet, int docStatus){
            ...
            ctrlist.addHeader("Unpaid Date", "20%");  
            ctrlist.addHeader("Action", "10%");                        
...
<%
                            ...
                            case 2 : objLeaveApplication.setHrManApproval(oidApprover);
                                    ...
                                    if (objLeaveApplication.getDocStatus() == 1) {
                                        ...
                                        if (objLeaveApplication.getEmployeeId() != 0 && maxApproval2 == I_Leave.LEAVE_APPROVE_1) {
                                         ...
                                         try{
                                             //PstLeaveApplication.updateExc(objLeave2);
    ...
    //try{
    //    vectorUnpaidStockTaken = SessLeaveApplication.ListUnpaidLeaveTake(objLeaveApplication.getOID());
    //    }catch(Exception e){
    //    System.out.println("Exception "+e.toString());
    //}
    }
...
function cmdCancel()
{
	...
	document.frm_leave_application.action="leave_app_edit_home.jsp";
...
function cmdBack()
{
	document.frm_leave_application.command.value="<%=String.valueOf(Command.ACTIVATE)%>"; 
	...
	if(empLoggedIn != 0)
	{
		if(empApprovalSelected != 0)
		{
			...
			//{
				...
				document.frm_leave_application.action="leave_app_approval_home.jsp";
				document.frm_leave_application.submit();  		
			//}else{
                          /*  if(index==1){
            ...
            <tr> 
                ...
                <tr> 
                    ...
                    <tr>                     
                        ...
                        <tr>
                            <td>
                            <% Vector res = drawListAnnualLeave(vectorAlStockTaken,indexAl, objLeaveApplication.getEmployeeId() ,oidLeave, objLeaveApplication.getDocStatus());
                        ...
                        <tr>
                            <td>
                            <% Vector vectdrawListLongLeave = drawListLongLeave(vectorLlStockTaken, objLeaveApplication.getEmployeeId() ,oidLeave, indexLl,objLeaveApplication.getDocStatus());
                        ...
                        <tr>
                            <td>
                             <% Vector vectdrawlistDpLeave = drawListDPLeave(vectorDpStockTaken, objLeaveApplication.getEmployeeId() ,oidLeave, indexDP,objLeaveApplication.getDocStatus());
