...
public String drawList(Vector objectClass,boolean isHRDLogin,int isAdminExecuteLeave,Hashtable hashViewPeriod ) 
{
...
//vectSize = sessLeaveApplication.countSearchLeaveApplicationExcecute(srcLeaveApp);
...
// update by satrya 2014-04-08 Vector records = sessLeaveApplication.searchLeaveApplicationExcecute(srcLeaveApp, start, recordToGet);
                            ...
                            <td valign="top">
							  ...
							  %> 
								<form name="frm_leave_application" method="post" action="">
								  ...
								  {
									 out.println(drawList(records,isHRDLogin,isAdminExecuteLeave,hashViewPeriod)); 
								  }										  
								  else
								  {
