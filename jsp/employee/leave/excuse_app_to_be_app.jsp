        ...
        for(int i=0; i<leave_application_id.length; i++){
          ...
          //  emp_approve[i] = FRMQueryString.requestString(request,"employee_approval_"+i); 
            ...
            //          employeeId  = Long.parseLong(emp_approve[i]);
             ...
             SessLeaveApplication.approvalandSetApproveCheckBox(objEmployee.getOID(),leaveAppIdProces);
    }
}
...
if((iCommand==Command.NEXT) || (iCommand==Command.FIRST) || (iCommand==Command.PREV) || (iCommand==Command.LAST)|| (iCommand==Command.BACK) || (iCommand==Command.APPROVE))
...
function cmdProccess() {
    ...
    document.frm_leave_application.action = "leave_app_to_be_app.jsp";
