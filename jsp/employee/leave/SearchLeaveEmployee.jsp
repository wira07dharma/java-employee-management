...
<%-- 
    Document   : SearchLeaveEmployee
    Created on : Dec 22, 2009, 2:16:49 PM
    Author     : Tu Roy
--%>
...
public String drawList(Vector objectClass)
{
	...
	for (int i = 0; i < objectClass.size(); i++) 
	{
		...
		lstData.add(rowx);
		lstLinkData.add(employee.getOID() + "','" + employee.getEmployeeNum() + "','" + employee.getFullName() + "','" + employee.getDepartmentId() + "','" + position.get(String.valueOf(employee.getPositionId())) + "','" + Formater.formatDate(employee.getCommencingDate(), "dd MMMM yyyy"));
	}
