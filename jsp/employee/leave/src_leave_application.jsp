...
function cmdAdd(){
	...
	document.frmsrcleaveapplication.action="leave_application_edit.jsp";
	document.frmsrcleaveapplication.submit();
}

function cmdSearch(){
	document.frmsrcleaveapplication.command.value="<%=String.valueOf(Command.LIST)%>";
	document.frmsrcleaveapplication.action="leave_application_list.jsp";
	document.frmsrcleaveapplication.submit();
}
                                      ...
                                      <table border="0" cellspacing="2" cellpadding="2" width="100%" >
                                        ...
                                        <tr>
                                          ...
                                          <td nowrap width="87%"> 
											...
											approval_value.add(""+PstLeaveApplication.FLD_NOT_APPROVED);
											approval_key.add(""+PstLeaveApplication.fieldApprovalStatusNames[PstLeaveApplication.FLD_NOT_APPROVED]);                                                          

											approval_value.add(""+PstLeaveApplication.FLD_APPROVE_BY_DEPT_HEAD);
											approval_key.add(""+PstLeaveApplication.fieldApprovalStatusNames[PstLeaveApplication.FLD_APPROVE_BY_DEPT_HEAD]);

											approval_value.add(""+PstLeaveApplication.FLD_APPROVE_BY_HR_MANAGER);
											approval_key.add(""+PstLeaveApplication.fieldApprovalStatusNames[PstLeaveApplication.FLD_APPROVE_BY_HR_MANAGER]);
											
											String selectValueApprovalStatus = ""+objSrcLeaveApplication.getApprovalStatus();                                                          
											
											if(isManager)
											{
												selectValueApprovalStatus = ""+PstLeaveApplication.FLD_NOT_APPROVED;
											}
											
											if(isHrManager)
											{
												selectValueApprovalStatus = ""+PstLeaveApplication.FLD_APPROVE_BY_DEPT_HEAD;
											}
											%>
                                        ...
                                        <tr> 
                                          ...
                                          <td nowrap width="85%"> 
                                            <table border="0" cellpadding="0" cellspacing="0" width="424">
                                              <tr> 
                                                <td width="6%"><a href="javascript:cmdSearch()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="Search for Leave Application" ></a></td>
