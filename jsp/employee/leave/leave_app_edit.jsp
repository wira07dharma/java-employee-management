...
<%!
    ...
    static final int LEAVE_TYPE_SPECIAL_STOCK = 5;
        ...
        if (vectorAlStockTaken.size() > 0) {
            ...
            for (indexAl = 1; indexAl <= vectorAlStockTaken.size(); indexAl++) {
                ...
                try {
                    ...
                    //perubahan untuk borobudur dibuka setahun 2016 //tidak bisa diedit
                    expiredDtCanUpdate = true;
                } catch (Exception E) {
                    System.out.println("[exception] " + E.toString());
                }
            ...
            if (statusEditAl == false) {
                ...
                if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                    ...
                    rowx.add("" + ControlDatePopupTaken + " " + ctrTimeStart);
                }
                if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                    rowx.add("");
                } else {
                    rowx.add("" + ControlDatePopupFinnish + " " + ctrTimeEnd);
                }//end
                if (oidEmployee == 0) {
                    rowx.add("");
                } else {
    ...
    public Vector drawListSpecialUnpaidLeave(Vector vectorSpecialUnpaidStockTaken, LeaveApplication objLeaveApplication, long oidLeave, int indexSpecialget, int docStatus, java.util.Date requestDate, int stsKaryawan, int typeForm) {
            //public Vector drawListSpecialUnpaidLeave(Vector vectorSpecialUnpaidStockTaken,long oidEmployee, long oidLeave, int indexSpecialget, int docStatus,java.util.Date requestDate){ 

        //  public Vector drawListSpecialUnpaidLeave(Vector vectorSpecialUnpaidStockTaken,long oidEmployee, long oidLeave, int indexSpecialget, int docStatus){
        Vector result = new Vector();
        Vector vctDetails = new Vector();
        long oidEmployee = 0;
        ...
        if (vectorSpecialUnpaidStockTaken.size() > 0) {
            ...
            for (indexSpecial = 1; indexSpecial <= vectorSpecialUnpaidStockTaken.size(); indexSpecial++) {

                SpecialUnpaidLeaveTaken objSpecialUnpaidLeaveTaken = (SpecialUnpaidLeaveTaken) vectorSpecialUnpaidStockTaken.get(indexSpecial - 1);
                //update by devin 2014-03-25
                try {
                    if (notSamePeriodLeaveKonfig) {
                ...
                if (indexSpecial == 1) {
                    ...
                    if (indexSpecial == indexSpecialget) {
                        ...
                        rowx.add("" + ControlDatePopupTakenDateSpecial + " " + ctrTimeStart);
                        rowx.add("" + ControlDatePopupFinnishDateSpecial + " " + ctrTimeEnd);
                        if (oidEmployee == 0) {
                            rowx.add("");
                        } else {
                            if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
...
///                    rowx.add(""+Formater.formatWorkDayHoursMinutes(objSpecialUnpaidLeaveTaken.getTakenQty(), leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave() ));
            ...
            if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                ...
                rowx.add("" + ControlDatePopupTaken + " " + ctrTimeStart);
            } //untuk memunculkan pilihan start time
            if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                rowx.add("");
            } else {
                rowx.add("" + ControlDatePopupFinnish + " " + ctrTimeEnd);
            }//end //untuk memunculkan pilihan end time
            if (oidEmployee == 0) {
                rowx.add("");
            } else {
                if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
    ...
    public Vector drawListDPLeave(Vector vListAl, Vector vectorDpStockTaken, long oidEmployee, long oidLeave, int indexDpGet, int docStatus, java.util.Date requestDate, int iCommand) {
        ...
        ctrlist.addHeader("Qty", "5%");
        ctrlist.addHeader("Taken", "5%");
        ctrlist.addHeader("Current Qty", "5%");
        ctrlist.addHeader("To Be Taken", "5%");
        ctrlist.addHeader("No. of Days <br />Eligible", "5%");
        ctrlist.addHeader("No. of Days <br />Requested", "5%");
        ...
        if (vectorDpStockTaken.size() > 0) {
            ...
            if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                ...
                rowx.add(leaveConfig != null && leaveConfig.getConfigurationLeaveApprovall() == I_Leave.LEAVE_CONFIG_REQUEST_DP_TAKEN_YES_LONG ? "" + ControlDatePopupTaken + "<br>" + ctrTimeStart + " <b>To</b> " + ControlDatePopupFinnishDate + " " + ctrTimeEnd + cekboxFullDay : "" + ControlDatePopupTaken + "<br>" + ctrTimeStart + "&nbsp; <b>To</b> &nbsp;" + ctrTimeEnd + " " + ControlDatePopupFinnishDate);
            }//end
...
<%!
    public Vector drawListSpecialStock(Vector vListAl, Vector vectorSpecialStockTaken, long oidEmployee, long oidLeave, int indexSSGet, int docStatus, java.util.Date requestDate, int iCommand, long oidSchedule) {
        Vector result = new Vector();
        Vector vctDetails = new Vector();
        ...
        ctrlist.addHeader("Current Qty", "5%");
        ctrlist.addHeader("To Be Taken", "5%");
        ctrlist.addHeader("Eligible", "5%");
        ctrlist.addHeader("Requested", "5%");
        ctrlist.addHeader("Taken Date", "20%");
        ctrlist.addHeader("Action", "10%");
        ...
        float eligbleDay = 0;
        float ssQty = 0;
        float totalSSTaken = 0;
        float curentSSQty = 0;
        float totalSS2BeTaken = 0;
		...
		for (int j = 0; j < vListAl.size(); j++) {
            RepItemLeaveAndDp item = null;
            item = (RepItemLeaveAndDp) vListAl.get(j);
            eligbleDay = item.getSSQty() - item.getSSTaken() - item.getSS2BTaken();
            // eligbleDay = item.getALTotal() - item.getALTaken() - item.getAL2BTaken();
            ssQty = item.getSSQty();
            totalSSTaken = item.getSSTaken();
            curentSSQty = item.getSSQty();
			totalSS2BeTaken = item.getSS2BTaken();
        }
		...
		for (int s = 0; s < listSchedule.size(); s++){
			ScheduleSymbol symbol = (ScheduleSymbol) listSchedule.get(s);
			schedule_value.add(String.valueOf(symbol.getOID()));
			schedule_key.add(symbol.getSymbol() + " - "+ symbol.getSchedule());
		}
        /* Stock yang boleh di ambil*/
        boolean StsCanMinus = false;
        /* Logikanya :
        ...
        if (vectorSpecialStockTaken.size() > 0) {
            ...
            String dateFinish = "";
            int indexSS;
            boolean statusEditSS = false;
            String formatTakenDate = "yyyy-MM-dd";
            String formatFinishTime = "";
            long oidDepHeadAppr = 0;
            long oidLeaveDifferent = 0;

            for (indexSS = 1; indexSS <= vectorSpecialStockTaken.size(); indexSS++) {
                SpecialStockTaken objStockTaken = (SpecialStockTaken) vectorSpecialStockTaken.get(indexSS - 1);
                try {
                    if (notSamePeriodLeaveKonfig) {
                        long oid = objStockTaken.getLeaveApplicationId();
                        String where = PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + " = " + oid;
                        Vector getData = PstLeaveApplication.list(0, 0, where, "");
                ...
                if (objStockTaken.getTakenDate().getHours() == objStockTaken.getTakenFinishDate().getHours()
                        && objStockTaken.getTakenDate().getMinutes() == objStockTaken.getTakenFinishDate().getMinutes()) {
                    formatTakenDate = "yyyy-MM-dd";
                } else {
                    formatTakenDate = "yyyy-MM-dd HH:mm";
                    formatFinishTime = " HH:mm";
                ...
                ScheduleSymbol scheduleSymbol = new ScheduleSymbol();
                try {
                    String where = PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_SCHEDULE_ID] + "=" + objStockTaken.getScheduleId();
                ...
                String selectValueSchedule = "" + objStockTaken.getScheduleId();

                String controlCombo = ControlCombo.draw(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SCHEDULE_ID], "elementForm", null, ""+oidSchedule, schedule_value, schedule_key, " onkeydown=\"javascript:fnTrapKD()\" onChange=\"javascript:selectSchedule(this.value)\"");

                dateStart = objStockTaken.getTakenDate() == null ? "" : Formater.formatDate(objStockTaken.getTakenDate(), "yyyy-MM-dd HH:mm");   //untuk Time start Date 
                dateFinish = objStockTaken.getTakenFinishDate() == null ? "" : Formater.formatDate(objStockTaken.getTakenFinishDate(), "yyyy-MM-dd HH:mm"); //untuk time Finnish date

                String ControlDatePopupTakenDateStock = ControlDatePopup.writeDate(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_DATE], (objStockTaken.getTakenDate() == null ? requestDate : objStockTaken.getTakenDate()), "getSsStartDate()"); //untuk tanggal taken date
                String ControlDatePopupFinnishDateStock = leaveConfig != null && leaveConfig.getConfigurationLeaveApprovall() == I_Leave.LEAVE_CONFIG_REQUEST_DP_TAKEN_YES_LONG ? ControlDatePopup.writeDate(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_FINISH_DATE], (objStockTaken.getTakenDate() == null ? requestDate : objStockTaken.getTakenDate()), "getSsFinishDate()") : ControlDatePopup.writeDateHide(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_FINISH_DATE], (objStockTaken.getTakenDate() == null ? requestDate : objStockTaken.getTakenDate()), "getSsFinishDate()");
                //update by satrya 2012-07-31
                //String ControlDatePopupTakenDateSpecial = ControlDatePopup.writeDate(FrmSpecialUnpaidLeaveTaken.fieldNames[FrmSpecialUnpaidLeaveTaken.FRM_FLD_TAKEN_DATE],(objSpecialUnpaidLeaveTaken.getTakenDate() == null ? new Date() : objSpecialUnpaidLeaveTaken.getTakenDate()), "getSpecialStartDate()");
                //String ControlDatePopupFinnishDateSpecial = ControlDatePopup.writeDate(FrmSpecialUnpaidLeaveTaken.fieldNames[FrmSpecialUnpaidLeaveTaken.FRM_FLD_TAKEN_FINNISH_DATE],( objSpecialUnpaidLeaveTaken.getTakenFinnishDate() == null ? new Date() : objSpecialUnpaidLeaveTaken.getTakenFinnishDate()),"getSpecialEndDate()");
                String ctrTimeStart = ControlDate.drawTime(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_DATE], objStockTaken.getTakenDate()/*requestDate*/, "elemenForm", 24, 15, 0); //ctrl start time 
                String ctrTimeEnd = ControlDate.drawTime(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_FINISH_DATE], objStockTaken.getTakenFinishDate()/*requestDate*/, "elemenForm", 24, 15, 0); //ctrl finnish 
                //String ctrTimeStart = ControlDate.drawTime(FrmSpecialUnpaidLeaveTaken.fieldNames[FrmSpecialUnpaidLeaveTaken.FRM_FLD_TAKEN_DATE], objSpecialUnpaidLeaveTaken.getTakenDate(), "elemenForm", 24, 15, 0);
                //String ctrTimeEnd = ControlDate.drawTime(FrmSpecialUnpaidLeaveTaken.fieldNames[FrmSpecialUnpaidLeaveTaken.FRM_FLD_TAKEN_FINNISH_DATE], objSpecialUnpaidLeaveTaken.getTakenFinnishDate(), "elemenForm", 24, 15, 0);
                ...
                if (indexSS == 1) {
                    ...
                    if (leaveConfig != null && leaveConfig.isLeaveApplicationIsDay()) {
                        if (notSamePeriodLeaveKonfig && oidDepHeadAppr != 0 && (oidLeaveDifferent != 0 || oidDepHeadAppr == 0 && oidLeaveDifferent != 0)) {
                            float qty = 0;
                            float totalQty = 0;
                            qty = DateCalc.workDayDifference(objStockTaken.getTakenDate(), objStockTaken.getTakenFinishDate(), 8f);
                            totalQty = qty + 1;
                            rowx.add("" + Formater.formatWorkDayHoursMinutes(qty, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));//No. of DaysRequested

                        } else {
                            rowx.add("" + Formater.formatWorkDayHoursMinutes(objStockTaken.getTakenQty(), leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));//No. of DaysRequested
                        }

                    } else {
                        rowx.add("" + Formater.formatWorkDayHoursMinutesII(objStockTaken.getTakenQty(), leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                    }
                    if (indexSSGet == indexSS) {
                        statusEditSS = true;
                        rowx.add(leaveConfig != null && leaveConfig.getConfigurationLeaveApprovall() == I_Leave.LEAVE_CONFIG_REQUEST_DP_TAKEN_YES_LONG ? "" + ControlDatePopupTakenDateStock + ControlDatePopupFinnishDateStock  : "" + ControlDatePopupTakenDateStock + ControlDatePopupFinnishDateStock);
                        if (oidEmployee == 0) {
                            rowx.add("");
                            //rowx.add("");
                        } else {
                            /*if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                                ...
                                rowx.add(leaveConfig != null && leaveConfig.getConfigurationLeaveApprovall() == I_Leave.LEAVE_CONFIG_REQUEST_DP_TAKEN_YES_LONG ? "" + ControlDatePopupFinnishDateStock + "<br>" + ctrTimeEnd : "" + ControlDatePopupFinnishDateStock + "<br>" + ctrTimeEnd);
                            }*/

                            if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
								if (StsCanMinus){
                                rowx.add("<input type=\"hidden\" value=\""+objStockTaken.getSpecialStockId()+"\" name=\"" + FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SPECIAL_STOCK_ID] + "\">"
											+ "<input type=\"hidden\" value=\""+objStockTaken.getScheduleId()+"\" name=\"" + FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SCHEDULE_ID] + "\">"
											+"<a href=\"javascript:cmdSaveSS('" + indexSS + "','" + objStockTaken.getOID() + "')\">Save</a> | <a href=\"javascript:cmdCancelSS('" + oidEmployee + "','" + oidLeave + "')\">Cancel</a>");
								 } else {
										rowx.add("No special stock eligible!");
									}
                            } else {
                                rowx.add("");
                            }
                        ...
                        //rowx.add("" + dateFinish);
                        if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
                            rowx.add("<a href=\"javascript:cmdEditSS('" + oidEmployee + "','" + oidLeave + "','" + indexSS + "','" + objStockTaken.getOID() + "')\">Edit</a> | <a href=\"javascript:cmdDeleteSS('" + indexSS + "','" + objStockTaken.getOID() + "')\">Delete</a>");
                        } else {
                            rowx.add("");
                        }
                    }
                    ...
                    if (leaveConfig != null && leaveConfig.isLeaveApplicationIsDay()) {
                        if (notSamePeriodLeaveKonfig && oidDepHeadAppr != 0 && (oidLeaveDifferent != 0 || oidDepHeadAppr == 0 && oidLeaveDifferent != 0)) {
                            float qty = 0;
                            float totalQty = 0;
                            qty = DateCalc.workDayDifferenceLl(objStockTaken.getTakenDate(), objStockTaken.getTakenFinishDate(), 8f);
                            totalQty = qty + 1;
                            rowx.add("" + Formater.formatWorkDayHoursMinutes(qty, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));

                        } else {
                            rowx.add("" + Formater.formatWorkDayHoursMinutes(objStockTaken.getTakenQty(), leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                        }
                        rowx.add("" + Formater.formatWorkDayHoursMinutes(objStockTaken.getTakenQty(), leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                    } else {
                        rowx.add("" + Formater.formatWorkDayHoursMinutesII(objStockTaken.getTakenQty(), leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
			...
			aNewDate.setSeconds(0);
			//jika sudah di save maka selanjutnya akan di set tgl n jambrp
			String ControlDatePopupTakenDate = ControlDatePopup.writeDate(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_DATE], requestDate == null ? aNewDate : requestDate, "getSsStartDate()");

			//update by satrya 2013-12-12  String ControlDatePopupFinnishDate = ControlDatePopup.writeDateHide(FrmDpStockTaken.fieldNames[FrmDpStockTaken.FRM_FIELD_FINNISH_DATE], requestDate ==null ? aNewDate: requestDate,"getDpFinishDate()");
			String ControlDatePopupFinnishDate = leaveConfig != null && leaveConfig.getConfigurationLeaveApprovall() == I_Leave.LEAVE_CONFIG_REQUEST_DP_TAKEN_YES_LONG ? ControlDatePopup.writeDate(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_FINISH_DATE], requestDate == null ? aNewDate : requestDate, "getSsFinishDate()") : ControlDatePopup.writeDateHide(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_FINISH_DATE], requestDate == null ? aNewDate : requestDate, "getSsFinishDate()");
			String ctrTimeStart = ControlDate.drawTime(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_DATE], aNewDate, "elemenForm", 24, 15, 0);//waktunya
			String ctrTimeEnd = ControlDate.drawTime(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_FINISH_DATE], aNewDate, "elemenForm", 24, 15, 0);//waktunya
			String controlCombo = ControlCombo.draw(FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SCHEDULE_ID], "elementForm", null, ""+oidSchedule, schedule_value, schedule_key, " onkeydown=\"javascript:fnTrapKD()\" onChange=\"javascript:selectSchedule(this.value)\"");

                rowx.add("" + i);
                rowx.add(controlCombo);
                if (leaveConfig != null && leaveConfig.isLeaveApplicationIsDay()) {
                    rowx.add("" + Formater.formatWorkDayHoursMinutes(ssQty, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                    rowx.add("" + "<p title=" + Formater.formatNumber(totalSSTaken, "###.###") + ">" + Formater.formatWorkDayHoursMinutes(totalSSTaken, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()) + "</p>");
                    rowx.add("" + Formater.formatWorkDayHoursMinutes(curentSSQty, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                    rowx.add("" + Formater.formatWorkDayHoursMinutes(totalSS2BeTaken, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                    rowx.add("" + "<p title=" + Formater.formatNumber(eligbleDay, "###.###") + ">" + Formater.formatWorkDayHoursMinutes(eligbleDay, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()) + "</p>");
                } else {
                    rowx.add("" + Formater.formatWorkDayHoursMinutesII(ssQty, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                    rowx.add("" + "<p title=" + Formater.formatNumber(totalSSTaken, "###.###") + ">" + Formater.formatWorkDayHoursMinutesII(totalSSTaken, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()) + "</p>");
                    rowx.add("" + Formater.formatWorkDayHoursMinutesII(curentSSQty, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                    rowx.add("" + Formater.formatWorkDayHoursMinutesII(totalSS2BeTaken, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()));
                    rowx.add("" + "<p title=" + Formater.formatNumber(eligbleDay, "###.###") + ">" + Formater.formatWorkDayHoursMinutesII(eligbleDay, leaveConfig.getHourOneWorkday(), leaveConfig.getFormatLeave()) + "</p>");
                }
                rowx.add("" + 0);
                if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                    ...
                    rowx.add(leaveConfig != null && leaveConfig.getConfigurationLeaveApprovall() == I_Leave.LEAVE_CONFIG_REQUEST_DP_TAKEN_YES_LONG ? "" + ControlDatePopupTakenDate + ControlDatePopupFinnishDate  : "" + ControlDatePopupTakenDate + ControlDatePopupFinnishDate);
                }
                ...
                if (oidEmployee == 0) {
                    ...
                    if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
						if (StsCanMinus){
							rowx.add("<a href=\"javascript:cmdSaveSS('0','0')\">Save</a>");
						} else {
							rowx.add("No special stock eligible!");
						}
                    } else {
            ...
            if (oidEmployee == 0) {
                ...
                /*if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                    ...
                    rowx.add(leaveConfig != null && leaveConfig.getConfigurationLeaveApprovall() == I_Leave.LEAVE_CONFIG_REQUEST_DP_TAKEN_YES_LONG ? "" + ControlDatePopupFinnishDate + "<br>" + ctrTimeEnd : "" + ControlDatePopupFinnishDate + "<br>" + ctrTimeEnd);
                }*/
                if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
                    if (StsCanMinus) {
                        rowx.add("<input type=\"hidden\" value=\"\" name=\"" + FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SPECIAL_STOCK_ID] + "\">"
									+ "<a href=\"javascript:cmdSaveSS('0','0')\">Save</a>");
                    } else {
                        rowx.add("No special stock eligible!");
                    }
                } else {
...
<%
	...
	int indexSS = FRMQueryString.requestInt(request, "indexSS");
	long oidSchedule = FRMQueryString.requestLong(request, FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SCHEDULE_ID]);
	...
	long TakenSsOid = FRMQueryString.requestLong(request, FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SPECIAL_STOCK_TAKEN_ID]);
...
//update by satrya 2012-07-25
    if (leaveType == LEAVE_TYPE_APPLICATION || (source != null && "presence".equals(source) && iCommand == Command.EDIT)) {
        ...
        if (ileaveConfig != null && ileaveConfig.getConfigurationSendMail() == I_Leave.LEAVE_CONFIG_SEND_EMAIL_CREATE_BY_LEAVE_FORM) {
            ...
            if (indexMain != 0) {
                iErrCode = ctrlLeaveApplication.action(iCommand, oidLeave, null, approot);
                ctrlLeaveApplication.setLeavePreparedBy(oidLeave, emplx.getOID());
            }
        ...
        if (leaveType == LEAVE_TYPE_APPLICATION) {
            ...
            if (oidApprover != 0) {
                ...
                switch (indexApproval) {
                    case 1:
                        objLeaveApplication.setDepHeadApproval(oidApprover);
                        ...
                        break;
                    case 2:
                        objLeaveApplication.setHrManApproval(oidApprover);
                        ...
                        break;
                    case 3:
                        objLeaveApplication.setGmApproval(oidApprover);
...
//update by satrya
    ...
    int iErrCodeSS = FRMMessage.ERR_NONE;
    String errMsgAL = "";
    String errMsgLL = "";
	...
	srcLeaveManagement.setScheduleId(oidSchedule);
    ...
    if (leaveType == LEAVE_TYPE_AL) {
        ...
        iErrCodeSpecial = ctrlSpecialUnpaidTaken.action(iCommand, TakenSpecialOid, positionOfLoginUser);
    ...
    } else if (leaveType == LEAVE_TYPE_SPECIAL_STOCK) {
        CtrlSpecialStockTaken ctrlSpecialStockTaken = new CtrlSpecialStockTaken(request);
        iErrCodeSS = ctrlSpecialStockTaken.action(iCommand, TakenSsOid);
        if ((iErrCodeDp == 0 && iCommand == Command.SAVE) || (iErrCodeDp == 0 && iCommand == Command.DELETE)) {
            indexSS = -1;
        }
        FrmSpecialStockTaken frmSpecialStockTaken = ctrlSpecialStockTaken.getForm();
        errMsgSS = ctrlSpecialStockTaken.getMessage();
    }
    listal = SessLeaveApp.detailLeaveDPStock(srcLeaveManagement);
    //update by satrya 2013-04-11
    ...
    Vector vectorSpecialUnpaidStockTaken = new Vector();
    Vector vectorUnpaidStockTaken = new Vector();
    //ADDED BY DEWOK 2019-07-16
    ...
    if (objLeaveApplication.getOID() != 0) {
        ...
        try {
            vectorSpecialUnpaidStockTaken = SessLeaveApplication.ListSpecialUnpaidLeave(objLeaveApplication.getOID(), type_form);
        } catch (Exception e) {
            System.out.println("Exception " + e.toString());
        }
        ...
        //ADDED BY DEWOK 2019-07-16
        try {
            String whereClause = PstSpecialStockTaken.fieldNames[PstSpecialStockTaken.FLD_LEAVE_APPLICATION_ID] + " = " + objLeaveApplication.getOID();
            String order = PstSpecialStockTaken.fieldNames[PstSpecialStockTaken.FLD_TAKEN_DATE];
            vectorSpecialStockTaken = PstSpecialStockTaken.list(0, 0, whereClause, order);
        } catch (Exception e) {
            System.out.println("Exception " + e.toString());
        }
...
<html>
    ...
    <head>    
        ...
        <script language="JavaScript">
			...
			function getSsStartDate() {
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_DATE])%>
            }

            function getSsFinishDate() {
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_TAKEN_FINISH_DATE])%>
            }
            ...
            <%}%>
                    ...
                    function cmdSaveReason()
                    {
                        document.frm_leave_application.indexMain.value = 1;
                        document.frm_leave_application.command.value = "<%=String.valueOf(Command.UNLOCK)%>";
                        document.frm_leave_application.action = "<%=approot%>/employee/leave/leave_app_edit.jsp";
                        document.frm_leave_application.submit();
                    }
                    function cmdRel(oid)
            ...
            <%}%>
                    ...
                    //ADDED BY DEWOK 2019-07-16
                    function cmdSaveSS(indexSS, TakenSSOid) {
                        getSsStartDate();
                        getSsFinishDate();
                        document.frm_leave_application.command.value = "<%=Command.SAVE%>";
                        document.frm_leave_application.leaveType.value =<%= LEAVE_TYPE_SPECIAL_STOCK%>;
                        document.frm_leave_application.indexSS.value = indexSS;
                        document.frm_leave_application.indexMain.value = 0;
                        document.frm_leave_application.<%=FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SPECIAL_STOCK_TAKEN_ID]%>.value = TakenSSOid;
                        document.frm_leave_application.action = "<%=approot%>/employee/leave/leave_app_edit.jsp";
                        document.frm_leave_application.submit();
                    }
					
					function cmdEditSS(oidEmployee, oidLeave, indexSS, TakenSsOid) {
                        getSsStartDate();
                        getSsFinishDate();
                        document.frm_leave_application.command.value = "<%=Command.EDIT%>";
                        document.frm_leave_application.<%=FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_LEAVE_APPLICATION_ID]%>.value = oidLeave;
					...
					function cmdDeleteSS(indexSS, TakenSsOid) {
                        var cfrm = confirm('Are you sure you want to delete Leave request ?');
                        if (cfrm == true) {
                            getSsStartDate();
                            getSsFinishDate();
                                                                        ...
                                                                        <tr>                     
                                                                            <td valign="top">
                                                                                ...
                                                                                <form name="frm_leave_application" method="post" action="">                            
                                                                                    ...
                                                                                    <input type="hidden" name="<%=FrmSpecialStockTaken.fieldNames[FrmSpecialStockTaken.FRM_FIELD_SPECIAL_STOCK_TAKEN_ID]%>" value="<%=String.valueOf(TakenDpOid)%>"> 
																					...
																					<input type="hidden" name="indexSS" value="<%=String.valueOf(indexSS)%>">    
                                                                                    ...
                                                                                    <div align="center">
                                                                                        ...
                                                                                        <%
                                                                                            if (type_form == PstLeaveApplication.LEAVE_APPLICATION) {
                                                                                                if (iCommand == Command.ADD) {
                                                                                                    ...
                                                                                                    out.println(ControlCombo.draw(FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_TYPE_FORM_LEAVE], null, "" + PstLeaveApplication.strLeaveAppType[objLeaveApplication.getTypeFormLeave()], vectValsLeaveType, vectListsLeaveType, ""));
                                                                                                    if (objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                                                                                                        out.println("EXECUTE");
                                                                                                    } else {
                                                                                                        out.println("");
                                                                                        ...
                                                                                        %>
                                                                                        <h2><%="" + PstLeaveApplication.strLeaveAppType[objLeaveApplication.getTypeFormLeave()]%> <%if (objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                                                                                                out.println("EXECUTE");
                                                                                            } else {
                                                                                                out.println("");
                                                                                            }%></h2>
                                                                                        ...
                                                                                        <h2>EXCUSE APPLICATION <%if (objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                                                                                                out.println("EXECUTE");
                                                                                            } else {
                                                                                                out.println("");
                                                                                            }%></h2>
                                                                                                ...
                                                                                                <%
                                                                                                    if (objLeaveApplication != null && objLeaveApplication.getOID() != 0) {
                                                                                                        ...
                                                                                                        try {
                                                                                                            //update by satrya 2012-07-31
                                                                                                            /// Date requestDateLeave =  objLeaveApplication.getSubmissionDate();
                                                                                                            vectdrawlistSpecialLeave = drawListSpecialUnpaidLeave(vectorSpecialUnpaidStockTaken, objLeaveApplication, oidLeave, indexSpecial, objLeaveApplication.getDocStatus(), objLeaveApplication.getSubmissionDate() != null ? objLeaveApplication.getSubmissionDate() : new Date(), repItemLeaveAndDp.getStatusKaryawan(), type_form);
                                                                                                            //update by satrya 2013-04-11
                                                                                                            //vectdrawlistSpecialLeave =drawListSpecialUnpaidLeave(vectorSpecialUnpaidStockTaken, objLeaveApplication.getEmployeeId() ,oidLeave, indexSpecial, objLeaveApplication.getDocStatus(),objLeaveApplication.getSubmissionDate() !=null ? objLeaveApplication.getSubmissionDate() : new Date());
                                                                                                            //vectdrawlistSpecialLeave =drawListSpecialUnpaidLeave(vectorSpecialUnpaidStockTaken, objLeaveApplication.getEmployeeId() ,oidLeave, indexSpecial, objLeaveApplication.getDocStatus());                            
...
%>   
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <%
                                                                                                    if (objLeaveApplication != null && objLeaveApplication.getOID() != 0 && (objLeaveApplication.getTypeFormLeave() == 0 && repItemLeaveAndDp.getStatusKaryawan() != 0) && type_form == PstLeaveApplication.LEAVE_APPLICATION) {
                                                                                                        try {
                                                                                                            Vector vectdrawlistDpLeave = drawListSpecialStock(listal, vectorSpecialStockTaken, objLeaveApplication.getEmployeeId(), oidLeave, indexSS, objLeaveApplication.getDocStatus(), objLeaveApplication.getSubmissionDate() != null ? objLeaveApplication.getSubmissionDate() : new Date(), iCommand, oidSchedule);
                                                                                                            vctStrDetail = (Vector) vectdrawlistDpLeave.get(1);
                                                                                                %>
                                                                                                <%=vectdrawlistDpLeave.get(0)%> 
                                                                                                <%
                                                                                        ...
                                                                                        <%
                                                                                            if (iErrCodeSS != CtrlSpecialStockTaken.RSLT_OK) {
                                                                                        %>   
                                                                                        <tr>
                                                                                            <td class="msgerror">
                                                                                                <font color = "FF0000">
                                                                                                <%
                                                                                                    String errorSS = "";
                                                                                                    errorSS = CtrlSpecialStockTaken.resultText[CtrlSpecialStockTaken.LANGUAGE_FOREIGN][iErrCodeSS];
                                                                                                %>   
                                                                                                Message : <%=errMsgSS + " : " + errorSS%><%//=errorDp%></font>                            
                                                                                            </td>
                                                                                        </tr>
                                                                                        <% 
                                                                                            }
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <table width="100%" bgcolor="#E0EDF0">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="75%">
                                                                                                            <% if (isHRDLogin) {%>
                                                                                                            <input type="text" name="<%= FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_LEAVE_REASON]%>" value="<%= objLeaveApplication.getLeaveReason()%>" size="50"> <a href="javascript:cmdSaveReason()" class="command"> Save New Reason </a> </td>
                                                                                                            <% } else if (objLeaveApplication.getDocStatus() != PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {%>
                                                                                                    ...
                                                                                                    <% } else {
                                                                                                            out.println("<B>" + (objLeaveApplication.getLeaveReason().equals("") ? "-" : objLeaveApplication.getLeaveReason()) + "</B>");
                                                                                                        }%>
                                                                                                    </td>
                                                                                                    </tr>                           
                                                                                                    <tr>
                                                                                                                                ...
                                                                                                                                <%
                                                                                                                                    if (iErrCode == 0 && objLeaveApplication.getOID() != 0) {
                                                                                                                                        if ((objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_TO_BE_APPROVE
                                                                                                                                            ...
                                                                                                                                            Vector listDivHead = leaveConfig.getApprovalEmployeeTopLink(objLeaveApplication.getEmployeeId(), 3);
