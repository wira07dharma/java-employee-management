...
long managerOid = FRMQueryString.requestLong(request, FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_DEP_HEAD_APPROVAL]);
...
%>
	...
	<jsp:param name="dep_head_id" value="<%=managerOid%>" />						
	</jsp:forward>	
<%
}
%>
...
function cmdBackToEditor(oidLeaveApplication, depHeadAuthorize, managerOid)	
{
  ...
  <tr>
    <td valign="middle" align="left">
      <form name="frm_leave_application" action="" onsubmit="window.status=''">
	    ...
	    <input type="hidden" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_DEP_HEAD_APPROVAL]%>" value="<%=managerOid%>">		
