...
public String drawList(Vector objectClass )
{
	...
	ctrlist.addHeader("<center>Approved by</center>","10%");	
		...
		ctrlist.addHeader("<center>SS</center>","4%");
	...
	for (int i=0; i<objectClass.size(); i++) 
	{
		...
		rowx.add(strSubmissionDate);	
				...
				float sumSS = SessLeaveApplication.countSS(objleaveApplication.getOID(),employee.getOID());
			  ...
			  if(leaveConfig!=null && leaveConfig.isLeaveApplicationIsDay()){
               rowx.add("<p title="+Formater.formatNumber(sumSS, "###.###")+">"+ Formater.formatWorkDayHoursMinutes(sumSS,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>"); 
              }else{
                rowx.add("<p title="+Formater.formatNumber(sumSS, "###.###")+">"+ Formater.formatWorkDayHoursMinutesII(sumSS,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>"); 
              }
		lstData.add(rowx);
	}
	return ctrlist.draw();
