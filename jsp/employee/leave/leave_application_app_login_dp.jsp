    ...
    switch(indexApproval){
        case 1: 
            %>
                ...
                <jsp:param name="oidDpAppMain" value="<%=oidDpAppMain%>" />
...
function cmdLogin()	
{
  ...
  document.frm_leave_application.action = "leave_application_app_login_dp.jsp";
...
function cmdBackToEditor(oidLeaveApplication, depHeadAuthorize, managerOid)	
{
  ...
  document.frm_leave_application.action = "dp_application_edit.jsp";
  document.frm_leave_application.submit();
}
