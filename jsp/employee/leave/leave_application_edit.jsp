...
float intAlEntitle = alStockManagement.getAlQty();
float intAlHasBeenTaken = alStockManagement.getQtyUsed();
float intAlSubTotal = alStockManagement.getQtyResidue();
float intAlBalance = intAlSubTotal - intAlToBeTaken;
float intLlEntitle = llStockManagement.getLLQty();
float intLlHasBeenTaken = llStockManagement.getQtyUsed();
float intLlSubTotal = llStockManagement.getQtyResidue();
float intLlBalance = intLlSubTotal - intLlToBeTaken;
...
if((objLeaveApplication.getDepHeadApproval()!=0) && (objLeaveApplication.getHrManApproval()!=0))
{
	...
	objLeaveApplicationReport.setVListOfDetailView(vectLeaveAppDetailView);		
	...
	objLeaveApplicationReport.setDateRequestApproval(objLeaveApplication.getSubmissionDate()!=null ? Formater.formatDate(objLeaveApplication.getSubmissionDate(),"MMM dd, yyyy") : "-");
	objLeaveApplicationReport.setDateDeptHeadApproval(objLeaveApplication.getDepHeadApproveDate()!=null ? Formater.formatDate(objLeaveApplication.getDepHeadApproveDate(),"MMM dd, yyyy") : "-");
	objLeaveApplicationReport.setDateHrManApproval(objLeaveApplication.getHrManApproveDate()!=null ? Formater.formatDate(objLeaveApplication.getHrManApproveDate(),"MMM dd, yyyy") : "-");
...
{ 
		...
		var linkPage  = "<%=printroot%>.report.leave.LeaveApplicationPdf?gettime=<%=String.valueOf(System.currentTimeMillis())%>";
...
//-------------------------- for Calendar -------------------------
    function getThn(){
        <%
         out.println(ControlDatePopup.writeDateCaller("frmsrcdpapplication","SUBDATE"));
         out.println(ControlDatePopup.writeDateCaller("frmsrcdpapplication",FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_DEP_HEAD_APPROVE_DATE]));
         out.println(ControlDatePopup.writeDateCaller("frmsrcdpapplication",FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_SUBMISSION_DATE]));
         out.println(ControlDatePopup.writeDateCaller("frmsrcdpapplication",FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_HR_MAN_APPROVE_DATE]));
         %>
    }
                                ...
                                <tr> 
                                  <td valign="top"> <!-- #BeginEditable "content" --> 
                                    <form name="frm_leave_application" method="post" action="">
                                      ...
                                      <input type="hidden" name="hidden_leave_application_id" value="<%=String.valueOf(oidLeaveApplication)%>">
                                      <input type="hidden" name="hidden_dep_head_authorize" value="<%=String.valueOf(depHeadAuthorize)%>">
                                      <input type="hidden" name="hidden_hr_man_authorize" value="<%=String.valueOf(hrManAuthorize)%>">
                                      <input type="hidden" name="dep_head_id" value="<%=String.valueOf(depHeadApprovalId)%>">
                                      <input type="hidden" name="hr_man_id" value="<%=String.valueOf(hrManApprovalId)%>">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td width="2%">&nbsp;</td>
                                                ...
                                                <td> 
                                                  <table width="100%" border="0">
                                                    <tr> 
                                                      ...
                                                      <td width="2%">:</td>
                                                      <td width="30%"> 
                                                      <%//ControlDate.drawDate(FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_SUBMISSION_DATE], (objLeaveApplication.getSubmissionDate()==null ? new Date() : objLeaveApplication.getSubmissionDate()), "formElemen", 1, -5)%>
                                                      <%=ControlDatePopup.writeDate(FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_SUBMISSION_DATE],objLeaveApplication.getSubmissionDate())%>
                                                      </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="11%">Name</td>
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="2%">:</td>
                                                      <td width="42%"> 
                                                        <input type="hidden" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_EMPLOYEE_ID]%>" value="<%=String.valueOf(oidEmployee)%>">
                                              ...
                                              <tr> 
                                                <td valign="top"> 
                                                  ...
                                                  <table width="100%" border="0">
                                                    ...
                                                    <tr align="center"> 
                                                      <td width="33%"><%//ControlDate.drawDate("SUBDATE", (objLeaveApplication.getSubmissionDate()==null ? new Date() : objLeaveApplication.getSubmissionDate()), "formElemen", 1, -5)%>
                                                      <%=ControlDatePopup.writeDate("SUBDATE",objLeaveApplication.getSubmissionDate())%>
                                                      </td>
                                                      <td width="34%"><%//ControlDate.drawDate(FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_DEP_HEAD_APPROVE_DATE], (objLeaveApplication.getDepHeadApproveDate()==null ? new Date() : objLeaveApplication.getDepHeadApproveDate()), "formElemen", 1, -5)%>
						      <%=ControlDatePopup.writeDate(FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_DEP_HEAD_APPROVE_DATE],objLeaveApplication.getDepHeadApproveDate())%>
                                                      </td>
                                                      <td width="33%">
													  <%
													  if( objLeaveApplication.getDepHeadApproval()!=0 )
													  {
													  	//out.println(ControlDate.drawDate(FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_HR_MAN_APPROVE_DATE], (objLeaveApplication.getHrManApproveDate()==null ? new Date() : objLeaveApplication.getHrManApproveDate()), "formElemen", 1, -5));
                                                                                                                out.println(ControlDatePopup.writeDate(FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_HR_MAN_APPROVE_DATE],objLeaveApplication.getHrManApproveDate()));
                                                                                                          }
													  else
													  {
													  	out.println("&nbsp;");
                                              ...
                                              <%
											  if( (privPrint) && (oidLeaveApplication>0) && (objLeaveApplication.getDepHeadApproval()!=0) && (objLeaveApplication.getHrManApproval()!=0) )
											  {
											  %>
                                              <tr> 
                                                <td> 
