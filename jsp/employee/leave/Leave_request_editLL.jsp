...
<%-- 
    Document   : Leave_request_editLL
    Created on : Dec 23, 2009, 1:21:57 PM
    Author     : Tu Roy
--%>
...
function cmdSave(index)
{
	var startstring = document.frm_leave_application.start.value;
        ...
        if(valid(startstring, endstring) == true) {
            ...
            document.frm_leave_application.action="leave_request_editLL.jsp";
                        ...
                        <form name="frm_leave_application" method="post" action="">
                            ...
                            <tr>
                                <td>
                                    ...
                                    {                                        
                                    %>  
                                    <a href="javascript:cmdProcess()" id="process">Process</a>c
                                    <% } %>
                                </td>
                            </tr>
                            <tr>
