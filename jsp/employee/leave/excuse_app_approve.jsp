...
public String drawList(Vector objectClass,boolean isHRDLogin,int isAdminExecuteLeave,long empId) 
{
	...
	for (int i=0; i<objectClass.size(); i++) 
	{
		Vector temp = (Vector) objectClass.get(i);
                ...
                objleaveApplication.setEmployeeId(empId);
		...
		rowx.add(strSubmissionDate);	
                ...
                if(viewLeaveAppPeriod.getAl_start_date() != null){
                    al_start = Formater.formatDate(viewLeaveAppPeriod.getAl_start_date(),"yyyy-MM-dd");
                }
                
                if(viewLeaveAppPeriod.getAl_end_date() != null){
                ...
                if(viewLeaveAppPeriod.getDp_end_date() != null){
                    dp_end = Formater.formatDate(viewLeaveAppPeriod.getDp_end_date(),"yyyy-MM-dd");
                }
                
                if(viewLeaveAppPeriod.getSp_start_date() != null){
                    sp_start = Formater.formatDate(viewLeaveAppPeriod.getSp_start_date(),"yyyy-MM-dd");
                }
                
                if(viewLeaveAppPeriod.getSp_end_date() != null){
                    sp_end = Formater.formatDate(viewLeaveAppPeriod.getSp_end_date(),"yyyy-MM-dd");
                }
            ...
            try{
               ...
               if((isHRDLogin || isAdminExecuteLeave !=0) && mustApp){
...
Vector records = sessLeaveApplication.searchLeaveApplicationStatusApprove(srcLeaveApp, start, recordToGet);
                            ...
                            <td valign="top">
							  ...
							  %> 
								<form name="frm_leave_application" method="post" action="">
								  ...
								  {
									 out.println(drawList(records,isHRDLogin,isAdminExecuteLeave,objEmployee.getOID())); 
								  }										  
								  else
								  {
