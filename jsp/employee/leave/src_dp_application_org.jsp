...
function cmdAdd(){
	...
	document.frmsrcdpapplication.action="dp_application_edit.jsp";
	document.frmsrcdpapplication.submit();
}

function cmdSearch(){
	document.frmsrcdpapplication.command.value="<%=String.valueOf(Command.LIST)%>";
	document.frmsrcdpapplication.action="dp_application_list.jsp";
	document.frmsrcdpapplication.submit();
}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" --> 
                  Employee &gt; Leave &gt; DP Application<!-- #EndEditable --> 
                  </strong></font> </td>
        </tr>
        <tr> 
          <td>
                                      ...
                                      <table border="0" cellspacing="2" cellpadding="2" width="100%" >
                                        ...
                                        <tr> 
                                          ...
                                          <td nowrap width="87%"> 
                                            ...
                                            approval_value.add(""+PstDpApplication.FLD_NOT_APPROVED);
                                            approval_key.add(""+PstDpApplication.fieldApprovalStatusNames[PstDpApplication.FLD_NOT_APPROVED]);                                                          

                                            approval_value.add(""+PstDpApplication.FLD_APPROVE_BY_DEPT_HEAD);
                                            approval_key.add(""+PstDpApplication.fieldApprovalStatusNames[PstDpApplication.FLD_APPROVE_BY_DEPT_HEAD]);
                                        ...
                                        <tr> 
                                          ...
                                          <td nowrap width="87%"> 
                                            ...
                                            status_value.add(""+PstDpApplication.FLD_DOC_STATUS_INCOMPLATE);
                                            status_key.add(""+PstDpApplication.fieldStatusNames[PstDpApplication.FLD_DOC_STATUS_INCOMPLATE]);

                                            status_value.add(""+PstDpApplication.FLD_DOC_STATUS_VALID);
                                            status_key.add(""+PstDpApplication.fieldStatusNames[PstDpApplication.FLD_DOC_STATUS_VALID]);                                                          

                                            status_value.add(""+PstDpApplication.FLD_DOC_STATUS_INVALID);
                                            status_key.add(""+PstDpApplication.fieldStatusNames[PstDpApplication.FLD_DOC_STATUS_INVALID]);
