...
<%-- JSP Block --%>
<%!
    public String drawList(Vector objectClass, long trainTypeId, int number) {        
        ...
        ctrlist.addHeader("Training Type","20%");
        ...
        for(int i = 0; i < objectClass.size(); i++) {
            ...
            TrainType trainingType = (TrainType)objectClass.get(i);

            if(trainTypeId == trainingType.getOID())
                 highlight = i;

            rowx.add(String.valueOf(number++));
            rowx.add(trainingType.getTypeName());
            rowx.add(trainingType.getTypeDesc());

            lstData.add(rowx);
            lstLinkData.add(String.valueOf(trainingType.getOID()));
        }
                                ...
                                %>
                                    <tr align="left" valign="top"> 
                                        <td height="22" valign="middle" colspan="3"> 
                                            <%= drawList(listTrainType,oidTrainType, start + 1)%> 
                                        </td>
                                    </tr>
                                <%   }  
                                     else {
                                       ...
                                       (frmTrainType.errorSize()>0)||(iCommand==Command.EDIT)||(iCommand==Command.ASK)){ %>
                                        ...
                                        <tr> 
                                            ...
                                            <tr align="left" valign="top"> 
                                                ...
                                                <td width="81%"> 
                                                    <input type="text" name="<%= frmTrainType.fieldNames[FrmTrainType.FRM_FIELD_TRAIN_TYPE_NAME] %>"  value="<%= trainingType.getTypeName() %>" class="elemenForm" size="30">
                                            ...
                                            <tr align="left" valign="top"> 
                                                ...
                                                <td width="81%"> 
                                                    <textarea name="<%= frmTrainType.fieldNames[FrmTrainType.FRM_FIELD_TRAIN_TYPE_DESC] %>" class="elemenForm" cols="30" rows="3"><%= trainingType.getTypeDesc() %></textarea>
                                                </td>
                                            </tr>
                                            </table>
                                            </td>
