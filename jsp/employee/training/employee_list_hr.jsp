<%-- 
    Document   : employee_list_hr
    Created on : Feb 4, 2009, 4:15:29 PM
    Author     : bayu
--%>
...
//privView=true;//userSession.checkPrivilege(AppObjInfo.composeCode(appObjCode, AppObjInfo.COMMAND_ADD));
...
<%
	...
	listEmployee = sessEmployee.searchEmployee(srcEmp, start, recordToGet);
    }else{
        //don't delete this !
...
<script language="JavaScript">
	...
	function cmdEdit(oid){
		...
		document.frm_employee.action="../databank/training.jsp?employee_oid=" + oid;
		document.frm_employee.submit();
	}

	function cmdListFirst(){
		document.frm_employee.command.value="<%=Command.FIRST%>";
		document.frm_employee.action="employee_list_hr.jsp";
		document.frm_employee.submit();
	}
