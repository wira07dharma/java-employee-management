...
<%
    ...
    vctEmployeeTraining = PstTrainingHistory.listEmployeeTrainingByActivity(oidTrainingActivityActual);
...
<html>    
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdChg(){
                window.open("search_plan.jsp", null, "height=600,width=800, status=yes,toolbar=no,menubar=yes,location=no, scrollbars=yes");
            }
                                                    ...
                                                    <td valign="top"> <form name="fractual" method="post" action="">
                                                        ...
                                                        <table width="100%" cellspacing="1" cellpadding="1" >
                                                            ...
                                                            <%
                                                                ...
                                                                String topic = "";
                                                                trainer = "";
                                                                 TrainingActivityPlan trnActPlan =null;
                                                                if (plans != null && plans.size() > 0) {
                                                                    trnActPlan = (TrainingActivityPlan) plans.get(0);
                                                                    try {
                                                ...
                                                <tr align="left"> 
                                                  ...
                                                  <td  width="85%"  valign="top"> 
                                                    <%                                                     
                                                        ...
                                                        if(trnActPlan!=null && trainingActivityActual.getOID()==0){ // set default organizer as add from plan 
                                                            selectedContact= String.valueOf(trainingActivityActual.getOrganizerID());
                                                        } 
                                                    %>
                                                                    ...
                                                                    <tr> 
                                                                        <td colspan="2" align="left"  valign="top" nowrap  >
                                                                            ...
                                                                            <tr> 
                                                                                ...
                                                                                Date</td>
                                                                                <td  class="listgentitle" width="18%">Training
                                                                                Hours</td>
                                                                            </tr>                                                                                                            
                                                                            <%
                                                                            ...
                                                                            <tr >
                                                                                ...
                                                                                <td class="listgensell"><%=emp.getEmployeeNum()%></td>
                                                                                ...
                                                                                <td class="listgensell"><%=trHis.getDuration()%></td>
                                                                            </tr>
                                                                            <%      } %>
                                                                            <%   } %>                                                                            
                                                                            <tr class="listgensell"> 
                                                                                <td colspan="6">
                                                                                <% if(vctEmployeeTraining.size() == 0) {%>
