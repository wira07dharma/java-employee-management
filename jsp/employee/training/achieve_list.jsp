...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_TRAINING, AppObjInfo.OBJ_TRAINING_ACHIEVE_LIST); %>
...
<script language="JavaScript">
	...
	function cmdEdit(oid){
		...
		document.frm_employee.action="achieve_edit.jsp";
		document.frm_employee.submit();
	}

	function cmdListFirst(){
		document.frm_employee.command.value="<%=Command.FIRST%>";
		document.frm_employee.action="achieve_list.jsp";
		document.frm_employee.submit();
	}
	...
	function cmdBack(){
		...
		document.frm_employee.action="src_achieve.jsp";
		document.frm_employee.submit();
	}
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" --> 
                  Employee &gt; Special Achievement &gt; Employee Search Result<!-- #EndEditable --> 
                  </strong></font> </td>
              </tr>
              <tr> 
                <td> 
