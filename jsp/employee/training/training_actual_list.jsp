...
<%
	...
	//vectSize = PstTrainingActivityActual.getCount(whereClause);
        vectSize = PstTrainingActivityActual.getCount(date,start,recordToGet,oidemp);
...
<body <%=noBack%> bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('<%=approot%>/images/BtnNewOn.jpg','<%=approot%>/images/BtnSearchOn.jpg')">
                                              ...
                                              <tr> 
                                                ...
                                                <td width="100%" colspan="2"> 
                                                  <table width="80%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                      <td width="9%"><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image100','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image100" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Add New Training on Plan"></a></td>
                                                      ...
                                                      <td width="78%" class="command" nowrap><a href="javascript:cmdAdd()">Add 
                                                        New Training Activity  Actual<br />(Based on Plan) </a></td>
                                                      <td width="10%">&nbsp;</td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="9%">&nbsp;</td>
                                                    ...
                                                    <tr> 
                                                      <td width="9%"><a href="javascript:cmdAddDirect()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image100','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image100" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Add New Training Directly"></a></td>
                                                      <td width="3%"><img src="<%=approot%>/images/spacer.gif" width="8" height="8"></td>
                                                      <td width="78%" class="command" nowrap><a href="javascript:cmdAddDirect()">Add 
                                                        New Training Activity  Actual<br />(Input Directly) </a></td>
                                                      <td width="10%">&nbsp;</td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="9%">&nbsp;</td>
