...
%>
<html>
<head><title>HARISMA - Search Employee</title>
<script language="javascript">
    function cmdEdit(oid, number, fullname, department, position, commencing_date) {        
        self.opener.document.fredit.<%=FrmTrainingHistory.fieldNames[FrmTrainingHistory.FRM_FIELD_EMPLOYEE_ID]%>.value = oid;
        self.opener.document.fredit.EMP_NUMBER.value = number;
        self.opener.document.fredit.EMP_FULLNAME.value = fullname;
        self.opener.document.fredit.EMP_DEPARTMENT.value = department;
        self.opener.document.fredit.EMP_POSITION.value = position;
        self.opener.document.fredit.EMP_COMMENCING_DATE.value = commencing_date;
        self.close();
    }
</script>
