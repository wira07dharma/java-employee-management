...
<%
    ...
    Vector vctTrType = PstTrainType.listAll();
    //String[] vctTrType = PstTraining.typeValues;

    srcTraining.setDepartmentId(deptOID);
    srcTraining.setTrainingType(type);

    Vector vctTraining = new Vector(1,1); 
    vctTraining = PstTrainingDept.getTrainingByDepartment(deptOID, srcTraining.getTrainingType());
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> 
                                                        <% 
                                                            ...
                                                            for (int i=0; i<vctTrType.size(); i++) {
                                                                    TrainType typ = (TrainType)vctTrType.get(i);
                                                                    trtype_key.add(typ.getTypeName());
                                                                    trtype_value.add(String.valueOf(typ.getOID()));
                                                            }
                                                        %> 
                                                        <%= ControlCombo.draw(frmSrcTraining.fieldNames[FrmSrcTraining.FRM_FIELD_TRAIN_TYPE],"formElemen",null, ""+srcTraining.getTrainingType(), trtype_value, trtype_key, " onChange=\"javascript:cmdChangeDept()\"") %> </td>
                                                    </tr>
                                                    <tr align="left" valign="top"> 
                                                      <td width="17%" nowrap> 
