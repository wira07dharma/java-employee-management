                                          ...
                                          <td colspan="2" align="left" nowrap valign="top"  > 
                                            <table width="98%" border="0" cellpadding="1" cellspacing="1" class="listgen">
                                              ...
                                              <tr class="listgensell"> 
                                                ...
                                                <td width="13%"><%=Formater.formatDate(trHis.getStartDate(), "dd-MM-yy")%> &nbsp;//&nbsp; <%=Formater.formatDate(trHis.getEndDate(), "dd-MM-yy")%></td>
                                                <td width="9%"> 
                                                  <div align="center"><%=trHis.getDuration()%></div>
                                                </td>
                                                <td width="9%"><%=trHis.getTrainer()%></td>
                                                <td width="15%"><%=trHis.getRemark()%></td>
												<td width="25%"><%=trn1.getDescription()%></td>
