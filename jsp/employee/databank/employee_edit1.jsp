                                                    ...
                                                    <tr align="left">
                                                      ...
                                                      <td  width="12%"  valign="top">
                                                        <div align="left">Resigned
                                                          Date</div></td>
                                                      <td  width="46%"  valign="top">
                                                        <%//=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_DATE], employee.getResignedDate()==null?new Date():employee.getResignedDate(), +5, -10,"formElemen")%> <%=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_DATE], employee.getResignedDate(), 0, -10,"formElemen")%> </td>
                                                    </tr>
                                                    <tr align="left">
                                                      <td width="0%"  valign="top"  >&nbsp;</td>
                                                      <td width="11%"  valign="top"  >
