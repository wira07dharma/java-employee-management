...
<%
            ...
            long oidSection = FRMQueryString.requestLong(request, "employee_oid");
                                                                                                ...
                                                                                                <table width="100%" border="0" cellspacing="3" cellpadding="0">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="20%" height="30">
                                                                                                            ...
                                                                                                            %>
                                                                                                            <input type="text" name="<%=FrmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_DEPARTMENT_ID]%>" value="<%=department.getDepartment()%> " class="formElemen">
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="20%" height="30">
                                                                                                            ...
                                                                                                            %>
                                                                                                            <input type="text" name="<%=FrmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_DIVISION_ID]%>" value="<%=division.getDivision()%> " class="formElemen">
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td width="20%" height="30">
                                                                                                            ...
                                                                                                            %>
                                                                                                            <input type="text" name="<%=FrmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_LEVEL_ID]%>" value="<%=level.getLevel()%> " class="formElemen">
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
