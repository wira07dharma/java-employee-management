...
<% 
/* 
 * Page Name  		:  employee_headcount.jsp
...
public String drawList(Vector objectClass, int st){
	...
	ctrlist.addHeader("Commencing","7%");
	...
	for (int i = 0; i < objectClass.size(); i++) {
		...
		//rowx.add(employee.getBirthDate()==null?"":"<nobr>" + Formater.formatDate(employee.getBirthDate(),"dd MMM yyyy") + "</nobr>");
                rowx.add(employee.getCommencingDate()==null?"":"<nobr>" + Formater.formatDate(employee.getBirthDate(),"dd MMM yyyy") + "</nobr>");		
		lstData.add(rowx);
...
<script language="JavaScript">
	...
	function cmdPrint(){
		window.open("<%=approot%>/servlet/com.dimata.harisma.report.EmployeeHeadcountPdf");
	}

	function cmdPrintXLS(){
		window.open("<%=approot%>/servlet/com.dimata.harisma.report.EmployeeHeadcountXLS");
	}
	...
	function cmdListFirst(){
		...
		document.frm_employee.action="employee_headcount.jsp";
		document.frm_employee.submit();
	}
          ...
          <td height="20">
		    <font color="#FF6600" face="Arial"><strong>
			  <!-- #BeginEditable "contenttitle" --> 
                  Employee &gt; Headcount Detail <!-- #EndEditable --> 
            </strong></font>
	      </td>
        </tr>
        <tr> 
                                          ...
                                          <td nowrap align="left" class="command"> 
                                            <table border="0" cellspacing="0" cellpadding="0" align="left">
                                              <tr> 
                                                ...
                                                <td width="4"><img src="<%=approot%>/images/spacer.gif" width="4" height="4"></td>
                                                <td nowrap><a href="javascript:cmdPrint()" class="command">Print Headcount</a></td-->
                                                <td width="8"><img src="<%=approot%>/images/spacer.gif" width="8" height="8"></td>
