    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch()        {
                ...
                document.frmstructure.action="employee_structure_all.jsp";
                document.frmstructure.submit();
            }
                                    ...
                                    <tr>
                                        <td height="20">
                                            <font color="#FF6600" face="Arial"><strong>
                                                    ...
                                                    Employee &gt; Employee Structure<!-- #EndEditable -->
                                                </strong></font>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    <td width="17%" nowrap>
        ...
        <table border="1" cellpadding="2" cellspacing="15">
            ...
            <tr>
                ...
                <%
                            for (int i = startLoop ; i < (startLoop + MAX_DIV)  ; i++) {
                                ...
                                listEmp = PstEmployee.list2(0, 0, whereClauseEmp, "emp."+PstEmployee.fieldNames[PstEmployee.FLD_FULL_NAME]);
            ...
            <tr>
                                ...
                                <td valign="top" align="center">
                                    <%if (listDep.size() == 0){
                                    %><table><tr><td align="center"> No Department </td></tr></table><%}%>
