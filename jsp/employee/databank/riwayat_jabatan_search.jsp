<%-- 
    Document   : riwayat_jabatan_search
    Created on : Sep 14, 2015, 5:11:06 PM
    Author     : Hendra Putu | Dimata 007
--%>
...
<script type="text/javascript">
    function cmdCari(){
        ...
        document.frm.action = "riwayat_jabatan_result.jsp";
        document.frm.submit();
    }
                        ...
                        <tr> 
                            <td  colspan="3" valign="top" style="padding: 12px"> 
                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                    <tr> 
                                        <td height="20"> <div id="menu_utama">Riwayat Jabatan</div> </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                                    ...
                                                    <td valign="top">
                                                        <form name="frm" method="post" action="">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td valign="middle">Satuan Kerja</td>
                                                                    <td valign="middle">
