                                                                                                            ...
                                                                                                            <table width="100%" cellspacing="2" cellpadding="2" >
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="46%" height="20">
                                                                                                                        ...
                                                                                                                        <!-- Ari_20110903
                                                                                                                            Menambah Link menuju employee_mutation.jsp { -->
                                                                                                                        <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_DIVISION_ID], "formElemen", null, "" + employee.getDivisionId(), div_value, div_key)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_DIVISION_ID)%>
                                                                                                                       </td>
                                                                                                                </tr>
                                                                                                                <tr align="left">
                                                                                                                    ...
                                                                                                                    <td  width="46%"  valign="top">
                                                                                                                        ...
                                                                                                                        %> <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_DEPARTMENT_ID], "formElemen", null, "" + employee.getDepartmentId(), dept_value, dept_key)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_DEPARTMENT_ID)%>
                                                                                                                       </td>
                                                                                                                </tr>
                                                                                                                <tr align="left">
                                                                                                                    <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                    <td width="11%"  valign="top"  >
                                                                                                                        <div align="left">Address (Permanent)</div></td>
                                                                                                                    <td  width="31%"  valign="top">
                                                                                                                        <input type="text" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDRESS_PERMANENT]%>" value="<%=(employee.getAddressPermanent() != null ? employee.getAddressPermanent() : "")%>" class="formElemen" size="45"></td>
                                                                                                                ...
                                                                                                                <tr align="left">
                                                                                                                    ...
                                                                                                                    <td  width="31%"  valign="top"><input type="text" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_PHONE]%>" value="<%=(employee.getPhone() != null ? employee.getPhone() : "")%>" class="formElemen">
                                                                                                                ...
                                                                                                                <tr align="left">
                                                                                                                    <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                    <td width="11%"  valign="top"  >
                                                                                                                        <div align="left">Phone (Emergency)</div></td>
                                                                                                                    <td  width="31%"  valign="top"><input type="text" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_PHONE_EMERGENCY]%>" value="<%=(employee.getPhoneEmergency() != null ? employee.getPhoneEmergency() : "")%>" class="formElemen">
                                                                                                                    ...
                                                                                                                    <td  width="46%"  valign="top">
                                                                                                                        ...
                                                                                                                        %> <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SECTION_ID], "formElemen", null, "" + employee.getSectionId(), sec_value, sec_key)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_SECTION_ID)%>
                                                                                                                        </td>
                                                                                                                </tr>
                                                                                                                <tr align="left">
                                                                                                                    <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                    ...
                                                                                                                    <td  width="46%"  valign="top">
                                                                                                                       <%=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_COMMENCING_DATE], employee.getCommencingDate() == null ? new Date() : employee.getCommencingDate(), 0, -40, "formElemen")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_COMMENCING_DATE)%>
                                                                                                                    </td>
                                                                                                                <tr align="left">
                                                                                                                    <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                    <td width="11%"  valign="top"  >
                                                                                                                ...
                                                                                                                <tr align="left">
                                                                                                                    ...
                                                                                                                    <td  width="12%"  valign="top" height="29">
                                                                                                                        <div align="left">Jamsostek Number</div></td>
                                                                                                                    <td  width="46%"  valign="top" height="29">
                                                                                                                        <input type="text" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ASTEK_NUM]%>" value="<%=employee.getAstekNum()%>" class="formElemen"></td>
                                                                                                                </tr>
                                                                                                                <tr align="left">
                                                                                                                    <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                    <td width="11%"  valign="top"  >
                                                                                                                    ...
                                                                                                                    <td  width="12%"  valign="top">
                                                                                                                        <div align="left">Jamsostek Date</div></td>
                                                                                                                    <td  width="46%"  valign="top"><%=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ASTEK_DATE], employee.getAstekDate() == null ? new Date() : employee.getAstekDate(), 1, -35, "formElemen")%> </td>
                                                                                                                </tr>
                                                                                                                <tr align="left">
                                                                                                                ...
                                                                                                                <tr align="left">
                                                                                                                    ...
                                                                                                                    <td  width="12%"  valign="top" nowrap>
                                                                                                                        <div align="left">Resigned Date</div></td>
                                                                                                                    <td  width="46%"  valign="top"><%//=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_DATE], employee.getResignedDate()==null?new Date():employee.getResignedDate(), +5, -10,"formElemen")%> <%=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_DATE], employee.getResignedDate(), +5, -10, "formElemen")%></td>
                                                                                                                </tr>
                                                                                                                <tr align="left">
                                                                                                                    <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                    <td width="11%"  valign="top"  >
                                                                                                                ...
                                                                                                                <tr align="left">
                                                                                                                    ...
                                                                                                                    <td  width="31%"  valign="top"><input type="text" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_BARCODE_NUMBER]%>" value="<%=(employee.getBarcodeNumber() != null ? employee.getBarcodeNumber() : "")%>" class="formElemen">
                                                                                                                        * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_BARCODE_NUMBER)%> &nbsp;</td>
                                                                                                                    <td  width="12%"  valign="top" nowrap>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td height="30"><input type="text" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_INDENT_CARD_NR]%>" value="<%=employee.getIndentCardNr()%>" class="formElemen">
                                                                                                                        <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_INDENT_CARD_NR)%> valid to <%=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_INDENT_CARD_VALID_TO],
                                                                                 employee.getIndentCardValidTo() == null ? new Date() : employee.getIndentCardValidTo(), 1, -25, "formElemen")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_INDENT_CARD_VALID_TO)%></td>
                                                                                                                    <td  width="12%"  valign="top">
                                                                                                                        <div align="left">Employee PIN</div></td>
                                                                                                                    <td  width="46%"  valign="top">
