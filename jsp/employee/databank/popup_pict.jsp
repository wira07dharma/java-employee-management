      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="2">
        <tr> 
          <td width="100%"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Detail Picture 
                                                  ...
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr align="left" valign="top"> 
                                                      <td height="14" valign="middle" colspan="3" class="listedittitle"> 
													  	<table width="75%" height="57" border="0">
														  <tr>
															<td>
															<%
																if((pictPath!=null && pictPath.length()>0))
																  {
																	out.println("<img width=\"800\" height=\"600\" src=\""+approot+"/"+pictPath+"\">");
																  }
																 else{
																  	 %>
																	 	<img width="140" height="150" src="../../imgcache/no_photo.JPEG"></image>
																	 <%
																  }
																 %>
															</td>
