    ...
    public String drawList(Vector objectClass, long workHistoryNowId, I_Dictionary dictionaryD) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if (careerPath.getHistoryGroup() == PstCareerPath.RIWAYAT_JABATAN){
                ...
                output += "<td><a href=\"javascript:cmdEdit('"+careerPath.getOID()+"')\">"+PstCareerPath.mutationType[careerPath.getMutationType()]+"</a></td>";
                ...
                output += "<td>"+careerPath.getDescription()+"</td>";
            ...
            <form name="frmcareerpath" method ="post" action="careerpath.jsp">
                ...
                <div class="content">
                    ...
                    <table class="tblStyle">
                        ...
                        %>
                        <tr>
                            <td colspan="15" class="title_tbl_part">Daftar Riwayat Jabatan</td>
                        </tr>
                        <tr>
                            <td class="title_tbl">Mutation Type</td>
                        ...
                        <tr>
                            <td colspan="15" class="title_tbl_part">Daftar Riwayat Grade</td>
                        </tr>
                        <%= drawListGrade(listCareerPath, iCommand == Command.SAVE ? careerPath.getOID() : oidCareerPath, dictionaryD)%>
                        <tr>
                            <td colspan="15" class="title_tbl_part">Daftar Riwayat Jabatan dan Grade</td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="15" class="title_tbl_part">Karir Sekarang</td>
                        </tr>
...
for (int i = 0; i < listSec.size(); i++) {
    ...
    sec_value.add(String.valueOf(sec.getOID()));
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            <textarea name="<%=FrmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_DESCRIPTION]%>" class="formElemen" cols="70" rows="3"><%= careerPath.getDescription()%></textarea>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
