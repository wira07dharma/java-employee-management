            ...
            <table cellspacing="2" cellpadding="2">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        %>
                          <%= ControlCombo.draw(frmSrcSpecialEmployee.fieldNames[FrmSrcSpecialEmployee.FRM_FIELD_LEVEL],"formElemen",null, "" + srcSpecialEmployee.getLevel(), lvl_value, lvl_key, " size=8 multiple onkeydown=\"javascript:fnTrapKD()\"") %>
                    </td>
                    <td>
                        <%
                        ...
                        gd_value.add("0");
                        gd_key.add("SELECT");
                        Vector listGradeLevel = PstGradeLevel.list(0, 0, "", "GRADE_CODE ASC");
            ...
            <div class="content" style="border-top: 1px solid #CCC">
                ...
                <table>
                    <tr>
                        ...
                        <td valign="top" id="coloum_title">District</td>
                        <td valign="top" id="coloum_title">Sub-District</td>
                    </tr>
                    <tr>
                         <td>
                            <% 
                        ...
                        <td>
                            <% 
                                ...
                                district_key.add("...ALL...");
                                Vector listDistrict = PstDistrict .list(0, 0, "", PstDistrict.fieldNames[PstDistrict.FLD_NAMA_DISTRICT]);
                                for (int i = 0; i < listDistrict.size(); i++) {
                                        District district = (District) listDistrict.get(i);
                                        district_key.add(district.getNmDistrict());
                                        district_value.add(String.valueOf(district.getOID()));
                                }
                          %>
                          <%= ControlCombo.draw(frmSrcSpecialEmployee.fieldNames[FrmSrcSpecialEmployee.FRM_FIELD_DISTRICT_ID],"formElemen",null, "" + srcSpecialEmployee.getDistrictId(), district_value, district_key, " size=8 multiple onkeydown=\"javascript:fnTrapKD()\"") %>
                        </td>
                ...
                <table>
                    <tr>
                        ...
                        <td valign="top" id="coloum_title">District Permanent</td>
                        <td valign="top" id="coloum_title">Sub District Permanent</td>
                    </tr>
                    <tr>
                        <td>
                            <% 
                        ...
                        <td>
                            <% 
                                Vector districtPerm_value = new Vector(1,1);
                                Vector districtPerm_key = new Vector(1,1); 
                                districtPerm_value.add("0");
                                districtPerm_key.add("...ALL...");
                                Vector listDistrictPerm = PstDistrict .list(0, 0, "", PstDistrict.fieldNames[PstDistrict.FLD_NAMA_DISTRICT]);
                                for (int i = 0; i < listDistrictPerm.size(); i++) {
                                        District districtPerm = (District) listDistrictPerm.get(i);
                                        districtPerm_key.add(districtPerm.getNmDistrict());
                                        districtPerm_value.add(String.valueOf(districtPerm.getOID()));
                                }
                          %>
                          <%= ControlCombo.draw(frmSrcSpecialEmployee.fieldNames[FrmSrcSpecialEmployee.FRM_FIELD_DISTRICT_ID_PERMANENT],"formElemen",null, "" + srcSpecialEmployee.getDistrictIdPermanent(), districtPerm_value, districtPerm_key, " size=8 multiple onkeydown=\"javascript:fnTrapKD()\"") %>
                        </td>
            ...
            <div class="content" style="border-top: 1px solid #CCC">
                <table>
                    <tr>
                        ...
                        <td><%=ControlDate.drawDateWithStyle(frmSrcSpecialEmployee.fieldNames[FrmSrcSpecialEmployee.FRM_FIELD_DATE_PERIOD_END], new Date(), 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%></td>
                    </tr>
                </table>
            </div>
            <div class="content" style="border-top: 1px solid #CCC">
