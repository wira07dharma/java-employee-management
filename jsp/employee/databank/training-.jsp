                                    ...
                                    <form name="fredit" method="post" action="">
                                      ...
                                      <input type="hidden" name="<%=FrmTrainingHistory.fieldNames[FrmTrainingHistory.FRM_FIELD_EMPLOYEE_ID]%>" value="<%=oidEmployee%>">
										 <table width="82%" height="31" border="0" bgcolor="#FFFFFF">
                                          ...
                                          <td width="13%" nowrap bgcolor="#0066CC"> 
                                            <div align="center"  class="tablink"><a href="careerpath.jsp?employee_oid=<%=oidEmployee%>" class="tablink"><span class="tablink"><%=dictionaryD.getWord(I_Dictionary.CAREER_PATH) %></span></a></div>
                                          </td>
										  <!-- untuk menampilkan trainingnya -->
										  <td width="13%" nowrap bgcolor="#66CCFF"> 
                                            <div align="center"><font class="tablink" ><span class="tablink">Training 
                                              </span></font></div>
                                          </td>
										  <td width="13%" nowrap bgcolor="#0066CC"> 
                                            <div align="center"  class="tablink"><a href="picture.jsp?employee_oid=<%=oidEmployee%>" class="tablink"><span class="tablink">&nbsp;&nbsp;&nbsp;Picture&nbsp;&nbsp;&nbsp;</span></a></div>
                                          </td>
										  
										   <td width="10%" nowrap bgcolor="#0066CC">
                                            <div align="center"><font class="tablink" ><span class="tablink"><a href="doc_relevant.jsp?employee_oid=<%=oidEmployee%>" class="tablink">Relevant Document</a></span></font></div>
                                          </td>
                                            ...
                                            <table width="98%" border="0" cellpadding="1" cellspacing="1" class="listgen">
                                              ...
                                              <tr class="listgensell"> 
												...
												%>
                                                  ...
                                                  <td width="14%"><a href="javascript:cmdEdit('<%=trHis.getOID()%>')"><%=Formater.formatDate(trHis.getStartDate(), "dd-MM-yy")%> &nbsp;//&nbsp; <%=Formater.formatDate(trHis.getEndDate(), "dd-MM-yy")%></a></td>
                                                <td width="8%"> 
