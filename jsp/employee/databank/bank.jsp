...
<%
            ...
            FrmEmployee frmEmployee = ctrlEmployee.getForm();
            FrmEmployeeMutation frmEmployeeMutation = ctrlEmployee.getFormMutation();
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSave(){
                ...
                document.frm_empmutation.prev_command.value="<%=prevCommand%>";
                document.frm_empmutation.action="employee_mutation.jsp";
                document.frm_empmutation.action="employee_mutation_8.jsp";
                document.frm_empmutation.submit();
            }
                                                                                                            ...
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="20%" height="30"><%
                                                                                                                        ...
                                                                                                                        %> <%= ControlCombo.draw(frmEmployeeMutation.fieldNames[FrmEmployeeMutation.FRM_FIELD_DIVISION_ID_MUTATION], "formElemen", null, "" + employee.getDivisionId(), div_value, div_key)%>* <%= frmEmployeeMutation.getErrorMsg(FrmEmployeeMutation.FRM_FIELD_DEPARTMENT_ID_MUTATION)%></td>
                                                                                                                    <td width="5%" height="30">Level</td>
                                                                                                                    <td width="20%" height="30"> <%
                                                                                                                        ...
                                                                                                                        %> <%= ControlCombo.draw(frmEmployeeMutation.fieldNames[FrmEmployeeMutation.FRM_FIELD_LEVEL_ID_MUTATION], "formElemen", null, "" + employee.getLevelId(), lvl_value, lvl_key)%>*<%= frmEmployeeMutation.getErrorMsg(FrmEmployeeMutation.FRM_FIELD_DEPARTMENT_ID_MUTATION)%> </td>
                                                                                                                </tr>

                                                                                                                <tr>
                                                                                                                    <td width="5%" height="30">Start by</td>
                                                                                                                    <td width="20%" height="30"><%--=	ControlDate.drawDateWithStyle(frmEmployeeMutation.fieldNames[FrmEmployeeMutation.FRM_FIELD_WORK_FROM], careerPath.getWorkFrom() == null ? new Date() : careerPath.getWorkFrom(), 5, -30, "formElemen")%> to
                                                                                                                        <%=	ControlDate.drawDateWithStyle(frmEmployeeMutation.fieldNames[FrmCareerPath.FRM_FIELD_WORK_TO], careerPath.getWorkTo() == null ? new Date() : careerPath.getWorkTo(), 5, -35, "formElemen")%> *
                                                                                                                        <% String strStart = frmEmployeeMutation.getErrorMsg(FrmCareerPath.FRM_FIELD_WORK_FROM);
                                                                                                                            String strEnd = frmEmployeeMutation.getErrorMsg(FrmCareerPath.FRM_FIELD_WORK_TO);
                                                                                                                            if ((strStart.length() > 0) && (strEnd.length() > 0)) {
                                                                                                                        %>
                                                                                                                        <%= strStart%>
                                                                                                                        <%} else {
