...
<%
             ...
             *******************************************************************/
%>
<!-- Ari_20110901_01 Membuat form new employee list{ -->
<%@ page language = "java" %>
<!-- package java -->
    ...
    <head>
        ...
        <script language="JavaScript">
            function cmdSearch()        {
                ...
                document.frmsrcemployee.action="new_employee_list.jsp";
                                    ...
                                    <tr>
                                        <td height="20">
                                            <font color="#FF6600" face="Arial"><strong>
                                                    ...
                                                    Employee &gt; New Employee List<!-- #EndEditable -->
                                                </strong></font>
                                        </td>
                                    </tr>
                                    <tr>
                                                                                                        ...
                                                                                                        <td width="100%">
                                                                                                            <table border="0" cellspacing="2" cellpadding="2" width="72%">
                                                                                                                ...
                                                                                                                <table border="0" width="100%">
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td height="8" width="100%" class="listtitle"><span class="listtitle">New Employee List</span>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <%if ((listEmployee != null) && (listEmployee.size() > 0)) {%>
                                                                                                                    <tr>
                                                                                                                        <td height="8" width="100%"><%=drawList(listEmployee, start, approot)%></td>
                                                                                                                    </tr>
                                                                                                                    <%} else {%>
                                                                                                                    <tr>
