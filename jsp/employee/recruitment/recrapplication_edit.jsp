...
<script language="JavaScript">
	...
	function cmdEdit(oid){ 
		...
		document.frm_recrapplication.command.value="<%=Command.ADD%>";
		document.frm_recrapplication.action="<%=approot%>/employee/databank/employee_edit.jsp?hidden_recr_application_id="+oid;
		document.frm_recrapplication.submit(); 
	} 
                                              ...
                                              <tr> 
                                                <td valign="top" width="50%"> 
                                                  ...
                                                  <table width="100%" cellspacing="2" cellpadding="2" >
                                                        ...
                                                        <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                          <tr> 
                                                            ...
                                                            <td width="84%"> 
                                                                ...
                                                                %>  
                                                                <%=ControlCombo.draw(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_POSITION], "formElemen", null, "" + recrApplication.getPosition(), pos_value, pos_key)%> * <%=frmRecrApplication.getErrorMsg(frmRecrApplication.FRM_FIELD_POSITION)%>
                                                            </td>
                                                          </tr>
                                                          <tr> 
                                                            ...
                                                            <td width="84%"> 
                                                               <%=ControlCombo.draw(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_OTHER_POSITION], "formElemen", null, "" + recrApplication.getOtherPosition(), pos_value, pos_key)%> * <%=frmRecrApplication.getErrorMsg(frmRecrApplication.FRM_FIELD_OTHER_POSITION)%>
                                                    ...
                                                    %>
                                                          ...
                                                          <tr> 
                                                            ...
                                                            <td width="11%">Blood 
                                                              group</td>
                                                            <td width="20%"> 
                                                            <%out.println(ControlCombo.draw(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_BLOOD_TYPE], "formElemen", null, recrApplication.getBloodType(), PstEmployee.getBlood(), PstEmployee.getBlood())); %>
                                                            </td>
                                                    ...
                                                    <%
                                                    String whereClauseEmp  = ""+PstEmployee.fieldNames[PstEmployee.FLD_FULL_NAME] + " = " + recrApplication.getFullName() + " AND " + PstEmployee.fieldNames[PstEmployee.FLD_BIRTH_DATE] + " = " + Formater.formatDate(recrApplication.getBirthDate(), "yyyy-MM-dd"); 
                                                    Vector vEmp = PstEmployee.list(0, 0, whereClauseEmp, "");
                                                    
                                                    if ( (iCommand ==  Command.EDIT) && (vEmp.size() == 0) ) {%>
                                                    <td nowrap><a href="javascript:cmdGenerate('<%=recrApplication.getOID()%>')" class="command">Hire</a></td>
