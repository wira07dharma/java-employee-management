...
<%
    ...
    long kategori = FRMQueryString.requestLong(request, frmRecrEducation.fieldNames[frmRecrEducation.FRM_FIELD_KATEGORI]);
...
function cmdUpdateKat(oidRecrEducation){
    
	document.frmrecreducation.command.value="<%=String.valueOf(Command.EDIT)%>";
...
function cmdBackSkill(OID){
                ...
                document.frmrecreducation.action="recrappl_skill.jsp";
                document.frmrecreducation.submit();
                }
function cmdAdd(){
								 ...
								 %>
                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="8" valign="middle" colspan="3"> 
                                            <%if((iCommand ==Command.ADD) || (iCommand ==Command.GOTO)||(iCommand==Command.SAVE)&&(frmRecrEducation.errorSize()>0)||(iCommand==Command.EDIT)||(iCommand==Command.ASK)){%>
                                                          ...
                                                          <tr align="left" valign="top">
                                                           ...
                                                           <tr align="left" valign="top">
                                                            ...
                                                            <td height="21" colspan="2" width="90%"> 
                                                                <%= ControlCombo.draw(frmRecrEducation.fieldNames[FrmRecrEducation.FRM_FIELD_KATEGORI],"formElemen",null, ""+(kategori) , FrmEducation.getUnitTypeValue(), FrmEducation.getUnitTypeValue(), "onChange=\"javascript:cmdUpdateKat("+oidRecrEducation+")\"") %>
                                                  ...
                                                  * <%= frmRecrEducation.getErrorMsg(FrmRecrEducation.FRM_FIELD_EDUCATION_ID) %> 
                                                  --%>
                                                        ...
                                                        String whereD = PstEducation.fieldNames[PstEducation.FLD_KATEGORI]+ "  =  " + kategori;
                                                                
                                                        Vector listEducation = PstEducation.list(0, 0, whereD, null);
