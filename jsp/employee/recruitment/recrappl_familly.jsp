                                                    ...
                                                    <tr align="left"> 
                                                      ...
                                                      <td colspan="2"  valign="top"  > 
                                                        <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                          ...
                                                          <tr> 
                                                            <td width="12%" nowrap>FOURTH
                                                              Child</td>
                                                            <td width="17%"> 
                                                              <input type="text" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD4_NAME]%>" value="<%=recrApplication.getChild3Name()%>" class="formElemen">
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD4_NAME)%></td>
                                                            <td width="11%" nowrap>Birthdate</td>
                                                            <td width="20%" nowrap> 
                                                              <%//=ControlDate.drawDateWithStyle(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD3_BIRTHDATE], (recrApplication.getChild3Birthdate()==null) ? new Date() : recrApplication.getChild3Birthdate(), 1, -55, "formElemen", "")%>
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD4_BIRTHDATE)%> 
                                                              <%=ControlDate.drawDateWithStyle(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD4_BIRTHDATE], recrApplication.getChild4Birthdate(), 1, -55, "formElemen", "")%><%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD4_BIRTHDATE)%> 
                                                            </td>
                                                            <td colspan="2" nowrap>Sex 
                                                              &nbsp;&nbsp;&nbsp; 
                                                              <% 
                                                                for(int i=0;i<PstRecrApplication.sexValue.length;i++){
                                                                String str = "";
                                                                if(recrApplication.getChild4Sex()==PstRecrApplication.sexValue[i]){str = "checked";}
                                                              %>
                                                              <input type="radio" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD4_SEX]%>" value="<%=PstRecrApplication.sexValue[i]%>" <%=str%> style="border:'none'">
                                                              <%=PstRecrApplication.sexKey[i]%> 
                                                              <% }%>
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD4_SEX)%> 
                                                            </td>
                                                          </tr>
                                                          
                                                          <tr> 
                                                            <td width="12%" nowrap>FIFTH 
                                                              Child</td>
                                                            <td width="17%"> 
                                                              <input type="text" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD5_NAME]%>" value="<%=recrApplication.getChild5Name()%>" class="formElemen">
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD5_NAME)%></td>
                                                            <td width="11%" nowrap>Birthdate</td>
                                                            <td width="20%" nowrap> 
                                                              <%//=ControlDate.drawDateWithStyle(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD3_BIRTHDATE], (recrApplication.getChild3Birthdate()==null) ? new Date() : recrApplication.getChild3Birthdate(), 1, -55, "formElemen", "")%>
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD5_BIRTHDATE)%> 
                                                              <%=ControlDate.drawDateWithStyle(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD5_BIRTHDATE], recrApplication.getChild3Birthdate(), 1, -55, "formElemen", "")%><%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD5_BIRTHDATE)%> 
                                                            </td>
                                                            <td colspan="2" nowrap>Sex 
                                                              &nbsp;&nbsp;&nbsp; 
                                                              <%-- <input type="text" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD3_SEX]%>" value="<%=recrApplication.getChild3Sex()%>" class="formElemen">
                                                              ...
                                                              <% 
                                                                for(int i=0;i<PstRecrApplication.sexValue.length;i++){
                                                                String str = "";
                                                                if(recrApplication.getChild5Sex()==PstRecrApplication.sexValue[i]){str = "checked";}
                                                              %>
                                                              <input type="radio" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD5_SEX]%>" value="<%=PstRecrApplication.sexValue[i]%>" <%=str%> style="border:'none'">
                                                              <%=PstRecrApplication.sexKey[i]%> 
                                                              <% }%>
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD5_SEX)%> 
                                                            </td>
                                                          </tr>
                                                          ...
                                                          <tr> 
                                                            <td width="12%" nowrap>SIXTH 
                                                              Child</td>
                                                            <td width="17%"> 
                                                              <input type="text" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD6_NAME]%>" value="<%=recrApplication.getChild6Name()%>" class="formElemen">
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD6_NAME)%></td>
                                                            <td width="11%" nowrap>Birthdate</td>
                                                            <td width="20%" nowrap> 
                                                              <%//=ControlDate.drawDateWithStyle(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD3_BIRTHDATE], (recrApplication.getChild3Birthdate()==null) ? new Date() : recrApplication.getChild3Birthdate(), 1, -55, "formElemen", "")%>
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD6_BIRTHDATE)%> 
                                                              <%=ControlDate.drawDateWithStyle(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD6_BIRTHDATE], recrApplication.getChild6Birthdate(), 1, -55, "formElemen", "")%><%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD6_BIRTHDATE)%> 
                                                            </td>
                                                            <td colspan="2" nowrap>Sex 
                                                              &nbsp;&nbsp;&nbsp; 
                                                              <%-- <input type="text" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD3_SEX]%>" value="<%=recrApplication.getChild3Sex()%>" class="formElemen">
                                                              ...
                                                              <% 
                                                                for(int i=0;i<PstRecrApplication.sexValue.length;i++){
                                                                String str = "";
                                                                if(recrApplication.getChild6Sex()==PstRecrApplication.sexValue[i]){str = "checked";}
                                                              %>
                                                              <input type="radio" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD6_SEX]%>" value="<%=PstRecrApplication.sexValue[i]%>" <%=str%> style="border:'none'">
                                                              <%=PstRecrApplication.sexKey[i]%> 
                                                              <% }%>
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD6_SEX)%> 
                                                            </td>
                                                          </tr>
                                                          
                                                          <tr> 
                                                            <td width="12%" nowrap>SEVENTH 
                                                              Child</td>
                                                            <td width="17%"> 
                                                              <input type="text" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD7_NAME]%>" value="<%=recrApplication.getChild7Name()%>" class="formElemen">
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD7_NAME)%></td>
                                                            <td width="11%" nowrap>Birthdate</td>
                                                            <td width="20%" nowrap> 
                                                              <%//=ControlDate.drawDateWithStyle(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD3_BIRTHDATE], (recrApplication.getChild3Birthdate()==null) ? new Date() : recrApplication.getChild3Birthdate(), 1, -55, "formElemen", "")%>
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD7_BIRTHDATE)%> 
                                                              <%=ControlDate.drawDateWithStyle(FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD7_BIRTHDATE], recrApplication.getChild3Birthdate(), 1, -55, "formElemen", "")%><%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD7_BIRTHDATE)%> 
                                                            </td>
                                                            <td colspan="2" nowrap>Sex 
                                                              &nbsp;&nbsp;&nbsp; 
                                                              <% 
                                                                for(int i=0;i<PstRecrApplication.sexValue.length;i++){
                                                                String str = "";
                                                                if(recrApplication.getChild7Sex()==PstRecrApplication.sexValue[i]){str = "checked";}
                                                              %>
                                                              <input type="radio" name="<%=FrmRecrApplication.fieldNames[FrmRecrApplication.FRM_FIELD_CHILD7_SEX]%>" value="<%=PstRecrApplication.sexValue[i]%>" <%=str%> style="border:'none'">
                                                              <%=PstRecrApplication.sexKey[i]%> 
                                                              <% }%>
                                                              <%=frmRecrApplication.getErrorMsg(FrmRecrApplication.FRM_FIELD_CHILD7_SEX)%> 
                                                            </td>
                                                          </tr>
