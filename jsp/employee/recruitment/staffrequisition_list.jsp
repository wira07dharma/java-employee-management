...
<% 
/* 
 * Page Name  		:  staffrequisition_list.jsp
...
<%
	...
	FrmSrcStaffRequisition frmSrcStaffRequisition = new FrmSrcStaffRequisition(request, srcStaffRequisition);
	frmSrcStaffRequisition.requestEntityObject(srcStaffRequisition);
	...
	SessStaffRequisition sessStaffRequisition = new SessStaffRequisition();
        try {
            session.putValue(SessStaffRequisition.SESS_SRC_STAFFREQUISITION, srcStaffRequisition);
        }
        catch (Exception e)
        {}
	vectSize = sessStaffRequisition.getCountSearch(srcStaffRequisition);
	//out.println("vectSize : "+vectSize);
	ctrlStaffRequisition.action(iCommand , oidStaffRequisition);
	if((iCommand==Command.FIRST)||(iCommand==Command.NEXT)||(iCommand==Command.PREV)||(iCommand==Command.LAST)||(iCommand==Command.LIST))
		start = ctrlStaffRequisition.actionList(iCommand, start, vectSize, recordToGet);
	Vector records = sessStaffRequisition.searchStaffRequisition(srcStaffRequisition, start, recordToGet);
%>
<!-- End of Jsp Block -->
<html>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" --> 
                  Employee &gt; Recruitment &gt; Staff Requisition<!-- #EndEditable --> 
                  </strong></font> </td>
              </tr>
              <tr> 
                <td> 
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                              <tr> 
                                                ...
                                                <td nowrap> <a href="javascript:cmdBack()" class="command">Back 
                                                  To Search Staff Requisition</a></td>
                                                <% if(privAdd){%>
