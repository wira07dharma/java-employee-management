	...
	for (int i = 0; i < objectClass.size(); i++) {
		...
		for(int j = 0 ;j < maxDayOfMonth; j++){
			if(startDatePeriod == maxDayOfMonth){
			 ...
			 String strReasonCode1= "";
			  // kondisi dibawah dikomentar karena kebutuhan dari pihak intimas
			 if((reason1 > -1) && (status1 == PstEmpSchedule.STATUS_PRESENCE_ABSENCE) || (reason1 == PstEmpSchedule.REASON_ABSENCE_SICKNESS)){
			 	//String strReasonCode1 = intReasonCode1 > -1 ? objPstEmpSchedule.strAbsenceReasonCode[intReasonCode1] : "";
			  	strReasonCode1 =  PstReason.getStrReason(reason1) ;				
			 }				
			  ...
			  // kondisi dibawah dikomentar karena kebutuhan dari pihak intimas
			   ...
			   //String strReasonCode1 = intReasonCode1 > -1 ? objPstEmpSchedule.strAbsenceReasonCode[intReasonCode1] : "";				
			  	strReasonCode1 =  PstReason.getStrReason(reason1) ;				
                                if(strReasonCode1==null || strReasonCode1.length()==0){
                                    strReasonCode1 = "Abs";
				}
                                }
