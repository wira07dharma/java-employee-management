<%-- 
    Document   : source_employee
    Created on : Sep 23, 2015, 4:31:06 PM
    Author     : Dimata 007
--%>
    ...
    <head>
        ...
        <script language="javascript">
            function cmdGetItem(oid) {
                var input_val = "FRM_FIELD_REQUESTED_BY";
                
                self.opener.document.frm.FRM_FIELD_REQUESTED_BY.value=oid;
                self.opener.document.frm.requestby.value=oid;
                self.opener.document.frm.submit();
            }
        </script>
    </head>
    <body>
        <h1 style="border-bottom: 1px solid #0599ab; padding-bottom: 12px;">Choose Employee</h1>
