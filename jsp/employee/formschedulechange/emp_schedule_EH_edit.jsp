...
<html><!-- #BeginTemplate "/Templates/main.dwt" -->
	...
	document.frmEmpScheduleChange.submit(); 
        ...
        document.frmEmpScheduleChange.action="documentApproval.jsp?oidApprover="+empId+"&oidEmpScheduleChange="+oidEmpScheduleChange+"&approvedLevel="+approvedLevel+"&alamatJsp=emp_schedule_EH_edit.jsp"+"&scheduleType=1";
                                                    ...
                                                    <div>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td width="35%" colspan="2">
                                                            ...
                                                            <tr>
                                                              <td height="20%">&nbsp;</td>
                                                              <td width="80%"><p>EARLY LEAVING FORM</p>
                                                                <p>(Form permohonan Ijin Meninggalkan Tugas)</p></td>
                                                              </tr>
                                                          </table>
                                                          </td>
                                                        </tr>
                                                          ...
                                                          <td height="30%" colspan="4" style="border:#000; border-bottom:medium" >
                                                            ...
                                                            <table  width="100%" cellpadding="0" cellspacing="0" border="0">
                                                              ...
                                                              <table class="tblStyle"   width="100%" height="20%" style="border-collapse: collapse; margin-top: 5px; font-size: 11px; padding: 0;" cellpadding="0" cellspacing="0" border="1">
                                                                  <tr>
                                                                    <td colspan="2" style="text-align:center;">Request for Leaving the duty early with reason </td>
                                                                    <td colspan="2" style="text-align:center;">(Permintaan Izin Meninggalkan Tugas lebih awal dengan alasan) : </td>
                                                                </tr>
