                                          ...
                                          <td height="8"  colspan="3"> 
                                                ...
                                                <td  >
                                                    <div>
                                                        <table width="80%" height="50%" border="0">
                                                            <tr>
                                                                <% if  (empScheduleChange.getApprovalDateLevel1() != null && empScheduleChange.getApprovalDateLevel2() != null && empScheduleChange.getApprovalDateApplicant() != null && empScheduleChange.getApprovalDateExchange() != null ){ %>
                                              ...
                                              <%
                                                ...
                                                for (int i = 0; i < listScheduleSym.size(); i++) {
                                                    ...
                                                    sym_key.add(scheduleSymbol.getSymbol());
                                                    ...
                                                    <div>
                                                        <table width="80%" height="50%" border="0">
                                                            <tr>
                                                              ...
                                                              Closed
                                                              <% } else { %>
                                                              <td width="20%" >: <%=ControlCombo.draw(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_STATUS_DOC], "formElemen", null, String.valueOf(empScheduleChange.getStatusDoc()), val_status, key_status, "")%></td>
                                                              <% } %>
                                                              <td width="10%"></td>
                                                              <td width="10%" >Type</td>
                                                              <td width="20%" >: Form Schedule Change</td>
                                                            </tr>
                                                        </table>
                                                      </div>
                                               </td>
                                                          ...
                                                          <td height="30%" colspan="4" style="border:#000; border-bottom:medium" >
                                                                  ...
                                                                  <table  width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                      ...
                                                                      <td width="40%" style="text-align: center;">Exchange With (Yang diajak Menukar) <input type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_EXCHANGE_EMPLOYEE_ID]%>" value="<%=empScheduleChange.getExchangeEmployeeId()%>" class=\"formElemen\" ><a href="javascript:cmdSearchEmpExchange()">Add Employee</a></td>
                                                                    </tr>
                                                                  </table>
                                                                  ...
                                                                  <table class="tblStyle"   width="100%" height="40%" style="border-collapse: collapse;font-size: 11px;" cellpadding="0" cellspacing="0" border="1">
                                                                      ...
                                                                      <td width="40%">: <input style="width: 90%; border: none;" type="text" name="EMP_DEPARTMENT" value="<%=departmentOri.getDepartment()%>" class="elemenForm"></td>
                                                                      <td width="40%">: <input style="width: 90%; border: none;" type="text" name="EMP_DEPARTMENT_EXC" value="<%=departmentExc.getDepartment()%>" class="elemenForm"></td>
                                                                    </tr>
                                                                      <tr>
                                                                      ...
                                                                      <tr>
                                                                        ...
                                                                        <td>: <input style="width: 90%; border: none;" type="text" name="EMP_NUMBER" value="<%=employeeOri.getEmployeeNum()%>" class="elemenForm"></td>
                                                                        <td>: <input style="width: 90%; border: none;" type="text" name="EMP_NUMBER_EXC" value="<%=employeeExc.getEmployeeNum()%>" class="elemenForm"></td>

                                                                      </tr>
                                                                      <tr>

                                                                        <td height="15%">Name(Nama)</td>
                                                                        <td>: <input style="width: 90%; border: none;" type="text" name="EMP_FULLNAME" value="<%=employeeOri.getFullName()%>" class="elemenForm"></td>
                                                                        <td>: <input style="width: 90%; border: none;" type="text" name="EMP_FULLNAME_EXC" value="<%=employeeExc.getFullName()%>" class="elemenForm"></td>

                                                                      </tr>
                                                                      <tr>
                                                                      <td height="15%">Position (Position)</td>
                                                                      <td>: <input style="width: 90%; border: none;" type="text" name="EMP_POSITION" value="<%=positionOri.getPosition()%>" class="elemenForm"></td>
                                                                      <td>: <input style="width: 90%; border: none;" type="text" name="EMP_POSITION_EXC" value="<%=positionExc.getPosition()%>" class="elemenForm"></td>
                                                              ...
                                                              <table class="tblStyle"   width="100%" height="50%" style="border-collapse: collapse; margin-top: 5px; font-size: 11px; padding: 0;" cellpadding="0" cellspacing="0" border="1">
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td width="10%">Tgl</td>
                                                                    <td width="40%">: <%=ControlDate.drawDateWithStyle(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_NEW_CHANGE_DATE], empScheduleChange.getNewChangeDate() == null ? new Date() : empScheduleChange.getNewChangeDate(), 0, -150, "formElemen")%> * <%=frmEmpScheduleChange.getErrorMsg(frmEmpScheduleChange.FRM_FIELD_NEW_CHANGE_DATE)%></td>
                                                                  </tr>
                                                                  <tr>
                                                                    <td>Shift</td>
                                                                    <% long scheduleIdOri = 0 ;
                                                                       ...
                                                                       %>
                                                                    <td>: <%=ControlCombo.draw(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_ORIGINAL_SCHEDULE_ID], "formElemen", null, "" + (empScheduleChange.getOriginalScheduleId() != 0 ? empScheduleChange.getOriginalScheduleId() : scheduleIdOri ), sym_value, sym_key)%><%//=symbolOri.equals("") ? "schedule di tanggal ini belum di ada" : "schedule asli "+symbolOri%></td>

                                                         
                                                                    <td>Shift</td>
                                                                    <td>: <%=ControlCombo.draw(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_NEW_CHANGE_SCHEDULE_ID], "formElemen", null, "" + (empScheduleChange.getNewChangeScheduleId()!= 0 ? empScheduleChange.getNewChangeScheduleId() : scheduleIdExc ), sym_value, sym_key)%><%//=symbolExc.equals("") ? "schedule di tanggal ini belum di ada" : "schedule asli "+symbolExc%></td>
                                                                    </tr>
                                                                 <!-- <tr>
                                                                    <td>Off</td>
                                                                    <td>--</td>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td colspan="3">: <input style="width: 97%;" type="text" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_REMARK]%>" value="<%=empScheduleChange.getRemark()%>" class="elemenForm"></td>
                                                                  </tr>
                                                              </table>
                                                              <p>&nbsp;</p>
