...
<%!    /**
     * @Description Untuk menampilkan daftar employee yang memiliki Dp dalam
     * periode terpilih
     * @Created by Gadnyana
    ...
    public String drawListSummary(int offset, Vector listal, SrcLeaveManagement srcLeaveManagement) {
        ...
        ctrlist.addHeader("Schedule", "10%", "0", "0");
        ...
        for (int i = 0; i < listal.size(); i++) {
            ...
            SpecialStockId specialStockId = (SpecialStockId) ls.get(0);
            Employee emp = (Employee) ls.get(1);
            ScheduleSymbol symbol = (ScheduleSymbol) ls.get(2);

            rowx.add("" + (offset + i + 1));
            rowx.add(emp.getEmployeeNum());
            rowx.add(emp.getFullName());
            rowx.add(symbol.getSchedule() + " (" + symbol.getSymbol() + ")");

            //int expiredQTY = SessLeaveManagement.getTotalDpExpired(dpStockManagement.getEmployeeId(),srcLeaveManagement);
//            float expiredQTY = SessLeaveManagement.getDpExpired(specialLeaveStock.getSpecialLeaveId(),null);
//            float residu = specialLeaveStock.getLeaveStatus()- specialLeaveStock.getEmployeeId()- expiredQTY;
            rowx.add("" + specialStockId.getQty());
            rowx.add("" + specialStockId.getQtyUsed());
//            rowx.add(""+expiredQTY);
//            rowx.add(""+residu);
            rowx.add("" + (specialStockId.getQty() - specialStockId.getQtyUsed()));

            lstData.add(rowx);
            lstLinkData.add(String.valueOf(specialStockId.getEmployeeId()));
        }
...
<%//
    ...
    // process get list Stock (summary or detail depend on Empid value)
    ...
    if (iCommand != Command.NONE) {
        ...
        vectListDP = SessLeaveManagement.listSpecialStockManagement(srcLeaveManagement, start, recordToGet);
    }
%>
<!-- End of JSP Block -->
<html>
    ...
    <head>
        ...
        <title>HARISMA - Special Stock Management</title>
        ...
        function cmdView() {
            ...
            function cmdUpdateDep() {
                ...
                document.frpresence.action = "dp_special_add.jsp";
            ...
            function cmdChange(oid)
            {
                ...
                document.frdp.start.value = "0";
                document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EMPLOYEE_ID]%>.value = oid;
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr> 
                                        <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Employee 
                                                &gt; Leave Application &gt; Special Stock Management<!-- #EndEditable --> 
                                            </strong></font>
                                        </td>
                                    </tr>
                                    <tr> 
                                                                        ...
                                                                        <tr> 
                                                                            <td valign="top"> <!-- #BeginEditable "content" --> 
                                                                                <form name="frdp" method="post" action="">
                                                                                    ...
                                                                                    <input type="hidden" name="<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EMPLOYEE_ID]%>" value="<%=empOid%>">
                                                                                    <table width="60%" border="0" cellspacing="2" cellpadding="2">
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="78%"> 
                                                                                                ...
                                                                                                <i><font color="#FF0000">Select all period</font></i>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr> 
                                                                                            <td width="1%">&nbsp;</td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td width="1%">&nbsp;</td>
                                                                                            <td nowrap width="18%">Schedule</td>
                                                                                            <td width="3%">:</td>
                                                                                            <td width="78%">
                                                                                                <%
                                                                                                    ...
                                                                                                    for (int s = 0; s < listSchedule.size(); s++){
                                                                                                        ...
                                                                                                        sch_key.add(symbol.getSymbol() + " - "+ symbol.getSchedule());
                                                                                                    }
                                                                                                %>
                                                                                                <%=ControlCombo.drawStringArraySelected(FrmSrcLeaveManagement.fieldNames[FrmSrcLeaveManagement.FRM_FIELD_SCHEDULE_ID], "chosen-select", null, srcLeaveManagement.getArrScheduleId(), sch_key, sch_value, null, " data-placeholder='Select Schedule'" )%>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td width="1%">&nbsp;</td>
                                                                                            ...
                                                                                            <td width="78%"> 
                                                                                                <table border="0" cellspacing="0" cellpadding="0" width="200
                                                                                                       ">
                                                                                                    <tr> 
                                                                                                        <td width="12"><a href="javascript:cmdView()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image101', '', '<%=approot%>/images/BtnSearchOn.jpg', 1)" id="aSearch"><img name="Image101" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="Get Stock"></a></td>
                                                                                                        <td width="5"><img src="<%=approot%>/images/spacer.gif" width="4" height="1"></td>
                                                                                                        <td width="63" class="command" nowrap><a href="javascript:cmdView()">Get Stock</a></td>
                                                                                                        <%if (privAdd) {%>
                                                                                                        <td width="12"><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10', '', '<%=approot%>/images/BtnNewOn.jpg', 1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Add New Stock"></a></td>
                                                                                                        <td width="5"><img src="<%=approot%>/images/spacer.gif" width="4" height="1"></td>
                                                                                                        <td width="103" class="command" nowrap><a href="javascript:cmdAdd()">Add New Stock</a></td>
                                                                                                        <%}%>												  
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
