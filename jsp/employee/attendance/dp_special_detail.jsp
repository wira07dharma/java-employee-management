...
//edited & documented by Edhy
    public String drawListPerEmployee(int offsetStart, Vector listdp, int iCommand, long oidDp, I_Leave leaveConfig) {
        ...
        for (int i = 0; i < listdp.size(); i++) {
            ...
            SpecialStockId SpStockMnt = (SpecialStockId) listdp.get(i);

            if (iCommand == Command.EDIT) {
                if (oidDp == SpStockMnt.getOID() && SpStockMnt.getStatus() == 0) {
                    rowx.add("" + (offsetStart + i + 1) + "<input type=\"hidden\" value=\"" + SpStockMnt.getOID() + "\">"
                            + "<input type=\"hidden\" value=\"" + SpStockMnt.getOID() + "\">");

                    rowx.add("</a><input onClick=\"ds_sh(this);\" name=" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE] + " readonly=\"readonly\" style=\"cursor: text\" value=\"" + Formater.formatDate((SpStockMnt.getOwningDate() == null ? new Date() : SpStockMnt.getOwningDate()), "yyyy-MM-dd") + "\"/>"
                            + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE] + "_mn\">"
                            + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE] + "_dy\">"
                            + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE] + "_yr\">"
...
//                rowx.add(ControlCombo.draw(FrmDpStockManagement.fieldNames[FrmDpStockManagement.FRM_FLD_FLAG_STOCK],null,""+PstDpStockManagement.DP_FLAG_EDIT_YES,fgStockValue,fgStockKey));
                    ...
                    rowx.add("</a><input onClick=\"ds_sh(this);\" name=" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE] + " readonly=\"readonly\" style=\"cursor: text\" value=\"" + Formater.formatDate((SpStockMnt.getExpiredDate() == null ? new Date() : SpStockMnt.getExpiredDate()), "yyyy-MM-dd") + "\"/>"
                            + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE] + "_mn\">"
                            + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE] + "_dy\">"
                            + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE] + "_yr\">"
                            + "<script language=\"JavaScript\" type=\"text/JavaScript\">getThn();</script><a>");

                    String strQtyFieldStyle = "";

                    float balance_residue = 0;
                    float sumExpired = SessLeaveManagement.getTotalExpiredDP(SpStockMnt.getOID());
                    balance_residue = SpStockMnt.getQty() - SpStockMnt.getQtyUsed() - sumExpired;
                    rowx.add("<input type=\"text\" onKeyUp=\"javascript:calqty()\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_QTY] + "\" value=\"" + SpStockMnt.getQty() + "\" class=\"elemenForm\" " + strQtyFieldStyle + "size=\"3\" readonly>");
                    rowx.add("<input type=\"text\" onKeyUp=\"javascript:calqty()\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_QTY_USED] + "\" value=\"" + SpStockMnt.getQtyUsed() + "\" class=\"elemenForm\" style=\"" + StyleBg + "\"" + readOnly + "\" size=\"3\">");
                    ...
                    //rowx.add("<input type=\"text\" onKeyUp=\"javascript:calqty()\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_QTY_RESIDUE] + "\" value=\"" + balance_residue + "\" class=\"elemenForm\" style=\"background-color:#F5F5F5\" readonly size=\"3\">");
...
//                fgKey.add("YES");
//
//                rowx.add(ControlCombo.draw(FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FLD_EXCEPTION_FLAG],null,""+dpStockMnt.getiExceptionFlag(),fgValue,fgKey));
//                
...
//                         + "<script language=\"JavaScript\" type=\"text/JavaScript\">getThn();</script><a>");
                    ...
                    for (int d = 0; d < PstSpecialStockId.fieldNames.length; d++) {
                        if (d == PstSpecialStockId.FLD_STATUS) {
                            stValue.add("" + d);
                            stKey.add(PstSpecialStockId.fieldNames[d]);
                        }
                    }

                    String note = SpStockMnt.getNote() == null ? "" : SpStockMnt.getNote();
//                rowx.add(PstSpecialStockId); 
                    ...
                    rowx.add("<textarea name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_NOTE] + "\" cols=\"40\" rows=\"3\" class=\"elemenForm\" >" + note + "</textarea>");
                //update by satrya 2013-05-6
                    ...
                    if (SpStockMnt.getStatus() == 0) {
                        rowx.add("<a href=\"javascript:cmdEdit(\'" + SpStockMnt.getOID() + "')\">" + Formater.formatDate(SpStockMnt.getOwningDate(), "MMM dd, yyyy") + "</a>");
                    } else {
                        rowx.add(Formater.formatDate(SpStockMnt.getOwningDate(), "MMM dd, yyyy"));
                    }

                    float sumExpired = SessLeaveManagement.getTotalExpiredDP(SpStockMnt.getOID());
                    //update by satrya 2013-02-24
//                rowx.add(PstSpecialStockId.fieldFlag[dpStockMnt.getFlagStock()]);
                    rowx.add(Formater.formatDate(SpStockMnt.getExpiredDate(), "MMM dd, yyyy"));

                    rowx.add("" + SpStockMnt.getQty());
                    rowx.add("" + SpStockMnt.getQtyUsed());
                    //rowx.add("" + sumExpired);
                    //rowx.add("" + SpStockMnt.getQtyResidue());
                    String str = "YES";
//                if(SpStockMnt.getExceptionFlag()==0)
//		{
//                        str = "NO";
//	                rowx.add(str);
//	                rowx.add("-");					
...
//		}			
//                rowx.add(PstSpecialStockId.fieldTypes[SpStockMnt.getStatus()]);
                    rowx.add(SpStockMnt.getNote() == null ? "" : SpStockMnt.getNote());
                }
            } // jika bukan command EDIT
            else {
                rowx.add("" + (offsetStart + i + 1));
                if (SpStockMnt.getStatus() == 0) //if( (dpStockMnt.getiDpStatus()==PstDpStockManagement.DP_STS_AKTIF) && (dpStockMnt.getQtyUsed()==0) )  
                {
                    rowx.add("<a href=\"javascript:cmdEdit(\'" + SpStockMnt.getOID() + "')\">" + Formater.formatDate(SpStockMnt.getOwningDate(), "MMM dd, yyyy") + "</a>");
                } else {
                    rowx.add(Formater.formatDate(SpStockMnt.getOwningDate(), "MMM dd, yyyy"));
                        ...
                        //update by satrya 2013-02-24
//                        rowx.add(PstDpStockManagement.fieldFlag[SpStockMnt.getFlagStock()]);
                ...
                //rowx.add("" + sumExpired);
                float balance = 0;
                balance = SpStockMnt.getQty() - SpStockMnt.getQtyUsed() - sumExpired;
                //rowx.add("" + balance);
                String str = "YES";
//			if(SpStockMnt.getiExceptionFlag()==0)
//			{
//				str = "NO";
//				rowx.add(str);
//				rowx.add("-");					
...
//			rowx.add(PstSpecialStockId.fieldNames[SpStockMnt.getStatus()]);
                rowx.add(SpStockMnt.getNote() == null ? "" : SpStockMnt.getNote());
            }

            lstData.add(rowx);
            lstLinkData.add(String.valueOf(SpStockMnt.getOID()));
        }
        ...
        if (oidDp == 0) {
            ...
            if (iCommand == Command.ADD) {
                ...
                rowadd.add("</a><input onClick=\"ds_sh(this);\" name=" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE] + " readonly=\"readonly\" style=\"cursor: text\" value=\"" + Formater.formatDate((new Date()), "yyyy-MM-dd") + "\"/>"
                        + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE] + "_mn\">"
                        + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE] + "_dy\">"
                        + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE] + "_yr\">"
                        + "<script language=\"JavaScript\" type=\"text/JavaScript\">getThn();</script><a>");
...
//                rowadd.add(ControlCombo.draw(FrmDpStockManagement.fieldNames[FrmDpStockManagement.FRM_FLD_FLAG_STOCK],null,""+PstDpStockManagement.DP_FLAG_EDIT_YES,fgStockValue,fgStockKey));
                ...
                rowadd.add("</a><input onClick=\"ds_sh(this);\" name=" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE] + " readonly=\"readonly\" style=\"cursor: text\" value=\"" + Formater.formatDate((new Date()), "yyyy-MM-dd") + "\"/>"
                        + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE] + "_mn\">"
                        + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE] + "_dy\">"
                        + "<input type=\"hidden\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE] + "_yr\">"
                        + "<script language=\"JavaScript\" type=\"text/JavaScript\">getThn();</script><a>");

                rowadd.add("<input type=\"text\" onKeyUp=\"javascript:calqty()\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_QTY] + "\" value=\"1\" class=\"elemenForm\" size=\"3\" readonly>");
                rowadd.add("<input type=\"text\" onKeyUp=\"javascript:calqty()\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_QTY_USED] + "\" value=\"0\" class=\"elemenForm\" style=\"background-color:#F5F5F5\" readonly size=\"3\">");
                ...
                //rowadd.add("<input type=\"text\" onKeyUp=\"javascript:calqty()\" name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_QTY_RESIDUE] + "\" value=\"0\" class=\"elemenForm\" style=\"background-color:#F5F5F5\" readonly size=\"3\">");
...
//                         + "<script language=\"JavaScript\" type=\"text/JavaScript\">getThn();</script><a>");
                ...
                //rowadd.add(ControlCombo.draw(FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_STATUS], null, "", stValue, stKey));
                ...
                rowadd.add("<textarea name=\"" + FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_NOTE] + "\" cols=\"40\" rows=\"3\" class=\"elemenForm\" ></textarea>");
            }
            lstData.add(rowadd);
        }
...
<%    int iCommand = FRMQueryString.requestCommand(request);
    ...
    long empOid = FRMQueryString.requestLong(request, FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EMPLOYEE_ID]);
	long scheduleId = FRMQueryString.requestLong(request, FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_SCHEDULE_ID]);
...
// for manage data dp
	...
	objSpecialStockId.setScheduleId(scheduleId);
...
//vectSize = SessLeaveManagement.countDetailDpStock(empOid);
    ...
    if (iCommand == Command.FIRST || iCommand == Command.NEXT || iCommand == Command.PREV || iCommand == Command.LAST || iCommand == Command.LIST) {
        start = ctrlSpecialStockId.actionList(iCommand, start, vectSize, recordToGet);
    }
...
//Mencari employeeId dan record DP	
    ...
    if (empOid != 0) {
        try {
            ...
            symbol = PstScheduleSymbol.fetchExc(scheduleId);
        } catch (Exception e) {
            System.out.println("exc when fetch emp : " + e.toString());
        }
        vectListDP = SessLeaveManagement.listDetailSpecialStock(empOid, start, recordToGet, srcLeaveManagement,scheduleId);
    }
    ...
    <head>
        ...
        function cmdBackSummary() {
            ...
            function calqty()
            {
                ...
                var resqty = document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_QTY_RESIDUE]%>.value = parseFloat(alqty) - parseFloat(usedqty) - parseFloat(exp);
            }
            ...
            function cmdEdit(oid)
            {
                ...
                document.frdp.action = "dp_special_detail.jsp";
                document.frdp.submit();
            }
            ...
            //--------------------------------------------------for calender
            function getThn() {
                var date1 = "" + document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE]%>.value;
                ...
                document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE]%>_mn.value = bln;
                document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE]%>_dy.value = hri;
                document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_OWNING_DATE]%>_yr.value = thn;

                var date2 = "" + document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE]%>.value;
                ...
                document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE]%>_mn.value = bln;
                document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE]%>_dy.value = hri;
                document.frdp.<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EXPIRED_DATE]%>_yr.value = thn;
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr> 
                                        <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Employee 
                                                &gt; Leave Application &gt; Stock Detail<!-- #EndEditable --> 
                                            </strong></font> </td>
                                    </tr>
                                    <tr> 
                                        <td> 
                                                                        ...
                                                                        <tr> 
                                                                            <td valign="top"> <!-- #BeginEditable "content" --> 
                                                                                <form name="frdp" method="post" action="">
                                                                                    ...
                                                                                    <input type="hidden" name="<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_EMPLOYEE_ID]%>" value="<%=String.valueOf(empOid)%>">
																					<input type="hidden" name="<%=FrmSpecialStockId.fieldNames[FrmSpecialStockId.FRM_FIELD_SCHEDULE_ID]%>" value="<%=scheduleId%>">
                                                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td>&nbsp;&nbsp;<b>Schedule &nbsp; &nbsp;: 
                                                                                                    <%=symbol.getSchedule().toUpperCase()%></b></td>
                                                                                        </tr>
                                                                                        <%
                                                                                            }
                                                                                                ...
                                                                                                <%
                                                                                                    if (empOid != 0) {
                                                                                                        ...
                                                                                                        if (iCommand == Command.ASK) {
                                                                                                            ctrLine.setDeleteQuestion("Are you sure to delete this Stock ?");//msgString);
                                                                                                        }

                                                                                                        // jika record DP sudah ada yg di-taken, maka tdk boleh dihapus
                                                                                                        if (objSpecialStockId.getQtyUsed() > 0) {
                                                                                                            ctrLine.setDeleteCaption("");
                                                                                                        }
