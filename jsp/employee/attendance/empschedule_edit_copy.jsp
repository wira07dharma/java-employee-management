...
<%!
    public String drawList(Vector objectClass) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            } catch(Exception e) { str_dt_TimeIn = ""; }
            ...
            } catch(Exception e) { str_dt_TimeOut = ""; }
...
<script language="JavaScript">
    ...
    function cmdSearchEmp(){
        ...
        window.open("empsearch.jsp?emp_number=" + emp_number + "&emp_fullname=" + emp_fullname + "&emp_department=" + emp_department + "&emp_period=" + emp_period + "&emp_section=" + emp_section, null, "height=400,width=700,status=yes,toolbar=no,menubar=no,location=no");
        //window.open("searchemployee.jsp", null, "status=yes,toolbar=no,menubar=no,location=no");
    }
                                                                ...
                                                                <tr> 
                                                                  <td> 
                                                                    <table border="1" cellpadding="3" cellspacing="0" bgcolor="#B0DDF0">
                                                                      ...
                                                                      <%---
                                                                      <tr> 
                                                                        <td colspan="7"><a href="javascript:cmdCopyPaste();">Create</a> 
