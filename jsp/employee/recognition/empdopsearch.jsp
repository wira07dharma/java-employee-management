...
<script language="javascript">
    ...
    function cmdEdit(oid, number, fullname, department, position, commencing_date) {        
        self.opener.document.frm_recognition.<%=FrmEmpSalary.fieldNames[FrmEmpSalary.FRM_FIELD_EMPLOYEE_ID]%>.value = oid;
        self.opener.document.frm_recognition.EMP_NUMBER.value = number;
        self.opener.document.frm_recognition.EMP_FULLNAME.value = fullname;
        self.opener.document.frm_recognition.EMP_DEPARTMENT.value = department;
        self.opener.document.frm_recognition.EMP_POSITION.value = position;
        self.opener.document.frm_recognition.EMP_COMMENCING_DATE.value = commencing_date;
        self.close();
    }
</script>
