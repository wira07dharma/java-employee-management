    ...
    try {
        ...
        System.out.println("Please contact your system administration to setup system property: ATTENDANCE_CONFIG ");
            ...
            if (iCommand == Command.POST){
                exportpayroll = PstArApMain.ExporttoPayment(listArApMain, periodeId, companyId);
            }
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdPost(oidArapMain){
                ...
                document.frmArApMain.prev_command.value="<%=prevCommand%>";
                document.frmArApMain.action="list_payment_deduction.jsp";
                document.frmArApMain.submit();
            }
                                                                                            ...
                                                                                            <td height="8" valign="middle" colspan="3">
                                                                                                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                                    <td width="24"><a href="javascript:cmdPost()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1003','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image1003" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" ></a><a href="javascript:cmdPost()" class="command" style="text-decoration:none">Export Payment Deduction</a></td>
