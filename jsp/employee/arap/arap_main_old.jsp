                                                                                                            ...
                                                                                                            <table border="0" cellspacing="2" cellpadding="2" width="50%">
                                                                                                                ...
                                                                                                                <tr align="left">
                                                                                                                                ...
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left">Voucher Date</div></td>
                                                                                                                                   <td  width="31%"  valign="top"><%=ControlDate.drawDateWithStyle(FrmArApMain.fieldNames[FrmArApMain.FRM_VOUCHER_DATE], arApMain.getVoucherDate() == null ? new Date() : arApMain.getVoucherDate(), 1, -35, "formElemen")%> </td>
                                                                                                                               
                                                                                                                                <td  width="58%"  valign="top" nowrap>
                                                                                                                                   <div align="left">Entry Date</div>
                                                                                                                                </td>
                                                                                                                                <td  width="46%"  valign="top">
                                                                                                                                   <td  width="31%"  valign="top"><%=ControlDate.drawDateWithStyle(FrmArApMain.fieldNames[FrmArApMain.FRM_ENTRY_DATE], arApMain.getEntryDate() == null ? new Date() : arApMain.getEntryDate(), 1, -35, "formElemen")%> </td>
                                                                                                                ...
                                                                                                                <tr align="left">
                                                                                                                                ...
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   ...
                                                                                                                                   <td  width="31%"  valign="top"><input type="text" name="EMP_FULLNAME" value="<% String name = PstEmployee.getEmployeeName(arApMain.getEmployeeId()); %><%=(arApMain.getEmployeeId() != 0 ? name : "-")%>" class="elemenForm"> <input type="hidden" name="<%=FrmArApMain.fieldNames[FrmArApMain.FRM_FIELD_EMPLOYEE_ID]%>" value="<%=(arApMain.getEmployeeId())%>" class="formElemen" > <a href="javascript:cmdSearchEmp()">add employee</a>  </td>
                                                                                                                               
                                                                                                                                <td  width="58%"  valign="top" nowrap>
                                                                                                                                   <div align="left">Creditor</div>
                                                                                                                                </td>
                                                                                                                ...
                                                                                                                <tr align="left">
                                                                                                                                <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left">Bill Date</div></td>
                                                                                                                                   <td  width="31%"  valign="top"><%=ControlDate.drawDateWithStyle(FrmArApMain.fieldNames[FrmArApMain.FRM_NOTA_DATE], arApMain.getNotaDate() == null ? new Date() : arApMain.getNotaDate(), 1, -35, "formElemen")%> 
                                                                                                                                   </td>  
                                                                                                                                <td  width="58%"  valign="top" nowrap>
                                                                                                                                   <div align="left">Bill Number</div>
                                                                                                                                </td>
                                                                                                                                <td  width="46%"  valign="top">
                                                                                                                                   <td  width="31%"  valign="top"><input  type="text" name="<%=FrmArApMain.fieldNames[FrmArApMain.FRM_NOTA_NO]%>"   value="<%=(arApMain.getNotaNo() != null ? arApMain.getNotaNo() : "")%>" class="formElemen">  </td>
                                                                                                                </tr>
                                                                                                                <tr align="left">
                                                                                                                                <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left">Amount / nominal</div></td>
                                                                                                                                    <td  width="31%"  valign="top">
                                                                                                                                        <%
                                                                                                                                    ...
                                                                                                                                    <input  type="text" name="<%=FrmArApMain.fieldNames[FrmArApMain.FRM_AMOUNT]%>"   value="<%=(arApMain.getAmount() != 0 ? arApMain.getAmount() : "")%>" class="formElemen">  </td>
                                                                                                                                    <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left"></div></td>
                                                                                                                                   <td  width="31%"  valign="top"><input  type="hidden" name="<%=FrmArApMain.fieldNames[FrmArApMain.FRM_RATE]%>"   value="<%=(arApMain.getRate() != 0 ? arApMain.getRate() : "1")%>" class="formElemen"> </td>
                                                                                                                </tr>
                                                                                                                <tr align="left">
                                                                                                                                <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left">Number Of Payment</div></td>
                                                                                                                                   <td  width="31%"  valign="top"><input  type="text" name="<%=FrmArApMain.fieldNames[FrmArApMain.FRM_NUMBER_OF_PAYMENT]%>"   value="<%=(arApMain.getNumberOfPayment() != 0 ? arApMain.getNumberOfPayment() : "")%>" class="formElemen">  </td>
                                                                                                                                   
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div width="31%" align="left">Period of Payment : every </div></td>
                                                                                                                                   <td  width="31%"  valign="top"><input  type="text" name="<%=FrmArApMain.fieldNames[FrmArApMain.FRM_PERIOD_EVERY]%>"   value="<%=(arApMain.getPeriodeEvery() != 0 ? arApMain.getPeriodeEvery() : "1")%>" class="formElemen"><%= ControlCombo.draw(FrmArApMain.fieldNames[FrmArApMain.FRM_PERIOD_EVERY_DMY], "formElemen", null, "" + (arApMain.getPeriodeEveryDMY()!=0?arApMain.getPeriodeEveryDMY():arApMain.getPeriodeEveryDMY()), FrmArApMain.getPerValue(), FrmArApMain.getPerKey(), "") %> * <%= frmArApMain.getErrorMsg(frmArApMain.FRM_PERIOD_EVERY_DMY) %>
                                                                                                                                   </td>
                                                                                                               </tr>
                                                                                                               <tr align="left">
                                                                                                                                <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left">Payment Amount Plan</div></td>
                                                                                                                                   <td  width="31%"  valign="top"><input  type="text" name="<%=FrmArApMain.fieldNames[FrmArApMain.FRM_PAYMENT_AMOUNT_PLAN]%>"   value="<%=(arApMain.getPayment_amount_plan() != 0 ? arApMain.getPayment_amount_plan() : "")%>" class="formElemen">  </td>
                                                                                                                                   
                                                                                                                </tr>
                                                                                                               <tr align="left">
                                                                                                                                <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left">Start Of Payment Date</div></td>
                                                                                                                                   <td  width="31%"  valign="top"><%=ControlDate.drawDateWithStyle(FrmArApMain.fieldNames[FrmArApMain.FRM_START_OF_PAYMENT_DATE], arApMain.getStartofpaymentdate() == null ? new Date() : arApMain.getStartofpaymentdate(), 1, -35, "formElemen")%> 
                                                                                                                                   </td>
                                                                                                               </tr>
                                                                                                               <tr align="left">
                                                                                                                                <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left">Deskripsi</div></td>
                                                                                                                                   <td  width="46%"  valign="top">
                                                                                                               ...
                                                                                                               <tr align="left">
                                                                                                                                <td width="0%"  valign="top"  >&nbsp;</td>
                                                                                                                                <td width="42%"  valign="top" nowrap  >
                                                                                                                                   <div align="left">Payroll Component Deduction</div></td>
                                                                                                                                   <td  width="46%"  valign="top">
