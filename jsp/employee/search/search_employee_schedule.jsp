<%-- 
    Document   : search_employee_schedule
    Created on : Jan 17, 2011, 2:52:29 PM
    Author     : dimata
--%>
...
<%
    ...
    long oidPeriod = FRMQueryString.requestLong(request,"periodOID");
            ...
            if(isHRDLogin || isEdpLogin || isGeneralManager){
                ...
                if(SectionList != null && SectionList.size() > 0){
                    ...
                    for(int i = 0 ; i < SectionList.size() ; i++){
                        ...
                        if(section.getDepartmentId() == oidDepartment){
