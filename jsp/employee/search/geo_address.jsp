...
<%
            ...
            long oidDistrict = FRMQueryString.requestLong(request, FrmDistrict.fieldNames[FrmDistrict.FRM_FIELD_DISTRICT_ID]);            
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function selectGeo(geoAddress){
                ...
                oidNegara= document.frmgeoaddress.<%=FrmDistrict.fieldNames[FrmDistrict.FRM_FIELD_ID_NEGARA]%>.value;
                oidProvinsi = document.frmgeoaddress.<%=FrmDistrict.fieldNames[FrmDistrict.FRM_FIELD_ID_PROPINSI ]%>.value;
                oidKabupaten = document.frmgeoaddress.<%=FrmDistrict.fieldNames[FrmDistrict.FRM_FIELD_ID_KABUPATEN]%>.value;
                oidKecamatan = document.frmgeoaddress.<%=FrmDistrict.fieldNames[FrmDistrict.FRM_FIELD_ID_KECAMATAN]%>.value;  
                oidDistrict = document.frmgeoaddress.<%=FrmDistrict.fieldNames[FrmDistrict.FRM_FIELD_DISTRICT_ID]%>.value;               
                <% if(addresstype==1) { %>
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_COUNTRY_ID]%>.value = oidNegara;
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_PROVINCE_ID]%>.value = oidProvinsi;
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_REGENCY_ID]%>.value = oidKabupaten;
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_SUBREGENCY_ID]%>.value = oidKecamatan;   
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_DISTRICT_ID]%>.value = oidDistrict;                    
                    self.opener.document.<%=formName%>.geo_address.value = geoAddress;                                        
                <%} else { %>
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_PMNT_COUNTRY_ID]%>.value = oidNegara;
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_PMNT_PROVINCE_ID]%>.value = oidProvinsi;
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_PMNT_REGENCY_ID]%>.value = oidKabupaten;
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_PMNT_SUBREGENCY_ID]%>.value = oidKecamatan;  
                    self.opener.document.<%=formName%>.<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ADDR_DISTRICT_ID]%>.value = oidDistrict;                       
                                                                                                                ...
                                                                                                                <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="82%"><%
                                                                                                                        ...
                                                                                                                        for (int i = 0; i < listNeg.size(); i++) {
                                                                                                                            ...
                                                                                                                            if(district.getIdNegara()==neg.getOID()){
                                                                                                                                geoAddress = geoAddress+ neg.getNmNegara();
                                                                                                                            }
                                                                                                                            neg_value.add(String.valueOf(neg.getOID()));                                                                                                                            
                                                                                                                        }
                                                                                                                        if(district.getIdNegara()==0){
                                                                                                                                geoAddress = geoAddress+ "-";
                                                                                                                        }
                                                                                                                        %>
                                                                                                                        <%= ControlCombo.draw(frmDistrict.fieldNames[FrmDistrict.FRM_FIELD_ID_NEGARA], "formElemen", null, "" + district.getIdNegara(), neg_value, neg_key, "onChange=\"javascript:cmdUpdateKec()\"")%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="82%"><%
                                                                                                                        ...
                                                                                                                        for (int i = 0; i < listPro.size(); i++) {
                                                                                                                            ...
                                                                                                                            if(district.getIdPropinsi()==prov.getOID()){
                                                                                                                                geoAddress = geoAddress+ ","+ prov.getNmProvinsi();
                                                                                                                            }
                                                                                                                            if(prov.getOID()==district.getIdPropinsi()){
                                                                                                                                oidProvOk=true;
                                                                                                                            }
                                                                                                                        }
                                                                                                                        if(!oidProvOk){
                                                                                                                            district.setIdPropinsi(0);
                                                                                                                            oidProvinsi=0;
                                                                                                                        }
                                                                                                                        if(district.getIdPropinsi()==0){
                                                                                                                                geoAddress = geoAddress+ ",-";
                                                                                                                            }
                                                                                                                        %>
                                                                                                                        <%= ControlCombo.draw(frmDistrict.fieldNames[FrmDistrict.FRM_FIELD_ID_PROPINSI], "formElemen", null, "" + district.getIdPropinsi(), pro_value, pro_key, "onChange=\"javascript:cmdUpdateKec()\"")%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="82%"><%
                                                                                                                        ...
                                                                                                                        String strWhereKab = PstKabupaten.fieldNames[PstKabupaten.FLD_ID_PROPINSI] + "=" + district.getIdPropinsi();
                                                                                                                        ...
                                                                                                                        for (int i = 0; i < listKab.size(); i++) {
                                                                                                                            ...
                                                                                                                            if(district.getIdKabupaten()==kab.getOID()){
                                                                                                                        ...
                                                                                                                        if(!oidKabOk){
                                                                                                                            oidKabupaten=0;
                                                                                                                            district.setIdKabupaten(0);
                                                                                                                        }
                                                                                                                        if(district.getIdKabupaten()==0){
                                                                                                                                geoAddress = geoAddress+ ",-";
                                                                                                                            }
                                                                                                                        %> <%= ControlCombo.draw(frmDistrict.fieldNames[FrmDistrict.FRM_FIELD_ID_KABUPATEN], "formElemen", null, "" + district.getIdKabupaten(), kab_value, kab_key, "onChange=\"javascript:cmdUpdateKec()\"")%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="82%"><%                                                                                                                    
                                                                                                                        ...
                                                                                                                        for (int i = 0; i < listKecamatan.size(); i++) {
                                                                                                                            ...
                                                                                                                            if(district.getIdKecamatan()==kec.getOID()){
                                                                                                                                geoAddress = geoAddress+ ","+ kec.getNmKecamatan();
                                                                                                                            }
                                                                                                                            if(oidKecamatan==kec.getOID()){
                                                                                                                              oidKecOk=true;  
                                                                                                                            }
                                                                                                                        }
                                                                                                                        if(!oidKecOk){
                                                                                                                            oidKecamatan=0;
                                                                                                                            district.setIdKecamatan(0);
                                                                                                                        }
                                                                                                                        if(district.getIdKecamatan()==0){
                                                                                                                                geoAddress = geoAddress+ ",-";
                                                                                                                            }
                                                                                                                        %> <%= ControlCombo.draw(frmDistrict.fieldNames[FrmDistrict.FRM_FIELD_ID_KECAMATAN], "formElemen", null, "" + district.getIdKecamatan(), kec_value, kec_key, "onChange=\"javascript:cmdUpdateKec()\"")%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                 <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="82%"><%                                                                                                                    
                                                                                                                        ...
                                                                                                                        Vector district_value = new Vector(1, 1);
                                                                                                                        Vector district_key = new Vector(1, 1);
                                                                                                                        district_value.add("0");
                                                                                                                        district_key.add("select ...");
                                                                                                                        
                                                                                                                        String whereClauseD = " d." + PstDistrict.fieldNames[PstDistrict.FLD_ID_KECAMATAN]+"="+oidKecamatan;
                                                                                                                        String orderClauseD = " k." + PstKabupaten.fieldNames[PstKabupaten.FLD_NM_KABUPATEN] + ", kec." + PstKecamatan.fieldNames[PstKecamatan.FLD_NM_KECAMATAN]+ ", d." + PstDistrict.fieldNames[PstDistrict.FLD_NAMA_DISTRICT];
                                                                                                                        Vector listDistrict = new Vector(1, 1);                                                                                                                        
                                                                                                                        listDistrict = PstDistrict.listJoinDist(0, 300, whereClauseD, orderClauseD);                                                                                                                        
                                                                                                                        
                                                                                                                        for (int i = 0; i < listDistrict.size(); i++) {
                                                                                                                            District dis = (District) listDistrict.get(i);
                                                                                                                            district_key.add(dis.getNmDistrict());
                                                                                                                            district_value.add(String.valueOf(dis.getOID()));
                                                                                                                            if(district.getOID()==dis.getOID()){
                                                                                                                                geoAddress = geoAddress+ ","+ dis.getNmDistrict();
                                                                                                                            }
                                                                                                                        }
                                                                                                                        if(district.getOID ()==0){
                                                                                                                                geoAddress = geoAddress+ ",-";
                                                                                                                            }
                                                                                                                        %> <%= ControlCombo.draw(frmDistrict.fieldNames[FrmDistrict.FRM_FIELD_DISTRICT_ID], "formElemen", null, "" + district.getOID(), district_value, district_key, "onChange=\"javascript:cmdUpdateKec()\"")%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
