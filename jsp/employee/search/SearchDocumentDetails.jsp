...
//    String whereClause = "RESIGNED = 0";
    ...
    where ="";  
      iErrCode = ctrlEmpDocList.action(iCommand , oidEmpDocList,srcEmployee,start,recordToGet,where,objectName,oidEmpDoc);
...
function cmdSave(){
    ...
    document.frmEmpDocList.action="SearchDocumentDetails.jsp";
