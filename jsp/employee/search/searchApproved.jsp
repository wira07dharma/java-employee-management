...
function cmdEdit(oid, number, fullname, department) {
        ...
        self.opener.document.<%=formName%>.EMP_NUMBER_APPROVED.value = number;
        self.opener.document.<%=formName%>.EMP_FULLNAME_APPROVED.value = fullname;
        self.opener.document.<%=formName%>.EMP_DEPARTMENT_APPROVED.value = department;
        self.close();
    }
function cmdAdd() {
...
//function cmdUpdateDep(){
	...
	//document.searchEmp.action="searchApproved.jsp"; 
