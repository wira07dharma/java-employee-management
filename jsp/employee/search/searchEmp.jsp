...
<%
    ...
    String firstName = FRMQueryString.requestString(request,"firstName");
...
function cmdEdit_old(oid, number, fullname, department) {
        ...
        self.opener.document.<%=formName%>.<%=firstName%>EMP_NUMBER.value = number;
        self.opener.document.<%=formName%>.<%=firstName%>EMP_FULLNAME.value = fullname;
        self.opener.document.<%=formName%>.<%=firstName%>EMP_DEPARTMENT.value = department;
        self.close();
    }
function cmdEdit(oid, number, fullname, department, position, commencing_date) {
        ...
        self.opener.document.<%=formName%>.<%=firstName%>EMP_FULLNAME.value = fullname;
        self.opener.document.<%=formName%>.<%=firstName%>EMP_DEPARTMENT.value = department;
        self.opener.document.<%=formName%>.<%=firstName%>EMP_POSITION.value = position;
        self.opener.document.<%=formName%>.<%=firstName%>EMP_COMMENCING_DATE.value = commencing_date;
        self.close();
    }
function cmdAdd() {
...
function cmdUpdateDep(){
	...
	document.searchEmp.action="searchEmp.jsp"; 
                            ...
                            <td valign="top">
		    				  <!-- #BeginEditable "content" -->
                                <% if (privStart) { %>
                                    ...
                                    <input type="hidden" name="firstName" value="<%=String.valueOf(firstName)%>">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                            <td>
