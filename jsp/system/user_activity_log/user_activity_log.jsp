...
<html>
    <head>
        ...
        <script type="text/javascript">
			...
			function cmdDetailJSON(oid){
                newWindow=window.open("more_detail_json.jsp?oid="+oid,"MoreDetail", "height=500,width=600,status=yes,toolbar=no,menubar=no,location=center,scrollbars=yes");
                newWindow.focus();
            }
        </script>
                        ...
                        <td width="50%" valign="top">
                            <table cellpadding="5" cellspacing="5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:cmdBrowseUser()" style="color:#474747" class="btn1">Pilih user</a>
