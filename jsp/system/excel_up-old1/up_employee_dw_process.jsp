      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" --> 
                  Uploader &gt; Employee &gt; Category Daily Worker<!-- #EndEditable --> 
                  </strong></font> </td>
        </tr>
        <tr> 
          <td>
                          ...
                          <tr> 
							...
							<%   
								...
								try 
								{
									...
									Excel tp = new Excel();
									int numcol = 7; // jumlah kolom untuk employee daily worker excel
									v = tp.ReadStream((InputStream) inStream, numcol);
									double dt = 0.0;							
							
									// Proses untuk category employee (training)
									String strEmpCat = "DAILY WORKER"; // change if name of category is different															
									long idCategory = 0;
									...
									*/
									...
									out.println("<form name=\"frmupload\" method=\"post\" action=\"up_employee_dw_save.jsp\">");
										...
										{											
											...
											switch ((i % numcol)) 
											{
												case 0 : // kalo sisanya 0 ==> pada kolom I (employee number)
													...
													out.println("<input type=\"hidden\" name=\"birthplace\" value=\"-\" >");
													out.println("<input type=\"hidden\" name=\"birthdate\" value=\"" + Formater.formatDate(new Date(), "yyyy-MM-dd") + "\" >");
												...
												case 4 : // kalo sisanya 4 ==> pada kolom V (employee position)
													String oidPost = "0";
													try
													{
														oidPost = String.valueOf(hashPosition.get(String.valueOf(v.elementAt(i))));
													}
													catch(Exception e)
													{
														System.out.println("Err : "+e.toString());
													}
													out.println("<td class=\"listgensell\"><input type=\"hidden\" name=\"position\" value=\"" + oidPost + "\" >"+v.elementAt(i)+"</td>");
													break;													
													
												case 5 : // kalo sisanya 5 ==> pada kolom VII (employee address)
													out.println("<td class=\"listgensell\"><input type=\"hidden\" name=\"address\" value=\"" + v.elementAt(i) + "\" >"+v.elementAt(i)+"</td>");
													break;
													
												case 6 : // kalo sisanya 6 ==> pada kolom VIII (employee sex)
