		    				  ...
		    				  <!-- #BeginEditable "content" -->
                                    <%
                                        ...
                                        for (int i = 0; i < empnumber.length; i++) 
										{
											...
											try{
                                            	if(Formater.formatDate(birthdate[i], "MM/dd/yy")!=null){
													emp.setBirthDate(Formater.formatDate(birthdate[i], "MM/dd/yy"));
												}
											}
											catch(Exception ex){
											...
											try{
												if(Formater.formatDate(commencingdate[i], "MM/dd/yy")!=null){
                                            	 	emp.setCommencingDate(Formater.formatDate(commencingdate[i], "MM/dd/yy"));
												}
											}
											catch(Exception ex){
