...
<%   
    ...
    try {
        ...
        Excel tp = new Excel();
        v = tp.ReadStream((InputStream) inStream);
        out.println("<form name=\"frmupload\" method=\"post\" action=\"up_position_save.jsp\">");
        out.println("<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">");
        for (int i = 0; i < v.size(); i++) {
            out.println("<tr><td><input type=\"checkbox\" name=\"cbposition\" value=\"" + v.elementAt(i) + "\" style=\"border-color:'white'\" checked></td><td>" + v.elementAt(i) + "</td></tr>");
        }
        out.println("</table>");
