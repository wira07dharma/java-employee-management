...
if(iCommand == Command.SAVE)
{
	...
	else
	{
		...
		for(int e=0; e<employeeId.length; e++)
		{
			...
			int intDpStockAmount = objPstDpStockManagement.getDpStockAmountPerEmployee(Long.parseLong(""+employeeId[e]));

			// get total AL stock per this employee
			PstAlStockManagement objPstAlStockManagement = new PstAlStockManagement();
			int intAlStockAmount = objPstAlStockManagement.getAlStockAmountPerEmployee(Long.parseLong(""+employeeId[e]));

			// get total LL stock per this employee
			PstLLStockManagement objPstLLStockManagement = new PstLLStockManagement();
			int intLlStockAmount = objPstLLStockManagement.getLlStockAmountPerEmployee(Long.parseLong(""+employeeId[e]));
