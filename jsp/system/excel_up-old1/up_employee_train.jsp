                          ...
                          <tr> 
                            <td valign="top">
		    				  <!-- #BeginEditable "content" -->
                                    <form name="form1" method="post" action="up_employee_train_process.jsp" enctype="multipart/form-data">
										<table width="100%" border="0">
                                        <tr> 
                                          <td><b>Choose Trainee's employee file 
                                            (.xls) to export to Harisma</b></td>   
                                        </tr>   
                                        <tr> 
                                          <td> 
