      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" --> 
                  Uploader &gt; Leave Management &gt; LL Stock<!-- #EndEditable --> 
                  </strong></font> </td>
        </tr>
        <tr> 
          <td>
                            ...
                            <td valign="top">
							  ...
							  <%   
								...
								try 
								{
									...
									// jumlah kolom untuk ll opname excel
									int numcol = 9; 
									v = tp.ReadStream((InputStream) inStream, numcol);
									double dt = 0.0;							
							
									// proses untuk data ll stock employee
									out.println("<form name=\"frmupload\" method=\"post\" action=\"up_opname_ll_save.jsp\">");
									out.println("&nbsp;&nbsp;<b>List employee's LL Stock</b>");
									out.println("<table width=\"90%\" class=\"listarea\"><tr width=\"100%\"><td>");								
									out.println("<table width=\"100%\" class=\"listgen\" cellpadding=\"1\" cellspacing=\"1\"><tr>");
									...
									if(v!=null && v.size()>0)
									{
										...
										{											
											out.println("<td align=\"centre\" class=\"listgentitle\">"+v.elementAt(tit)+"</td>");
										}
										out.println("</tr>");																			
										...
										{											
											...
											switch ((i % numcol)) 
											{
												...
												case 3 : // kalo sisanya 3 ==> pada kolom IV (commencing)
													...
													out.println("<td align=\"center\" class=\"listgensell\"><input type=\"hidden\" name=\"commencingdate\" value=\"" + Formater.formatDate(HSSFDateUtil.getJavaDate(dt), "yyyy-MM-dd") + "\">"+Formater.formatDate(HSSFDateUtil.getJavaDate(dt), "dd-MM-yyyy")+"</td>");
													break;

												case 4 : // kalo sisanya 4 ==> pada kolom V (entitledment I)
													out.println("<td align=\"right\" class=\"listgensell\"><input type=\"hidden\" name=\"entitlement1\" value=\"" + v.elementAt(i) + "\">"+v.elementAt(i)+"</td>");
													break;

												case 5 : // kalo sisanya 5 ==> pada kolom VI (entitledment II)
													out.println("<td align=\"right\" class=\"listgensell\"><input type=\"hidden\" name=\"entitlement2\" value=\"" + v.elementAt(i) + "\">"+v.elementAt(i)+"</td>");
													break;
													
												case 6 : // kalo sisanya 6 ==> pada kolom VII (total LL)
													out.println("<td align=\"right\" class=\"listgensell\"><input type=\"hidden\" name=\"llstock\" value=\"" + v.elementAt(i) + "\" >"+v.elementAt(i)+"</td>");																										
													break;

												case 7 : // kalo sisanya 7 ==> pada kolom VII (taken ytd)
													out.println("<td align=\"right\" class=\"listgensell\"><input type=\"hidden\" name=\"takenytd\" value=\"" + v.elementAt(i) + "\" >"+v.elementAt(i)+"</td>");																										
													break;
													
												case 8 : // kalo sisanya 8 ==> pada kolom VIII (taken mtd)
													out.println("<td align=\"right\" class=\"listgensell\"><input type=\"hidden\" name=\"takenmtd\" value=\"" + v.elementAt(i) + "\">"+v.elementAt(i)+"</td>");
													out.println("</tr>");
													break;													
									...
									{	
										...
										out.println("<input type=\"submit\" value=\"Upload LL\">");									
										out.println("</td></tr></table>");
									}
