...
<%!
	public String drawList(Vector objectClass, long oidLog) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add(""+(i+1));
            rowx.add(""+logSysHistory.getLogDocumentType());
            
            lstData.add(rowx);
            lstLinkData.add(String.valueOf(logSysHistory.getLogDocumentType()));
        }
...
<%
    ...
    /*switch statement */
    iErrCode = ctrlLogSysHistory.action(iCommand , oidLogActivity);
    /* end switch*/
	...
	*/		
    ...
    listLogSysHistory = PstLogSysHistory.listDistinctDocId();
...
<head>
    ...
    <script language="javascript">
        function cmdChoose(kpiId) {
            self.opener.document.frmlogactivity.doc.value = kpiId;
...
<body>
    <div id="title">Document Search</div>
    <div id="content">
