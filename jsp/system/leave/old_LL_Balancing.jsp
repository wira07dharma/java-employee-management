...
<%!
    public String drawList(Vector objEmpLLData, Date opnameDate, int start){
        ...
        ctrlist.addHeader("<center>Name</center>","18%","2","0");
        ...
        ctrlist.addHeader("<center>"+dictionaryD.getWord(I_Dictionary.ENTITLE)+"</center>","7%","2","0");
        
        ctrlist.addHeader("<center>System</center>","25%","0","5");
        ctrlist.addHeader("<center>Previous</center>","5%","0","0");
        ctrlist.addHeader("<center>Entitled</center>","5%","0","0");
        ctrlist.addHeader("<center>QTY</center>","5%","0","0");
        ...
        ctrlist.addHeader("<center>New</center>","25%","0","5");
        ctrlist.addHeader("<center>Previous</center>","5%","0","0");
        ctrlist.addHeader("<center>Entitled</center>","5%","0","0");
        ctrlist.addHeader("<center>QTY</center>","5%","0","0");
        ctrlist.addHeader("<center>"+dictionaryD.getWord(I_Dictionary.TAKEN)+"</center>","5%","0","0");
        ...
        */
        ...
        for (int i = 0; i < objEmpLLData.size(); i++){
            ...
            if(objEmployee.getCommencingDate()!=null){
                ...
                int system_previous = 0;
                int system_ll = 0;
                int system_qty = 0;
                int system_taken = 0;
                int system_balance = 0;
                long systemID = 0;
                ...
                if(objllstockmanagement != null){
                    ...
                    system_ll = objllstockmanagement.getEntitled();
                    system_qty = objllstockmanagement.getLLQty();
                    system_taken = objllstockmanagement.getQtyUsed();
                    system_balance = system_previous + system_qty - system_taken;
                }
                ...
                if(dataLL == null){                                                  
                    ...
                    opBalance = opPrevious + opQty - opTaken;
                ...
                rowx.add("<input type=\"hidden\" name=\"system_ll"+i+"\" value=\"\">"+system_ll);
                ...
                //int opnameBalance = dataLL.getLastPerToClearLL() + dataLL.getLLQty() - dataLL.getLlTakenYear1();  
                int opnameBalance = 0;  
                
                if(opnameNotYetProcess){
                     if(DateSekarang.equals(DateSekarangOpname)){
                        rowx.add("<input type=\"text\" name=\"new_previous"+i+"\" value=\""+opPrevious+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<input type=\"text\" name=\"new_ll"+i+"\" value=\""+opLL+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<input type=\"text\" name=\"new_qty"+i+"\" value=\""+opQty+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<input type=\"text\" name=\"new_taken"+i+"\" value=\""+opTaken+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<input type=\"text\" disabled=\"true\" name=\"new_balance"+i+"\" value=\""+opBalance+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<a href=\"javascript:cmdNote('"+systemID+"')\"><img border=\"0\" src=\"../../images/BtnNew.jpg\" width=\"14\" height=\"14\" title=\"Note\"></a>");
                     }else{                       
                        rowx.add("<input type=\"text\" disabled=\"true\" name=\"new_previous"+i+"\" value=\""+opPrevious+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<input type=\"text\" disabled=\"true\" name=\"new_ll"+i+"\" value=\""+opLL+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<input type=\"text\" disabled=\"true\" name=\"new_qty"+i+"\" value=\""+opQty+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<input type=\"text\" disabled=\"true\" name=\"new_taken"+i+"\" value=\""+opTaken+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<input type=\"text\" disabled=\"true\" name=\"new_balance"+i+"\" value=\""+opBalance+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                        rowx.add("<img border=\"0\" src=\"../../images/BtnNew.jpg\" width=\"14\" height=\"14\" title=\"Note\">");
                     }                    
                }else{   
                    rowx.add("<input type=\"text\" name=\"new_previous"+i+"\" value=\""+system_previous+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                    rowx.add("<input type=\"text\" name=\"new_ll"+i+"\" value=\""+system_ll+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                    rowx.add("<input type=\"text\" name=\"new_qty"+i+"\" value=\""+system_qty+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                    rowx.add("<input type=\"text\" name=\"new_taken"+i+"\" value=\""+system_taken+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");
                    rowx.add("<input type=\"text\" disabled=\"true\" name=\"new_balance"+i+"\" value=\""+system_balance+"\" size=\"5\" onkeyup=\"cmdCekLast("+i+")\">");      
                    rowx.add("<a href=\"javascript:cmdNote('"+systemID+"')\"><img border=\"0\" src=\"../../images/BtnNew.jpg\" width=\"14\" height=\"14\" title=\"Note\"></a>");                                           
                }               
                ...
                if(iEntitled_Intv5<=0){
                    ...
                    rowx.add("<input type=\"text\" size=\"3\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR1]+"\"  class=\""+(commDateAtYearInt8.getYear()==commDateAtYear.getYear()?"styleInt8":"elemenForm")+"\" value=\""+(objLLUpload.getLlTakenYear1()>0?objLLUpload.getLlTakenYear1():0)+"\">");
                    ...
                    if(opnameDate.getTime()>=commDateAtYear.getTime()){
                        rowx.add("<input type=\"text\" size=\"3\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR2]+"\"  class=\""+(commDateAtYearInt8.getYear()==commDateAtYear.getYear()?"styleInt8":"elemenForm")+"\" value=\""+(objLLUpload.getLlTakenYear2()>0?objLLUpload.getLlTakenYear2():0)+"\">");
                    }else{
                        rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR2]+"\" value=\"0\"><input type=\"text\" size=\"3\" name=\"\"  class=\"elemenForm\" value=\""+(objLLUpload.getLlTakenYear2()>0?objLLUpload.getLlTakenYear2():0)+"\" disabled=\"true\">");
                    }
                    commDateAtYear.setYear(commDateAtYear.getYear()+1);
                    //System.out.println("Data tanggal :::::: Commencing Date ::: "+commDateAtYear);
                    if(opnameDate.getTime()>=commDateAtYear.getTime()){
                        rowx.add("<input type=\"text\" size=\"3\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR3]+"\"  class=\""+(commDateAtYearInt8.getYear()==commDateAtYear.getYear()?"styleInt8":"elemenForm")+"\" value=\""+(objLLUpload.getLlTakenYear3()>0?objLLUpload.getLlTakenYear3():0)+"\">");
                    }else{
                        rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR3]+"\" value=\"0\"><input type=\"text\" size=\"3\" name=\"\"  class=\"elemenForm\" value=\""+(objLLUpload.getLlTakenYear3()>0?objLLUpload.getLlTakenYear3():0)+"\" disabled=\"true\">");
                    }
                    commDateAtYear.setYear(commDateAtYear.getYear()+1);
                    if(opnameDate.getTime()>=commDateAtYear.getTime()){
                        rowx.add("<input type=\"text\" size=\"3\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR4]+"\"  class=\""+(commDateAtYearInt8.getYear()==commDateAtYear.getYear()?"styleInt8":"elemenForm")+"\" value=\""+(objLLUpload.getLlTakenYear4()>0?objLLUpload.getLlTakenYear4():0)+"\">");
                    }else{
                        rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR4]+"\" value=\"0\"><input type=\"text\" size=\"3\" name=\"\"  class=\"elemenForm\" value=\""+(objLLUpload.getLlTakenYear4()>0?objLLUpload.getLlTakenYear4():0)+"\" disabled=\"true\">");
                    }
                    commDateAtYear.setYear(commDateAtYear.getYear()+1);
                    if(opnameDate.getTime()>=commDateAtYear.getTime()){
                        rowx.add("<input type=\"text\" size=\"3\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR5]+"\"  class=\""+(commDateAtYearInt8.getYear()==commDateAtYear.getYear()?"styleInt8":"elemenForm")+"\" value=\""+(objLLUpload.getLlTakenYear5()>0?objLLUpload.getLlTakenYear5():0)+"\">");
                    }else{
                        rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR5]+"\" value=\"0\"><input type=\"text\" size=\"3\" name=\"\"  class=\"elemenForm\" value=\""+(objLLUpload.getLlTakenYear5()>0?objLLUpload.getLlTakenYear5():0)+"\" disabled=\"true\">");
                    }
                }
                */
                //rowx.add("<a href=\"javascript:cmdNote('"+systemID+"')\"><img border=\"0\" src=\"../../images/BtnNew.jpg\" width=\"14\" height=\"14\" title=\"Note\"></a>");
                ...
                //rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR2]+"\" value=\"0\"><input type\"text\" size=\"3\" class=\"elemenForm\" value=\"0\" disabled=\"true\">");
                //rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR3]+"\" value=\"0\"><input type\"text\" size=\"3\" class=\"elemenForm\" value=\"0\" disabled=\"true\">");
                //rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR4]+"\" value=\"0\"><input type\"text\" size=\"3\" class=\"elemenForm\" value=\"0\" disabled=\"true\">");
                //rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_LL_TAKEN_YEAR5]+"\" value=\"0\"><input type\"text\" size=\"3\" class=\"elemenForm\" value=\"0\" disabled=\"true\">");
                //==============================================/INPUT DATA
                rowx.add("<input type=\"hidden\" name=\""+FrmLLUpload.fieldNames[FrmLLUpload.FRM_FLD_DATA_STATUS]+"\" value=\""+PstLLUpload.FLD_DOC_STATUS_NOT_PROCESS+"\">");
        ...
        */ 
        ...
        try {
            ...
            */
            ...
            //new_ll = request.getParameterValues(FrmLLUpload.fieldNames[FrmLLUpload.f]);
...
function cmdCekLast(index){
    ...
    %>
            case <%=""+k%>:           
            prev = parseInt(document.<%=FrmSrcLLUpload.FRM_LL_UPLOAD%>.<%="new_previous"+k%>.value);
            taken = parseInt(document.<%=FrmSrcLLUpload.FRM_LL_UPLOAD%>.<%="new_taken"+k%>.value);
            qty = parseInt(document.<%=FrmSrcLLUpload.FRM_LL_UPLOAD%>.<%="new_qty"+k%>.value);
