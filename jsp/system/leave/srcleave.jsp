                    ...
                    <tr> 
                      <td class="tablecolor"> 
                                                ...
                                                <td width="99%"> 
                                                  <table border="0" cellspacing="2" cellpadding="2" width="100%" >
                                                    <tr> 
                                                      ...
                                                      <td width="2%"><b>:</b></td>
                                                      <td width="87%"> 
                                                        <input type="text" name="<%=frmSrcLeave.fieldNames[FrmSrcLeave.FRM_FIELD_EMP_NUMBER] %>"  value="<%= srcLeave.getEmpNumber() %>" class="elemenForm"  onkeydown="javascript:fnTrapKD()" size="30">
                                                      </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="11%"> 
                                                      ...
                                                      <td width="2%"><b>:</b></td>
                                                      <td width="87%"> 
                                                        <input type="text" name="<%=frmSrcLeave.fieldNames[FrmSrcLeave.FRM_FIELD_FULLNAME] %>"  value="<%= srcLeave.getFullName() %>" class="elemenForm" onkeydown="javascript:fnTrapKD()" size="40">
                                                      </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="11%"> 
						...
						Vector department_key = new Vector(1,1);
															...
															String wClause = "";
															if(bCheckLoginDeparment)
															{
																if(!privStart && privStartSpec)
																{
																	wClause = PstDepartment.fieldNames[PstDepartment.FLD_DEPARTMENT_ID] + " = " + departmentOfLoginUser.getOID();
																}
															}
															else
															{
                                                            ...
                                                            Vector listDept = PstDepartment.list(0, 0, wClause, " DEPARTMENT ");                                                        
						...
						%>
                                                        <%= ControlCombo.draw(frmSrcLeave.fieldNames[FrmSrcLeave.FRM_FIELD_DEPARTMENT],"elementForm", null, selectValueDepartment, department_value, department_key," onkeydown=\"javascript:fnTrapKD()\"") %> </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="11%">Leave Period 
                                                      </td>
                                                      <td width="2%"><b>:</b></td>
                                                      <td width="87%"> 
                                                        <% 
                                                Vector leave_period_value = new Vector(1,1);
                                                Vector leave_period_key = new Vector(1,1);       
												String sOrderBy = PstLeavePeriod.fieldNames[PstLeavePeriod.FLD_START_DATE] + " DESC"; 
                                                Vector listLeavePeriod = PstLeavePeriod.list(0, 0, "", sOrderBy);                                                        
                                                for (int i = 0; i < listLeavePeriod.size(); i++) 
												{													
                                                    LeavePeriod objLeavePeriod = (LeavePeriod) listLeavePeriod.get(i);
                                                    leave_period_key.add(objLeavePeriod.getName());
                                                    leave_period_value.add(String.valueOf(objLeavePeriod.getOID()));
                                                }
                                            %>
                                                        <%= ControlCombo.draw(FrmSrcLeave.fieldNames[FrmSrcLeave.FRM_FIELD_LEAVE_PERIOD_ID],"formElemen",null, ""+srcLeave.getLeavePeriodId(), leave_period_value, leave_period_key, "") %> </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="11%"> 
						...
						%>
                                                        <%= ControlCombo.draw(frmSrcLeave.fieldNames[FrmSrcLeave.FRM_FIELD_SECTION],"elementForm", null, selectValueSection, section_value, section_key," onkeydown=\"javascript:fnTrapKD()\"") %> </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="11%"> 
						...
						%>
                                                        <%= ControlCombo.draw(frmSrcLeave.fieldNames[FrmSrcLeave.FRM_FIELD_POSITION],"elementForm", null, selectValuePosition, position_value, position_key," onkeydown=\"javascript:fnTrapKD()\"") %> </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="11%">&nbsp;</td>
                                                      <td width="2%">&nbsp;</td>
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td nowrap width="87%"> 
                                                        <table border="0" cellpadding="0" cellspacing="0" width="398">
                                                          <tr> 
                                                            <td width="5%"><a href="javascript:cmdSearch()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="Search for Leave" ></a></td>
                                                            <td width="2%"><img src="<%=approot%>/images/spacer.gif" width="8" height="8"></td>
                                                            <td width="36%" class="command" nowrap><a href="javascript:cmdSearch()">Search 
                                                              for Leave</a></td>
                                                            <% if(privAdd || privAddSpec){%>
                                                            <td width="2%"><img src="<%=approot%>/images/spacer.gif" width="8" height="8"></td>
                                                            <td width="5%"><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image100','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image100" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Add New Leave"></a></td>
                                                            <td width="2%"><img src="<%=approot%>/images/spacer.gif" width="8" height="8"></td>
                                                            <td width="48%" class="command" nowrap><a href="javascript:cmdAdd()">Add 
                                                              New Leave</a></td>
                                                            <%}%>
                                                          </tr>
                                                        </table>
