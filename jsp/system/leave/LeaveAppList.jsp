...
<%-- 
    Document   : LeaveAppList
    Created on : Dec 22, 2009, 10:28:41 AM
    Author     : Tu Roy
--%>
<%@ page language = "java" %>
<!-- package java -->
...
function cmdEdit(oidLeave, oidEmployee)
{
	document.frm_leave_application.command.value="<%=Command.EDIT%>";
        //document.frm_leave_application.<%=FrmAlStockTaken.fieldNames[FrmAlStockTaken.FRM_FIELD_AL_STOCK_ID]%>.value = oidLeave;
