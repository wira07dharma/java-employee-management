...
<%-- 
    Document   : LeaveAppSearch
    Created on : Dec 22, 2009, 10:12:24 AM
    Author     : Tu Roy
--%>
...
{        
	...
	try
	{				
		objSrcLeaveApplication = (SrcLeaveApplication) session.getValue(SessLeaveApplication.SESS_SRC_LEAVE_APPLICATION);			
...
<!--
function cmdAdd(){
	document.frmsrcleaveapplication.command.value="<%=String.valueOf(Command.ADD)%>";
	document.frmsrcleaveapplication.action="LeaveAppAdd.jsp";
	document.frmsrcleaveapplication.submit();
}

function cmdSearch(){
	document.frmsrcleaveapplication.command.value="<%=String.valueOf(Command.LIST)%>";
	document.frmsrcleaveapplication.action="LeaveAppList.jsp";
	document.frmsrcleaveapplication.submit();
}
...
//-------------------------- for Calendar -------------------------
    function getThn(){
        <%
         out.println(ControlDatePopup.writeDateCaller("frmsrcleaveapplication",FrmSrcLeaveApplication.fieldNames[FrmSrcLeaveApplication.FRM_FIELD_SUBMISSION_DATE]));
         %>
    }
    ...
    function hideObjectForDate(){
        <%
            out.println(ControlDatePopup.writeDateHideObj("frmsrcleaveapplication", FrmSrcLeaveApplication.fieldNames[FrmSrcLeaveApplication.FRM_FIELD_APPROVAL_STATUS]));
            out.println(ControlDatePopup.writeDateHideObj("frmsrcleaveapplication", FrmSrcLeaveApplication.fieldNames[FrmSrcLeaveApplication.FRM_FIELD_DOC_STATUS]));
        %>
    }

    function showObjectForDate(){
        <%
            out.println(ControlDatePopup.writeDateShowObj("frmsrcleaveapplication", FrmSrcLeaveApplication.fieldNames[FrmSrcLeaveApplication.FRM_FIELD_APPROVAL_STATUS]));
            out.println(ControlDatePopup.writeDateShowObj("frmsrcleaveapplication", FrmSrcLeaveApplication.fieldNames[FrmSrcLeaveApplication.FRM_FIELD_DOC_STATUS]));
        %>
    } 
                          ...
                          <tr> 
                            <td valign="top">
		    				  <!-- #BeginEditable "content" --> 
                                    <form name="frmsrcleaveapplication" method="post" action="">
                                      ...
                                      <table border="0" cellspacing="2" cellpadding="2" width="100%" >
                                        ...
                                        <tr> 
                                          ...
                                          <td width="2%">&nbsp;</td>
                                          <td width="85%">&nbsp;
                                          <%//ControlDate.drawDate(objFrmSrcLeaveApplication.fieldNames[objFrmSrcLeaveApplication.FRM_FIELD_SUBMISSION_DATE], (objSrcLeaveApplication.getSubmissionDate()==null ? new Date() : objSrcLeaveApplication.getSubmissionDate()), 1,-5) %>
                                        ...
                                        <%--<tr> 
                                          ...
                                          <td nowrap width="87%"> 
											...
											status_value.add(""+PstLeaveApplication.FLD_DOC_STATUS_VALID);
											status_key.add(""+PstLeaveApplication.fieldStatusNames[PstLeaveApplication.FLD_DOC_STATUS_VALID]);                                                          

											status_value.add(""+PstLeaveApplication.FLD_DOC_STATUS_INVALID);
											status_key.add(""+PstLeaveApplication.fieldStatusNames[PstLeaveApplication.FLD_DOC_STATUS_INVALID]);
                                        ...
                                        <tr> 
                                          ...
                                          <td nowrap width="85%"> 
                                            <table border="0" cellpadding="0" cellspacing="0" width="424">
                                              <tr> 
                                                <td width="30%"><a href="javascript:cmdSearch()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="Search" >
                                                </a><a href="javascript:cmdSearch()">Search</a></td>
                                                <td width="30%"><a href="javascript:cmdSearch()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image100','','<%=approot%>/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="Search" >
                                                </a><a href="javascript:cmdAdd()">Add</a></td>
                                                <td width="40%"><img src="<%=approot%>/images/spacer.gif" width="8" height="8"></td>
                                                <%--//<td width="25%" class="command" nowrap> | 
                                                <a href="javascript:cmdSearch()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="Search for Leave Application" ></a></td>
                                                <td width="2%"><img src="<%=approot%>/images/spacer.gif" width="8" height="8"> <a href="javascript:cmdAdd()">Add New</a></td>
                                                <%--//if(privAdd){%>
                                                <td width="6%"><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image100','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image100" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Add New Leave Application"></a></td>
