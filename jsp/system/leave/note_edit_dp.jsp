...
long oid = FRMQueryString.requestLong(request,"hidden_DP_id");
...
Employee emp = new Employee();
	...
	try{
                ...
                objDpStockManagement = PstDpStockManagement.fetchExc(oid);
                objEmployee = PstEmployee.fetchExc(objDpStockManagement.getEmployeeId());
                System.out.println("emp id "+objDpStockManagement.getEmployeeId());
                System.out.println("Nama employee "+objEmployee.getFullName());
		
		if(iCommand==Command.SAVE){
                        objDpStockManagement.setStNote(note);
                        
                        oid = SessDPUpload.updateDPNote(objDpStockManagement.getOID(), objDpStockManagement.getStNote());
                        
			//oid = PstDpStockManagement.updateExc(objDpStockManagement);
...
function cmdSave(oid){
	...
	document.frmnote.action="note_edit_dp.jsp?hidden_DP_id="+oid;
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	%>
      ...
      <td width="77%"> 
        <%
	String notereal = "";
        notereal = objDpStockManagement.getStNote() == null ? "" : objDpStockManagement.getStNote();	
	%>
      ...
      <td width="77%"> 
        <table width="50%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="92%" class="command" nowrap><a href="javascript:cmdSave('<%=oid%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnSaveOn.jpg',1)" id="aSearch">
            Save Note </a></td>
          </tr>
        </table>
      </td>
