...
<%!
    public String drawList(Vector objEmpALData, Date opnameDate,int start){
        ...
        ctrlist.addHeader("<center>AL Entitle","8%","0","0");
        ctrlist.addHeader("<center>AL Stock Qty","8%","0","0");
        ...
        ctrlist.addHeader("<center>AL Entitle</center>","6%","0","0");
        ctrlist.addHeader("<center>AL Stock QTY</center>","6%","0","0");
        ...
        for (int i = 0; i < objEmpALData.size(); i++){
            ...
            if(objEmployee.getCommencingDate()!=null){
                ...
                int alQtyCurrent = 0;
                int qtyUsedCurrent = 0;
                int qtyResidueCurrent = 0;
                int entitledCurrent = 0; 
...
function cmdCekLast(index,max){
    ...
    %>
            ...
            prev = parseInt(document.<%=FrmSrcAlUpload.FRM_AL_UPLOAD%>.<%="data_emp_to_clear_last_per"+k%>.value);
            taken = parseInt(document.<%=FrmSrcAlUpload.FRM_AL_UPLOAD%>.<%="data_emp_taken_curr_per"+k%>.value);
            qty = parseInt(document.<%=FrmSrcAlUpload.FRM_AL_UPLOAD%>.<%="data_emp_ALQty_new"+k%>.value);
            balance = ( prev + qty ) - taken;
            
            val1 = parseInt(document.<%=FrmSrcAlUpload.FRM_AL_UPLOAD%>.<%="data_emp_to_clear_last_per"+k%>.value);
            val2 = parseInt(document.<%=FrmSrcAlUpload.FRM_AL_UPLOAD%>.<%="data_emp_taken_curr_per"+k%>.value);
                
            document.<%=FrmSrcAlUpload.FRM_AL_UPLOAD%>.<%="data_emp_balance_per"+k%>.value=balance;
