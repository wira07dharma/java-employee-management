...
if (privStart) 
{
	...
	try 
	{
            ...
            if(machineNumbers.length>0 && !(machineNumbers[0].equals("")) && machineNumbers[0].length()>0){
                v1 = accessTMA.executeCommand(accessTMA.CHECK_MACHINE, machineNumbers[0], "");
	...
	try 
	{
            ...
            if(machineNumbers.length>1 && !(machineNumbers[1].equals("")) && machineNumbers[1].length()>0){
                v2 = accessTMA.executeCommand(accessTMA.CHECK_MACHINE, machineNumbers[1], "");
                ...
                if ( v2 != null )
                {
                    ...
                    {
                        tma02Status = "Check machine TMA-"+machineNumbers[1]+" : OK";
                    }	
                }
            }
	}
	...
	{
		tma02Status = "<span class='errfont'><i>Unable to connect to machine TMA-"+machineNumbers[1]+"</i></span>";
	}
}
%>
