...
if (privStart) 
{
	...
	try 
	{
		...
		v1 = canteenTMAAccess.executeCommand(canteenTMAAccess.CHECK_MACHINE, "01", "");
		...
		if ( v1 != null )
		{
			...
			{
				tma01Status = "Check machine TMA-01 : OK";
			}	
		}
	}
	catch (Exception e) 
	{
		tma01Status = "<span class='errfont'><i>Unable to connect to machine TMA-01</i></span>";
	}
