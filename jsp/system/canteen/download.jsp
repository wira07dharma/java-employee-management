...
if (privStart) 
{
	try 
	{
		...
		v1 = canteenTMAAccess.executeCommand(canteenTMAAccess.DOWNLOAD, "01", "");
		if (String.valueOf(v1.get(0)).equals("OFF") == false) 
		{
			succeed01 = true;
		}
		tma01Status = String.valueOf(v1.get(0)) + " transaction(s) downloaded from TMA-01";
	}
	catch (Exception e) 
	{
		tma01Status = "Unable to download from TMA-01";
	}
...
String SMTP_SERVER = String.valueOf(PstSystemProperty.getValueByName("SMTP_SERVER"));                                
String HARISMA_EMAIL = String.valueOf(PstSystemProperty.getValueByName("HARISMA_EMAIL"));                                
String ADMIN_EMAIL = String.valueOf(PstSystemProperty.getValueByName("ADMIN_EMAIL"));                                
String ADMIN_CC = String.valueOf(PstSystemProperty.getValueByName("ADMIN_CC"));                                
String ADMIN_BCC = String.valueOf(PstSystemProperty.getValueByName("ADMIN_BCC"));                                
