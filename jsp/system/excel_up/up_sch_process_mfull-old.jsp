...
<% int  appObjCode = 0;//AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_DATABANK, AppObjInfo.OBJ_DATABANK); %>
...
if(iCommand == Command.SAVE)
{
	...
	else
	{
		...
		for(int e=0; e<employeeId.length; e++)
		{
			...
			float intAlStockAmount = objPstAlStockManagement.getAlStockAmountPerEmployee(empId);
			...
			float intLlStockAmount = objPstLLStockManagement.getLlStockAmountPerEmployee(empId);
