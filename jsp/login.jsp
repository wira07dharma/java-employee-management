...
<%@page import="com.dimata.harisma.utility.service.leavedp.ServiceLlClosing"%>
<%@page import="com.dimata.harisma.utility.service.leavedp.ServiceAlClosing"%>
...
System.out.println("Exception"+except);
    ...
    if (iCommand == CMD_LOGIN || (machineLogin == 1) ) {
        ...
        if (dologin == SessUserSession.DO_LOGIN_OK) {
            ...
            boolean alClosingServiceRunning = serviceAlClosing.getStatus();
            if (!alClosingServiceRunning){
                serviceAlClosing.startService();
            }
            
            ServiceLlClosing serviceLlClosing = new ServiceLlClosing();
            boolean llClosingServiceRunning = serviceLlClosing.getStatus();
            if(!llClosingServiceRunning){
                serviceLlClosing.startService();
            }
