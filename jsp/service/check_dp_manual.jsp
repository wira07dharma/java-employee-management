	...
	{	
		...
		if(diffStartToFinish >= 0)
		{
			...
			{				
				...
				ServiceDpStock objServiceDpStock = new ServiceDpStock();
				objServiceDpStock.processDpStock(selectedDate);	
				System.out.println("Process check dp activation and expired on : " + selectedDate);
			}		
			strMessage = "<div class=\"msginfo\">Checking DPs activation and expired process done ...</div>";					
		}
		else
		{
...
<title>HARISMA - Check Day Off Payment Manual</title>
<script language="JavaScript">
function cmdCheck()
{
  document.frmcheckdp.command.value="<%= Command.SUBMIT %>";	  
  document.frmcheckdp.action="check_dp_manual.jsp";    
  document.frmcheckdp.submit();  
}
</script>
<!-- #EndEditable --> 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Application 
                  &gt; Check Day Off Payment Manually<!-- #EndEditable --> </strong></font> 
                </td>
              </tr>
              <tr> 
                <td> 
                              ...
                              <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tabbg">
                                <tr> 
                                  <td valign="top"> <!-- #BeginEditable "content" --> 
                                    <form name="frmcheckdp" method="post" action="">
                                      <input type="hidden" name="command" value="">
                                      <table width="100%" border="0" cellpadding="2" cellspacing="2">
                                        <tr> 
                                          <td width="48%" valign="top"><b>. : 
                                            : CHECKING DP MANUALLY : : .</b></td>
                                        </tr>
                                        <tr> 
                                          <td width="48%" valign="top">This process 
                                            will check and update DPs data per 
                                            employee for <b><i>activation</i></b> 
                                            and <b><i>expired</i></b>.</td>
                                        </tr>
                                        <tr> 
