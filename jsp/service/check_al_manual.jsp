	...
	{	
		...
		if(diffStartToFinish >= 0)
		{
			...
			{				
				...
				ServiceAlStock objServiceAlStock = new ServiceAlStock();
				objServiceAlStock.processAlStock(selectedDate);									
				System.out.println("Process check al owning and expired on : " + selectedDate);
			}		
			strMessage = "<div class=\"msginfo\">Checking ALs acquisition and expired process done ...</div>";					
		}
		else
		{
...
<title>HARISMA - Check Annual Leave Manual</title>
<script language="JavaScript">
function cmdCheck()
{
  document.frmcheckal.command.value="<%= Command.SUBMIT %>";	  
  document.frmcheckal.action="check_al_manual.jsp";    
  document.frmcheckal.submit();  
}
</script>
<!-- #EndEditable --> 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Application 
                  &gt; Check Annual Leave Manually<!-- #EndEditable --> </strong></font> 
                </td>
              </tr>
              <tr> 
                <td> 
                              ...
                              <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tabbg">
                                <tr> 
                                  <td valign="top"> <!-- #BeginEditable "content" --> 
                                    <form name="frmcheckal" method="post" action="">
                                      <input type="hidden" name="command" value="">
                                      <table width="100%" border="0" cellpadding="2" cellspacing="2">
                                        <tr> 
                                          <td width="48%" valign="top"><b>. : 
                                            : CHECKING AL MANUALLY : : .</b></td>
                                        </tr>
                                        <tr> 
                                          <td width="48%" valign="top">This process 
                                            will check and update ALs data per 
                                            employee for <b><i>acquisition</i></b> 
