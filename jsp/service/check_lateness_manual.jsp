...
<%  int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_SYSTEM, AppObjInfo.G2_MANUAL_CHECKING, AppObjInfo.OBJ_MANUAL_CHECKING_LATENESS); %>
	...
	{	
		...
		if(diffStartToFinish >= 0)
		{
			...
			{				
				...
				objLatenessAnalyser.checkEmployeeLateness(selectedDate,lDepartmentOid,lSectionOid,sEmployeeName);	
				System.out.println("Process check lateness on : " + selectedDate);
			}		
			strMessage = "<div class=\"msginfo\">Checking lateness process done ...</div>";					
		}
		else
		{
...
<title>HARISMA - Check Lateness Manual</title>
<script language="JavaScript">
function deptChange() 
{
	document.frmchecklateness.command.value = "<%=Command.GOTO%>";
	document.frmchecklateness.hidden_goto_dept.value = document.frmchecklateness.DEPARTMENT_OID.value;	
	document.frmchecklateness.action = "check_lateness_manual.jsp";
	document.frmchecklateness.submit();
}

function cmdCheck()
{
  document.frmchecklateness.command.value="<%= Command.SUBMIT %>";	  
  document.frmchecklateness.action="check_lateness_manual.jsp";    
  document.frmchecklateness.submit();  
}
</script>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Application 
                  &gt; Check Lateness Manually<!-- #EndEditable --> </strong></font> 
                </td>
              </tr>
              <tr> 
                <td> 
                              ...
                              <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tabbg">
                                <tr> 
                                  <td valign="top"> <!-- #BeginEditable "content" --> 
                                    <form name="frmchecklateness" method="post" action="">
                                      ...
                                      <table width="100%" border="0" cellpadding="2" cellspacing="2">
                                        <tr> 
                                          <td colspan="3" valign="top"><b>. : 
                                            : CHECKING LATENESS MANUALLY : : .</b></td>
                                        </tr>
                                        <tr> 
                                          <td colspan="3" valign="top">This process 
                                            is used to analyze employee's lateness 
                                            and update their status to be &quot;LATE&quot;. 
                                          </td>
                                        </tr>
                                        <tr> 
