       ...
       <%}%>      
                                                                            ...
                                                                            <td valign="top">
                                                                                ...
                                                                                <form name="frm" method="post" action=""> 
                                                                                   ...
                                                                                   //     if (iCommand == Command.ACTIVATE) {
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="8" width="100%" class="comment"><span class="comment">
                                                                                            Approval List is empty, <a href="javascript:cmdViewApprovalLeave()">Check Again</a>                                                         
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%
                                                                                        }                                                
                                                                                    ...
                                                                                    <!--    <tr> 
                                                                                            <td height="8" width="100%" class="comment"><span class="comment">                                                
                                                                                                <a href="javascript:cmdViewApprovalLeave()">View Approval List</a>                                                
                                                                                            </td>
                                                                                        </tr>   --!>
                                                                                        <%
                                                                                      //          }
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td height="8" width="100%" class="comment"><span class="comment">  
                                                                                                <a href="javascript:cmdProccessSchedule()">Process Schedule</a>
                                                                                            </td>
                                                                                        </tr>    
                                                                                        <%                                                                                                
                                                                                        }else{
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td height="8" width="100%" class="comment"><span class="comment">                                                
                                                                                                <a href="javascript:cmdScheduleCheck()">Schedule To Be Check</a>                                                
                                                                                            </span></td>
                                                                                        </tr>
            ...
            if (!NonViewBirthday) {
                ...
                if ((listEmpBirthday != null) && (listEmpBirthday.size() > 0)) {%>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="8" width="100%" class="comment"><span class="comment">
                                                                                                    <b> Employee's Ended Contract List</b>
                                                                                               </span> 
                                                                                            </td>
                                                                                        </tr>
                                                                                        
                                                                                         
                                                                                    <tr><td height="8" width="100%">Employee End Contract Today :<%=sizeEndContractToday%> Employee - <a href="javascript:checkview(1)"> view detail</a></td></tr>
                                                                                    <%if(viewListEndV1==1){%>
