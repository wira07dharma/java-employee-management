                                                ...
                                                <td> 
                                                  <table width="98%" class="listarea">
                                                    <tr> 
													  ...
													  vctX.add(""+((sumActPrgTotal*100.0)/sumPlanPrgTotal));
													  vctX.add(""+sumPlanHourTotal);
													  vctX.add(""+sumActHourTotal);
													  vctX.add(""+((sumActHourTotal*100.0)/sumPlanHourTotal));
													  vctX.add(""+sumPlanTrainTotal);
													  vctX.add(""+sumActTrainTotal);
													  vctX.add(""+((sumActTrainTotal*100.0)/sumPlanTrainTotal));
													  vctX.add("");
													  vctX.add("");
													  ...
													  %>
                                                        ...
                                                        <table width="100%" class="listgen" cellspacing="1">
                                                          ...
                                                          <tr bgcolor="#003399"> 
                                                            ...
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=((sumActPrgTotal * 100.0)/sumPlanPrgTotal)%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                            ...
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=((sumActHourTotal * 100.0)/sumPlanHourTotal)%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                            ...
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=((sumActTrainTotal *100.0)/sumPlanTrainTotal)%></font></b></font></div>
                                                            </td>
