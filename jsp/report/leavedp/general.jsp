...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_LEAVE_DP_RECORD_REPORT, AppObjInfo.OBJ_LEAVE_GENERAL_REPORT); %>
...
Vector vctDept = PstDepartment.listAll();
if(iCommand==Command.PRINT){
	CtrlPrevLeave ctrl = new CtrlPrevLeave(request);
	ctrl.action(iCommand);
}
...
<SCRIPT language=JavaScript>
	...
	<%if(iCommand==Command.PRINT){%> 
		window.open("<%=printroot%>.report.leavedp.GeneralPdf","general_leavedp",'scrollbars=yes,status=yes,width=850,height=650,resizable=yes'); 
	<%}%>

	function cmdPrint(){
		document.frm_report.action="general.jsp";
		document.frm_report.command.value="<%=Command.PRINT%>";
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Report 
                  &gt; Leave &amp; DP &gt; General<!-- #EndEditable --> </strong></font> 
                </td>
              </tr>
              <tr> 
                <td> 
                            ...
                            <td valign="top"> 
                              <table style="border:1px solid <%=garisContent%>" width="100%" border="0" cellspacing="1" cellpadding="1" class="tabbg">
                                <tr> 
								  ...
								  <form name="frm_report" method="post" action="">
									<input type="hidden" name="command">
                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                      <tr> 
                                        <td> 
                                          <div align="center"><b>RECAPITULATION 
                                            OF YEAR LEAVE, LONG LEAVE, DP</b></div>
                                        </td>
                                      </tr>
                                      <tr> 
                                        <td> 
                                          <div align="center"><b>for the month 
                                            of <%=Formater.formatDate(new Date(), "MMMM yyyy")%></b></div>
                                        </td>
                                      </tr>
                                    </table>
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1" class="listgen">
                                        <tr class="listgentitle"> 
                                          ...
                                          <td rowspan="2" class="listgentitle"> 
                                            <div align="center"><b><%=dictionaryD.getWord(I_Dictionary.DEPARTMENT) %></b></div>
                                          </td>
									...
									int blcLl = 0;
									  ...
									  if(vctDept!=null && vctDept.size()>0){
									  
											for(int i=0; i<vctDept.size(); i++){
												Department dep = (Department)vctDept.get(i);
									  ...
									  %>
                                        ...
                                        <%}}else{%>
                                        <tr class="listgensell"> 
                                          <td colspan="14"><font color="#FFFFFF"><i>no 
										...
										%>
                                            <div align="center"><b>Previous Month 
                                              (<%=Formater.formatDate(prevMonth, "MMMM")%>)<br>
                                              Variance</b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getDpLm()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getDpAdd()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getDpTaken()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getDpBal()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getAlLm()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getAlAdd()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getAlTaken()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getAlBal()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getLlLm()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getLlAdd()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getLlTaken()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=prev.getLlBal()%></b></div>
                                          </td>
                                        </tr>
                                        <tr class="listgensell"> 
                                          <td> 
                                            <div align="center"><b><%=totDpAmount - prev.getDpLm()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=totAddDp - prev.getDpAdd()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=totTakeDp - prev.getDpTaken()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=(totDpAmount + totAddDp - totTakeDp) - prev.getDpBal()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=totAlAmount - prev.getAlLm()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=totAddAl - prev.getAlAdd()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=totTakeAl-prev.getAlTaken()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=(totAlAmount + totAddAl - totTakeAl)-prev.getAlBal()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=totLlAmount-prev.getLlLm()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=totAddLl-prev.getLlAdd()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=totTakeLl-prev.getLlTaken()%></b></div>
                                          </td>
                                          <td> 
                                            <div align="center"><b><%=(totLlAmount + totAddLl - totTakeLl)-prev.getLlBal()%></b></div>
                                          </td>
                                        </tr>
                                      </table>
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <td colspan="2"> 
                                          <table cellpadding="0" cellspacing="0" border="0">
                                            <tr> 
                                              ...
                                              <td width="15"><a href="javascript:cmdPrint()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image101','','<%=approot%>/images/BtnNew.jpg',1)"><img name="Image101" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Search Employee"></a></td>
