...
<html>
    <head>
		...
		document.frm.submit();
            ...
            function cmdXls(){
		document.frm.command.value="<%=String.valueOf(Command.LIST)%>";
		document.frm.action="detail_report_xls_all.jsp";
		document.frm.submit();
            }
        </script>
    </head>
                ...
                <div style="padding: 17px; background-color: #FFF;">
                    ...
                    <table>
                        <tr>
                            <td valign="top">
                                <div class="divinput">                                   
                                  <%=ControlDate.drawDateWithStyle("dateFrom",  dateFrom, 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%> &nbsp;to&nbsp; 
                                  <%=ControlDate.drawDateWithStyle("dateTo", dateTo, 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%>
                                </div>                                
                            </td>
                        </tr>
                        <tr>
