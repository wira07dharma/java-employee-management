<%-- 
    Document   : detail_report
    Created on : 02-Jan-2017, 14:33:46
    Author     : GUSWIK
--%>
...
<%
    ...
    try{
        if (type == 1){
           ...
           employeeId = alStockManagement.getEmployeeId();
        } else if (type == 2) {
           ...
           employeeId = llStockManagement.getEmployeeId();
        }
    ...
    try{
        hashEmp = PstEmployee.fetchExcHashtable(empId);
    }catch(Exception e){
    }
