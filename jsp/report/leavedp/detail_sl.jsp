<%-- 
    Document   : detail_sl
    Created on : 18-Sep-2017, 16:30:43
    Author     : Gunadi
--%>
...
<html>
    <head>
		...
		document.frm.action="detail_sl.jsp";
		document.frm.submit();
            }
            function cmdXls(){
		document.frm.command.value="<%=String.valueOf(Command.LIST)%>";
		document.frm.action="detail_sl_xls.jsp";
		document.frm.submit();
            }
        </script>
    </head>
                ...
                <div style="padding: 17px; background-color: #FFF;">
                    ...
                    <table>
                        <tr>
                            <td valign="top">
                                <div class="divinput">                                   
                                  <%=ControlDate.drawDateWithStyle("dtFrom",  dateFrom, 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%> &nbsp;to&nbsp; 
                                  <%=ControlDate.drawDateWithStyle("dtTo", dateTo, 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%>
                                </div>                                
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <a class="btn" style="color:#FFF" href="javascript:cmdXls()">Export</a>
                            </td>
                        </tr>
                    </table> 
                </div>
