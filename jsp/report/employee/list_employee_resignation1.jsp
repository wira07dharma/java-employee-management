...
function cmdSearch(){
		...
		document.frmsrcemployee.action="employee_list_recognition.jsp";
		document.frmsrcemployee.submit();
}
          ...
          <td height="20">
		    <font color="#FF6600" face="Arial"><strong>
			  <!-- #BeginEditable "contenttitle" --> 
                  Report &gt;Employee &gt; Employee Resignation Search<!-- #EndEditable --> 
            </strong></font>
	      </td>
        </tr>
        <tr> 
                                              ...
                                              <tr> 
                                                ...
                                                <td width="97%"> 
                                                  <table border="0" cellspacing="2" cellpadding="2" width="72%">
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      <td width="17%" height="24" nowrap>Selected 
                                                        Date</td>
