...
<%
    ...
    if((iCommand==Command.NEXT)||(iCommand==Command.FIRST)||
       (iCommand==Command.PREV)||(iCommand==Command.LAST)||(iCommand == Command.BACK)){
         ...
         try{ 
            srcTraining = (SrcTrainingRpt)session.getValue("TRAINING_PROFILES_REPORT"); 
    ...
    session.putValue("TRAINING_PROFILES_REPORT", srcTraining);
    ...
    session.putValue("TRAINING_PROFILES_REPORT_PRINT", vct);	
%>
<!-- End of Jsp Block -->
...
<script language="JavaScript">
	...
	function cmdPrint(){
		window.open("<%=approot%>/servlet/com.dimata.harisma.report.employee.TrainingProfilesPdf?approot=<%=approot%>");
	}

	function cmdPrintXLS(){
		window.open("<%=approot%>/servlet/com.dimata.harisma.report.employee.TrainingProfilesXLS?approot=<%=approot%>");
	}
		
	function cmdListFirst(){
		document.frm_employee.command.value="<%=Command.FIRST%>";
		document.frm_employee.action="list_training_profiles.jsp";
	...
	function cmdBack(){
		...
		document.frm_employee.action="src_training_profiles.jsp";
		document.frm_employee.submit();
	}
            ...
            <table  width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Training 
                  &gt; Training Profiles &gt; Search Result<!-- #EndEditable --> 
                  </strong></font> </td>
              </tr>
              <tr> 
                <td> 
