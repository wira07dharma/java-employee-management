<%-- 
    Document   : src_report_emp
    Created on : Jan 28, 2009, 4:07:59 PM
    Author     : bayu
--%>
...
<%
    ...
    FrmSrcTrainingRptId frmSrcTraining = new FrmSrcTrainingRptId(request, srcTraining);
    ...
    if(iCommand == Command.BACK) {
        ...
        try{
            srcTraining = (SrcTrainingRptId)session.getValue("TRAINING_REPORT_EMP");
           
            if(srcTraining == null) {
                srcTraining = new SrcTrainingRptId();
            }
         
            session.removeValue("TRAINING_REPORT_EMP");
        }
        catch (Exception e){            
            srcTraining = new SrcTrainingRptId();
        }		
...
<script language="JavaScript">
    ...
    function cmdSearch(){
            ...
            document.frmsrcemployee.action="list_report_emp.jsp";
    ...
    function cmdRefresh(){
            document.frmsrcemployee.command.value="<%=Command.NONE%>";
            document.frmsrcemployee.action="src_report_emp.jsp";
            document.frmsrcemployee.submit();
    }
    
    function cmdListEmployee() {
            document.frmsrcemployee.command.value="<%=iCommand%>";
            win = window.open("<%=approot%>/employee/training/src_emp.jsp?formName=frmsrcemployee&name=<%=frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_NAME]%>&payroll=<%=frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_PAYROLL]%>" +
                              "&oid=<%=frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_EMPLOYEE]%>&dept=<%=frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_DEPARTMENT]%>", null, "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
    }
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> 
                  ...
                  Training &gt; Training Report By ID
                  <!-- #EndEditable --> 
                  </strong></font> </td>
        </tr>
        <tr> 
                                                ...
                                                <td width="97%"> 
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                        ...
                                                        <td width="83%">                                                             
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="hidden" name="<%=frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_EMPLOYEE] %>"  value="<%= ""+srcTraining.getEmployeeId() %>">
                                                                    <input type="hidden" name="<%=frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_DEPARTMENT] %>"  value="<%= ""+srcTraining.getDepartmentId() %>">
                                                                    <input type="text" readonly size="33" name="<%=frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_NAME] %>"  value="<%= ""+srcTraining.getName()%>" class="formElemen" maxlength="50">
                                                                </td>                                                                
                                                                <td>    
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                        ...
                                                        <td width="83%"> 
                                                            <input type="text" readonly name="<%=frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_PAYROLL] %>"  value="<%= srcTraining.getPayroll() %>" class="elemenForm" onkeydown="javascript:fnTrapKD()">                                                             
                                                        </td>
                                                    </tr>        
                                                    ...
                                                    <%--<tr align="left" valign="top"> 
                                                        ...
                                                        <td width="83%"> 
                                                            ...
                                                            %>
                                                            <%= ControlCombo.draw(frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_DEPARTMENT],"formElemen",null, ""+srcTraining.getDepartmentId(), dept_value, dept_key) %> 
                                                        </td>
                                                    </tr>--%>                                                   
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                        ...
                                                        <td width="83%"> 
                                                            <%=ControlDate.drawDateWithStyle(frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_START_DATE], (srcTraining.getStartDate() == null) ? new Date() : srcTraining.getStartDate(), 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%> &nbsp;to&nbsp; 
                                                            <%=ControlDate.drawDateWithStyle(frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_END_DATE], (srcTraining.getEndDate()== null) ? new Date() : srcTraining.getEndDate(), 0, -50,"formElemen", " onkeydown=\"javascript:fnTrapKD()\"")%>
                                                        </td>
                                                    </tr>           
                                                    ...
                                                    <%--<tr align="left" valign="top"> 
                                                        ...
                                                        <td width="83%"> 
                                                            <% 
                                                                ...
                                                                for (int i = 0; i < FrmSrcTrainingRptId.orderKey.length; i++) {
                                                                        or_key.add(FrmSrcTrainingRptId.orderKey[i]);
                                                                        or_value.add(String.valueOf(i));
                                                                }
                                                            %>
                                                            <%= ControlCombo.draw(frmSrcTraining.fieldNames[FrmSrcTrainingRptId.FRM_FIELD_SORT_BY],"formElemen",null, ""+srcTraining.getSortBy(), or_value, or_key, " onkeydown=\"javascript:fnTrapKD()\"") %> 
                                                        </td>
                                                    </tr>--%>
                                                    <tr align="left" valign="top"> 
                                                      <td width="17%"> 
