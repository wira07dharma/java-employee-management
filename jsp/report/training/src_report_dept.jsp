<%-- 
    Document   : src_report_dept
    Created on : Jan 28, 2009, 2:39:38 PM
    Author     : bayu
--%>
...
<%
    ...
    if(iCommand == Command.BACK) {
        ...
        try{
            ...
            session.removeValue("TRAINING_REPORT_DEPT");
        }
        catch (Exception e){            
            srcTraining = new SrcTrainingRpt();
        }		
...
<script language="JavaScript">
    ...
    function cmdSearch(){
            ...
            document.frmsrcemployee.action="list_report_dept.jsp";
    ...
    function cmdRefresh(){
            ...
            document.frmsrcemployee.action="src_report_dept.jsp";
            document.frmsrcemployee.submit();
    }
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> 
                  ...
                  Training &gt; Training Report By Department
                  <!-- #EndEditable --> 
                  </strong></font> </td>
        </tr>
        <tr> 
