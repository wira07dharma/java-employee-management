<%-- 
    Document   : src_training_coursedate
    Created on : Jan 29, 2009, 5:11:18 PM
    Author     : bayu
--%>
...
<%
    ...
    if(iCommand==Command.BACK) {
        ...
        try{
            ...
            session.removeValue("TRAINING_COURSEDATE_REPORT");
        }
        catch (Exception e){
...
<script language="JavaScript">
    ...
    function cmdSearch(){
            ...
            document.frmsrcemployee.action="list_training_coursedate.jsp";
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> 
                  ...
                  Training &gt; Training Report By Course Date
                  <!-- #EndEditable --> 
                  </strong></font> </td>
        </tr>
        <tr> 
                                                ...
                                                <td width="97%"> 
                                                  <table border="0" cellspacing="2" cellpadding="2" width="72%">
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                        ...
                                                        <td width="83%">
                                                            <%=ControlDate.drawDateMY(frmSrcTraining.fieldNames[FrmSrcTrainingRpt.FRM_FIELD_TRAIN_MONTH],iCommand == Command.NONE ? new Date() : srcTraining.getTrainingMonth(), "MMMM", "formElemen", +4, -8)%>
                                                        </td>
                                                    </tr>                    
                                                    <tr> 
                                                      <td width="17%" height="21" nowrap> 
