<%-- 
    Document   : training_profiles
    Created on : Jan 28, 2009, 10:32:03 AM
    Author     : bayu
--%>
...
<%
    ...
    if(iCommand == Command.BACK) {
        ...
        try{
            ...
            session.removeValue("TRAINING_PROFILES_REPORT");
        }
        catch (Exception e){            
            srcTraining = new SrcTrainingRpt();
        }		
...
<script language="JavaScript">
    ...
    function cmdSearch(){
            ...
            document.frmsrcemployee.action="list_training_profiles.jsp";
    ...
    function cmdRefresh(){
            ...
            document.frmsrcemployee.action="src_training_profiles.jsp";
            document.frmsrcemployee.submit();
    }
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> 
                  ...
                  Training &gt; Training Profiles Report
                  <!-- #EndEditable --> 
                  </strong></font> </td>
        </tr>
        <tr> 
                                              ...
                                              <tr> 
                                                ...
                                                <td width="97%"> 
                                                    ...
                                                    <%--<tr align="left" valign="top"> 
                                                        ...
                                                        <td width="83%"> 
                                                            <input type="text" name="<%=frmSrcTraining.fieldNames[FrmSrcTrainingRpt.FRM_FIELD_NAME] %>"  value="<%= srcTraining.getName() %>" class="elemenForm" size="40" onkeydown="javascript:fnTrapKD()"> 
                                                        </td>
                                                    </tr>           
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                        ...
                                                        <td width="83%"> 
                                                            <input type="text" name="<%=frmSrcTraining.fieldNames[FrmSrcTrainingRpt.FRM_FIELD_PAYROLL] %>"  value="<%= srcTraining.getPayroll() %>" class="elemenForm" onkeydown="javascript:fnTrapKD()"> 
                                                        </td>
                                                    </tr>           
                                                      ...
                                                      <td width="83%"> 
                                                        <table width="40%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr> 
                                                            ...
                                                            <td width="50%" class="command" nowrap><a href="javascript:cmdSearch()">Search Training Profiles</a></td>
