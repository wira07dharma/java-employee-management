...
<%!
	public Vector drawList(Vector objectClass, Department department){
		...
		if(objectClass != null && objectClass.size()>0){
			for (int i = 0; i < objectClass.size(); i++) {
				...
				//rowx.add(trainingActivityPlan.getProgram()); //2
			...
			rowx = new Vector();
			rowx.add("&nbsp"+department.getDepartment());
			rowx.add("");
			rowx.add("");
			rowx.add("");
			rowx.add("");
	...
	/*public Vector drawTotal(Vector object){
		ControlList ctrlist = new ControlList();
		ctrlist.setAreaWidth("98%");		
		ctrlist.setListStyle("listgen");
		ctrlist.setTitleStyle("tableheader");
		...
		ctrlist.addHeader("","14%","2","0");
		ctrlist.addHeader("","4%","2","0");		
		ctrlist.addHeader("","20%","2","0");
		
		ctrlist.addHeader("","12%","0","3");
		ctrlist.addHeader("","4%","0","0");
		ctrlist.addHeader("","4%","0","0");
		ctrlist.addHeader("","4%","0","0");
		...
		ctrlist.addHeader("","15%","0","3");
		ctrlist.addHeader("","4%","0","0");
		ctrlist.addHeader("","4%","0","0");
		ctrlist.addHeader("","4%","0","0");
				
		ctrlist.addHeader("","10%","2","0");
		ctrlist.addHeader("","16%","2","0");
...
<script language="JavaScript">
	...
	function cmdListFirst(){
		...
		document.fract.action="monthly_tr_rpt.jsp";
		document.fract.submit();
	}
                                                ...
                                                <td width="91%"> 
                                                  <table width="29%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                      ...
                                                      <td width="35%" class="command" nowrap><a href="javascript:cmdListFirst()">Generate 
                                                        Monthly Training Report</a></td>
                                                      <% if(privAdd){%>
                                                      <%}else{%>
                                                      <%}%>
                                                    </tr>
                                        ...
                                        <tr> 
                                          <td width="100%" class="command"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                              ...
                                              <tr> 
                                                <td>
                                                  <%//=drawList(listPlanning,department)%>
                                                </td>
                                              </tr>
                                              <%}%>
                                              <tr> 
											  ...
											  double sumPlanHourTotal = 0;
											  double sumActHourTotal = 0;
                                              ...
                                              <tr> 
                                                <td><%
												Vector vctTemp = drawList(listPlanning,department); 									
												Vector vc = (Vector)vctTemp.get(1);
												...
												sumPlanHourTotal =  sumPlanHourTotal +  Double.parseDouble((String)vc.get(2));
												sumActHourTotal =  sumActHourTotal +  Double.parseDouble((String)vc.get(3));
                                                ...
                                                <td> 
                                                  <table width="98%" class="listarea">
                                                    <tr> 
													  ...
													  vctX.add(""+sumPlanHourTotal);
													  vctX.add(""+sumActHourTotal);
                                                        ...
                                                        <table width="100%" class="listgen" cellspacing="1">
                                                          <tr bgcolor="#003399"> 
                                                            ...
                                                            <td width="4%"  height="26" > 
                                                              <div align="center"><b><font color="#FFFF00"> 
                                                                Plan</font></b></div>
                                                            </td>
                                                            <td width="4%"  height="26" > 
                                                              <div align="center"><b><font color="#FFFF00"> 
                                                          ...
                                                          <tr bgcolor="#003399"> 
                                                            <td height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b>GRAND 
                                                                TOTAL</b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><%=sumTotalEmpAll%></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=sumPlanPrgTotal%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=sumActPrgTotal%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=Formater.formatNumber(((sumActPrgTotal * 100.0)/sumPlanPrgTotal), "###.##")%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=sumPlanHourTotal%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=sumActHourTotal%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=Formater.formatNumber(((sumActHourTotal * 100.0)/sumPlanHourTotal), "###.##")%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=sumPlanTrainTotal%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=sumActTrainTotal%></font></b></font></div>
                                                            </td>
                                                            <td  height="29" > 
                                                              <div align="center"><font color="#FFFF00"><b><font size="2"><%=Formater.formatNumber(((sumActTrainTotal *100.0)/sumPlanTrainTotal), "###.##")%></font></b></font></div>
                                                            </td>
