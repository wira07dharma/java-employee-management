...
<%!
    ...
    public String drawList(Vector<SrcEsptA1> objectClass) {
        ...
        ctrlist.setCellSpacing("0");
         ...
         ctrlist.addHeader("Pay Num", "");
         ctrlist.addHeader("Emp Name", "");
         ctrlist.addHeader("NPWP", "");
         ctrlist.addHeader("Type Tax", "");
         ctrlist.addHeader("Jumlah Bruto", "");
         ctrlist.addHeader("Jumlah Pph21 - 19", "");
         ctrlist.addHeader("Jumlah Pph21 - 20", "");
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            String jumlah19 =  Formater.formatNumberVer1(espt.getJumlah_19(), "#,###");
            String jumlah20 =  Formater.formatNumberVer1(espt.getJumlah_20(), "#,###");
             if (!jumlah19.equals(jumlah20)){
            no = no + 1;
...
<%  
    ...
    if (iCommand == Command.LIST){
        ...
        Pajak pajak = new Pajak();
            listEspt = SessESPT.getListEsptA1AnnualTaxDifferent(pajak, periodId, divisionId, departmentId, sectionId, inSalBrutto, inPPHBrutto);
    ...
    <head>
        ...
        <script type="text/javascript">
            function compChange(val) 
            {
                ...
                document.frm_src_espt.action = "src_annual_tax_different.jsp";
            ...
            function cmdSearch(){ 
             ...
             function cmdSearchAll(){ 
                document.frm_src_espt.command.value="<%=Command.LIST%>";
                document.frm_src_espt.action="src_annual_tax_different.jsp?search=1";
                document.frm_src_espt.submit();
            }
            ...
            function cmdExportExcelAll(){	
                ...
                document.frm_src_espt.action="<%=approot%>/servlet/espta1.xlsAnnualTaxDifferent"; 
                                    ...
                                    <tr>
                                        <td style="background-color:#EEE;" valign="top">
                                            ...
                                            <table style="padding:9px; border:1px solid #00CCFF;" <%=garisContent%> width="100%" border="0" cellspacing="1" cellpadding="1" class="tablecolor">
                                                <tr>
                                                    <td valign="top">
                                                        <div id="mn_utama">Search Data for Annual Tax Different</div>
