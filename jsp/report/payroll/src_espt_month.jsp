                                                        ...
                                                        <form name="frm_src_espt" method="POST" action="">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr align="left" valign="top"> 
                                                                  ...
                                                                  <td width="83%"> 
                                                                    <input type="radio" name="inp_resignStatus" value="0" checked>
                                                                    <%=dictionaryD.getWord("NO")%> 
                                                                    <input type="radio" name="inp_resignStatus" value="1">
                                                                    <%=dictionaryD.getWord("YES")%>
                                                                    <input type="radio" name="inp_resignStatus" value="2">
                                                                    <%=dictionaryD.getWord(I_Dictionary.ALL)%> This Period 
                                                                    <input type="radio" name="inp_resignStatus" value="3">
                                                                    ALL Resign Yes (if status is "all resign yes" then it will display from January until the period chosen) </td>
                                                                </tr>
                                                                <tr>
