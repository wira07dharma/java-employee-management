<%-- 
    Document   : salary_movement_report
    Created on : Dec 13, 2018, 12:46:19 PM
    Author     : IanRizky
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
			function compChange(val) 
            {
                ...
                document.frm.action = "salary_movement_report.jsp";
                document.frm.submit();
            }
            ...
            function cmdExportExcel(){	 
                document.frm.action="export_excel/salary_movement.jsp"; 
                                                    ...
                                                    <td valign="top">
                                                        <form name="frm" method="post" action="">
                                                            ...
                                                            <table>
                                                                ...
                                                                %>
																<tr>
																	<td valign="top" id="tdForm">Payroll</td>
																	<td valign="top" id="tdForm">
																		<input type="text" name="emp_num" value="" />
																	</td>
																</tr>
                                                                <tr>
