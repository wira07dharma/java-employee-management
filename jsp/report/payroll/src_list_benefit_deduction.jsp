...
<%!    public String drawList(JspWriter outJsp,Vector listdatanew, Vector vpcomponent, long sourcetype, Hashtable listAttdAbsensi, Vector vReason ) {
      ...
      ctrlist.addHeader("Component", "20%", "0","" + (vpcomponent!=null && vpcomponent.size()>0?n:0));  
        ...
        double gajihariansect = 0 ;
        double gajihariandept = 0 ;
        double gajihariandivi = 0 ;
        double gajihariancomp = 0 ;
        ...
        try {
            if (listdatanew.size() > 0){
                    ...
                    for (int i=0; i<listdatanew.size(); i++) 
                {
                      ...
                      if(true || /*rekapitulasiPresenceDanSchedule.getPresenceOnTime() > 0*/true){
                                        ...
                                        for(int d=0;d<pcomp.size();d++){
                                            PayComponenttemp payComponenttemp = (PayComponenttemp) pcomp.get(d);
                                                ...
                                                //  nilainormal = (payComponenttemp.getCompValue()/rekapitulasiPresenceDanSchedule.getTotalWorkingDays())*rekapitulasiPresenceDanSchedule.getPresenceOnTime();
                                                    nilainormal = (payComponenttemp.getCompValue());
                                                } 
                                        }
                                    }
                      ...
                      if ((empCat != propProbation) && (empCat != propDailyworker)){
                          ...
                          totalgajitunjanganservice = totalgajitunjanganservice + nilainormal;
                            gajihariansect = gajihariansect + nilainormal;
                            gajihariandept = gajihariandept + nilainormal;
                            gajihariandivi = gajihariandivi + nilainormal;
                            gajihariancomp = gajihariancomp + nilainormal;
                      } 
                                        ...
                                        for(int d=0;d<pcomp.size();d++){
                                            ...
                                            if ((empCat == propProbation) || (empCat == propDailyworker)){
                                                if (payComponenttemp.getCompId() == propGPokok){
                                                    ...
                                                    if (/*rekapitulasiPresenceDanSchedule.getPresenceOnTime() == 0*/false){
                                                       rowx.add("Rp.-");
                                                    } else{
                                                        //total section
                     ...
                     if ((!TempSection2.equals(section2)) && ((!TempSection2.equals("")) || (TempSection2 != null))  ){
                                        ...
                                        rowxtotalsec.add("");
                                        rowxtotalsec.add("");
                                        rowxtotalsec.add("Rp. " + Formater.formatNumber(gajihariansect, "#,###.##"));
                                        gajihariansect = 0 ;
                     ...
                     if (((!TempDepartment2.equals(department2)) && (department2 != null) && i != 0) || (i ==(listdatanew.size() - 1))){
                                        ...
                                        rowxtotaldepart.add("");
                                        rowxtotaldepart.add("");
                                        rowxtotaldepart.add("Rp. " + Formater.formatNumber(gajihariandept, "#,###.##"));
                                        gajihariandept = 0 ;
                     ...
                     if (((!TempDivision2.equals(division2)) && (division2 != null) && i != 0) || (i ==(listdatanew.size() - 1))){
                                        ...
                                        rowxtotaldiv.add("");
                                        rowxtotaldiv.add("");
                                        rowxtotaldiv.add("Rp. " + Formater.formatNumber(gajihariandivi, "#,###.##"));
                                        gajihariandivi = 0 ;
                     ...
                     if (((!TempCompany2.equals(company2)) && (company2 != null) && i != 0) || (i ==(listdatanew.size() - 1))){
                                        ...
                                        rowxtotalcomp.add("");
                                        rowxtotalcomp.add("");
                                        rowxtotalcomp.add("Rp. " + Formater.formatNumber(gajihariancomp, "#,###.##"));
                                        gajihariancomp = 0 ;
        ...
        try {
            if (listdatanew.size() > 0){
                    ...
                    for (int i=0; i<listdatanew.size(); i++) 
                {
                      ...
                      if(/*rekapitulasiPresenceDanSchedule.getPresenceOnTime() > 0*/true){
                                        ...
                                        for(int d=0;d<pcomp.size();d++){
                                            PayComponenttemp payComponenttemp = (PayComponenttemp) pcomp.get(d);
                                                ...
                                                if ( payComponenttemp.getCompId() == propGPokok ){
                                                    ...
                                                    nilaigajiharian = (payComponenttemp.getCompValue());
