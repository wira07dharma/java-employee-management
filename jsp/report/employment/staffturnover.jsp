...
<script language="JavaScript">
    ...
    function cmdShowStaffRecapitulationMonthly(month, year) {
        document.frmstaff.command.value="<%=Command.LIST%>";
        document.frmstaff.month.value = month;
        document.frmstaff.year.value = year;
        document.frmstaff.action="staffrecapitulationmonthly.jsp";
    ...
    function cmdPrint(){
        window.open("<%=approot%>/servlet/com.dimata.harisma.report.employment.StaffTurnPdf?year=<%=year%>&month=<%=month%>&recapYear=<%=recapYear%>");
    }
</script>
<!-- #EndEditable --> 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Reports 
                  &gt; Employment &gt; Staff Turnover<!-- #EndEditable --> </strong></font> 
                </td>
              </tr>
              <tr> 
                <td> 
                                            ...
                                            <table width="73%" border="0" cellpadding="0" cellspacing="0">
                                              <tr> 
                                                ...
                                                <td   valign="middle" background="<%=approot%>/images/tab/inactive_bg.jpg" nowrap> 
                                                  <div align="center" class="tablink"><a href="javascript:cmdShowStaffRecapitulationMonthly('<%=month%>','<%=year%>');" class="tablink">Staff 
                                                    Recapitulation</a></div>
                                                </td>
                                                        ...
                                                        <table border="0" cellspacing="1" cellpadding="1" class="listgen">
                                                          <tr> 
                                                            <td class="listgensell"> 
                                                              <div align="center"><b>DETAIL 
                                                                INFORMATION<br>TURNOVER REPORT<br>
                                                              ...
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="1" class="listgen">
                                                                ...
                                                                <tr> 
                                                                  <td class="listgentitle"> 
                                                                    <div align="center">NEW HIRE</div>
                                                                  </td>
                                                                </tr>
                                                                <tr> 
                                                                  <td class="listgentitle">
                                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="listgen">
                                                                      <tr> 
                                                                        <td class="listgensell"><b>No</b></td>
                                                                        <td class="listgensell"><b>Name</b></td>
                                                                        <td class="listgensell"><b>Position</b></td>
                                                                        <td class="listgensell" nowrap><b>Comm. 
                                                                          Date 
                                                                          </b></td>
                                                                        <td class="listgensell" nowrap><b>Effective 
                                                                          Date 
                                                                          </b></td>
                                                                        <td class="listgensell"><b>Remarks</b></td>
                                                                      </tr>
                                                                      <%
                                                                      ...
                                                                      <tr> 
                                                                        ...
                                                                        <td class="listgensell"><%=employee.getFullName()%></td>
                                                                        <td class="listgensell"><%=position.getPosition()%></td>
                                                                        <td class="listgensell"><%=Formater.formatDate(employee.getCommencingDate(), "dd-MMM-yyyy")%></td>
                                                                        <td class="listgensell">&nbsp;</td>
                                                                        <td class="listgensell">&nbsp;</td>
                                                                      </tr>
                                                                      <% } %>
                                                                  ...
                                                                  <td class="listgentitle">
                                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="listgen">
                                                                      ...
                                                                      <tr> 
                                                                        ...
                                                                        <td class="listgensell"><%=Formater.formatDate(employee.getCommencingDate(), "dd-MMM-yyyy")%></td>
                                                                        <td class="listgensell">&nbsp;</td>
                                                                        <td class="listgensell"><%=res.getResignedReason()%></td>
                                                                      </tr>
                                                                      <% } %>
                                                                    </table>
                                                                  </td>
