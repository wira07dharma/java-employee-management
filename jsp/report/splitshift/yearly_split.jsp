...
<%!    int DATA_NULL = 0;
     ...
     */
    public String drawList(Hashtable hSplitShiftYearly) {
...
//Date date = FRMQueryString.requestDate(request,"month_year");
    ...
    SplitShiftYearly splitShiftYearly = new SplitShiftYearly("", "");
    SessSplitShift sessSplitShift = new SessSplitShift();

    Vector<SplitShiftMonthlyRekap> totalSplitShiftMonthlyRekap = new Vector();
    ...
    if (iCommand == Command.LIST) {
        ...
        for (int d = 0; d < listPeriod.size(); d++) {
            ...
            totalSplitShiftMonthlyRekap = sessSplitShift.getListMonth(listSplitShiftPresence, dateOfMonth, dEndDateOfMonth);

            for (int j = 0; j < totalSplitShiftMonthlyRekap.size(); j++) {
                SplitShiftMonthlyRekap splitShiftMonthlyRekap = totalSplitShiftMonthlyRekap.get(j);
                SplitShiftYearly splitShiftYear = hSplitShiftYearly.get(splitShiftMonthlyRekap.getEmpNum());
                if (splitShiftYear == null) {
                    SplitShiftYearly empSplitShiftYearly = new SplitShiftYearly(splitShiftMonthlyRekap.getEmpNum(), splitShiftMonthlyRekap.getEmpName());
                    empSplitShiftYearly.setMonthlyRekap(splitShiftMonthlyRekap);
                    hSplitShiftYearly.put(empSplitShiftYearly.getEmpNum(), empSplitShiftYearly);
                } else {
                    splitShiftYear.setMonthlyRekap(splitShiftMonthlyRekap);
                }
            }
        }
    }

    session.putValue("listresult", hSplitShiftYearly);
%>
<!-- End of JSP Block -->
<html>
    ...
    <head>
        ...
        <script language="JavaScript">
            function cmdView(){
                ...
                document.frpresence.action="yearly_split.jsp";
            ...
            function cmdExportExcel(){
                ...
                var linkPage = "<%=approot%>/report/splitshift/export_excel/export_excel_yearly_split.jsp";    
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr> 
                                        <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Attendance 
                                                &gt; Yearly Split Shift<!-- #EndEditable --> </strong></font> 
                                        </td>
                                    </tr>
                                    <tr> 
                                        <td> 
                                                                            ...
                                                                            <td valign="top"> <!-- #BeginEditable "content" -->
                                                                                <form name="frpresence" method="post" action="">
                                                                                    ...
                                                                                    <table width="60%" border="0" cellspacing="2" cellpadding="2">
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="30%" nowrap="nowrap">:
                                                                                                <input class="masterTooltip" type="text" size="40" name="emp_number"  value="<%= splitShiftYearly.getEmpNum() != null ? splitShiftYearly.getEmpNum() : empNum%>" title="You can Input Payroll Number more than one, ex-sample : 1111,2222" class="elemenForm" onKeyDown="javascript:fnTrapKD()">
                                                                                            </td>
                                                                                            <td width="5%" nowrap="nowrap"><div align="right"> Full Name </div> </td>
                                                                                            <td width="59%" nowrap="nowrap">:
                                                                                                <input class="masterTooltip" type="text" size="50" name="full_name"  value="<%= splitShiftYearly.getEmpName() != null ? splitShiftYearly.getEmpName() : fullName%>" title="You can Input Full Name more than one, ex-sample : saya,kamu" class="elemenForm" onKeyDown="javascript:fnTrapKD()">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <!-- update by devin 2014-01-29 -->
                                                                                        <tr>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                                        <% if (hSplitShiftYearly != null && hSplitShiftYearly.size() > 0) {%>
                                                                                        <tr>
                                                                                            <td><hr></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <%=drawList(hSplitShiftYearly)%>																						
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%if (privPrint) {%>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <table width="18%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr>
                                                                                                        <td width="17%"><a href="javascript:cmdExportExcel()"><img src="../../images/BtnNew.jpg" width="24" height="24" border="0" alt="Print Yearly Split Shift"></a></td>												  
                                                                                                        <td width="83%">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="msginfo">&nbsp;&nbsp;No split shift data found ...</div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%}%>
                                                                                    </table>
