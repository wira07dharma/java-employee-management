...
//script untuk cek resolusi browser yg di gunakan
  /*if (window.screen){
var w = screen.width;
tmt_url_640 = "presence_report_daily_1_20130522.jsp";
    if(w>=1250){
		...
		// set the check value for all check boxes
         ...
         function  checkSymbol(obj){
            ...
            function cmdView(){
                ...
                document.frpresence.action="presence_report_daily_1.jsp";
...
if (processDependOnUserDept) {
      ...
      if(oidCompany!=0){
			...
			%>
                        <%= ControlCombo.draw("hidden_companyId", "formElemen", null, ""+oidCompany, comp_value, comp_key, "onChange=\"javascript:cmdUpdateDiv()\"")%> 
                                                                                            </td>
...
if (processDependOnUserDept) {
    ...
    oidDivision = tmpFirstDiv;
			...
			%> <%= ControlCombo.draw("hidden_divisionId", "formElemen", null,""+oidDivision , div_value, div_key, "onChange=\"javascript:cmdUpdateDep()\"")%>                                                                                          
                                                                                            </td>
                                                                                        </tr>
