...
<%!    int DATA_NULL = 0;
    ...
    public Vector drawList(JspWriter outObj,int iCommand,Vector listAttendanceRecordDailly, Vector listPresencePersonalInOut,Vector listOvertimeDaily,HolidaysTable holidaysTable,  Date selectDateFrom, Date selectDateTo,String fullName,String empNum,boolean privUpdatePresence,int start,int showOvertime) {
        ...
        ctrlist.setRowSelectedStyles("rowselectedstyles");
            ...
            ctrlist.addHeader("Schedule", "1%", "0", "1");
            ctrlist.addHeader("Symbol", "3%", "0", "0");
          ...
          if(showOvertime==0){ 
            ...
            if (privUpdatePresence) {
                ctrlist.addHeader("Select", "1%", "2", "0");
            }
            ...
            if(listAttendanceRecordDailly !=null && listAttendanceRecordDailly.size() > 0){
                ...
                **/
                        ...
                        try{
                            ...
                            //System.out.println("Execption PAYROLL_INSENTIF_MAX_LEVEL: " + ex);
                            outObj.println("<blink>PAYROLL_INSENTIF_DEPT_ID_EXCEPT NOT TO BE SET</blink>" );
                        }*/ 
            ...
            for (int i = 0; i < listAttendanceRecordDailly.size(); i++) { 
                ...
                Date dateLeave = new Date(lDatePresence);
                 ...
                 int leaveStatus =-1;
                try{
                    leaveStatus = PstLeaveApplication.getLeaveFormStatus(lEmpId, dateLeave);
                  }catch(Exception ex){
               ...
               **/
                 long oidLeave  = 0;
                 String sSymbolLeave = ""; 
               Vector listLeaveAplication =  PstLeaveApplication.listOid(lEmpId, dateLeave);
               ...
               // HolidaysTable holidaysTable = PstPublicHolidays.getHolidaysTable(selectedDateFrom, selectedDateTo); 
                if(holidaysTable.isHoliday(religion_id !=0 ? religion_id : 0, presenceReportDaily.getSelectedDate())){
                 ...
                 if(daysHolidayName !=null && daysHolidayName.length()>0){
                       cmdDaysHoliday = "<p><abbr title=\""+daysHolidayName+"\"><font color=\"#FF0000\">"+"Libur<br>"+dayStringColor+",<br>"+dateStringColor+"</font></p>"; 
                 }else{
                ...
                //update by satrya 2012-10-10 
                 if(listPresencePersonalInOut!=null && listPresencePersonalInOut.size() > 0 ){
                         ...
                         Date dtSchEmpScheduleBIn = new Date();
                         Date dtSchEmpScheduleBOut = new Date();
                         ...
                         if(presenceBreak.getEmployeeId()==presenceReportDaily.getEmpId() 
                             ...
                             if(presenceBreak.getStatus()== Presence.STATUS_OUT_PERSONAL){
                                 ...
                                 //if((presenceBreak.getScheduleDatetime()==null || presenceBreak.getPresenceDatetime().getTime() < presenceBreak.getScheduleDatetime().getTime())){
                                  if((presenceBreak.getPresenceDatetime().getTime() < presenceBreak.getScheduleDatetime().getTime())){ ///jika karyawan mendahului istirahat
                                   ...
                                   long iDurationBOut = 0;
                                     iDurationBOut = DateCalc.timeDifference(dtpresenceDateTime, dtSchEmpScheduleBOut);
                                  if (iDurationBOut > 0){
                                      // if(dtSchDateTime.getTime() >  dtpresenceDateTime.getTime()){
                                     //istirahat duluan 
                                  bOut =bOut+ "P:" +Formater.formatDate(presenceBreak.getPresenceDatetime(),"d/M/yy")+"<br> <font color=\"#FF0000\">"+ Formater.formatDate(presenceBreak.getPresenceDatetime(),"HH:mm")+"<br><br></font>";
                                 
                                 }else{
                                  bOut =bOut+ "P:" +Formater.formatDate(presenceBreak.getPresenceDatetime(),"d/M/yy")+"<br>"+Formater.formatDate(presenceBreak.getPresenceDatetime(),"HH:mm")+"<br><br>";
                                 }
                                   dBout = dBout+ "P:" +Formater.formatDate(presenceBreak.getPresenceDatetime(),"HH:mm"); 
                                  ...
                                  long iDurationBIn = 0;
                                  iDurationBIn = DateCalc.timeDifference(dtpresenceDateTime, dtSchEmpScheduleBIn); 
                                  if (iDurationBIn < 0){
                                  //if(dtSchDateTime.getTime() <  dtpresenceDateTime.getTime()){
                                  bIn =bIn+ "P:" +Formater.formatDate(presenceBreak.getPresenceDatetime(),"d/M/yy")+"<br> <font color=\"#FF0000\">"+ Formater.formatDate(presenceBreak.getPresenceDatetime(),"HH:mm")+"<br><br></font>";
                                  }else{
                                  bIn =bIn+ "P:" +Formater.formatDate(presenceBreak.getPresenceDatetime(),"d/M/yy")+"<br>"+Formater.formatDate(presenceBreak.getPresenceDatetime(),"HH:mm")+"<br><br>";
                                 }
                                    dBin = dBin+ "P:" +Formater.formatDate(presenceBreak.getPresenceDatetime(),"HH:mm"); 
                                  //if(preBOut!=null && preBOut.getStatus()==Presence.STATUS_OUT_PERSONAL){
                                   if(preBreakOut !=0L){   
                                  //update by satrya 2012-09-27
                                    //if(presenceBreak.getScheduleDatetime()==null || presenceBreak.getPresenceDatetime().getTime() > presenceBreak.getScheduleDatetime().getTime()){
                                  if(presenceBreak.getPresenceDatetime().getTime() > presenceBreak.getScheduleDatetime().getTime()){ ///jika karyawan melewati jam istirahat
                    ...
                    String sSymbol =""; 
                        if(strSchldSymbol1 !=null && strSchldSymbol1.length() >0){
                              ...
                              if(Al_oid != presenceReportDaily.getScheduleId1() && LL_oid != presenceReportDaily.getScheduleId1() && DP_oid != presenceReportDaily.getScheduleId1()){
                                  ...
                                  sSymbol ="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\"   id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"2\" "
                                        + "title =\""+strScheduleDesc1st+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\">"
                                      ...
                                      if(sSymbolLeave !=null && sSymbolLeave.length() > 0){
                                          sSymbol ="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\"  id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"2\" "
                                            + "title =\""+strScheduleDesc1st+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\">"+" / <B>"+sSymbolLeave+"</B>"
                                                  ;// +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                      }
                                      else{
                                          sSymbol ="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\" id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"2\""
                                  ...
                                  sSymbol = strSchldSymbol1 ;
                                    ...
                                    {
                                     sSymbol ="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\"  id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"3\" "
 + "                                         title =\""+strScheduleDesc1st+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\">"+" / <B>"+sSymbolLeave+"</B>"
                                            ;//  +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                    }
                             }
                          ...
                          sSymbol="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\"  id=\"inputName\" name=\"" + inputName+ "_symbol\" value=\"" + strSchldSymbol1 !=null || strSchldSymbol1.length() > 0 ? strSchldSymbol1.toUpperCase() : ""+0 + "\"  size=\"3\" "
                                    + "title =\""+"-"+"&nbsp;["+"00:00"+"&nbsp;"+"00:00"+"]\">";
                        }
                  //mencari sSymbol2nd
                        String sSymbol2nd =""; 
                        if(strSchldSymbol2 !=null && strSchldSymbol2.length() >0){
                              ...
                              if(Al_oid != presenceReportDaily.getScheduleId2() && LL_oid != presenceReportDaily.getScheduleId2() && DP_oid != presenceReportDaily.getScheduleId2()){
                                  if(iLeaveMinuteEnable !=1){
                                  sSymbol2nd ="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\"   id=\"inputName\" name=\"" + inputName2nd + "_symbol\" value=\"" + strSchldSymbol2.toUpperCase() + "\"  size=\"2\" "
                                  ...
                                  sSymbol2nd = strSchldSymbol2;
                                    ...
                                    {
                                     sSymbol2nd ="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\"  id=\"inputName\" name=\"" + inputName2nd + "_symbol\" value=\"" + strSchldSymbol2.toUpperCase() + "\"  size=\"3\" "
 + "                                         title =\""+strScheduleDesc2nd+"&nbsp;["+sDtSchldBO2nd+"&nbsp;"+sDtSchldBI2nd+"]\">"+" / <B>"+sSymbolLeave+"</B>"
                                            ;
                                    }
                             }
                          ...
                          //sSymbol2nd="-";
                             sSymbol2nd="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\"  id=\"inputName\" name=\"" + inputName2nd+ "_symbol\" value=\"" + strSchldSymbol2 !=null || strSchldSymbol2.length() > 0 ? strSchldSymbol2.toUpperCase() : "0" + "\"  size=\"3\" "
                                    + "title =\""+"-"+"&nbsp;["+"00:00"+"&nbsp;"+"00:00"+"]\">";
                        }
                   ///command script
...
//loop untuk b-Out / B-In
                   ...
                   rowx.add(sSymbol +"<br>"+cmdEditAttendace +" || "+cmdEditAttendanceManual);
                ...
                if(showOvertime==0){ 
                    ...
                    //rowx.add(!privUpdatePresence ? "" : ((presenceReportDaily.getScheduleId1() == Al_oid) || (presenceReportDaily.getScheduleId1() == LL_oid) || (presenceReportDaily.getScheduleId1() == DP_oid)) || (scheduleSymbolIdMap.containsKey(""+presenceReportDaily.getScheduleId1()))  ? "<a href=\"javascript:cmdEditLeave('" + presenceReportDaily.getEmpId() + "','" + lDatePresence + "');\">"+(leaveStatus ==PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED ? " <font color=\"#FF0000\"> <center> <blink>  Open </blink> </center></font>" : "<font color=\"#00000\"> <center> View </center></font>")+"</a>" : ("<a href=\"javascript:cmdNewLeave('" +  presenceReportDaily.getEmpId() + "','" + lDatePresence + "');\"><center>New</center></a>"));
        ...
        if (userSelect != null && userSelect.length > 0) {
            ...
            for (int i = 0; i < userSelect.length; i++) {
                try {
                   ...
                   int updateSchedule = PstEmpSchedule.updateScheduleByAbsenceDaily(oidScheduleEmp, dateSelect, oidSch1nd,status, reason, note,oidSch1nd2nd,status2nd,reason2nd,note2nd);
                   ...
                   if(updateSchedule !=0){
                       message = message + " Update Daily Report Schedule Success No.Payroll :" + empNumSelect +"," ;
                   }
...
//update by satrya 2013-04-09
 ...
 //update by satrya 2013-03-29
   ...
   vectSize = SessEmpSchedule.getCountSessEmpSchedule(sessEmpSchedule,oidDepartment,selectedDateFrom,selectedDateTo,oidSection,empNum,fullName,status1st,stsPresenceSel,reason_sts);	
try
                {	 
                    if(selectedDateFrom!=null && selectedDateTo!=null){
                        ...
                        sessEmpSchedule.setStatus1(status1st);
	...
	//vectListAL = SessLeaveManagement.listSummaryAlStockInt(srcLeaveManagement, start, recordToGet); 
	  ...
	  listAttendanceRecordDailly = SessEmpSchedule.listEmpPresenceDaily(sessEmpSchedule.getDepartement(), sessEmpSchedule.getFromDate(), sessEmpSchedule.getToDate(),
                 sessEmpSchedule.getSection(), sessEmpSchedule.getEmpNum().trim(),  sessEmpSchedule.getEmpFullName().trim(),
                  sessEmpSchedule.getStatus1(), sessEmpSchedule==null && sessEmpSchedule.getStart() == 0 ? start : sessEmpSchedule.getStart(), recordToGet,stsPresenceSel,sessEmpSchedule.getReasonSts());
                 
                 
          }else{
              listAttendanceRecordDailly = SessEmpSchedule.listEmpPresenceDaily(oidDepartment, selectedDateFrom, selectedDateTo, oidSection, empNum, fullName, status1st, start, recordToGet,stsPresenceSel,reason_sts);    
          }
         ...
         if(sessEmpSchedule!=null){
          //listPresencePersonalInOut =  PstPresence.list(vectSize , recordToGet, order, sessEmpSchedule.getDepartement(), sessEmpSchedule.getEmpFullName().trim()
           ...
           listPresencePersonalInOut =  PstPresence.list(0 , 0, order, sessEmpSchedule.getDepartement(), sessEmpSchedule.getEmpFullName().trim() 
                , sessEmpSchedule.getFromDate(), sessEmpSchedule.getToDate(), sessEmpSchedule.getSection(), sessEmpSchedule.getEmpNum().trim(),stsPresenceSel);//di tambahkan stsPresenceSel
    ...
    <head> 
        ...
        %>
         ...
         function  checkSymbol(obj){
            ...
            /*function cmdExecuteLeave(employeeId, dateLeaveLong){            
               // var linkPage = "<//%=approot%>/employee/leave/leave_app_execute.jsp?source=presence&command=<//%=(Command.EDIT)%>&employeeId="+employeeId+"&dateLeaveLong="+dateLeaveLong; 
                //update by satrya 2012-07-27
                var linkPage = "<//%//=approot%>/employee/leave/leave_app_edit.jsp?source=presence&command=<//%=(Command.EDIT)%>&employeeId="+employeeId+"&dateLeaveLong="+dateLeaveLong; 
              // window.open(linkPage,"Leave","height=600,width=800,status=yes,toolbar=yes,menubar=no,location=no"); 
              var newWin = window.open(linkPage,"Leave","height=700,width=950,status=yes,toolbar=yes,menubar=no,resizable=yes,scrollbars=yes,location=yes");  			
                newWin.focus();*/
                                                                                          ...
                                                                                          <div align="left"><%=dictionaryD.getWord(I_Dictionary.DEPARTMENT) %></div>                                                                                            </td>
                                                                                            <td width="30%" nowrap="nowrap"> : 
                                                                                                <%/*
                                                                                                     ...
                                                                                                     */%>
                                                                                                <% //=ControlCombo.draw("department", null,""+oidDepartment,deptValue,deptKey, "onChange=\"javascript:cmdUpdateDep()\"")%>
                                                                                        ...
                                                                                        <tr> 
                                                                                          ...
                                                                                          <div align="left">Status </div></td>
                                                                                            <td width="59%" nowrap="nowrap">: 
                                                                                                ...
                                                                                                %>
                                                                                          <%=ControlCombo.draw("status_schedule1st","-select-", status1st, status_value, status_key)%>                                                                                            
                                                                                            </td>
                                                                                            ...
                                                                                            <td>
                                                                                                <table width="18%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="35%" nowrap="nowrap"><b><a href="javascript:updateDaily()" class="buttonlink">Update Daily Presence</a></b> 													
                                                                                                        </td>
                                                                                                       <%if(showOvertime==0){%>
