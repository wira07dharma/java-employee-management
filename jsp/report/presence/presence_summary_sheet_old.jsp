...
public String drawList(Vector listPresenceReport, Date date, int start) 
{
    if(listPresenceReport!=null && listPresenceReport.size()>0)
    {
        ...
        int dateOfMonth = newCalendarTemp.getActualMaximum(Calendar.DAY_OF_MONTH); 
            ...
            ctrlist.addHeader("Id","4%", "2", "0");
            ctrlist.addHeader("Band Member","10%", "2", "0");
            ...
            */
            ...
            ctrlist.addHeader("DP Record","8%", "0", "5");
            ctrlist.addHeader("Qty","2%", "0", "0");		
            ctrlist.addHeader("Tkn.","2%", "0", "0");		
            ctrlist.addHeader("Will Be Tkn.","2%", "0", "0");            	
            ctrlist.addHeader("Exp","2%", "0", "0");            	
            ctrlist.addHeader("Blc.","2%", "0", "0");
            /**
            ...
            ctrlist.addHeader("Blc.","2%", "0", "0");
            */
            ctrlist.addHeader("AL Record","12%", "0", "7");
            ctrlist.addHeader("Prev Per.","2%", "0", "0");		
            ctrlist.addHeader("Ent.","2%", "0", "0");		
            ctrlist.addHeader("Curr. Ent.","2%", "0", "0");		
            ctrlist.addHeader("Sub Tot.","2%", "0", "0");
            ctrlist.addHeader("Tkn.","2%", "0", "0");
            ctrlist.addHeader("Will Be Tkn.","2%", "0", "0");
            ctrlist.addHeader("Blc.","2%", "0", "0");
            ...
            */
            ...
            ctrlist.addHeader("LL Record","14%", "0", "9");
            ctrlist.addHeader("Prev. Per.","2%", "0", "0");		
            ctrlist.addHeader("Ent 1.","2%", "0", "0");		
            ctrlist.addHeader("Ent 2.","2%", "0", "0");		
            ctrlist.addHeader("Curr Ent","2%", "0", "0");		
            ctrlist.addHeader("Sub. Tot.","2%", "0", "0");
            ctrlist.addHeader("Tkn.","2%", "0", "0");
            ctrlist.addHeader("Will Be Tkn.","2%", "0", "0");
            ...
            for(int i=0; i<maxPresenceData; i++) 
            {
                ...
                float exp         = 0;
                float Blnc        = 0;
                float DPBalanceWth2BTaken = 0;
                float residueDp   = 0;
                float expired     = 0;
                
                resultDp = SessLeaveApp.detailLeaveDPStockByEmployee(Long.parseLong(empId));//SessLeaveApp.detailLeaveDPStockByEmployee(empId);
                
                if(resultDp != null && resultDp.size() > 0){
                    
                    RepItemLeaveAndDp item = null;
                
                    item = (RepItemLeaveAndDp)resultDp.get(0);
                    
                    qtyDp     = item.getDPQty();
                    tknDp     = item.getDPTaken();
                    willBeTkn = item.getDP2BTaken();
                    DPBalanceWth2BTaken = item.getDPBalanceWth2BTaken();
                    
                    try{
                        expired   = SessLeaveManagement.totalExpiredDp(item.getEmployeeId());
                    }catch(Exception e){
                        System.out.println("EXCEPTION "+e.toString());                    
                    }
                    
                    residueDp = DPBalanceWth2BTaken - expired;
