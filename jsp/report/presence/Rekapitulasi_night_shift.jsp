...
<%!    public String drawListSo4(JspWriter outJsp,RekapitulasiAbsensi rekapitulasiAbsensi,Vector listCompany,Hashtable hashDivision,Hashtable hashDepartment,Hashtable hashSection,Hashtable hashEmployee,Hashtable hashEmployeeSection,Hashtable listAttdAbsensi,HashTblPayDay hashTblPayDay,long oidEmployeeDw, int viewschedule, Hashtable listPayDayfromSalLevel,int OnlyDw) {
        ...
        long dayOFF =0;
         ...
         double nightShiftValue =0;
            try{
              nightShiftValue = Double.parseDouble(PstSystemProperty.getValueByName("NIGHT_SHIFT_VALUE"));
             }catch(Exception ex){
                 System.out.println("NIGHT_SHIFT_VALUE NOT Be SET"+ex);
             }
        ...
        ctrlist.addHeader("NIGHT SHIFT", "5%", "0", "0");
            ...
            if (rekapitulasiAbsensi.getDtFrom() != null && rekapitulasiAbsensi.getDtTo() != null) {
                ...
                if (listCompany != null && listCompany.size() > 0) { 
                    for (int idxcom = 0; idxcom < listCompany.size(); idxcom++) {
                                                ...
                                                if (hashEmployee != null && hashEmployee.size() > 0) { 
                                                    ...
                                                    if (sessEmployee != null && sessEmployee.getListEmployee() != null && sessEmployee.getListEmployee().size() > 0) {
                                                           ...
                                                           rekapitulasiPresenceDanSchedule = new RekapitulasiPresenceDanSchedule(); 
                                                            ...
                                                            if(employeeMinimalis.getSectionId()==0){
                                                               ...
                                                               //menghitung per department
                                                                ...
                                                                rowx.add(""+rekapitulasiPresenceDanSchedule.getNightShift()); 
                                                                //rowx.add("");
                                                                rowx.add(""+Formater.formatNumberMataUang(nightShiftValue, "Rp") ); 
                                                                rowx.add(""+Formater.formatNumberMataUang((rekapitulasiPresenceDanSchedule.getNightShift()* nightShiftValue), "Rp"));
                                                                ...
                                                                if(hashTblPayDay!=null){
                                                                    rekapitulasiAbsensiGrandTotal.setPayDay(rekapitulasiAbsensiGrandTotal.getPayDay()+nightShiftValue);
                                                                        rekapitulasiAbsensiGrandTotal.setTotalPayDay(rekapitulasiAbsensiGrandTotal.getTotalPayDay()+(rekapitulasiPresenceDanSchedule.getNightShift()* nightShiftValue));
                                                                        rekapitulasiAbsensiGrandTotalPerCompany.setPayDay(rekapitulasiAbsensiGrandTotalPerCompany.getPayDay()+ nightShiftValue);
                                                                        rekapitulasiAbsensiGrandTotalPerCompany.setTotalPayDay(rekapitulasiAbsensiGrandTotalPerCompany.getTotalPayDay()+(rekapitulasiPresenceDanSchedule.getNightShift()*nightShiftValue));
                                                                }
                                                        ...
                                                        if(hashSection==null ||  (hashSection != null && hashSection.size() > 0 && hashSection.containsKey(""+department.getOID())==false)){
                                                                ...
                                                                rowx.add("<b>"+rekapitulasiAbsensiGrandTotal.getNightShift()+"</b>"); 
                                                                ...
                                                                for (int idxSec = 0; idxSec < cloneSection.size(); idxSec++) {
                                                                    ...
                                                                    if (hashEmployeeSection != null && hashEmployeeSection.size() > 0) {
                                                                        ...
                                                                        if (cloneListEmp!=null) {
                                                                                ...
                                                                                if(employeeMinimalis.getSectionId()!=0){
                                                                                   ...
                                                                                   String sdw2 = String.valueOf(Dw);
                                                                                    if ( nilaiemp2.equals(sdw2)){
                                                                                            ...
                                                                                            harianDw = (Double) (Double.valueOf(nightShiftValue));
                                                                                            }
                                                                                            rekapitulasiAbsensiGrandTotal.setPayDay(rekapitulasiAbsensiGrandTotal.getPayDay()+harianDw);
                                                                                            rekapitulasiAbsensiGrandTotal.setTotalPayDay(rekapitulasiAbsensiGrandTotal.getTotalPayDay()+(rekapitulasiPresenceDanSchedule.getNightShift()*harianDw));
                                                                                            rekapitulasiAbsensiGrandTotalSec.setPayDay(rekapitulasiAbsensiGrandTotalSec.getPayDay()+harianDw);
                                                                                            rekapitulasiAbsensiGrandTotalSec.setTotalPayDay(rekapitulasiAbsensiGrandTotalSec.getTotalPayDay()+(rekapitulasiPresenceDanSchedule.getNightShift()*harianDw));
                                                                                            rekapitulasiAbsensiGrandTotalPerCompany.setPayDay(rekapitulasiAbsensiGrandTotalPerCompany.getPayDay()+harianDw);
                                                                                            rekapitulasiAbsensiGrandTotalPerCompany.setTotalPayDay(rekapitulasiAbsensiGrandTotalPerCompany.getTotalPayDay()+(rekapitulasiPresenceDanSchedule.getNightShift()*harianDw));
                                                                                    
                                                                                        } else {
                                                                                            rekapitulasiAbsensiGrandTotal.setPayDay(rekapitulasiAbsensiGrandTotal.getPayDay()+nightShiftValue);
                                                                                            rekapitulasiAbsensiGrandTotal.setTotalPayDay(rekapitulasiAbsensiGrandTotal.getTotalPayDay()+(rekapitulasiPresenceDanSchedule.getNightShift()*nightShiftValue));
                                                                                            rekapitulasiAbsensiGrandTotalSec.setPayDay(rekapitulasiAbsensiGrandTotalSec.getPayDay()+nightShiftValue);
                                                                                            rekapitulasiAbsensiGrandTotalSec.setTotalPayDay(rekapitulasiAbsensiGrandTotalSec.getTotalPayDay()+(rekapitulasiPresenceDanSchedule.getNightShift()*nightShiftValue));
                                                                            ...
                                                                            rowx.add("<b>"+rekapitulasiAbsensiGrandTotalSec.getNightShift()+"</b>");
                        ...
                        rowx.add("<b>"+rekapitulasiAbsensiGrandTotalPerCompany.getNightShift()+"</b>");  
    ...
    <head> 
        ...
        <script language="JavaScript">
            ...
            function cmdUpdateDiv(){
                ...
                document.frpresence.action="Rekapitulasi_night_shift.jsp";
            ...
            function cmdExportExcel(source_type){
                ...
                var linkPage = "<%=approot%>/report/presence/export_excel/export_excel_Rekapitulasi_night_shift.jsp?source_type="+source_type;    
                        ...
                        /*
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="39%">
                                                                                                ...
                                                                                                <a href="javascript:cmdSearch(0)">Search  Night Shift</a></td>  
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
