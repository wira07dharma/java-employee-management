...
function reportPdf(){
	var linkPage = "/harismav2-bd/servlet/com.dimata.harisma.report.employee.LatenessPdf";
                                        ...
                                        <tr> 
                                          ...
                                          <td width="88%"> 
                                            <table border="0" cellspacing="0" cellpadding="0" width="137">
                                              <tr> 
                                                <td width="16"><a href="javascript:cmdView()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','/harismav2-bd/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="/harismav2-bd/images/BtnSearch.jpg" width="24" height="24" alt="Search Lateness"></a></td>
                                                <td width="2"><img src="/harismav2-bd/images/spacer.gif" width="4" height="1"></td>
                                          ...
                                          <tr>
											...
											<table width="100%" class="listarea"> <tr><td><div class="listgentitle"></div></td></tr><tr><td>
                                                  <table width="100%" class="listgen" cellspacing="1">
                                                    <tr></tr>
                                                    <tr> 
                                                      <td width="1%" class="listgentitle" > 
                                                        No</td>
                                                      <td width="6%" class="listgentitle" ><%=dictionaryD.getWord(I_Dictionary.DEPARTMENT) %></td>
                                                      <td width="6%" class="listgentitle" > 
                                                        Payroll</td>
                                                    ...
                                                    <tr> 
                                                      <td class="listgensell" >1</td>
                                                      <td class="listgensell" >Accounting</td>
                                                      <td class="listgensell" >51002849</td>
                                                      <td class="listgensell" >TOPHAN 
                                                        KUSMARDIANTO</td>
                                                      <td class="listgensell" >M4</td>
                                                      <td class="listgensell" >08:00</td>
                                                      <td class="listgensell" >16:35</td>
                                                      <td class="listgensell" >-8h, 
                                                        -35m </td>
                                                    </tr>
                                                    <tr>
                                                      <td class="listgensell" >2</td>
                                                      <td class="listgensell" >Engineering</td>
                                                      <td class="listgensell" >98998998</td>
                                                      <td class="listgensell" >MADE 
                                                        GEDE </td>
                                                      <td class="listgensell" >M4</td>
                                                      <td class="listgensell" >08:00</td>
                                                      <td class="listgensell" >16:00</td>
                                                      <td class="listgensell" >-8h, 
                                                        0m </td>
                                                    </tr>
                                                  </table>
