 ...
 */
public Vector drawList(Vector listNightShiftPresence, int dateOfMonth) 
{
...
{
	//listNightShiftPresence = SessNightShift.listNightShiftDataMonthly(oidDepartment,date);
	// untuk aplikasi yang membutuhkan parameter section.Jika cukup dengan parameter department pake yang atas
    //update by devin 2014-01-29
    //listNightShiftPresence = SessNightShift.listNightShiftDataMonthly(oidDepartment,date,oidSection);
...
// process on drawlist
Vector vectResult = drawList(listNightShiftPresence, dateOfMonth);
...
if(session.getValue("NIGHT_SHIFT_MONTHLY")!=null){
	session.removeValue("NIGHT_SHIFT_MONTHLY");
}
session.putValue("NIGHT_SHIFT_MONTHLY",vectPresence);			
%>
<!-- End of JSP Block -->
<html>
...
function cmdView(){
	...
	document.frpresence.action="monthly_night.jsp";
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Attendance 
                  &gt; Monthly Night Shift<!-- #EndEditable --> </strong></font> 
                </td>
              </tr>
              <tr> 
                <td> 
                                            ...
                                            <!-- update by devin 2014-01-29 -->
                                                                                            <td width="6%" nowrap="nowrap"><div align="left">Payrol Num </div></td>
                                                                                             <td width="30%" nowrap="nowrap">:
                                                                                               <input class="masterTooltip" type="text" size="40" name="emp_number"  value="<%= nightShiftMonthly.getEmpNum() != null ? nightShiftMonthly.getEmpNum() : empNum %>" title="You can Input Payroll Number more than one, ex-sample : 1111,2222" class="elemenForm" onKeyDown="javascript:fnTrapKD()">
                                          </td>
                                                                                             <td width="5%" nowrap="nowrap"><div align="right"> Full Name </div> </td>
                                                                                             <td width="59%" nowrap="nowrap">:
                                                                                             <input class="masterTooltip" type="text" size="50" name="full_name"  value="<%= nightShiftMonthly.getEmpName() != null ? nightShiftMonthly.getEmpName() : fullName%>" title="You can Input Full Name more than one, ex-sample : saya,kamu" class="elemenForm" onKeyDown="javascript:fnTrapKD()">
                                                                                             </td>
                                                                                            </tr>
                                                                                            <!-- update by devin 2014-01-29 -->
                                                                                            <tr>
            ...
            prevDivision = dept.getDivision();             
              ...
              <td width="59%" nowrap="nowrap">:
                ...
                <%=ControlCombo.draw("section", null, "" + oidSection, sec_value, sec_key,"onChange=\"javascript:cmdUpdateSec()\"")%></td>
                                        ...
                                        <tr> 
                                         <td width="5%" align="left" nowrap valign="top"><div align="right">Period</div></td>
              <td width="59%" nowrap="nowrap">: <%//=ControlDate.drawDateMY("month_year",date==null || iCommand == Command.NONE?new Date():date,"MMM yyyy","formElemen",0,installInterval)%>
										  		<%
										...
										<tr>
											<td>
                                              ...
                                              <tr>
                                                ...
                                                <td width="11%"><a href="javascript:reportPdf()"><img src="../../images/BtnNew.jpg" width="24" height="24" border="0" alt="Print Monthly Night Shift"></a></td>
												  
                                                <td width="89%"><b><a href="javascript:reportPdf()" class="buttonlink">Print 
                                                  Monthly Night Shift</a></b> </td>
												</tr>
											  </table>
											 </td>
										</tr>
