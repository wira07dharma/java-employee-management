...
<%@page import="com.dimata.harisma.session.attendance.NightShiftYearly"%>
<%@page import="com.dimata.harisma.session.attendance.NightShiftMonthlyRekap"%>
...
<%
   ...
   // int year = session.getValue("year");
    ...
    if(session.getValue("listresult")!=null){
        hNightShiftYearly = (Hashtable)session.getValue("listresult"); 
    }    
%>
