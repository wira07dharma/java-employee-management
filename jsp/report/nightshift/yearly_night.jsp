...
<!-- JSP Block -->
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_NIGHT_SHIFT_REPORT, AppObjInfo.OBJ_NIGHT_SHIFT_MONTHLY_REPORT);%>
...
%>
<%!    public String drawList(Hashtable hNightShiftYearly) {
        ...
        numHash = hNightShiftYearly.keys();
        while (numHash.hasMoreElements()) {
            ...
            NightShiftYearly lateYear = (NightShiftYearly) hNightShiftYearly.get(str);

            rowx.add("" + jml++);
            rowx.add(lateYear.getEmpNum());
            rowx.add(lateYear.getEmpName());
            for (int m = 0; m < lateYear.getTotalMonthly().size(); m++) {
                NightShiftMonthlyRekap monthlyLate = (NightShiftMonthlyRekap) lateYear.getTotalMonthly().get(m);
...
//update by devin 2014-01-29
    ...
    NightShiftYearly nightShiftYearly = new NightShiftYearly("", "");
    SessNightShift sessNightShift = new SessNightShift();

    Vector<NightShiftMonthlyRekap> totalNightShiftMonthlyRekap = new Vector();
//Vector listTotalLateness = new Vector();

    Hashtable<String, NightShiftYearly> hNightShiftYearly = new Hashtable();
    ...
    if (iCommand == Command.LIST) {
        ...
        for (int d = 0; d < listPeriod.size(); d++) {
            ...
            listNightShiftPresence = sessNightShift.listNightShiftDataMonthly(oidDepartment, oidCompany, oidDivision, date, oidSection, empNum.trim(), fullName.trim());
            totalNightShiftMonthlyRekap = sessNightShift.getListMonth(listNightShiftPresence, dateOfMonth, dEndDateOfMonth);

            for (int j = 0; j < totalNightShiftMonthlyRekap.size(); j++) {
                NightShiftMonthlyRekap nightShiftMonthlyRekap = totalNightShiftMonthlyRekap.get(j);
                NightShiftYearly nightShiftYear = hNightShiftYearly.get(nightShiftMonthlyRekap.getEmpNum());
                if (nightShiftYear == null) {
                    NightShiftYearly empNightShiftYear = new NightShiftYearly(nightShiftMonthlyRekap.getEmpNum(), nightShiftMonthlyRekap.getEmpName());
                    empNightShiftYear.setMonthlyRekap(nightShiftMonthlyRekap);
                    hNightShiftYearly.put(empNightShiftYear.getEmpNum(), empNightShiftYear);
                } else {
                    nightShiftYear.setMonthlyRekap(nightShiftMonthlyRekap);
                }
            }
        }

        session.putValue("listresult", hNightShiftYearly);
    }
    ...
    <head>
        ...
        <script language="JavaScript">
            function cmdView(){
                ...
                document.frpresence.action="yearly_night.jsp";
            ...
            function reportPdf(){	 
                var linkPage = "<%=printroot%>.report.attendance.MonthlyNightShiftPdf";  
            ...
            function cmdExportExcel(){
                ...
                var linkPage = "<%=approot%>/report/nightshift/export_excel/export_excel_yearly_night.jsp";    
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr> 
                                        <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Attendance 
                                                &gt; Yearly Night Shift<!-- #EndEditable --> </strong></font> 
                                        </td>
                                    </tr>
                                    <tr> 
                                        <td> 
                                                                            ...
                                                                            <td valign="top"> <!-- #BeginEditable "content" -->
                                                                                <form name="frpresence" method="post" action="">
                                                                                    ...
                                                                                    <table width="60%" border="0" cellspacing="2" cellpadding="2">
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="30%" nowrap="nowrap">:
                                                                                                <input class="masterTooltip" type="text" size="40" name="emp_number"  value="<%= nightShiftYearly.getEmpNum() != null ? nightShiftYearly.getEmpNum() : empNum%>" title="You can Input Payroll Number more than one, ex-sample : 1111,2222" class="elemenForm" onKeyDown="javascript:fnTrapKD()">
                                                                                            </td>
                                                                                            <td width="5%" nowrap="nowrap"><div align="right"> Full Name </div> </td>
                                                                                            <td width="59%" nowrap="nowrap">:
                                                                                                <input class="masterTooltip" type="text" size="50" name="full_name"  value="<%= nightShiftYearly.getEmpName() != null ? nightShiftYearly.getEmpName() : fullName%>" title="You can Input Full Name more than one, ex-sample : saya,kamu" class="elemenForm" onKeyDown="javascript:fnTrapKD()">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <!-- update by devin 2014-01-29 -->
                                                                                        <tr>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                                        <% if(hNightShiftYearly != null && hNightShiftYearly.size() > 0) {%>
                                                                                        <tr>
                                                                                            <td><hr></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <%=drawList(hNightShiftYearly)%>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%if (privPrint) {%>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <table width="27%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="11%"><a href="javascript:cmdExportExcel()"><img src="../../images/BtnNew.jpg" width="24" height="24" border="0" alt="Print Yearly Night Shift"></a></td>

                                                                                                        <td width="89%"><b><a href="javascript:cmdExportExcel()" class="buttonlink">Print 
                                                                                                                    Yearly Night Shift</a></b> </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="msginfo">&nbsp;&nbsp;No night shift data found ...</div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%}%>
                                                                                    </table>
