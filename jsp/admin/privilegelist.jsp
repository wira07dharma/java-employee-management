...
<body <%=noBack%> bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('<%=approot%>/images/BtnNewOn.jpg','<%=approot%>/images/BtnEditOn.jpg')">
                        ...
                        <table style="border:1px solid <%=garisContent%>" width="100%" border="0" cellspacing="1" cellpadding="1" class="tabbg">
                            <tr><td>
                                                ...
                                                <td height="21" valign="middle" colspan="4"> 
                                                      <div align="left"><b><font color="#000000">Search For Privilege Name</font></b></div>
                                                </td>
                                                <form name="search" method="get" action="">
                                                <tr align="left" valign="top">
                                                    <td height="21" valign="top" width="10%">
                                                      <div align="left">Privilege Name&nbsp;</div>
                                                    </td>
                                                    <td height="21" colspan="3">
                                                    <input onFocus="this.select()" name="privilegeNameSearch"  type="text" id="privilege" size="25" maxlength="25">
