...
//String whereClause = "";
//String orderClause = PstAppUser.fieldNames[PstAppUser.FLD_LOGIN_ID];
                      ...
                      <td valign="top"> 
                        <table style="border:1px solid <%=garisContent%>" width="100%" border="0" cellspacing="1" cellpadding="1" class="tablecolor">
                            <tr>
                                            <td>
                                                ...
                                                <tr align="left" valign="top">
                                                    ...
                                                    <td height="21" colspan="3">
                                                        <input onFocus="this.select()" name="login"  type="text" id="login" size="25" maxlength="25" value="<%=login==null ||login.length()==0?"":login%>">
                                                    </td>
                                                </tr>
                                                <tr align="left" valign="top">
                                                    <td height="21" valign="top" width="7%">
                                                    ...
                                                    <td height="21" colspan="3">
                                                        <input onFocus="this.select()" name="fullname"  type="text" id="fullname" size="25" maxlength="25" value="<%=fullname==null ||fullname.length()==0?"":fullname%>">
                                                    </td>
                                                </tr>
                                                <tr align="left" valign="top">
                                                    <td height="21" valign="top" width="7%">
                                            ...
                                            %>
                                            <%=cmbox.draw("status_login" ,"formElemen",
                                            null, Integer.toString(iStsLogin), stsVals, sts)%> 
