...
long oid = FRMQueryString.requestLong(request,"hidden_payslip");
	...
	try{
		//update by satrya 2013-01-06
            ...
            if(oid!=0){
                ...
                if(paySlip!=null && paySlip.getEmployeeId()!=0){
                    objEmployee = PstEmployee.fetchExc(paySlip.getEmployeeId());
                }
            }
		...
		if(iCommand==Command.SAVE){
                    //update by satrya 2013-01-06
                       ...
                       //oid = PstAlStockManagement.updateExc(objAlStockManagement);
                        ...
                        PstPaySlip.updateNote(note,paySlip.getOID()); 
...
function cmdSave(oid){
	...
	document.frmnote.action="note_edit_admin.jsp?hidden_payslip="+oid;
...
<input type="hidden" name="hidden_leave_stock_id" value="<%=oid%>">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td colspan="3"><b>PAY INPUT NOTE</b></td>
    </tr>
    <tr> 
      <td width="21%">&nbsp;</td>
      <td width="2%">&nbsp;</td>
	...
	String notereal = "";
       ...
       // notereal = objAlStockManagement.getStNote() == null ? "" : objAlStockManagement.getStNote();
        notereal = paySlip.getNoteAdmin() == null ? "" : paySlip.getNoteAdmin();
	%>
