...
<!-- JSP Block -->
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_PAYROLL, AppObjInfo.G2_PAYROLL_OVERTIME, AppObjInfo.OBJ_PAYROLL_OVERTIME_INPUT);%>
...
public Vector drawList(Vector objectClass,long oidPeriod,int dayMonth,int startDatePeriod,int dateOfMonth,long departmentId, long sectionId)
	{
		...
		for (int i = 0; i <=objectClass.size(); i++) {
			 ...
			 //ambil salary
			 double sumSalary = Double.parseDouble(String.valueOf(PstSystemProperty.getValueByName("OVERTIME_VALUE")));
