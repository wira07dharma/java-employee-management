...
<html>
    ...
    <head>
        ...
        <SCRIPT language=JavaScript>
            ...
            function cmdViewHtml() {
                document.frm_printing.target = "";
                document.frm_printing.toEmail.value = "0";
                document.frm_printing.command.value = "<%=Command.PRINT%>";
                document.frm_printing.aksiCommand.value = "0";
                document.frm_printing.action = "pay_slip_view.jsp";
                document.frm_printing.target = "";
                document.frm_printing.submit();
            }
            ...
            function cmdPrintText() {
                ...
                document.frm_printing.command.value = "<%=Command.PRINT%>";
                document.frm_printing.aksiCommand.value = "1";
                document.frm_printing.action = "<%=approot%>/PayPrintTextA4";
                document.frm_printing.target = "";
                document.frm_printing.submit();
            }
                                                                                        ...
                                                                                        <tr> <td colspan="5">
                                                                                                <table>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="View HTML">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdViewHtml()" class="command">View HTML</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
