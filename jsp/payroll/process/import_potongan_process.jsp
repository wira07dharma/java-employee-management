<%-- 
    Document   : import_potongan_process
    Created on : Mar 6, 2017, 11:26:29 AM
    Author     : mchen
--%>

<%@page import="com.dimata.harisma.session.payroll.ImportPotonganProcess"%>
...
<script type="text/javascript">
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title"><a class="btn-small" style="color:#FFF;" href="javascript:cmdBack()">Back</a> Import Potongan Process</span>
        </div>
        <div class="content-main">
            <form name="frm" method="post" action="">
            <%
                ImportPotonganProcess importProcess = new ImportPotonganProcess();
                JspWriter output = pageContext.getOut();
                importProcess.drawImportResult(config, request, response, output, empDivisionId, sdmDivisionOid);
            %>
            </form>
        </div>
