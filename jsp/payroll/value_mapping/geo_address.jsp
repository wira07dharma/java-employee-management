        ...
        <script language="JavaScript">
            ...
            function selectGeo(geoAddress){
                ...
                <% if(addresstype==1) { %>
                    ...
                    self.opener.document.<%=formName%>.<%=FrmValue_Mapping.fieldNames[FrmValue_Mapping.FRM_FIELD_ADDR_COUNTRY_ID]%>.value = oidNegara;
                    self.opener.document.<%=formName%>.<%=FrmValue_Mapping.fieldNames[FrmValue_Mapping.FRM_FIELD_ADDR_PROVINCE_ID]%>.value = oidProvinsi;
                    self.opener.document.<%=formName%>.<%=FrmValue_Mapping.fieldNames[FrmValue_Mapping.FRM_FIELD_ADDR_REGENCY_ID]%>.value = oidKabupaten;
                    self.opener.document.<%=formName%>.<%=FrmValue_Mapping.fieldNames[FrmValue_Mapping.FRM_FIELD_ADDR_SUBREGENCY_ID]%>.value = oidKecamatan;                    
