...
%>
<%!
	public String drawList(int iCommand,FrmPayBanks frmObject, PayBanks objEntity, Vector objectClass,  long bankId)
	{
      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="2">
        <tr> 
          <td width="100%"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Setup > Bank List <!-- #EndEditable --> </strong></font> </td>
              </tr>
              <tr> 
                <td> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <table style="border:1px solid <%=garisContent%>" width="100%" border="0" cellspacing="1" cellpadding="1" class="tabbg">
                                <tr> 
                                  <td valign="top"> <!-- #BeginEditable "content" -->                                      
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listgensell">
                                        <%
										 try{                                              
                                                %>
									  <tr align="left" valign="top"> 
										<td height="22" valign="middle" colspan="5" > <%= drawList(iCommand, frmPayBanks, payBanks,listPayBanks,oidBank)%> </td>
									  </tr>
										  <% 
											  }catch(Exception exc){ 
											  }%>  
									  ...
									  <%//if((iCommand == Command.NONE || iCommand == Command.DELETE || iCommand ==Command.BACK || iCommand ==Command.SAVE)&& (frmDepartment.errorSize()<1)){
                                               if((iCommand != Command.ADD && iCommand != Command.ASK && iCommand != Command.EDIT)&& (frmPayBanks.errorSize()<1)){
												if(privAdd){%>
                                          <td width="14%"><img src="<%=approot%>/images/spacer.gif" width="1" height="1"><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image261','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Add new data"></a><a href="javascript:cmdAdd()" class="command"> 
                                            Add New Bank</a> </td>
                                          <td width="13%">&nbsp;</td>
                                          <td width="44%"><img src="<%=approot%>/images/spacer.gif" width="1" height="1"></td>
                                          <td width="13%">&nbsp;</td>
                                          <td width="16%">&nbsp;</td>
										  <%}
											  }%>
									  ...
									  <tr>
									  	<%if((iCommand ==Command.ADD)||(iCommand==Command.SAVE)&&(frmPayBanks.errorSize()>0)||(iCommand==Command.EDIT)||(iCommand==Command.ASK)){%> 
										<td width="14%"><a href="javascript:cmdSave()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image261','','<%=approot%>/images/BtnSave.jpg',1)"><img name="Image261" border="0" src="<%=approot%>/images/BtnSave.jpg" width="24" height="24" alt="Save Data"></a>
                                          <a href="javascript:cmdSave()" class="command">Save Bank</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										</td>
										<td width="13%"><img name="Image261" border="0" src="<%=approot%>/images/BtnDel.jpg" width="24" height="24" alt="Delete">
										 <a href="javascript:cmdConfirmDelete()" class="command">Delete Bank</a>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
										</td>
										<td width="44%"> <a href="javascript:cmdBack()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image261','','<%=approot%>/images/BtnBack.jpg',1)"><img name="Image261" border="0" src="<%=approot%>/images/BtnBack.jpg" width="24" height="24" alt="Back to List"></a>
