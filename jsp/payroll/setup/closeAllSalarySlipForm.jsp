...
Date dateChange = FRMQueryString.requestDate(request, "dateChange");
...
{
     listEmployee = PstPayEmpLevel.listUpdateEmpLevel(empNum, nama, companyId, divisionId, departmentId, sectionId, positionId, payGroup, dateChange);    
}
...
function cmdAdd(){
	...
	document.frmsrcpresence.action="closeAllSalarySlipForm.jsp";
                                                      ...
                                                      <td height="21" width="88%"> 
                                                        <table width="100%" border="0">
                                                          <tr> 
                                                            ...
                                                            %>
                                                            <td width="95%"><%=ControlDate.drawDate("dateChange", selectedDateChange, 0, installInterval) %></td>
                                                          </tr>
