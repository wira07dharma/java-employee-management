...
flyout.addMenuFlyOut("employee.jsp", "Employee", dictionaryD.getWord("NEW_EMPLOYEE"), false, null, "new_employee", ""+approot+"/employee/databank/new_employee_list.jsp", "",userSession.checkPrivilege(AppObjInfo.composeCode(
             ...
             AppObjInfo.COMMAND_VIEW)));
flyout.addMenuFlyOut("employee.jsp", "Employee", dictionaryD.getWord("ABSENCE_MANAGEMENT"), false, null, "absence_management", ""+approot+"/employee/absence/srcabsence.jsp", "",userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("employee.jsp", "Employee", dictionaryD.getWord("ATTENDANCE"), true, dictionaryD.getWord("MANUAL_REGISTRATION"), "attendance", "#", ""+approot+"/employee/presence/srcpresence.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
...
if(namaUser1.equals("Employee")){
    ...
    flyout.addMenuFlyOut("employee.jsp", "Employee", dictionaryD.getWord("LEAVE_APPLICATION"), true, "DP Re-Calculate", "leave_application", "#", ""+approot+"/employee/leave/if_dp_not_balance1.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("reports.jsp", "Reports", "Payroll", true, "Leave Entitle Report", "payroll", "#", ""+approot+"/report/payroll/leave_entitle_report.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_PAYROLL_REPORT, AppObjInfo.OBJ_MENU_LIST_SALARY_SUMMARY_REPORT), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("master_data.jsp", "Master Data", "Geo Area", true, dictionaryD.getWord("SUB REGENCY"), "geo_area", "#", ""+approot+"/masterdata/kecamatan.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("master_data.jsp", "Master Data", dictionaryD.getWord(I_Dictionary.PAYROLL) + " " +dictionaryD.getWord(I_Dictionary.GROUP) , true, dictionaryD.getWord(I_Dictionary.PAYROLL) + " " +dictionaryD.getWord(I_Dictionary.GROUP), dictionaryD.getWord(I_Dictionary.PAYROLL) + " " +dictionaryD.getWord(I_Dictionary.GROUP), "#", ""+approot+"/masterdata/PayrollGroup.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_MASTERDATA, AppObjInfo.G2_MENU_MD_COMPANY, AppObjInfo.OBJ_MENU_DEPARTMENT), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("system.jsp", "System", "System Management", true, "System Log", "system_management", "#", ""+approot+"/log/system_log.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
