  ...
  <tr> 
    <td  bgcolor="#9BC1FF" height="10" valign="middle"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
			<td align="left"><img src="<%=approot%>/images/harismaMenuLeft1.jpg" width="100%" height="8"></td>
          <td align="center"><img src="<%=approot%>/images/harismaMenuLine1.jpg" width="100%" height="8" style="background-repeat:repeat-x"></td>
			<td align="right"><img src="<%=approot%>/images/harismaMenuRight1.jpg" width="100%" height="8"></td>
		  </tr>
		</table>
	</td> 
  </tr>
                                                ...
                                                <tr> 
                                                    <td > 
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" >
                                                            <tr> 
                                                                <td valign="top"> 
                                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2"  bgcolor="<%=bgColorContent%>">
                                                                        <tr>
                                                                           <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->
                                                                                Modif Template &gt;  Custom Template  <!-- #EndEditable --> </strong></font> </td>
                                                                        </tr>
                                                                        <tr> 
                                                                            <td valign="top"  style="background-color:<%=bgColorContent%>; ">
                                                                                <!-- #BeginEditable "content" -->
                                                                                <table style="border:1px solid <%=garisContent%>" width="100%">
                        <tr>
                            <td bgcolor="#0066FF">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table width="100%">
                                                    ...
                                                    <!--<tr>
                                                        <td width="3%" nowrap><input id='nav3' type="radio" name="<%//=FrmTempDinamis.fieldNames[FrmTempDinamis.FRM_FLD_TEMP_NAVIGATION]%>" value="menu_iii" <%//=chekedMenu3%>/></td>
                                                        <td width="47%" nowrap><img src="../imgstyle/menu_3.png" width="100%"></td>
                                                        <td width="3%"><input id='nav5' type="radio" name="<%//=FrmTempDinamis.fieldNames[FrmTempDinamis.FRM_FLD_TEMP_NAVIGATION]%>" value="menu_v" <%//=chekedMenu4%>/></td> 
                                                        <td width="47%"><img src="../imgstyle/menu_5.png" width="100%"></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="3%" nowrap><input id='nav6' type="radio" name="<%//=FrmTempDinamis.fieldNames[FrmTempDinamis.FRM_FLD_TEMP_NAVIGATION]%>" value="menu_vi" <%//=chekedMenu5%>/></td>
                                                        <td width="47%" nowrap><img src="../imgstyle/menu__6.PNG" width="100%"></td>
                                                        <td width="3%"><input id='nav7' type="radio" name="<%//=FrmTempDinamis.fieldNames[FrmTempDinamis.FRM_FLD_TEMP_NAVIGATION]%>" value="menu_vii" <%//=chekedMenu6%>/></td> 
                                                        <td width="47%"><img src="../imgstyle/menu_7.PNG" width="100%"></td>
                                                    </tr>-->
                                                </table>
                                            </td>
                                        </tr>
