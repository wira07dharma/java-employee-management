...
<% int  appObjCode = 1;//AppObjInfo.composeObjCode(AppObjInfo.G1_MASTER_D, AppObjInfo.G2_MASTER_D_CANTEEN, AppObjInfo.OBJ_MASTER_D_DAILY_CHECKLIST); %>
...
<script language="javascript">
    function cmdEdit(oid, number, fullname, department, position, commencing_date) {
        ...
        self.opener.document.frm_commentcardheader.<%=FrmCommentCardHeader.fieldNames[FrmCommentCardHeader.FRM_FIELD_EMPLOYEE_ID]%>.value = oid;
        //self.opener.document.frm_commentcardheader.EMP_NUMBER.value = number;
        self.opener.document.frm_commentcardheader.EMPFULLNAME.value = fullname;
        self.opener.document.frm_commentcardheader.EMPDEPARTMENT.value = department;
        self.opener.document.frm_commentcardheader.EMPPOSITION.value = position;
        //self.opener.document.frm_commentcardheader.EMP_COMMENCING_DATE.value = commencing_date;
        self.close();
    }
</script>
