...
iErrCode = ctrlKPI_Type.action(iCommand , oidKPI_Type);
/* end switch*/
		    				  ...
		    				  <!-- #BeginEditable "content" --> 
							    ...
							    %>
								 ...
								 %>
									...
									ctrLine.setBackCaption("Back to List KPI_Type");
									ctrLine.setCommandStyle("buttonlink");
									ctrLine.setAddCaption("Add KPI_Type");
									ctrLine.setSaveCaption("Save KPI_Type");
									ctrLine.setDeleteCaption("Delete KPI_Type");
									ctrLine.setConfirmDelCaption("Yes Delete KPI_Type");
