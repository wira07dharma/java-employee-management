...
<!-- Jsp Block -->
<%!    
    public String drawList(Vector objectClass, long positionId, I_Atendance attdConfig, int statPos) {
        ...
        for(int i=0;i<PstPosition.strPositionLevelNamesWithRank.length;i++){
            
            name.add(""+PstPosition.strPositionLevelNamesWithRank[i]);
            //sche_key.add(""+PstPosition.strPositionLevelNamesWithRank[i]);
            
            if(PstPosition.strPositionLevelNames[statPos] == PstPosition.strPositionLevelNamesWithRank[i]){
                //sche_key.clear();
                name.clear();
            }
        }
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            String posLevlName = PstPosition.strPositionLevelNames[position.getPositionLevel()];
            ...
            for(int j=0;j<name.size();j++){
                ...
                //String nameType = sche_key[j];
                if(posLevlName.equals(name.get( j ))){
                    lstData.add(rowx);
...
function cmdChoose(posId) {
    self.opener.document.frmjobdesc.checker_pos_id.value = posId;
...
function cmdSearchPosition(){
    ...
    document.frmposition.action="srcchecker.jsp";
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr align="left" valign="top"> 
                                                <td height="22" valign="middle" colspan="3"> 
                                                  <%= drawList(listPosition,oidPosition,attdConfig,statPos)%> 
                                                </td>
                                              </tr>
                                              <%  
											  }
