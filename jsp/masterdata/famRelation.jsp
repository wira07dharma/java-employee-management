...
<%!    public String drawList(Vector objectClass, long famRelationId, I_Dictionary dictionaryD) {
        ...
        ctrlist.addHeader(dictionaryD.getWord("FAMILY")+" "+dictionaryD.getWord("RELATIONSHIP"), "10%");
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add(PstFamRelation.levelNames[famRelation.getFamRelationType()]);
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->
                                                    Master Data &gt; <%=dictionaryD.getWord(I_Dictionary.EMPLOYEE)%> &gt; <%=dictionaryD.getWord("FAMILY")%> <%=dictionaryD.getWord("RELATIONSHIP")%><!-- #EndEditable -->
                                                </strong></font> </td>
                                    </tr>
                                    <tr>
                                        <td>
                                                                                                ...
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                                                    <tr>
                                                                                                        <td colspan="3" class="listtitle"><%=oidFamRelation == 0 ? "Add" : "Edit"%>
                                                                                                            <%=dictionaryD.getWord("FAMILY")%> <%=dictionaryD.getWord("RELATIONSHIP")%></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr align="left" valign="top">
                                                                                                        ...
                                                                                                        <td height="21" valign="top" width="7%"><%=dictionaryD.getWord("FAMILY")%> <%=dictionaryD.getWord("RELATIONSHIP")%></td>
                                                                                                    ...
                                                                                                    <tr align="left" valign="top">
                                                                                                        <td height="21" valign="top" width="1%">&nbsp;</td>
                                                                                                        <td height="21" valign="top" width="7%"><%=dictionaryD.getWord("FAMILY")%> <%=dictionaryD.getWord("TYPE")%></td>
                                                                                                        <td height="21" colspan="2" width="92%">
                                                                                                            <%
                                                                                                                if (iCommand == Command.ADD) {
                                                                                                                    out.println(ControlCombo.draw(FrmFamRelation.fieldNames[FrmFamRelation.FRM_FIELD_FAMILY_RELATION_TYPE], "formElemen", null, "" + defaultFamRelationType, PstFamRelation.getLevelValues(), PstFamRelation.getLevelKeys()));
                                                                                                                } else {
                                                                                                                    out.println(ControlCombo.draw(FrmFamRelation.fieldNames[FrmFamRelation.FRM_FIELD_FAMILY_RELATION_TYPE], "formElemen", null, "" + (famRelation.getFamRelationType()), PstFamRelation.getLevelValues(), PstFamRelation.getLevelKeys()));
                                                                                                                }
                                                                                                            %>
                                                                                                        </td>
                                                                                                    </tr>
