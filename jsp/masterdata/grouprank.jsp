...
<%!
	...
	public String drawList(int iCommand,FrmGroupRank frmObject, GroupRank objEntity, Vector objectClass,  long groupRankId)
...
function cmdAdd(){
	...
	document.frmgrouprank.action="grouprank.jsp";
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">                                              
                                              ...
                                              <tr align="left" valign="top"> 
                                                <td height="22" valign="middle" colspan="3"> 
                                                  <%= drawList(iCommand,frmGroupRank, groupRank,listGroupRank,oidGroupRank)%></td>
                                              </tr>
                                              <% 
											  }catch(Exception exc){ 
											  }%>
