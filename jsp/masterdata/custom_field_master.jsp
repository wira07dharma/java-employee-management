...
<%!
   ...
   public String drawList(Vector objectClass) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add("<a class=\"btn-del\" href=\"javascript:cmdMinta('"+custom.getOID()+"')\">&times;</a>");
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cmdMinta(oid){
                ...
                document.getElementById("oid_custom_field").value=oid;
            }
            
            function cmdHapus(){
                
                document.<%=FrmCustomFieldMaster.FRM_NAME_CUSTOM_FIELD_MASTER%>.command.value="<%=Command.DELETE%>";
                document.<%=FrmCustomFieldMaster.FRM_NAME_CUSTOM_FIELD_MASTER%>.prev_command.value="<%=prevCommand%>";
                getCmd();
            }
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        ...
                                                        <form name="<%=FrmCustomFieldMaster.FRM_NAME_CUSTOM_FIELD_MASTER%>" method="POST" action="">
                                                            ...
                                                            <input type="hidden" id="oid_custom_field" name="oid_custom_field" value="<%=oidCustomField%>" />
                                                            ...
                                                            <table style="color:#474747; background-color: #E3E3E3; padding:12px" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <button id="btn1" onclick="cmdAsk('<%=oidCustomField%>')">Delete</button>
                                                                    </td>
                                                                </tr>
                                                            </table>
