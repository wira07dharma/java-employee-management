                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td>
                                                          ...
                                                          for (int i = 0; i < TaxCalculator.STATUS_EMPLOYEE.length; i++) {
                                                              ...
                                                              status_emp_idx.add(TaxCalculator.STATUS_EMPLOYEE[i]);
                                                          }
                                                                
                                                        %> 
                                                        <%= ControlCombo.draw(frmMarital.fieldNames[FrmMarital.FRM_FIELD_MARITAL_STATUS_TAX], "formElemen", null, "" + marital.getMaritalStatusTax(), status_emp_str, status_emp_idx) %>
                                                      </td>
                                                    </tr>
                                                    <tr align="left" valign="top"> 
                                                      <td valign="top" width="26%"> 
