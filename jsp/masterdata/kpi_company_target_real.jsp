                            ...
                            if (divId >0 && divId == division.getOID()){
                                    ...
                                    // rowx.add("Achievement"); 
                                        ...
                                        if (depId > 0 && depId == department.getOID()){     
                                            ...
                                            HlistKPI_EmployeeDepart_Target= PstKPI_Employee_Target.Hlist(0, 0, " DEPARTMENT_ID = "+department.getOID()+" AND SECTION_ID = "+0, "");
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">                                              
                                              ...
                                              <tr align="left" valign="top"> 
                                                  ...
                                                  <%if(iCommand == Command.EDIT){%>
                                                   ...
                                                   <% } else  if ((divId> 0) && (depId> 0) &&  (iCommand == Command.EDIT) && VSection.size() > 0 ) {%>
