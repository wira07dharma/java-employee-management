...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			 ...
			 if(index == i && (iCommand == Command.EDIT || iCommand == Command.ASK)){
				...
				rowx.add("<a  href=\"javascript:cmdEditDetail2('"+String.valueOf(empDoc.getOID())+"')\">Edit detail</a><input type=\"hidden\" name=\""+frmObject.fieldNames[FrmEmpDoc.FRM_FIELD_DETAILS] +"\" value=\""+empDoc.getDetails()+"\" class=\"elemenForm\"> * ");
				...
				rowx.add("<a  href=\"javascript:cmdEditDetail2('"+String.valueOf(empDoc.getOID())+"')\">Edit detail</a>");
				rowx.add(""+ geo);
                               // rowx.add(" - ");
			} 
		...
		if(iCommand == Command.ADD || (iCommand == Command.SAVE && frmObject.errorSize() > 0)){ 
				...
				rowx.add(ControlDate.drawDateWithStyle(frmObject.fieldNames[FrmEmpDoc.FRM_FIELD_REQUEST_DATE], (objEntity.getRequest_date() == null ? new Date() : objEntity.getRequest_date() ), 0, -40, "formElemen") +"*"+ frmObject.getErrorMsg(frmObject.FRM_FIELD_REQUEST_DATE));
...
sEmpDoc.setDocNumber(docNumber);
                    ...
                    <tr> 
				      ...
				      <input type="hidden" name="EmpDocument_oid" value="<%=oidEmpDoc%>">
                                      ...
                                      <tr> 
                                          ...
                                          <td  nowrap="nowrap">Doc Master    : </td><td>   
                                            <%
                                        ...
                                        <td  nowrap="nowrap">Doc Number    :  </td><td>   
                                          ...
                                          <td height="8"  colspan="3"> 
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">                                              
                                              ...
                                              <tr align="left" valign="top"> 
                                                ...
                                                <%// if (((iCommand == Command.LIST) || (iCommand == Command.EDIT) || (iCommand == Command.ADD)) && listEmpDoc.size()>0){%>
                                                <% if (((iCommand == Command.LIST) || (iCommand == Command.EDIT) || (iCommand == Command.ADD))){%>
