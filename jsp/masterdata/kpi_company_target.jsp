...
%>
<!-- Jsp Block -->
<%!    public String drawList(int iCommand, Vector objectClass, long kpi_company_targetId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId,long companyId) {
...
<title>KPI Company Target</title>
