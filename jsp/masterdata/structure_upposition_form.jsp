...
<html>
    ...
    <body>
        <h1 style="border-bottom: 1px solid #0599ab; padding-bottom: 12px;">Up Position</h1>
        ...
        if (listPosition != null && listPosition.size()>0){
            for(int i=0; i<listPosition.size(); i++){
                ...
                %>
                <div class="item" onclick="javascript:cmdGetItem('<%=position.getOID()%>', '<%=position.getPosition()%>')"><%=position.getPosition()%></div>
                <%
            }
        }
        %>
