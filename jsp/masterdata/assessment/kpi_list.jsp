...
<%!    public String drawList(Vector objectClass, long kpi_listId) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            lstData.add(rowx);
            lstLinkData.add("'"+kpi_list.getOID()+"','"+kpi_list.getKpi_title() +"'" );
        }
...
<html><!-- #BeginTemplate "/Templates/main.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            function cmdSelect(oidKPI, KPITitle){
                self.opener.document.forms.frmAssessmentFormItem.<%=FrmAssessmentFormItem.fieldNames[FrmAssessmentFormItem.FRM_FIELD_KPI_LIST_ID]%>.value=oidKPI;
                self.opener.document.forms.frmAssessmentFormItem.<%=FrmAssessmentFormItem.fieldNames[FrmAssessmentFormItem.FRM_FIELD_KPI_LIST_ID]%>text.value=KPITitle;                
                self.close();
            }
                                                                                                        ...
                                                                                                        <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="83%">
                                                                                                                        <%
                                                                                                                                    ...
                                                                                                                                    %>
                                                                                                                       <%= ControlCombo.draw(FrmKPI_List.fieldNames[FrmKPI_List.FRM_FIELD_COMPANY_ID], "formElemen", null, "" + (kpi_list.getCompany_id()), comp_value2, comp_key2,"")%> 
