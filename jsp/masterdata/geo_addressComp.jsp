<%@page import="com.dimata.harisma.entity.masterdata.PstNegara"%>
<%@page import="com.dimata.harisma.entity.masterdata.PstProvinsi"%>
<%@page import="com.dimata.harisma.entity.masterdata.Kabupaten"%>
<%@page import="com.dimata.harisma.entity.masterdata.PstKecamatan"%>
<%@page import="com.dimata.harisma.entity.masterdata.PstKabupaten"%>
<%@page import="com.dimata.harisma.entity.masterdata.Provinsi"%>
<%@page import="com.dimata.harisma.entity.masterdata.Negara"%>
<%@page import="com.dimata.harisma.form.masterdata.FrmCompetitor"%>
<%@page import="com.dimata.harisma.entity.admin.AppObjInfo"%>
<%@page import="com.dimata.harisma.entity.masterdata.Kecamatan"%>
<%@page import="com.dimata.gui.jsp.ControlLine"%>
<%@page import="com.dimata.qdep.form.FRMMessage"%>
<%@page import="com.dimata.harisma.form.masterdata.CtrlKecamatan"%>
        ...
        <script language="JavaScript">
            ...
            function selectGeo(geoAddress){
                ...
                <% if(addresstype==1) { %>
                    ...
                    self.opener.document.<%=formName%>.<%=FrmCompetitor.fieldNames[FrmCompetitor.FRM_FIELD_COUNTRY_ID]%>.value = oidNegara;
                    self.opener.document.<%=formName%>.<%=FrmCompetitor.fieldNames[FrmCompetitor.FRM_FIELD_PROVINCE_ID]%>.value = oidProvinsi;
                    self.opener.document.<%=formName%>.<%=FrmCompetitor.fieldNames[FrmCompetitor.FRM_FIELD_REGION_ID]%>.value = oidKabupaten;
                    self.opener.document.<%=formName%>.<%=FrmCompetitor.fieldNames[FrmCompetitor.FRM_FIELD_SUBREGION_ID]%>.value = oidKecamatan;                    
            ...
            function cmdUpdateKec(){
                ...
                document.frmgeoaddress.action="geo_addressComp.jsp";
