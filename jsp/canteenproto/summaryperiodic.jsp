            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Reports 
                  >> Summary >> Report Periodic<!-- #EndEditable --> </strong></font> 
                </td>
              </tr>
              <tr>
                <td>
                                     ...
                                     <tr>
                                      <td width="1%"></td>
                                          <td> 
                                            <table width="760">
                                              <tr> 
                                                <td width="101"><%=dictionaryD.getWord(I_Dictionary.DEPARTMENT) %></td>
                                                <td width="19">:</td>
                                                <td width="624"> 
                                              ...
                                              <tr> 
                                                ...
                                                <td width="624"> 
                                                  ...
                                                  to 
                                                  <select name="select" class="formElemen" >
                                                    <option value="1">Jan</option>
                                                    <option value="2">Feb</option>
                                                    <option value="3">Mar</option>
                                                    <option value="4">Apr</option>
                                              ...
                                              <tr>
                                                <td valign="top" width="101">Nominal</td>
                                                <td valign="top" width="19">:</td>
                                                <td width="624">
                                                  <input type="text" name="textfield" value="6000" size="10">
                                                </td>
                                              </tr>
                                              <tr> 
                                                <td valign="top" width="101">Report 
                                                  Type </td>
                                                <td valign="top" width="19">:</td>
                                                <td width="624"> 
                                                  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
