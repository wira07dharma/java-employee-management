...
<%
    ...
    String prepared = "HRD Staff";
    String approved = "HRD Manager";
    ...
    if (iCommand == Command.LIST) {
        ...
        dataOfVisits = sessCanteenVisitation.getPeriodicPaymentMealReport(date, dateto, oidDepartment , oidSection, scheduleId, rpType);
        ...
        <tr>
          <td>
            ...
            During outside opening schedule </td>
                                          ...
                                          <tr>
                                            <td><input name="MORNING_AFTERNOON_NIGHT_ID" type="radio" value="2" <%if(rpType==2){%>checked<%}%>>
            All </td>
                                          </tr>
                                      </table></td>
                                    </tr>
