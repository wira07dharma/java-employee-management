...
<%!
    ...
    public Vector drawList(Date firstDate, Vector dataOfReport)
    {
...
<%
    ...
    if (actualWeek == weekOfMonth && iCommand == Command.LIST) {
        ...
        dataOfVisits = (Vector)sessCanteenVisitation.getDetailVisitationReportWeekly(deptOid,secOid, date,0,weekOfMonth,scheduleId);
