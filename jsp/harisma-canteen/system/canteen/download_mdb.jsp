	...
	try 
	{
		...
		TransferCanteenFromMdbTidex canteenMdbAccess = new TransferCanteenFromMdbTidex();
                ...
                if(machineNumbers.length>0 && !(machineNumbers[0].equals("")) && machineNumbers[0].length()>0){
                    rtDt = canteenMdbAccess.transferDataCanteen(machineNumbers[0]);
                    iTrans= rtDt.numberOfRecords;
                    if (iTrans>0) 
                    {
                            succeed01 = true;
                    }
                }
		tma01Status = "" + iTrans + " transaction(s) downloaded from TMA-"+machineNumbers[0];
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          ...
                                          <td> 
                                            ...
                                            <%=tma01Status%><br>
                                            <%
                                            if(rtDt!=null && rtDt.empNotFound!=null && rtDt.empNotFound.size()>0){
                                                out.println("Download report :<br>");
                                                for(int id=0;id<rtDt.empNotFound.size();id++){
                                                    String str= (String) rtDt.empNotFound.get(id);
                                                    out.println(str+"<br>");
                                                }
                                            }
