...
<title>HARISMA - Reset Canteen Machine</title>
<!-- #EndEditable --> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" bgcolor="#F9FCFF" >
  ...
  <tr> 
    <td width="88%" valign="top" align="left"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
                <td height="20"> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Timekeeping >> Reset Machine<!-- #EndEditable --> </strong></font> 
                </td>
        </tr>
        <tr> 
          <td>
