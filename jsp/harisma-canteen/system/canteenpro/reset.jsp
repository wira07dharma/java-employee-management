...
<title>HARISMA - Reset Timekeeping Machine</title>
<!-- #EndEditable --> 
...
<SCRIPT language=JavaScript>
    ...
    function confirmDelete(number) {
        sMsg = "Do you want to proceed for machine "+number;
        if (!window.confirm(sMsg)) {
            window.event.returnValue = false;
        }
        else {
            document.frmReset.hide_number_machine.value=number;
            document.frmReset.submit();
        }
    }
    function confirmDelete2() {
        sMsg = "Do you want to proceed for all machine ";
        if (!window.confirm(sMsg)) {
            window.event.returnValue = false;
        }
        else {
		    				  ...
		    				  <!-- #BeginEditable "content" -->
                                <% if (privStart) { %>
                                    <form name="frmReset" method="post" action="reset_process.jsp">
                                      <input type="hidden" name="hide_number_machine" id="hide_number_machine"> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td> 
                                        ...
                                        <tr> 
                                          <td> 
                                            <div align="center"> 
                                              ...
                                              <%
                                              out.println("<br><input type=\"button\" name=\"Submit\" value=\"Reset machine\" onclick=\"javascript:confirmDelete2();\">");
/*                                                String machineNumber = "01";
                                            ...
                                            //    int count = 0;
                                                while(strTokenizer.hasMoreTokens()){
                                                    ...
                                                    out.println("<br><input type=\"button\" name=\"Submit\" value=\"Reset machine ["+machineNumbers+"]\" onclick=\"javascript:confirmDelete("+machineNumbers+");\">");
