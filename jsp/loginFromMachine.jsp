...
System.out.println("Exception"+except);
    ...
    int cekOut = Integer.parseInt((request.getParameter("cekOut") == null) ? "0" : request.getParameter("cekOut"));
        ...
        if (machineLogin == 1){
           ...
           // }
            ...
            if (cekOut == 1){
                ...
                machineTransaction.setCardId(employeeMachineLogin.getBarcodeNumber());
...
<html>
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdLogin()	
            {
                document.frmLogin.action = "loginFromMachine.jsp";
                document.frmLogin.submit();
            }

             function cmdSaveAbsen(){
                document.frmLogin.command.value = 0 ;
                document.frmLogin.cekOut.value = 1 ;
                alert("ss");
                document.frmLogin.action = "loginFromMachine.jsp?cekOut=1";
                document.frmLogin.submit();
            }
    ...
    <body bgcolor="#F5F5F5" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/login_images/button_f2.jpg');window.status=''">
        <!-- <%=com.dimata.qdep.db.DBHandler.CONFIG_FILE%> -->
        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" bgcolor="#FFFFFF">
            <tr>
                <td  bgcolor="<%=footerBg%>" height="20" ID="MAINMENU" valign="middle">
            ...
            <tr>
                <td valign="middle" align="left">
                   <!-- <form name="frmLogin" action="" onsubmit="window.status=''"> -->
                        ...
                        <input type="hidden" name="cekOut" value="<%=cekOut%>">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td width="100%">
                                    <div align="center"><img src="<%=approot%>/imgcompany/<%=pictureCompany == null || pictureCompany.getNamaPicture() == null ? "logo.png" : pictureCompany.getNamaPicture()%>"  width="182"></div>
                                </td>
                            </tr>
                            <tr>
                                <td width="100%">&nbsp;</td>
                                ...
                                <td valign="top">
                                    <div class="content">
                                        ...
                                        <div class="formlogin">
                                            ...
                                            <input type="hidden" name="machineLogin" size="35" value="<%=machineLogin %>" />   
                                            <input type="hidden" name="machineLoginEmployeeId" size="35" value="<%=machineLoginEmployeeId %>" />    
                                            <input type="hidden" name="cekOut" size="35" value="<%=cekOut %>" />  
                                        <tr>
                                                    <td valign="center" style="padding-right: 7px; color: #575757"><strong>Login Name</strong></td>
                                                    <td valign="center"><input type="text" name="login_id" size="35" value="<%=loginID %>" /></td>
                                                </tr>
                                                    <tr>
                                                    <td valign="center" style="padding-right: 7px; color: #575757"><strong>Password</strong></td>
                                                    <td valign="center"><input type="password" name="pass_wd" size="35" value="<%=passwd %>" /></td>
                                                    </tr>
                                        <tr>
                                        ...
                                        <tr>
                                                    <td colspan="2" align="right" valign="top"><button class="tombol" onclick="cmdLogin()">Login</button></td>
                                                    <td colspan="2" align="right" valign="top"><button class="tombol" onclick="cmdSaveAbsen()">Cek Out</button></td>
