 ...
 * @author GUSWIK
 */
    public static final String TBL_SYSPROP = "hr_system_property";//"SYSTEM_PROPERTY"; //hr_system_property
    ...
    public static String[] valueTypes = { "STRING", "TEXT","NUMBER","DATE" };    
    public static String[] displayTypes = { "SINGLE TEXT","MULTI TEXT","DROP DOWN","DATE PICKER" };
    
    public static final int ABSENCE_NOT_INCLUDE_OFF_SCHEDULE = 0;
    public static final int ABSENCE_INCLUDE_OFF_SCHEDULE = 1;
    ...
    public static String getValueByName(String name)
    {
      ...
      public static int UpdateValuByName(String nameSysProp, String value) {
        int result = 0;
        //System.out.println("periodId : " + periodId + ", idxFieldName : " + idxFieldName);
            ...
            try {
                String sql = "UPDATE " + PstSystemProperty.TBL_SYSPROP + " SET ";
                sql = sql + " " + PstSystemProperty.fieldNames[PstSystemProperty.FLD_VALUE] + " = \"" + value + "\" ";

                sql = sql + " WHERE " + PstSystemProperty.fieldNames[PstSystemProperty.FLD_NAME]
                        + " = \"" + nameSysProp+"\"";

                //System.out.println("... updateScheduleDataByPresence on " + strPresenceTime);  
                System.out.println("updateSysprop : " + sql);
                result = DBHandler.execUpdate(sql);
            } catch (Exception e) {
                System.out.println("updateSysprop : " + e.toString());
            } finally {
        ...
        public static boolean getValueBoolean(String name)
    {
        ...
        try {        
            ...
            while(rs.next()) {                
                String tmpVal = rs.getString(1);
                try{
                    val = Boolean.parseBoolean(tmpVal);
                }catch(Exception exc){
                    val=false;
                }
                break;
