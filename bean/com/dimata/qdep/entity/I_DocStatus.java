...
public interface I_DocStatus {
    ...
    */
    ...
    public static final int DOCUMENT_STATUS_PAID            = 8;
    ...
    */
    public static final String[] fieldDocumentStatus = {
        ...
        public static final String[] fieldDocumentStatusShort = {
        "Drf",
        "Tba",
        "Fnl",
        "Rvs",
    ...
    * declaration of identifier to explain document status above
    */
    public static final int[] fieldDocumentStatusVal = {
        DOCUMENT_STATUS_DRAFT           ,
        DOCUMENT_STATUS_TO_BE_APPROVED  ,
        DOCUMENT_STATUS_FINAL           ,
        DOCUMENT_STATUS_REVISED         ,
