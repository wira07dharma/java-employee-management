...
public class CtrlTempDinamis extends Control implements I_Language{
    ...
    public TempDinamis getTempDinamis(){return tempDinamis; }
    
    public FrmTempDinamis getForm(){ return frmTempDinamis; }
               ...
               case Command.SAVE :
                ...
                if(tempDinamis.getOID()==0){
                    ...
                    try{
                         ...
                         if (this.tempDinamis.getNavigation().equals("menu_iii")){
                            PstSystemProperty.UpdateValuByName("MENU_HEADER", "BANK");
                        } else {
                            PstSystemProperty.UpdateValuByName("MENU_HEADER", "HR");
                        }
