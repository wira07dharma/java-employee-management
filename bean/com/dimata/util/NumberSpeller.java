...
public class NumberSpeller
{
    ...
    private void spellNumToIna(int num) {
        ...
        if(num > numObj.MAX_VALUE || num < 0) {
            strBuffSpell.append("ERROR::Invalid integer value to be spelled, value range: 0 - " + numObj.MAX_VALUE);
            System.out.println("spellNumToIna ada di IF::::::::");
            return;
        }
        System.out.println("spellNumToIna ada di dibawah IF::::::::");
    ...
    public String spellNumberToIna(double num) {
        ...
        System.out.println("EKSEKUSI METHOD spellNumberToIna(double num)");
        //String numStr = String.valueOf(num);
        String numStr = Formater.formatNumber(num, "###.##");//String.valueOf(num);
        //String numStr = "10000000";
