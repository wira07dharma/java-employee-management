...
public class FrmValue_Mapping extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_SEX = 22;
    public static final int FRM_FIELD_STATUS = 23;
    public static final int FRM_FIELD_RELIGION = 24;

    public static final int FRM_FIELD_LOS_FROM_IN_DAY       =25 ;
    public static final int FRM_FIELD_LOS_FROM_IN_MONTH     =26 ;
    public static final int FRM_FIELD_LOS_FROM_IN_YEAR      =27 ;
    public static final int FRM_FIELD_LOS_TO_IN_DAY         =28 ;
    public static final int FRM_FIELD_LOS_TO_IN_MONTH       =29 ;
    public static final int FRM_FIELD_LOS_TO_IN_YEAR        =30 ;
    public static final int FRM_FIELD_LOS_CURRENT_DATE      =31 ;
    public static final int FRM_FIELD_LOS_PER_CURRENT_DATE  =32 ;
    public static final int FRM_FIELD_RESIGN_STATUS  =33 ;
	public static final int FRM_FIELD_REMARK = 34;
    ...
    public static int[] fieldTypes = {
        ...
        TYPE_STRING,//"START_DATE",
        TYPE_STRING,//"END_DATE",
    ...
    public Value_Mapping getEntityObject() {
    ...
    public void requestEntityObject(Value_Mapping value_Mapping) {
        try {
            ...
            value_Mapping.setStartdate(java.sql.Date.valueOf(getString(FRM_FIELD_START_DATE)));
            value_Mapping.setEnddate(java.sql.Date.valueOf(getString(FRM_FIELD_END_DATE)));
            ...
            value_Mapping.setValue(getFloat(FRM_FIELD_VALUE));
            value_Mapping.setGrade(getLong(FRM_FIELD_GRADE));
            value_Mapping.setSex(getInt(FRM_FIELD_SEX));
            value_Mapping.setStatus(getInt(FRM_FIELD_STATUS));
            value_Mapping.setReligion(getLong(FRM_FIELD_RELIGION));
            ...
            value_Mapping.setResignStatus(getInt(FRM_FIELD_RESIGN_STATUS));
