...
public class FrmRecrApplicationMisc extends FRMHandler implements I_FRMInterface, I_FRMType 
{
	private RecrApplication recrApplication;

	public static final String FRM_NAME_RECRAPPLICATIONMISC		=  "FRM_NAME_RECRAPPLICATIONMISC" ;
	...
	public static final int FRM_FIELD_CHILD3_SEX			=  45 ;
         */
	public static final int FRM_FIELD_FNL_POSITION_ID		=  1;//46 ;
	public static final int FRM_FIELD_FNL_DEPARTMENT_ID		=  2;//47 ;
	public static final int FRM_FIELD_FNL_LEVEL_ID			=  3;//48 ;
	public static final int FRM_FIELD_FNL_MEDICAL_SCHEME		=  4;//49 ;
	public static final int FRM_FIELD_FNL_HOSPITALIZATION		=  5;//50 ;
	public static final int FRM_FIELD_FNL_ASTEK_DEDUCTION		=  6;//51 ;
	public static final int FRM_FIELD_FNL_BASIC_SALARY		=  7;//52 ;
	public static final int FRM_FIELD_FNL_SERVICE_CHARGE		=  8;//53 ;
	public static final int FRM_FIELD_FNL_ALLOWANCE			=  9;//54 ;
	public static final int FRM_FIELD_FNL_ANNUAL_LEAVE		= 10;//55 ;
	public static final int FRM_FIELD_FNL_OTHER_BENEFIT		=  11;//56 ;
	public static final int FRM_FIELD_FNL_PRIVILEGE			=  12;//57 ;
	public static final int FRM_FIELD_FNL_COMM_DATE			=  13;//58 ;
	public static final int FRM_FIELD_FNL_PROBATION			=  14;//59 ;

	public static String[] fieldNames = {
		"FRM_FIELD_RECR_APPLICATION_ID",  /*"FRM_FIELD_POSITION",
		"FRM_FIELD_OTHER_POSITION",  "FRM_FIELD_SALARY_EXP",
		"FRM_FIELD_DATE_AVAILABLE",  "FRM_FIELD_FULL_NAME",
		"FRM_FIELD_SEX",  "FRM_FIELD_BIRTH_PLACE",
		"FRM_FIELD_BIRTH_DATE",  "FRM_FIELD_RELIGION_ID",
		...
		"FRM_FIELD_CHILD2_SEX",  "FRM_FIELD_CHILD3_NAME",
		"FRM_FIELD_CHILD3_BIRTHDATE",  "FRM_FIELD_CHILD3_SEX",
                 */
	...
	public static int[] fieldTypes = {
		...
		TYPE_DATE + ENTRY_REQUIRED,  TYPE_LONG + ENTRY_REQUIRED,
	...
	public FrmRecrApplicationMisc(){
	}
	public FrmRecrApplicationMisc(RecrApplication recrApplication){
		this.recrApplication = recrApplication;
	}

	public FrmRecrApplicationMisc(HttpServletRequest request, RecrApplication recrApplication){
		super(new FrmRecrApplicationMisc(recrApplication), request);
		this.recrApplication = recrApplication;
	}

	public String getFormName() { return FRM_NAME_RECRAPPLICATIONMISC; } 
