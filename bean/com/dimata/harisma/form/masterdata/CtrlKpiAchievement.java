...
public class CtrlKpiAchievement extends Control implements I_Language{
    ...
    private Frm_KPI_Employee_Achievement frm_KPI_Employee_Achievement;
    ...
    public CtrlKpiAchievement(HttpServletRequest request) {
        msgString = "";
    ...
    public int action(int cmd, long oidKPI_Company_Target, long kpiListId, int tahun, long companyId,long type,long divisiId,long departementId,long secId) {
        msgString = "";
          ...
          case Command.SAVE :
				...
				Vector VListEmployeeDepartTarget = (Vector) frmKPI_Company_Target.getVlistKpiEmployeeDepartTarget();
                                ...
                                for (int x = 0; x < VListEmployeeDepartTarget.size(); x++) {      
                                    ...
                                    employeeId = employeeId+" "+kPI_Employee_Target.getEmployeeId()+",";
                                }
				...
				Vector VListEmployeeTarget = (Vector) frmKPI_Company_Target.getVlistKpiEmployeeTarget();
                                ...
                                //delete all kpi employee target
                                if (type == 5){
                                long delDiv = pstKPI_Employee_Target.deleteKpiEmployeTarget(tahun, kpiListId, companyId);
                                }
