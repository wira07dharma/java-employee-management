 ...
 * @author artha
 */
public class TrainingTargetXLS extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        if ((listTraining != null) && (listTraining.size() > 0)) {                
            ...
            String[] tableSubTitle = {
                "Department : "+dept,
                "Period : " + Formater.formatDate(srcTraining.getMonth(), "MMMM yyyy"),
                "Category : " + (srcTraining.getTypeOfSearch() == 0 ? "Achieving Target" : "Not Achieving Target"),
            ...
            for(int i=0;i<vct.size();i++){
                ...
                //Duration
                cell = row.createCell((short) collPos);
                cell.setCellValue(SessTraining.getDurationString(duration));//Value Here
                cell.setCellStyle(styleValue);
                collPos++;
