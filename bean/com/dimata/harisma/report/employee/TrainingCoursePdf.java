...
public class TrainingCoursePdf extends HttpServlet {   
     ...
     */
     ...
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("Report By Course Detail ", fontTitle), false);           
            ...
            try {
                listTraining = (Vector) sess.getValue("TRAINING_COURSE_REPORT_PRINT");
            } 
            catch (Exception e) {
            ...
            if ((listTraining != null) && (listTraining.size() > 0)) {                
                ...
                Training course = (Training)PstTraining.fetchExc(srcTraining.getTrainingId());
                
                try {
                    document.add(getHeader(course.getName(), pathImage));
                } 
                catch (Exception exc) {}
    ...
    private static Table getHeader(String course, String pathImage) throws BadElementException, DocumentException {
        ...
        hcell = new Cell(new Chunk("Course Name ", fontSubTitle));        
        hcell.setBorderColor(new Color(255, 255, 255));
        ...
        hcell = new Cell(new Chunk(course, fontSubTitle));
        hcell.setHorizontalAlignment(Element.ALIGN_LEFT);
        hcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        hcell.setBorderColor(new Color(255, 255, 255));
