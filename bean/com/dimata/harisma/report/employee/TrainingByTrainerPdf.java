 ...
 * @author guest
 */
public class TrainingByTrainerPdf extends HttpServlet {   
     ...
     */
     ...
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("Report By Trainer ", fontTitle), false);           
            ...
            if ((listTraining != null) && (listTraining.size() > 0)) {                
                ...
                try {
                    document.add(getHeader(srcTraining.getTrainer(), pathImage));
                } 
                catch (Exception exc) {}
    ...
    private static Table getHeader(String trainer, String pathImage) throws BadElementException, DocumentException {
        ...
        hcell = new Cell(new Chunk("Trainer ", fontSubTitle));        
        hcell.setBorderColor(new Color(255, 255, 255));
