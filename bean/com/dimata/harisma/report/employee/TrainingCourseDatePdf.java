...
public class TrainingCourseDatePdf extends HttpServlet {   
     ...
     */
     ...
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("Report By Course Date ", fontTitle), false);           
            ...
            try {
                listTraining = (Vector) sess.getValue("TRAINING_COURSEDATE_REPORT_PRINT");
            } 
            catch (Exception e) {
            ...
            if ((listTraining != null) && (listTraining.size() > 0)) {                
                ...
                Date date = srcTraining.getTrainingMonth();
                
                try {
                    document.add(getHeader(date, pathImage));
                } 
                catch (Exception exc) {}
    ...
    private static Table getHeader(Date date, String pathImage) throws BadElementException, DocumentException {
        ...
        hcell = new Cell(new Chunk("Course Month ", fontSubTitle));        
        hcell.setBorderColor(new Color(255, 255, 255));
