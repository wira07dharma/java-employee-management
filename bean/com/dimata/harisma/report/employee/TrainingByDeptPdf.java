 ...
 * @author guest
 */
public class TrainingByDeptPdf extends HttpServlet {   
     ...
     */
     ...
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("Report By Department ", fontTitle), false);           
            ...
            try {               
                listTraining = (Vector)sess.getValue("TRAINING_REPORT_DEPT_PRINT");
            ...
            if ((listTraining != null) && (listTraining.size() > 0)) {                
                ...
                try {
                    document.add(getHeader(dept, pathImage));
                } 
                catch (Exception exc) {}
    ...
    private static Table getHeader(String deptName, String pathImage) throws BadElementException, DocumentException {
