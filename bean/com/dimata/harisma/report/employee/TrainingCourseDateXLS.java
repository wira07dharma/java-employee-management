 ...
 * @author artha
 */
public class TrainingCourseDateXLS  extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        if ((listTraining != null) && (listTraining.size() > 0)) {                
            ...
            Position posTemp = (Position)vTempData.get(1);
            Training trainTemp = (Training)vTempData.get(3);
            TrainingHistory histTemp = (TrainingHistory)vTempData.get(4);
            ...
            String[] tableTitle = {
                "Report by Course Date"
            };
            String[] tableSubTitle = {
                "Course Month : "+Formater.formatDate(srcTraining.getTrainingMonth(), "MMMM yyyy"),
