...
public class TrainingMonthlyGenPdf  extends HttpServlet
{
    ...
    {        
        ...
        if(list == null) {
            int ctnInt[] = {25,20,5,5,5,5,5,5,5,5,5,10};
            list = new Table(12);
            list.setBorderColor(new Color(255,255,255));
            list.setWidth(100);
            list.setWidths(ctnInt);
        ...
        Cell hcell = new Cell(new Chunk("Program", fontListHeader));
    ...
    private static Table getListDetail(Table list, Vector detail, Department dept, int index) throws BadElementException, DocumentException 
    {
        ...
        Cell lisContent = new Cell(new Chunk((String)detail.get(0), fontLsContent));
        ...
        lisContent = new Cell(new Chunk((String)detail.get(1), fontLsContent));
