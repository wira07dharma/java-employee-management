...
import com.dimata.harisma.entity.search.SrcTrainingRptId;
 ...
 * @author artha
 */
public class TrainingByEmpXLS  extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        if ((listTraining != null) && (listTraining.size() > 0)) {                
            ...
            try{
                dept = PstDepartment.fetchExc(srcTraining.getDepartmentId()).getDepartment();
                emp = PstEmployee.fetchExc(srcTraining.getEmployeeId());
            }catch(Exception ex){}
