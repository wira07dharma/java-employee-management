 ...
 * @author  yunny
 */
public class ListAbsenceReasonPdf extends HttpServlet {
                ...
                try{
	                ...
	                listAbsence = (Vector)vctMonthlyAbsence.get(2);
                        ...
                        if(sectName.equals("")){
                            ...
                            sectName =" - SECTION : "+(String)vctMonthlyAbsence.get(7);
                        }
                        //System.out.println("absenceReasonList  "+absenceReasonList);
            ...
            if(listAbsence!=null && listAbsence.size()>0)
            {
                ...
                {          
                    ...
                    for(int j=0; j<listReasonMaster.size(); j++)
                    {
                       ...
                       // System.out.println("listAbsence.............."+listAbsence);
...
//                    }   
    ...
    {        
        ...
        try
        {                        
           int maxColumn = (listAbReason * 2 ) + 6; 
           ...
           // untuk tanggal pertama dalam period yang dipilih
            datatable.setDefaultColspan(listAbReason);
            datatable.setDefaultRowspan(1);            
            datatable.setDefaultHorizontalAlignment(Cell.ALIGN_CENTER);
