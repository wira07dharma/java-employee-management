...
public class EmployeeDetailPdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //10 Shio
            titleCellTop2 = new Cell(new Chunk("Shio : "+employee.getShio(), tableContent));
            titleCellTop2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop2.setBorderColor(new Color(255, 255, 255));
            personTable2.addCell(titleCellTop2);
            ...
            titleCellTop2 = new Cell(new Chunk("Length of Service", tableContent));
            titleCellTop2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop2.setBorderColor(new Color(255, 255, 255));
            personTable2.addCell(titleCellTop2);
            ...
            titleCellTop2.setBorderColor(new Color(255, 255, 255));
            personTable2.addCell(titleCellTop2);
            long dayDiffLos = DateCalc.dayDifference(employee.getCommencingDate(), employee.getResignedDate() != null ? employee.getResignedDate() : new Date());
                double los = getLosValue(dayDiffLos+"/365");
            titleCellTop2 = new Cell(new Chunk("" + los, tableContent));
            titleCellTop2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop2.setBorderColor(new Color(255, 255, 255));
            personTable2.addCell(titleCellTop2);
            ...
            titleCellTop2 = new Cell(new Chunk("Elemen", tableContent));
            titleCellTop2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop2.setBorderColor(new Color(255, 255, 255));
            personTable2.addCell(titleCellTop2);
            ...
            titleCellTop2 = new Cell(new Chunk("" + employee.getElemen(), tableContent));
            titleCellTop2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop2.setBorderColor(new Color(255, 255, 255));
            personTable2.addCell(titleCellTop2);
            ...
            if (vCareer != null && vCareer.size() > 0) {
                ...
                int careerHeaderTop[] = {10, 10, 10, 10, 10};
                Table careerTable = new Table(5);
                ...
                if (vReprimand != null && vReprimand.size() > 0) {
                    ...
                    */
                    ...
                    for (int i = 0; i < vReprimand.size(); i++) {
                        ...
                        titleCellTop = new Cell(new Chunk("" + warningChapter.getBabTitle(), tableContent));
                        titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titleCellTop.setBorderColor(new Color(255, 255, 255));
                        dataTable.addCell(titleCellTop);
                        ...
                        titleCellTop = new Cell(new Chunk("" + warningPasal.getPasalTitle(), tableContent));
                        titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titleCellTop.setBorderColor(new Color(255, 255, 255));
                        dataTable.addCell(titleCellTop);
