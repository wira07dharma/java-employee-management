 ...
 * @author  gedhy
 */
public class WeeklyAbsenteeismPdf extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try{
	        vctWeeklyAbsence = (Vector)sessEmpabsence.getValue("ABSENTEEISM_WEEKLY");
            }catch(Exception e){
            ...
            if(vctWeeklyAbsence != null && vctWeeklyAbsence.size()>0){
                try{
	                ...
	                listAbsence = (Vector)vctWeeklyAbsence.get(2);
                        ...
                        empNumb = (String)vctWeeklyAbsence.get(6);
                                             if(vctWeeklyAbsence.get(7)!=null)
                        fullName = (String)vctWeeklyAbsence.get(7);
                                              if(vctWeeklyAbsence.get(8)!=null)
                        oidSection = Long.parseLong((String)vctWeeklyAbsence.get(8));
           ...
           /* HeaderFooter header = new HeaderFooter(new Phrase("ABSENTEEISM REPORT " + strWeek.toUpperCase() + " OF " + (Formater.formatDate(absence,"MMMM yyyy").toUpperCase()) +
           ...
           if(listStruktur !=null && listStruktur.size()>0){
            ...
            if(division ==null || division.length() <= 0 ){
             ...
             String strReportTitle = 
                                    "ABSENTEEISM REPORT PER : " + (Formater.formatDate(startDate,"dd MMMM yyyy")).toUpperCase() + " To " + (Formater.formatDate(endDate,"dd MMMM yyyy")).toUpperCase() +
