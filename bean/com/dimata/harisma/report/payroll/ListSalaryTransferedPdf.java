/*
 * ListSalaryTransferedPdf.java
 *
 * Created on August 28, 2007, 11:26 AM
 */
 ...
 * @author  yunny
 */
public class ListSalaryTransferedPdf extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("LIST OF SALARY TRANSFERED" +//(Formater.formatDate(presence,"MMMM")+ "-" +(Formater.formatDate(presence+1,"MMMM yyyy").toUpperCase()) +
...
//                    }   
            ...
            if(Integer.parseInt(summ)==1){
                ...
                if (!writer.fitsPage(tableEmpPresence)) {
                    document.add(tableEmpPresence);   
                    document.newPage(); 
                    tableEmpPresence = createSummSalary(totalTransfered, fontTitle,fontHeader);
    ...
    {        
        ...
        {                        
           int maxColumn = 7; 
            ...
            datatable.addCell(new Phrase("Department", font1));
            datatable.addCell(new Phrase("Section", font1));
            datatable.addCell(new Phrase("Comp.Date", font1));
            datatable.addCell(new Phrase("Bank Acc. Nr.", font1));
            datatable.addCell(new Phrase("Total Transfered", font1));
     ...
     * @created by Yunny
     */    
    public static Table createSummSalary(String totalTransfered, Font font1,Font font2)
    {        
        Table datatable = null;  
        try
        {                        
