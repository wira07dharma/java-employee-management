/*
 * mealAllowanceMontlyPdf.java
 *
 * Created on September 6, 2007, 2:30 PM
 */
 ...
 * @author  yunny
 */
public class mealAllowanceMontlyPdf extends HttpServlet{
...
//                    }   
    ...
    {        
        ...
        {        
           ...
           int maxColumn = maxDayOfMonth+8; 
            ...
            datatable.addCell(new Phrase("Category", font1));
   ...
   public static Table  createSummSalary(String sumMealWeekly,String totalMealAll,String totalAbsence,String totalPayment,Font font1)
    ...
    /** Creates a new instance of mealAllowanceMontlyPdf */
    public mealAllowanceMontlyPdf() {
    }
