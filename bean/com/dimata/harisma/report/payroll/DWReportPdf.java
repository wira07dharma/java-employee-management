 ...
 * DWReportPdf.java
 *
 * Created on January 20, 2008, 12:49 PM
 */
 ...
 * @author  YUNI
 */
public class DWReportPdf extends HttpServlet{
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Document document = new Document(PageSize.LETTER.rotate(), 7, 7, 50, 50);
        ...
        try {
            ...
            if(vctMonthlyAbsence != null && vctMonthlyAbsence.size()==13){
                try{
                        ...
                        if(selectedDateFrom.getMonth()!=selectedDateTo.getMonth()){
                                maxColum = (dateOfMonth-(startDate-1))+selectedDateTo.getDate();
                        }else{
                                maxColum =  selectedDateTo.getDate() -  selectedDateFrom.getDate()+1;
                        }
                        periodName = (String)vctMonthlyAbsence.get(6);
                        sumMealMontly = (String) vctMonthlyAbsence.get(7);
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("MONTLY MEAL ALLOWANCE " +//(Formater.formatDate(presence,"MMMM")+ "-" +(Formater.formatDate(presence+1,"MMMM yyyy").toUpperCase()) +
                				  ...
                				  "\nPERIOD : "+ periodName, fontHeader), false);
           ...
           //------------------------------------
            ...
            /* create header */            
            Table tableEmpPresence = createHeaderDetailDinamis(listAllowance,selectedDateFrom,maxColum, fontContent);
            ...
            if(listAllowance!=null && listAllowance.size()>0)
            {
                ...
                {          
                    ...
                    // no
                    String tmpStrVal="";
                    tmpStrVal=String.valueOf(itemAbsence.get(0)==null?"":itemAbsence.get(0));                    
                    cellEmpData = new Cell(new Chunk(tmpStrVal,fontContent));
                    ...
                    tmpStrVal=String.valueOf(itemAbsence.get(1)==null?"":itemAbsence.get(1));                    
                    cellEmpData = new Cell(new Chunk(tmpStrVal,fontContent));
                    cellEmpData.setHorizontalAlignment(Cell.ALIGN_LEFT);
                    cellEmpData.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                    cellEmpData.setBackgroundColor(whiteColor);
                    ...
                    tmpStrVal=String.valueOf(itemAbsence.get(3)==null?"":itemAbsence.get(3));                    
                    ...
                    tmpStrVal=String.valueOf(itemAbsence.get(4)==null?"":itemAbsence.get(4));                    
                    cellEmpData = new Cell(new Chunk(String.valueOf(tmpStrVal),fontContent));
                    cellEmpData.setHorizontalAlignment(Cell.ALIGN_LEFT);
                    cellEmpData.setVerticalAlignment(Cell.ALIGN_MIDDLE);
                    cellEmpData.setBackgroundColor(whiteColor);
                    cellEmpData.setBorder(Rectangle.LEFT | Rectangle.TOP | Rectangle.BOTTOM | Rectangle.RIGHT);
                    ...
                    if (!writer.fitsPage(tableEmpPresence)) {
                        ...
                        document.newPage();                        
                        tableEmpPresence = createHeaderDetailDinamis(listAllowance,selectedDateFrom,maxColum, fontContent);
                    }
...
//                    }   
             ...
             if(Integer.parseInt(sumMealMontly)==1){
                
                if (!writer.fitsPage(tableEmpPresence)) {
                    document.add(tableEmpPresence);   
                    document.newPage(); 
                    tableEmpPresence = createSummSalary(sumMealMontly,totalMealAll,totalAbsence,totalPayment,fontTitle);
    ...
    {        
        ...
        {        
           ...
           int maxColumn = maxDayOfMonth+7; 
            ...
            headerwidths[4] = 2;
            int index = 5;                        
            for(int j=0; j<(maxDayOfMonth-1); j++)
            {   
           ...
           datatable.setDefaultRowspan(1);
            datatable.setDefaultColspan(maxDayOfMonth);
            datatable.setBackgroundColor(summaryColor);                
            datatable.setDefaultVerticalAlignment(Cell.ALIGN_MIDDLE);
            ...
            datatable.setBackgroundColor(summaryColor);                
            datatable.setDefaultVerticalAlignment(Cell.ALIGN_MIDDLE);
            datatable.addCell(new Phrase("Desc", font1));
           ...
           for(int d=0; d<(maxDayOfMonth-1); d++)
            {
     ...
     * @created by Yunny
     */    
   public static Table  createSummSalary(String sumMealWeekly,String totalMealAll,String totalAbsence,String totalPayment,Font font1)
    {        
        Table datatable = null;  
        try
        {                        
           ...
           // create table
            ...
            datatable.setBackgroundColor(whiteColor); 
             ...
             // row 1 cols 1
            Cell placeCell = new Cell(new Chunk("Denpasar,"+Formater.formatDate(new Date(),"26-MMM-yyyy"), font1));
    ...
    /** Creates a new instance of DWReportPdf */
    public DWReportPdf() {
    }
