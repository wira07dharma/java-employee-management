 ...
 * @author  gedhy
 */
public class MonthlyPresencePdf  extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try{
	        vctMonthlyPresence = (Vector)sessEmpPresence.getValue("PRESENCE_RPT_MONTHLY");
            }catch(Exception e){
            ...
            String empNum="";
            String fullName="";
            if(vctMonthlyPresence != null && vctMonthlyPresence.size() > 0){
                try{
	            	presence = (String) vctMonthlyPresence.get(0);
                         if(vctMonthlyPresence.get(1)!=null){
	                long oidDepartment = Long.parseLong((String)vctMonthlyPresence.get(1));
                          ...
                          if(vctMonthlyPresence.get(5) !=null){
                      long  oidSection = Long.parseLong((String)vctMonthlyPresence.get(5));
                        if(oidSection !=0){
                            section = (com.dimata.harisma.entity.masterdata.Section)PstSection.fetchExc(oidSection);
                        }
                      }
                         if(vctMonthlyPresence.get(2)!=null){
	                listPresence = (Vector)vctMonthlyPresence.get(2);
                         }
                         if(vctMonthlyPresence.get(3)!=null){
                        intDateOfMonth = Integer.parseInt(String.valueOf(vctMonthlyPresence.get(3)));}
                         if(vctMonthlyPresence.get(4)!=null){
                        startDatePeriod = Integer.parseInt(String.valueOf(vctMonthlyPresence.get(4)));}
                        //update by satrya2012-10-17
                       /* if(vctMonthlyPresence.get(5)!=null){
                        empNum = String.valueOf(String.valueOf(vctMonthlyPresence.get(5)));}
                        if(vctMonthlyPresence.get(6)!=null){
                        fullName = String.valueOf(String.valueOf(vctMonthlyPresence.get(6)));}*/
           ...
           /* HeaderFooter header = new HeaderFooter(new Phrase("PRESENCE REPORT PER " + presence.toUpperCase() +
            ...
            document.setHeader(header);*/
             String strReportTitle = //"ATTENDANCE RECORD : " + (Formater.formatDate(presence,"dd MMMM yyyy")).toUpperCase() +
                                    "PRESENCE REPORT PER : " + presence.toUpperCase() +
    ...
    {        
        ...
        {                        
            ...
            datatable.setBackgroundColor(summaryColor);                
            datatable.setDefaultVerticalAlignment(Cell.ALIGN_MIDDLE);
            datatable.addCell(new Phrase("Total Days", font1));            
