 ...
 * @author  gedhy
 */
public class WeeklyNightShiftPdf extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try{
	        vctWeeklyPresence = (Vector)sessEmpPresence.getValue("NIGHT_SHIFT_WEEKLY");
            }catch(Exception e){
            ...
            HeaderFooter header = new HeaderFooter(new Phrase("NIGHT SHIFT REPORT " + strWeek.toUpperCase() + " OF " + (Formater.formatDate(presence,"MMMM yyyy").toUpperCase()) +
