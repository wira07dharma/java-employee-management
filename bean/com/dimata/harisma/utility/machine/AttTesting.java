 ...
 */
public class AttTesting implements AttTransfer_I, Runnable {
    ...
    private String message="";
     // database ODBC
    String dsnName="localhost:3309";/// 205.101.0.214:3306 alamat tmpt mysql
    String user="root";//profinger
    String password="12345";//""
    String dbName="absensi_test";//melia
    ...
    int flagSdhSelesaiCountMencariDataTgl=1;
     ...
     public AttTesting() {
            initClass(100, "AttTesting", user,password, tableName,
