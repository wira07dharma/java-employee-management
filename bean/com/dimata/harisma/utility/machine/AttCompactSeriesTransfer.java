 ...
 * @author ktanjana
 */
public class AttCompactSeriesTransfer implements AttTransfer_I, Runnable {
    ...
    public AttCompactSeriesTransfer() {
        initClass(10, "AttCompactSeriesTransfer", "", "", "CHECKINOUT",
