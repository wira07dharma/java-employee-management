 ...
 * @author IanRizky
 */
public class Att2000TransferSQLServer implements AttTransfer_I, Runnable {
    ...
    public Att2000TransferSQLServer() {
        initClass(10, "192.168.1.60", "dimata", "dimata", "CHECKINOUT",
    ...
    public int initRecordToGet() {
        ...
        try {
            ...
            theConn = SQLServerConnection.getConnection(dsnName,dbName, user, password);
    ...
    public void run() {
        ...
        try {
			getConn = SQLServerConnection.getConnection(dsnName,dbName, user, password);
			//System.out.println("getConn "+getConn);
        } catch (Exception exc) {
        ...
        while (this.running) {
            ...
            try {
                ...
                sql = "select top 50 u." + this.employee_num + ",a." + this.checkTime + ",a." + this.checkType
    ...
    public boolean updateODBC(String pkData, String userid, String checktime, String db_access) {
        ...
        try {
            ...
            cn = SQLServerConnection.getConnection(dsnName,dbName, user, password);
