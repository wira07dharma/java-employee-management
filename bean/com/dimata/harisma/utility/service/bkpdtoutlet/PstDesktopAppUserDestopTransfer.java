/*
 * PstDesktopAppUserDestopTransfer.java
 *
...
public class PstDesktopAppUserDestopTransfer extends DBHandler implements I_DBInterface, I_DBType, I_Persintent  {
    ...
    /** Creates new PstDesktopAppUserDestopTransfer */
    public PstDesktopAppUserDestopTransfer() {
    }
    
    public PstDesktopAppUserDestopTransfer(int i) throws DBException {
        super(new PstDesktopAppUserDestopTransfer());
    }
    
    
    public PstDesktopAppUserDestopTransfer(String sOid) throws DBException {
        super(new PstDesktopAppUserDestopTransfer(0));
        if(!locate(sOid))
    ...
    public PstDesktopAppUserDestopTransfer(long lOid) throws DBException {
        super(new PstDesktopAppUserDestopTransfer(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
        return new PstDesktopAppUserDestopTransfer().getClass().getName();
    }
    ...
    public static long insert(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException  {
        //        try{
        PstDesktopAppUserDestopTransfer pstObj = new PstDesktopAppUserDestopTransfer(0);
  ...
  */
    ...
    public static long update(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        PstDesktopAppUserDestopTransfer pstObj = null;
        if(tabelEmployeeOutletTransferData.getUserId()!=0){
        pstObj = new PstDesktopAppUserDestopTransfer(tabelEmployeeOutletTransferData.getUserId());
        pstObj.setString(FLD_LOGIN_ID, tabelEmployeeOutletTransferData.getLoginId());
        pstObj.setString(FLD_PASSWORD, tabelEmployeeOutletTransferData.getPassword());
    ...
    public static long delete(long oid) {
        try {
            PstDesktopAppUserDestopTransfer pstObj = new PstDesktopAppUserDestopTransfer(oid);
            pstObj.delete();
            return oid;
        }catch(Exception e) {
            System.out.println(e);
