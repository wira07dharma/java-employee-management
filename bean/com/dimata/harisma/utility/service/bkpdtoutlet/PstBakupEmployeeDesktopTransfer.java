...
public class PstBakupEmployeeDesktopTransfer extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public PstBakupEmployeeDesktopTransfer() {
    }

    public PstBakupEmployeeDesktopTransfer(int i) throws DBException {
        super(new PstBakupEmployeeDesktopTransfer());
    }

    public PstBakupEmployeeDesktopTransfer(String sOid) throws DBException {
        super(new PstBakupEmployeeDesktopTransfer(0));
        if (!locate(sOid)) {
    ...
    public PstBakupEmployeeDesktopTransfer(long lOid) throws DBException {
        super(new PstBakupEmployeeDesktopTransfer(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
        return new PstBakupEmployeeDesktopTransfer().getClass().getName();
    }
    ...
    public static String insertExc(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        String sql="";
        try {
            PstBakupEmployeeDesktopTransfer pstEmployee = new PstBakupEmployeeDesktopTransfer(0);
...
//            pstEmployee.setLong(FLD_EMPLOYEE_ID, );
            sql = pstEmployee.SyntacInsert(tabelEmployeeOutletTransferData.getEmployeeId());
            //employee.setOID(pstEmployee.getlong(FLD_EMPLOYEE_ID));
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
            throw new DBException(new PstBakupEmployeeDesktopTransfer(0), DBException.UNKNOWN);
        }
        return sql;
    }
    ...
    public static String updateExc(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        ...
        try {
            if (tabelEmployeeOutletTransferData.getEmployeeId() != 0) {
                PstBakupEmployeeDesktopTransfer pstEmployee = new PstBakupEmployeeDesktopTransfer(tabelEmployeeOutletTransferData.getEmployeeId());
...
//                pstEmployee.setLong(FLD_EMP_CATEGORY_ID, tabelEmployeeOutletTransferData.getEmpCategoryId());
    ...
    public static long deleteExc(long oid) throws DBException {
        try {
            PstBakupEmployeeDesktopTransfer pstEmployee = new PstBakupEmployeeDesktopTransfer(oid);
            pstEmployee.delete();
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
    ...
    public static boolean checkOID(long employeeId) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_HR_EMPLOYEE + " WHERE "
                    + PstBakupEmployeeDesktopTransfer.fieldNames[PstBakupEmployeeDesktopTransfer.FLD_EMPLOYEE_ID] + " = '" + employeeId + "'";
    ...
    public static Date getCommercingDatePerEmployee(long employeeId) {
        ...
        try {
            String sql = "SELECT " + PstBakupEmployeeDesktopTransfer.fieldNames[PstBakupEmployeeDesktopTransfer.FLD_COMMENCING_DATE] + " FROM " + TBL_HR_EMPLOYEE + " WHERE "
                    + PstBakupEmployeeDesktopTransfer.fieldNames[PstBakupEmployeeDesktopTransfer.FLD_EMPLOYEE_ID] + " = '" + employeeId + "'";
            ...
            while (rs.next()) {
                dtComercing = rs.getDate(PstBakupEmployeeDesktopTransfer.fieldNames[PstBakupEmployeeDesktopTransfer.FLD_COMMENCING_DATE]);
            }
            rs.close();
        } catch (Exception e) {
            System.out.println("err : " + e.toString());
