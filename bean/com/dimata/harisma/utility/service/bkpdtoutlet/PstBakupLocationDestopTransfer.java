 ...
 * @author Wiweka
 */
public class PstBakupLocationDestopTransfer extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public PstBakupLocationDestopTransfer() {
    }

    public PstBakupLocationDestopTransfer(int i) throws DBException {
        super(new PstBakupLocationDestopTransfer());
    }

    public PstBakupLocationDestopTransfer(String sOid) throws DBException {
        super(new PstBakupLocationDestopTransfer(0));
        if (!locate(sOid)) {
    ...
    public PstBakupLocationDestopTransfer(long lOid) throws DBException {
        super(new PstBakupLocationDestopTransfer(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
        return new PstBakupLocationDestopTransfer().getClass().getName();
    }
    ...
    public static String insertExc(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        String sql="";
        try {
            PstBakupLocationDestopTransfer pstPositionDestopTransfer = new PstBakupLocationDestopTransfer(0);
            ...
            sql = pstPositionDestopTransfer.SyntacInsert(tabelEmployeeOutletTransferData.getLocationId());
        }catch (Exception e) {
    ...
    public static long updateExc(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        try {
            if (tabelEmployeeOutletTransferData.getWorkHistoryId() != 0) {
                PstBakupLocationDestopTransfer pstPositionDestopTransfer = new PstBakupLocationDestopTransfer(tabelEmployeeOutletTransferData.getLocationId());
            ...
            throw new DBException(new PstBakupLocationDestopTransfer(0), DBException.UNKNOWN);
        }
        return 0;
    }
    ...
    public static long deleteExc(long oid) throws DBException {
        try {
            PstBakupLocationDestopTransfer pstCareerPath = new PstBakupLocationDestopTransfer(oid);
    ...
    public static boolean checkOID(long locationId) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_P2_LOCATION + " WHERE "
                    + PstBakupLocationDestopTransfer.fieldNames[PstBakupLocationDestopTransfer.FLD_LOCATION_ID] + " = " + locationId;
