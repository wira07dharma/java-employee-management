 ...
 */
public class PstBakupEmployeeOutletDesktop extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language{
    ...
    public static final int[] fieldTypes = {
     ...
     public PstBakupEmployeeOutletDesktop() {
    }
    
    public PstBakupEmployeeOutletDesktop(int i) throws DBException {
        super(new PstBakupEmployeeOutletDesktop());
    }
    
    public PstBakupEmployeeOutletDesktop(String sOid) throws DBException {
        super(new PstBakupEmployeeOutletDesktop(0));
        if (!locate(sOid))
    ...
    public PstBakupEmployeeOutletDesktop(long lOid) throws DBException {
        super(new PstBakupEmployeeOutletDesktop(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
         return new PstBakupEmployeeOutletDesktop().getClass().getName();
    }
    ...
    public long fetchExc(Entity ent) throws Exception {
     ...
     public static EmployeeOutlet fetchExc(long oid) throws DBException {
        try {
            ...
            PstBakupEmployeeOutletDesktop pstEmployeeOutlet = new PstBakupEmployeeOutletDesktop(oid);
            ...
            throw new DBException(new PstBakupEmployeeOutletDesktop(0), DBException.UNKNOWN);
        }
    }
    ...
    public static long updateExc(EmployeeOutlet employeeOutlet) throws DBException {
        try {
            if (employeeOutlet.getOID() != 0) {
                PstBakupEmployeeOutletDesktop pstEmployeeOutlet = new PstBakupEmployeeOutletDesktop(employeeOutlet.getOID());
    ...
    public static String insertExc(EmployeeOutlet employeeOutlet) throws DBException {
        String sql="";
        try {
            PstBakupEmployeeOutletDesktop pstEmployeeOutlet = new PstBakupEmployeeOutletDesktop(0);
               ...
               // pstEmployeeOutlet.setLong(FLD_EMP_SCHEDULE_ID, employeeOutlet.getSchedleSymbolId());
               // pstEmployeeOutlet.setLong(FLD_EMP_SCHEDULE_ID_2ND, employeeOutlet.getSchedleSymbolId2nd());
            sql =pstEmployeeOutlet.SyntacInsert(employeeOutlet.getOID());
    ...
    public static void resultToObject(ResultSet rs, EmployeeOutlet employeeOutlet) {
        try 
        {
            employeeOutlet.setOID(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_OUTLET_EMPLOYEE_ID]));
             employeeOutlet.setDtFrom(rs.getDate(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_FROM]));
            employeeOutlet.setDtTo(rs.getDate(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_TO]));
            employeeOutlet.setEmployeeId(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMPLOYEE_ID]));
            employeeOutlet.setLocationId(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_LOCATION_ID]));
            employeeOutlet.setPositionId(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_POSITION_ID]));
            employeeOutlet.setScheduleType(rs.getInt(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_TYPE_SCHEDULE]));
            //employeeOutlet.setSchedleSymbolId(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMP_SCHEDULE_ID]));
            //employeeOutlet.setSchedleSymbolId2nd(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMP_SCHEDULE_ID_2ND]));
        }
        catch (Exception e) 
        {
            e.printStackTrace();
    ...
    private static void resultToObjectSessEmployee(ResultSet rs, SessEmployeeOutlet sessEmployeeOutlet) {
        try 
        {
            sessEmployeeOutlet.setEmployeeOutletId(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_OUTLET_EMPLOYEE_ID]));
             sessEmployeeOutlet.setDtFrom(DBHandler.convertDate(rs.getDate(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_FROM]), rs.getTime(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_FROM])));
            sessEmployeeOutlet.setDtTo(DBHandler.convertDate(rs.getDate(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_TO]),rs.getTime(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_TO])));
            sessEmployeeOutlet.setEmployeeId(rs.getLong("emp."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID]));
            sessEmployeeOutlet.setLocationId(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_LOCATION_ID]));
            sessEmployeeOutlet.setPositionId(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_POSITION_ID]));
            
            /*sessEmployeeOutlet.setSchedleSymbolId(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMP_SCHEDULE_ID]));
            sessEmployeeOutlet.setSchedleSymbolId2nd(rs.getLong(PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMP_SCHEDULE_ID_2ND]));
...
+ " INNER JOIN " +PstEmployee.TBL_HR_EMPLOYEE + " AS emp ON eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMPLOYEE_ID]+ " = emp."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID]
+ " INNER JOIN " +PstLocation.TBL_P2_LOCATION + " AS loc ON eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_LOCATION_ID]+ " = loc."+PstLocation.fieldNames[PstLocation.FLD_LOCATION_ID]
+ " INNER JOIN " + PstPosition.TBL_HR_POSITION  + " AS pos ON pos."+PstPosition.fieldNames[PstPosition.FLD_POSITION_ID]+"=eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_POSITION_ID];
//+ " INNER JOIN " + PstScheduleSymbol.TBL_HR_SCHEDULE_SYMBOL + " AS sch ON sch."+PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_SCHEDULE_ID]+"=eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMP_SCHEDULE_ID];
if(whereClause!=null && whereClause.length()>0){
    if(dtFrom!=null && dtTo!=null){
        sql = sql + " WHERE " + whereClause + " AND \"" + Formater.formatDate(dtTo, "yyyy-MM-dd 23:59") + "\" >= eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_FROM]
        + " AND  eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_TO] + " >= \""+ Formater.formatDate(dtFrom, "yyyy-MM-dd 00:00")+"\"";
    }else{
        sql = sql + " WHERE " + whereClause;
    }
}else{
    if(dtFrom!=null && dtTo!=null){
        sql = sql + " WHERE \""+Formater.formatDate(dtTo, "yyyy-MM-dd HH:mm") + "\" >= eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_FROM]
        + " AND  eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_TO] + " >= \""+ Formater.formatDate(dtFrom, "yyyy-MM-dd HH:mm")+"\"";
    }
}
            if(order != null && order.length() > 0)
                sql = sql + " ORDER BY " + order;
...
+ " LEFT JOIN " +TBL_HR_EMP_OUTLET + " AS eo ON eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMPLOYEE_ID]+ " = emp."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID];
if(dtFrom!=null && dtTo!=null){
        sql = sql + " AND \"" + Formater.formatDate(dtTo, "yyyy-MM-dd 23:59") + "\" >= eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_FROM]
        + " AND  eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_DATE_TO] + " >= \""+ Formater.formatDate(dtFrom, "yyyy-MM-dd 00:00")+"\"";
}
sql = sql +" LEFT JOIN " +PstLocation.TBL_P2_LOCATION + " AS loc ON eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_LOCATION_ID]+ " = loc."+PstLocation.fieldNames[PstLocation.FLD_LOCATION_ID]
+ " LEFT JOIN " + PstPosition.TBL_HR_POSITION  + " AS pos ON pos."+PstPosition.fieldNames[PstPosition.FLD_POSITION_ID]+"=eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_POSITION_ID];
//+ " INNER JOIN " + PstScheduleSymbol.TBL_HR_SCHEDULE_SYMBOL + " AS sch ON sch."+PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_SCHEDULE_ID]+"=eo."+PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_EMP_SCHEDULE_ID];
if(whereClause!=null && whereClause.length()>0){
        sql = sql + " WHERE " + whereClause;
}
     ...
     public static int getCount(String whereClause){
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT COUNT("+ PstBakupEmployeeOutletDesktop.fieldNames[PstBakupEmployeeOutletDesktop.FLD_OUTLET_EMPLOYEE_ID] + ") FROM " + TBL_HR_EMP_OUTLET;
            if(whereClause != null && whereClause.length() > 0) {
                sql = sql + " WHERE " + whereClause;
            }
