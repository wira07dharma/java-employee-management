 ...
 */
public class BakupEmployeeOutletTransferData implements Runnable {
    ...
    public void run() {
        try {
            ...
            String whereClause = "";
            TmpBakupDataEmployeeOutletTransfer tmpBakupDataEmployeeOutletTransfer = new TmpBakupDataEmployeeOutletTransfer();
...
//            }
            ...
            while (this.running && (sdhHabisDataTransOutlet || sdhHabisDataTransSchedule || sdhHabisDataTransMasterSch)) {
                ...
                try {
                    ...
                    tmpBakupDataEmployeeOutletTransfer = new TmpBakupDataEmployeeOutletTransfer();
                    int limit = 50;
                    //String sql = "";
                    //String SyntacQuery = "";
                    //String sScheduleId = "";
                    ...
                    if (isCbxKadivMapping()) {
                        try {
                            ...
                            recordSize = 0;
                            progressSize = 0;
                            setTransferKadivPerOutlet("", sdhHabisDataTransOutlet, tmpBakupDataEmployeeOutletTransfer);
                            ...
                            try {
                                ...
                                if (tmpBakupDataEmployeeOutletTransfer != null && tmpBakupDataEmployeeOutletTransfer.getEmployeeId() != null && tmpBakupDataEmployeeOutletTransfer.getEmployeeId().length() > 0) {
                                    //sEmployeeId = sEmployeeId.substring(0, sEmployeeId.length() - 1);
                                    String sEmployeeId = tmpBakupDataEmployeeOutletTransfer.getEmployeeId().substring(0, tmpBakupDataEmployeeOutletTransfer.getEmployeeId().length() - 1);
                                    tmpBakupDataEmployeeOutletTransfer.setEmployeeId(sEmployeeId);
                                }

                                if (periodId != null && periodId.length() > 0 && tmpBakupDataEmployeeOutletTransfer != null && tmpBakupDataEmployeeOutletTransfer.getEmployeeId() != null && tmpBakupDataEmployeeOutletTransfer.getEmployeeId().length() > 0) {
                                    recordSize = 0;
                                    progressSize = 0;

                                    setScheduleTransfer(periodId, tmpBakupDataEmployeeOutletTransfer.getEmployeeId(), sdhHabisDataTransSchedule, tmpBakupDataEmployeeOutletTransfer);
                                }
                            } catch (Exception exc) {
                    ...
                    if (isCbxOutlet()) {
                        try {
                            if (whereClause != null && whereClause.length() > 0) {
                                recordSize = 0;
                                progressSize = 0;
                                setTransferOutlet(whereClause, sdhHabisDataTransOutlet, tmpBakupDataEmployeeOutletTransfer);
                                setTransferOvertime(whereClause, sdhHabisDataTransOutlet, tmpBakupDataEmployeeOutletTransfer);
                                setTransferExtraSch(whereClause, sdhHabisDataTransOutlet, tmpBakupDataEmployeeOutletTransfer);
                                ...
                                setTransferMappingOutlet(tmpBakupDataEmployeeOutletTransfer);
...
//                                    }
                                    ...
                                    if (periodId != null && periodId.length() > 0 && tmpBakupDataEmployeeOutletTransfer.getEmployeeId() != null && tmpBakupDataEmployeeOutletTransfer.getEmployeeId().length() > 0) {
                                        recordSize = 0;
                                        progressSize = 0;
                                        //sScheduleId = setScheduleTransfer(sql, periodId, tmpBakupDataEmployeeOutletTransfer.getEmployeeId(), sdhHabisDataTransSchedule);
                                        setScheduleTransfer(periodId, tmpBakupDataEmployeeOutletTransfer.getEmployeeId(), sdhHabisDataTransSchedule, tmpBakupDataEmployeeOutletTransfer);
                                    }
                                } catch (Exception exc) {
                                    message = "Error transfer setScheduleTransfer" + exc;
                    ...
                    if (isCbxScheduleSymbol()) {
                        try {
                            ...
                            if (tmpBakupDataEmployeeOutletTransfer != null && tmpBakupDataEmployeeOutletTransfer.getScheduleId() != null && tmpBakupDataEmployeeOutletTransfer.getScheduleId().length() > 0) {
                                //sEmployeeId = sEmployeeId.substring(0, sEmployeeId.length() - 1);
                                String sScheduleId = tmpBakupDataEmployeeOutletTransfer.getScheduleId().substring(0, tmpBakupDataEmployeeOutletTransfer.getScheduleId().length() - 1);
                                tmpBakupDataEmployeeOutletTransfer.setScheduleId(sScheduleId);
                            }
...
//                            }
                            ...
                            setScheduleSymbolTransfer(getInputParam(), tmpBakupDataEmployeeOutletTransfer.getScheduleId(), tmpBakupDataEmployeeOutletTransfer);
                        } catch (Exception exc) {
                    ...
                    this.running = false;
                    if (true) {
                       if(tmpBakupDataEmployeeOutletTransfer!=null && tmpBakupDataEmployeeOutletTransfer.getsQuery()!=null && tmpBakupDataEmployeeOutletTransfer.getsQuery().length()>0 && getLocationSave()!=null && getLocationSave().length()>0){
                            writeTextSql(tmpBakupDataEmployeeOutletTransfer.getsQuery(), getLocationSave());
                       }
                    }
    ...
    public static void writeTextSql(String syntak,String location) throws IOException {
         Writer writer = null;
        try {
            if(location!=null && location.length()>0){
                //location = location.substring(0, location.length()-1);
                File file = new File(location+"\\syntak_sql.sql");
    ...
    public static int getCountEmpOutletMappingDownload(Date Start, Date End, String noMesin) {
        ...
        try {
            ...
            if (Start != null && End != null && noMesin != null && noMesin.length() > 0) {
                sql = sql + " AND " + "\"" + Formater.formatDate(End, "yyyy-MM-dd HH:mm:59") + "\" >= empoutlet." + PstEmployeeOutletDesktop.fieldNames[PstEmployeeOutlet.FLD_DATE_FROM] + " AND  empoutlet." + PstEmployeeOutlet.fieldNames[PstEmployeeOutlet.FLD_DATE_TO] + " >= \"" + Formater.formatDate(Start, "yyyy-MM-dd HH:mm:00") + "\""
...
//    }
     ...
     * @param sdhHabisData
     */
    public void setTransferKadivPerOutlet(String whereClause, boolean sdhHabisData, TmpBakupDataEmployeeOutletTransfer tmpBakupDataEmployeeOutletTransfer) throws SQLException {
        DBResultSet dbrs = null;
        ResultSet rs = null;
        String sql = "";
        String sqlQuery = "";
        ...
        try {
            sql = "SELECT emp." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID] + ",emp." + PstEmployee.fieldNames[PstEmployee.FLD_FULL_NAME]
                    ...
                    + ",loc." + PstLocation.fieldNames[PstLocation.FLD_CODE] + " FROM " + PstMappingKadivMain.TBL_HR_MAPPING_KADIV_MAIN + " AS mkm "
                    + " INNER JOIN " + PstEmployee.TBL_HR_EMPLOYEE + " AS emp ON mkm." + PstMappingKadivMain.fieldNames[PstMappingKadivMain.FLD_EMPLOYEE_ID] + "=emp." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID]
                    + " INNER JOIN " + PstMappingKadivDetail.TBL_HR_MAPPING_KADIV_DETAIL + " AS mkd ON mkm." + PstMappingKadivMain.fieldNames[PstMappingKadivMain.FLD_MAPPING_KADIV_MAIN_ID] + "=mkd." + PstMappingKadivDetail.fieldNames[PstMappingKadivDetail.FLD_MAPPING_KADIV_MAIN_ID]
                    + " INNER JOIN " + PstPosition.TBL_HR_POSITION + " AS pos ON pos." + PstPosition.fieldNames[PstPosition.FLD_POSITION_ID] + " = emp." + PstEmployee.fieldNames[PstEmployee.FLD_POSITION_ID]
                    + " LEFT JOIN " + PstAppUser.TBL_APP_USER + " AS appuser ON appuser." + PstAppUser.fieldNames[PstAppUser.FLD_EMPLOYEE_ID] + "=emp." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID]
            ...
            while (rs != null && rs.next() && theSize > 0 && isRunning()) {
                ...
                if (tabelEmployeeOutletTransferData.getEmployeeId() != 0) {
                    ...
                    if (true) {//if (hashEmployeeId.size() == 0 || hashEmployeeId.containsKey("" + tabelEmployeeOutletTransferData.getEmployeeId()) == false) {
                        try {
                            sqlQuery = sqlQuery + PstBakupEmployeeDesktopTransfer.insertExc(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
...
//                    else {
//                        PstBakupEmployeeDesktopTransfer.updateExc(tabelEmployeeOutletTransferData);
...
//                    }
                ...
                if (tabelEmployeeOutletTransferData.getWorkHistoryId() != 0) {
                    if (true) {//if ((hashWorkHistory.size() == 0 || hashWorkHistory.containsKey("" + tabelEmployeeOutletTransferData.getWorkHistoryId()) == false)) {
                        try {
                            sqlQuery = sqlQuery + PstBakupCareerPathDestopTransfer.insertExc(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  kadiv" + exc);
                        }
                        //hashEmployeeId.put("" + tabelEmployeeOutletTransferData.getEmployeeId(), tabelEmployeeOutletTransferData.getFullName());
...
//                    }
                ...
                if (tabelEmployeeOutletTransferData.getUserId() != 0) {
                    if (true) {//if (hashAppUser.size() == 0 || hashAppUser.containsKey("" + tabelEmployeeOutletTransferData.getUserId()) == false) {
                        try {
                            sqlQuery = sqlQuery + PstBakupAppUserDestopTransfer.insert(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  kadiv" + exc);
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText("Exception transfer Employee  Outlet" + exc);
...
//                    }
                ...
                if (tabelEmployeeOutletTransferData.getPositionId() != 0) {
                    if (true) {//if (hashPosition.size() == 0 || hashPosition.containsKey("" + tabelEmployeeOutletTransferData.getPositionId()) == false) {
                        try {
                            sqlQuery = sqlQuery + PstBakupPositionDestopTransfer.insertExc(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  kadiv" + exc);
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText("Exception transfer Employee  kadiv" + exc);
...
//                    }
                ...
                if (tabelEmployeeOutletTransferData.getLocationId() != 0) {
                    if (true) {//if (hashLocation.size() == 0 || hashLocation.containsKey("" + tabelEmployeeOutletTransferData.getLocationId()) == false) {
                        try {
                            sqlQuery = sqlQuery + PstBakupLocationDestopTransfer.insertExc(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  Outlet" + exc);
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText("Exception transfer Employee  Outlet" + exc);
...
//                }
            ...
            tmpBakupDataEmployeeOutletTransfer.setEmployeeId(empId);
            tmpBakupDataEmployeeOutletTransfer.setsQuery(sqlQuery);
            //return tmpBakupDataEmployeeOutletTransfer;
        }
    }

    public void setTransferMappingOutlet(TmpBakupDataEmployeeOutletTransfer tmpBakupDataEmployeeOutletTransfer) throws SQLException {
        DBResultSet dbrs = null;
        ResultSet rs = null;
        String empMappingOutletId = "";
        String syntacSql = "";
        //String whereClause = "";
        //Hashtable hashEmployeeOutlet = PstEmployeeOutletDesktop.hashEmpMappingIdAda(0, 0, "", "");
        try {
            ...
            if (getDtStart() != null && getDtFinish() != null && getCodeLocationMesin() != null && getCodeLocationMesin().length() > 0) {
                sql = sql + " AND " + "\"" + Formater.formatDate(getDtFinish(), "yyyy-MM-dd HH:mm:59") + "\" >= empoutlet." + PstEmployeeOutletDesktop.fieldNames[PstEmployeeOutlet.FLD_DATE_FROM] + " AND  empoutlet." + PstEmployeeOutlet.fieldNames[PstEmployeeOutlet.FLD_DATE_TO] + " >= \"" + Formater.formatDate(getDtStart(), "yyyy-MM-dd HH:mm:00") + "\""
            ...
            while (rs != null && rs.next() && theSize > 0 && isRunning()) {
                ...
                if (employeeOutlet.getOID() != 0) {
                    ...
                    if (true) {//if (hashEmployeeOutlet.size() == 0 || hashEmployeeOutlet.containsKey("" + employeeOutlet.getOID()) == false) {
                        try {
                            syntacSql = syntacSql + PstBakupEmployeeOutletDesktop.insertExc(employeeOutlet) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  Outlet" + exc);
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText("Exception transfer Employee  Outlet" + exc);
            ...
            if (tmpBakupDataEmployeeOutletTransfer != null) {
                String query = tmpBakupDataEmployeeOutletTransfer.getsQuery() != null && tmpBakupDataEmployeeOutletTransfer.getsQuery().length() > 0 ? (tmpBakupDataEmployeeOutletTransfer.getsQuery() + "\n" + syntacSql) : syntacSql;
                tmpBakupDataEmployeeOutletTransfer.setsQuery(query);
            }
        }
    }

    public void setTransferOutlet(String whereClause, boolean sdhHabisData, TmpBakupDataEmployeeOutletTransfer tmpBakupDataEmployeeOutletTransfer) throws SQLException {
        DBResultSet dbrs = null;
        ResultSet rs = null;
        String empId = "";
        String syntacSql = "";
        ...
        try {
            ...
            while (rs != null && rs.next() && theSize > 0 && isRunning()) {
                ...
                if (tabelEmployeeOutletTransferData.getEmployeeId() != 0) {
                    ...
                    if (true) {//if (hashEmployeeId.size() == 0 || hashEmployeeId.containsKey("" + tabelEmployeeOutletTransferData.getEmployeeId()) == false) {
                        try {
                            syntacSql = syntacSql + PstBakupEmployeeDesktopTransfer.insertExc(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  Outlet" + exc);
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText("Exception transfer Employee  Outlet" + exc);
                ...
                if (tabelEmployeeOutletTransferData.getWorkHistoryId() != 0) {
                    if (true) {//if ((hashWorkHistory.size() == 0 || hashWorkHistory.containsKey("" + tabelEmployeeOutletTransferData.getWorkHistoryId()) == false)) {
                        try {
                            syntacSql = syntacSql + PstBakupCareerPathDestopTransfer.insertExc(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  Outlet" + exc);
                        }
                        //hashEmployeeId.put("" + tabelEmployeeOutletTransferData.getEmployeeId(), tabelEmployeeOutletTransferData.getFullName());
                ...
                if (tabelEmployeeOutletTransferData.getUserId() != 0) {
                    if (true) {//if (hashAppUser.size() == 0 || hashAppUser.containsKey("" + tabelEmployeeOutletTransferData.getUserId()) == false) {
                        try {
                            syntacSql = syntacSql + PstBakupAppUserDestopTransfer.insert(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  Outlet" + exc);
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText("Exception transfer Employee  Outlet" + exc);
                ...
                if (tabelEmployeeOutletTransferData.getPositionId() != 0) {
                    if (true) {// if (hashPosition.size() == 0 || hashPosition.containsKey("" + tabelEmployeeOutletTransferData.getPositionId()) == false) {
                        try {
                            syntacSql = syntacSql + PstBakupPositionDestopTransfer.insertExc(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  Outlet" + exc);
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText("Exception transfer Employee  Outlet" + exc);
                ...
                if (tabelEmployeeOutletTransferData.getLocationId() != 0) {
                    if (true) {//if (hashLocation.size() == 0 || hashLocation.containsKey("" + tabelEmployeeOutletTransferData.getLocationId()) == false) {
                        try {
                            syntacSql = syntacSql + PstBakupLocationDestopTransfer.insertExc(tabelEmployeeOutletTransferData) + ";\n";
                        } catch (Exception exc) {
                            this.setMessage("Exception transfer Employee  Outlet" + exc);
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText("Exception transfer Employee  Outlet" + exc);
...
//                }
            ...
            //return empId;
            if (tmpBakupDataEmployeeOutletTransfer != null && empId != null && empId.length() > 0) {
                String tmpEmpId = tmpBakupDataEmployeeOutletTransfer.getEmployeeId() != null && tmpBakupDataEmployeeOutletTransfer.getEmployeeId().length() > 0 ? tmpBakupDataEmployeeOutletTransfer.getEmployeeId() + "," + empId : empId;
                tmpBakupDataEmployeeOutletTransfer.setEmployeeId(tmpEmpId);
                String query = tmpBakupDataEmployeeOutletTransfer.getsQuery() != null && tmpBakupDataEmployeeOutletTransfer.getsQuery().length() > 0 ? (tmpBakupDataEmployeeOutletTransfer.getsQuery() + "\n" + syntacSql) : syntacSql;
                tmpBakupDataEmployeeOutletTransfer.setsQuery(query);
            }
        }
    ...
    public void setTransferOvertime(String whereClause, boolean sdhHabisData, TmpBakupDataEmployeeOutletTransfer tmpBakupDataEmployeeOutletTransfer) throws SQLException {
        DBResultSet dbrs = null;
        ResultSet rs = null;
        String empId = "";
        String sql = "";
...
//                }
    ...
    public void setTransferExtraSch(String whereClause, boolean sdhHabisData, TmpBakupDataEmployeeOutletTransfer tmpBakupDataEmployeeOutletTransfer) throws SQLException {
        DBResultSet dbrs = null;
        ResultSet rs = null;
        String empId = "";
        String syntacSql = "";
...
//                }
     ...
     */
    public void setScheduleTransfer(String periodId, String sEmployeeId, boolean dataHabis, TmpBakupDataEmployeeOutletTransfer tmpBakupDataEmployeeOutletTransfer) throws SQLException {
        DBResultSet dbrs = null;
        ResultSet rs = null;
        String scheduleId = "";
        String syntakSql = "";
        ...
        try {
            ...
            while (rs != null && rs.next() && theSize > 0 && isRunning()) {
                ...
                if (tabelEmployeeScheduleTransfer.getPeriodId() != 0) {
                    if (true) {//if (hashPeriod.size() == 0 || hashPeriod.containsKey("" + tabelEmployeeScheduleTransfer.getPeriodId()) == false) {
                      
                        try {
                            syntakSql = syntakSql + PstBakupPeriodDestopTransfer.insertExc(tabelEmployeeScheduleTransfer) + ";\n";
                        } catch (Exception exc) {
                ...
                if (tabelEmployeeScheduleTransfer.getEmpScheduleId() != 0) {
                    ...
                    if (true) {//if (hashEmployeeSchedule.size() == 0 || hashEmployeeSchedule.containsKey("" + tabelEmployeeScheduleTransfer.getEmpScheduleId()) == false) {

                        try {
                            syntakSql = syntakSql + PstBakupEmpScheduleDestopTransfer.insertExc(tabelEmployeeScheduleTransfer) + ";\n";
                        } catch (Exception exc) {
                            message = "Error insert data period" + exc;
                            if (msgDownloadInformation != null) {
                                msgDownloadInformation.setText(message);
...
//                }
            ...
            //return scheduleId;
            if (tmpBakupDataEmployeeOutletTransfer != null) {
//                String tmpSchedule = tmpBakupDataEmployeeOutletTransfer.getScheduleId() != null && tmpBakupDataEmployeeOutletTransfer.getScheduleId().length() > 0 ? (tmpBakupDataEmployeeOutletTransfer.getScheduleId() + "," + scheduleId) : scheduleId;
//                tmpBakupDataEmployeeOutletTransfer.setScheduleId(tmpSchedule);
                String query = tmpBakupDataEmployeeOutletTransfer.getsQuery() != null && tmpBakupDataEmployeeOutletTransfer.getsQuery().length() > 0 ? (tmpBakupDataEmployeeOutletTransfer.getsQuery() + "\n" + syntakSql) : syntakSql;
                tmpBakupDataEmployeeOutletTransfer.setsQuery(query);
                String tmpScheduleId = tmpBakupDataEmployeeOutletTransfer.getScheduleId() != null && tmpBakupDataEmployeeOutletTransfer.getScheduleId().length() > 0 ? (tmpBakupDataEmployeeOutletTransfer.getScheduleId() + "\n" + scheduleId) : scheduleId;
                tmpBakupDataEmployeeOutletTransfer.setScheduleId(tmpScheduleId);
            }

        }
    }

    public void setScheduleSymbolTransfer(String inputScheduleParam, String sScheduleId, TmpBakupDataEmployeeOutletTransfer tmpBakupDataEmployeeOutletTransfer) throws SQLException {
        DBResultSet dbrs = null;
        ResultSet rs = null;
        ...
        try {
            ...
            while (rs != null && rs.next() && theSize > 0 && isRunning()) {
                ...
                if (tabelEmployeeScheduleTransfer.getScheduleId() != 0) {
                    if (true) {//if (hashSchedule.size() == 0 || hashSchedule.containsKey("" + tabelEmployeeScheduleTransfer.getScheduleId()) == false) {
                        try {
                            syntancSql = syntancSql + PstBakupScheduleDestopTransfer.insertExc(tabelEmployeeScheduleTransfer) + ";\n";
                        } catch (Exception exc) {
...
//                tmpBakupDataEmployeeOutletTransfer.setScheduleId(tmpSchedule);
    ...
    /**
     * @param locationSave the locationSave to set
     */
