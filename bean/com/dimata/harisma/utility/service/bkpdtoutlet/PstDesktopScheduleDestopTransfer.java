 ...
 * @author Wiweka
 */
public class PstDesktopScheduleDestopTransfer extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public PstDesktopScheduleDestopTransfer() {
    }

    public PstDesktopScheduleDestopTransfer(int i) throws DBException {
        super(new PstDesktopScheduleDestopTransfer());
    }

    public PstDesktopScheduleDestopTransfer(String sOid) throws DBException {
        super(new PstDesktopScheduleDestopTransfer(0));
        if (!locate(sOid)) {
    ...
    public PstDesktopScheduleDestopTransfer(long lOid) throws DBException {
        super(new PstDesktopScheduleDestopTransfer(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
        return new PstDesktopScheduleDestopTransfer().getClass().getName();
    }
    ...
    public static long insertExc(TabelEmployeeScheduleTransfer tabelEmployeeScheduleTransfer) throws DBException {
        try {
            PstDesktopScheduleDestopTransfer PstDesktopScheduleDestopTransfer = new PstDesktopScheduleDestopTransfer(0);

            PstDesktopScheduleDestopTransfer.setString(FLD_SCHEDULE, tabelEmployeeScheduleTransfer.getNameSchedule());
            PstDesktopScheduleDestopTransfer.setString(FLD_SYMBOL, tabelEmployeeScheduleTransfer.getScheduleSymbol());
            PstDesktopScheduleDestopTransfer.setLong(FLD_SCHEDULE_CATEGORY_ID, tabelEmployeeScheduleTransfer.getScheduleCategory());
            PstDesktopScheduleDestopTransfer.setDate(FLD_TIME_IN, tabelEmployeeScheduleTransfer.getTimeIn());
            PstDesktopScheduleDestopTransfer.setDate(FLD_TIME_OUT, tabelEmployeeScheduleTransfer.getTimeOut());
            PstDesktopScheduleDestopTransfer.setDate(FLD_BREAK_IN, tabelEmployeeScheduleTransfer.getBreakIn());
            PstDesktopScheduleDestopTransfer.setDate(FLD_BREAK_OUT, tabelEmployeeScheduleTransfer.getBreakOut());


            PstDesktopScheduleDestopTransfer.insert(tabelEmployeeScheduleTransfer.getScheduleId());
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
            throw new DBException(new PstDesktopScheduleDestopTransfer(0), DBException.UNKNOWN);
        }
    ...
    public static long updateExc(TabelEmployeeScheduleTransfer tabelEmployeeScheduleTransfer) throws DBException {
        try {
            if (tabelEmployeeScheduleTransfer.getScheduleId() != 0) {
                PstDesktopScheduleDestopTransfer PstDesktopScheduleDestopTransfer = new PstDesktopScheduleDestopTransfer(tabelEmployeeScheduleTransfer.getScheduleId());
                ...
                PstDesktopScheduleDestopTransfer.update();
                return tabelEmployeeScheduleTransfer.getScheduleId();
    ...
    public static long deleteExc(long oid) throws DBException {
        try {
            PstDesktopScheduleDestopTransfer pstCareerPath = new PstDesktopScheduleDestopTransfer(oid);
    ...
    public static boolean checkOID(long positionId) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_HR_SCHEDULE_SYMBOL + " WHERE "
                    + PstDesktopScheduleDestopTransfer.fieldNames[PstDesktopScheduleDestopTransfer.FLD_SCHEDULE_ID] + " = " + positionId;
