 ...
 */
public class PstMachineTransactionDesktop extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
	...
	public PstMachineTransactionDesktop(){
	}

	public PstMachineTransactionDesktop(int i) throws DBException { 
		super(new PstMachineTransactionDesktop()); 
	}

	public PstMachineTransactionDesktop(String sOid) throws DBException { 
		super(new PstMachineTransactionDesktop(0)); 
		if(!locate(sOid)) 
	...
	public PstMachineTransactionDesktop(long lOid) throws DBException { 
		super(new PstMachineTransactionDesktop(0)); 
		String sOid = "0"; 
		try { 
	...
	public String getPersistentName(){ 
		return new PstMachineTransactionDesktop().getClass().getName(); 
	}
	...
	public static MachineTransaction fetchExc(long oid) throws DBException{ 
		try{ 
                    ...
                    PstMachineTransactionDesktop PstMachineTransactionDesktop = new PstMachineTransactionDesktop(oid); 
                    ...
                    throw new DBException(new PstMachineTransactionDesktop(0),DBException.UNKNOWN); 
		}
	}

	public static long insertExc(MachineTransaction MachineTransaction) throws DBException{ 
		try{ 
                    PstMachineTransactionDesktop PstMachineTransactionDesktop = new PstMachineTransactionDesktop(0);
                    ...
                    PstMachineTransactionDesktop.insert(); 
                    MachineTransaction.setOID(PstMachineTransactionDesktop.getlong(FLD_MACHINE_TRANS_ID));
		}catch(DBException dbe){ 
                    throw dbe; 
		}catch(Exception e){ 
                    throw new DBException(new PstMachineTransactionDesktop(0),DBException.UNKNOWN); 
	...
	public static long updateExc(MachineTransaction MachineTransaction) throws DBException{ 
		try{ 
                    if(MachineTransaction.getOID() != 0){ 
                        PstMachineTransactionDesktop PstMachineTransactionDesktop = new PstMachineTransactionDesktop(MachineTransaction.getOID());
	...
	private static void resultToObject(ResultSet rs, MachineTransaction MachineTransaction){
		try{
			MachineTransaction.setOID(rs.getLong(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_MACHINE_TRANS_ID]));
			MachineTransaction.setCardId(rs.getString(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_CARD_ID]));
                        Date date = null;
                        try{
                            Date dateTemp = rs.getDate(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_DATE_TRANS]);
                            Time time = rs.getTime(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_DATE_TRANS]);
			...
			MachineTransaction.setMode(rs.getString(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_MODE]));
			MachineTransaction.setStation(rs.getString(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_STATION]));
			MachineTransaction.setPosted(rs.getInt(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_POSTED]));
                        MachineTransaction.setVerify(rs.getInt(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_VERIFY]));
                        MachineTransaction.setNote(rs.getString(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_NOTE]));
		}catch(Exception e){ }
	}
	...
	public static boolean checkOID(long MachineTransactionId){
		...
		try{
                    String sql = "SELECT * FROM " + TBL_HR_MACHINE_TRANS 
                            + " WHERE " + PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_MACHINE_TRANS_ID] 
	...
	public static int getCount(String whereClause){
		...
		try {
                    String sql = "SELECT COUNT("
                            + PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_MACHINE_TRANS_ID] 
    ...
    public static Hashtable hashListMachineTrans(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT * FROM " + PstMachineTransactionDesktop.TBL_HR_MACHINE_TRANS;
            if (whereClause != null && whereClause.length() > 0) {
                sql = sql + " WHERE " + whereClause;
            }
            if (order != null && order.length() > 0) {
            ...
            while (rs.next()) {
                String sCardId = rs.getString(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_CARD_ID]);
                ...
                sessMachineTransactionDestop.addDtTransaction(DBHandler.convertDate(rs.getDate(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_DATE_TRANS]), rs.getTime(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_DATE_TRANS])));
                sessMachineTransactionDestop.addMode(rs.getString(PstMachineTransactionDesktop.fieldNames[PstMachineTransactionDesktop.FLD_MODE]));
