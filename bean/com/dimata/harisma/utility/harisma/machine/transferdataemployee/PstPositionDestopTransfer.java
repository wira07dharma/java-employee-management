 ...
 * @author Wiweka
 */
public class PstPositionDestopTransfer extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public PstPositionDestopTransfer() {
    }

    public PstPositionDestopTransfer(int i) throws DBException {
        super(new PstPositionDestopTransfer());
    }

    public PstPositionDestopTransfer(String sOid) throws DBException {
        super(new PstPositionDestopTransfer(0));
        if (!locate(sOid)) {
    ...
    public PstPositionDestopTransfer(long lOid) throws DBException {
        super(new PstPositionDestopTransfer(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
        return new PstPositionDestopTransfer().getClass().getName();
    }
    ...
    public static long insertExc(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        try {
            PstPositionDestopTransfer pstPositionDestopTransfer = new PstPositionDestopTransfer(0);

            pstPositionDestopTransfer.setString(FLD_POSITION, tabelEmployeeOutletTransferData.getPositionName());

            pstPositionDestopTransfer.insert(tabelEmployeeOutletTransferData.getPositionId());
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
            throw new DBException(new PstPositionDestopTransfer(0), DBException.UNKNOWN);
        }
    ...
    public static long updateExc(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        try {
            if (tabelEmployeeOutletTransferData.getWorkHistoryId() != 0) {
                PstPositionDestopTransfer pstPositionDestopTransfer = new PstPositionDestopTransfer(tabelEmployeeOutletTransferData.getPositionId());
    ...
    public static long deleteExc(long oid) throws DBException {
        try {
            PstPositionDestopTransfer pstCareerPath = new PstPositionDestopTransfer(oid);
    ...
    public static boolean checkOID(long positionId) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_HR_POSITION + " WHERE "
                    + PstPositionDestopTransfer.fieldNames[PstPositionDestopTransfer.FLD_POSITION_ID] + " = " + positionId;
