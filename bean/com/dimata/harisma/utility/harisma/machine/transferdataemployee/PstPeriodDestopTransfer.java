 ...
 * @author Wiweka
 */
public class PstPeriodDestopTransfer extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public PstPeriodDestopTransfer() {
    }

    public PstPeriodDestopTransfer(int i) throws DBException {
        super(new PstPeriodDestopTransfer());
    }

    public PstPeriodDestopTransfer(String sOid) throws DBException {
        super(new PstPeriodDestopTransfer(0));
        if (!locate(sOid)) {
    ...
    public PstPeriodDestopTransfer(long lOid) throws DBException {
        super(new PstPeriodDestopTransfer(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
        return new PstPeriodDestopTransfer().getClass().getName();
    }
    ...
    public static long insertExc(TabelEmployeeScheduleTransfer tabelEmployeeScheduleTransfer) throws DBException {
        try {
            PstPeriodDestopTransfer pstPositionDestopTransfer = new PstPeriodDestopTransfer(0);
            ...
            pstPositionDestopTransfer.insert(tabelEmployeeScheduleTransfer.getPeriodId());
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
            throw new DBException(new PstPeriodDestopTransfer(0), DBException.UNKNOWN);
        }
    ...
    public static long updateExc(TabelEmployeeScheduleTransfer tabelEmployeeScheduleTransfer) throws DBException {
        try {
            if (tabelEmployeeScheduleTransfer.getPeriodId() != 0) {
                PstPeriodDestopTransfer pstPositionDestopTransfer = new PstPeriodDestopTransfer(tabelEmployeeScheduleTransfer.getPeriodId());
    ...
    public static long deleteExc(long oid) throws DBException {
        try {
            PstPeriodDestopTransfer pstCareerPath = new PstPeriodDestopTransfer(oid);
    ...
    public static boolean checkOID(long periodId) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_HR_PERIOD + " WHERE "
                    + PstPeriodDestopTransfer.fieldNames[PstPeriodDestopTransfer.FLD_PERIOD_ID] + " = " + periodId;
