 ...
 * @author Dimata 007
 */
public class EmployeeOutletTransferData implements Runnable {
    ...
    public String setTransferMappingOutlet() throws SQLException {
        ...
        try {
            ...
            if (rs !=null && getDtStart() != null && getDtFinish() != null && getCodeLocationMesin() != null && getCodeLocationMesin().length() > 0){
                try{
                    if (StrEmployeeOutletWithDate.length() > 2) {
                        Date dt = EmployeeOutletTransferData.deleteByEmpOutlet(StrEmployeeOutletWithDate);
                    }
