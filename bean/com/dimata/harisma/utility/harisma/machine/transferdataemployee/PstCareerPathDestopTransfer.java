 ...
 * @author Wiweka
 */
public class PstCareerPathDestopTransfer extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public PstCareerPathDestopTransfer() {
    }

    public PstCareerPathDestopTransfer(int i) throws DBException {
        super(new PstCareerPathDestopTransfer());
    }

    public PstCareerPathDestopTransfer(String sOid) throws DBException {
        super(new PstCareerPathDestopTransfer(0));
        if (!locate(sOid)) {
    ...
    public PstCareerPathDestopTransfer(long lOid) throws DBException {
        super(new PstCareerPathDestopTransfer(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
        return new PstCareerPathDestopTransfer().getClass().getName();
    }
    ...
    public static long insertExc(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        try {
            PstCareerPathDestopTransfer pstCareerPath = new PstCareerPathDestopTransfer(0);
            ...
            throw new DBException(new PstCareerPathDestopTransfer(0), DBException.UNKNOWN);
        }
    ...
    public static long updateExc(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        try {
            if (tabelEmployeeOutletTransferData.getWorkHistoryId() != 0) {
                PstCareerPathDestopTransfer pstCareerPath = new PstCareerPathDestopTransfer(tabelEmployeeOutletTransferData.getWorkHistoryId());
    ...
    public static long deleteExc(long oid) throws DBException {
        try {
            PstCareerPathDestopTransfer pstCareerPath = new PstCareerPathDestopTransfer(oid);
    ...
    public static boolean checkOID(long workHistoryNowId) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_HR_WORK_HISTORY_NOW + " WHERE "
                    + PstCareerPathDestopTransfer.fieldNames[PstCareerPathDestopTransfer.FLD_WORK_HISTORY_NOW_ID] + " = " + workHistoryNowId;
