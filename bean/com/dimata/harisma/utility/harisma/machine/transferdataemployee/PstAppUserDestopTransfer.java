...
public class PstAppUserDestopTransfer extends DBHandler implements I_DBInterface, I_DBType, I_Persintent  {
    ...
    /** Creates new PstAppUserDestopTransfer */
    public PstAppUserDestopTransfer() {
    }
    
    public PstAppUserDestopTransfer(int i) throws DBException {
        super(new PstAppUserDestopTransfer());
    }
    
    
    public PstAppUserDestopTransfer(String sOid) throws DBException {
        super(new PstAppUserDestopTransfer(0));
        if(!locate(sOid))
    ...
    public PstAppUserDestopTransfer(long lOid) throws DBException {
        super(new PstAppUserDestopTransfer(0));
        String sOid = "0";
        try {
    ...
    public String getPersistentName() {
        return new PstAppUserDestopTransfer().getClass().getName();
    }
    ...
    public static long insert(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException  {
        //        try{
        PstAppUserDestopTransfer pstObj = new PstAppUserDestopTransfer(0);
  ...
  */
    ...
    public static long update(TabelEmployeeOutletTransferData tabelEmployeeOutletTransferData) throws DBException {
        PstAppUserDestopTransfer pstObj = null;
        if(tabelEmployeeOutletTransferData.getUserId()!=0){
        pstObj = new PstAppUserDestopTransfer(tabelEmployeeOutletTransferData.getUserId());
        pstObj.setString(FLD_LOGIN_ID, tabelEmployeeOutletTransferData.getLoginId());
        pstObj.setString(FLD_PASSWORD, tabelEmployeeOutletTransferData.getPassword());
    ...
    public static long delete(long oid) {
        try {
            PstAppUserDestopTransfer pstObj = new PstAppUserDestopTransfer(oid);
            pstObj.delete();
            return oid;
        }catch(Exception e) {
            System.out.println(e);
