...
public class DBHandler implements I_DBType {
    ...
    public static String CONFIG_FILE = com.dimata.RootClass.getThisClassPath() + System.getProperty("file.separator") + "outletHarisma.xml";
   ...
   public static String getMesinLocation() throws Exception {
    ...
    /**
     * Keterangan: merubah sql time menjadi date
     * create by satrya 2014-06-28
     * @param time
     * @return 
     */
    public static java.util.Date convertDate(java.sql.Time time) {
        if (time != null) {
