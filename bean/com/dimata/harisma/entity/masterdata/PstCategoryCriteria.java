...
public class PstCategoryCriteria extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public static final  String TBL_HR_CATEGORY_CRITERIA = "hr_category_criteria";//"HR_CATEGORY_CRITERIA";
	...
	public static final  int FLD_DESC_1 = 3;
	public static final  int FLD_DESC_2 = 4;
	public static final  int FLD_DESC_3 = 5;
	public static final  int FLD_DESC_4 = 6;
	public static final  int FLD_DESC_5 = 7;
	...
	public static CategoryCriteria fetchExc(long oid) throws DBException{ 
		try{ 
			...
			categorycriteria.setDesc1(pstCategoryCriteria.getString(FLD_DESC_1));
			categorycriteria.setDesc2(pstCategoryCriteria.getString(FLD_DESC_2));
			categorycriteria.setDesc3(pstCategoryCriteria.getString(FLD_DESC_3));
			categorycriteria.setDesc4(pstCategoryCriteria.getString(FLD_DESC_4));
			categorycriteria.setDesc5(pstCategoryCriteria.getString(FLD_DESC_5));
	...
	public static long insertExc(CategoryCriteria categorycriteria) throws DBException{ 
		try{ 
			...
			pstCategoryCriteria.setString(FLD_DESC_1, categorycriteria.getDesc1());
			pstCategoryCriteria.setString(FLD_DESC_2, categorycriteria.getDesc2());
			pstCategoryCriteria.setString(FLD_DESC_3, categorycriteria.getDesc3());
			pstCategoryCriteria.setString(FLD_DESC_4, categorycriteria.getDesc4());
			pstCategoryCriteria.setString(FLD_DESC_5, categorycriteria.getDesc5());
	...
	private static void resultToObject(ResultSet rs, CategoryCriteria categorycriteria){
		try{
			...
			categorycriteria.setDesc1(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_1]));
			categorycriteria.setDesc2(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_2]));
			categorycriteria.setDesc3(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_3]));
			categorycriteria.setDesc4(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_4]));
			categorycriteria.setDesc5(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_5]));
