 ...
 * @author GUSWIK
 */
public class PstDocMasterActionParam extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {

   public static final String TBL_HR_DOC_MASTER_ACTION_PARAM = "hr_doc_action_param";
   public static final int FLD_DOC_ACTION_PARAM_ID = 0;
   public static final int FLD_ACTION_PARAMETER = 1;
   public static final int FLD_OBJECT_NAME = 2;
   public static final int FLD_OBJECT_ATTRIBUTE = 3;
   ...
   public PstDocMasterActionParam() {
    ...
    public String getTableName() {
        return TBL_HR_DOC_MASTER_ACTION_PARAM;
    }
    ...
    public static Vector list(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_HR_DOC_MASTER_ACTION_PARAM;
    ...
    public static long deletewhereActionId( long actionId) {
        ...
        long resulthasil =0;
        try {
            String sql = "DELETE  FROM " + TBL_HR_DOC_MASTER_ACTION_PARAM + " WHERE "
    ...
    public static boolean checkOID(long docActionParamId) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_HR_DOC_MASTER_ACTION_PARAM + " WHERE "
    ...
    public static int getCount(String whereClause) {
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT COUNT(" + PstDocMasterActionParam.fieldNames[PstDocMasterActionParam.FLD_DOC_ACTION_PARAM_ID] + ") FROM " + TBL_HR_DOC_MASTER_ACTION_PARAM;
            if (whereClause != null && whereClause.length() > 0) {
                sql = sql + " WHERE " + whereClause;
            }
