...
public class PstEducation extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public static final  String TBL_HR_EDUCATION = "hr_education";//"HR_EDUCATION";
	...
	public static final  int FLD_EDUCATION_DESC = 2;
        public static final  int FLD_EDUCATION_LEVEL = 3;
        public static final  int FLD_KATEGORI = 4;
	...
	public static Education fetchExc(long oid) throws DBException{ 
		try{ 
			...
			education.setEducationDesc(pstEducation.getString(FLD_EDUCATION_DESC));
                        education.setEducationLevel(pstEducation.getInt(FLD_EDUCATION_LEVEL));
			education.setKategori(pstEducation.getString(FLD_KATEGORI));
	...
	public static long insertExc(Education education) throws DBException{ 
		try{ 
			...
			pstEducation.setString(FLD_EDUCATION_DESC, education.getEducationDesc());
                        pstEducation.setInt(FLD_EDUCATION_LEVEL, education.getEducationLevel());
                        pstEducation.setString(FLD_KATEGORI, education.getKategori());
	...
	private static void resultToObject(ResultSet rs, Education education){
		try{
			...
			education.setEducationDesc(rs.getString(PstEducation.fieldNames[PstEducation.FLD_EDUCATION_DESC]));
                        education.setEducationLevel(rs.getInt(PstEducation.fieldNames[PstEducation.FLD_EDUCATION_LEVEL]));
                        education.setKategori(rs.getString(PstEducation.fieldNames[PstEducation.FLD_KATEGORI]));
