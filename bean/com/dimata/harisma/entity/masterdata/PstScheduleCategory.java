...
public class PstScheduleCategory extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public static final  String TBL_HR_SCHEDULE_CATEGORY = "hr_schedule_category";//"HR_SCHEDULE_CATEGORY";
	...
	public static final  int[] fieldTypes = {
		...
		TYPE_STRING,
         ...
         public static final int CATEGORY_ABSENCE               = 3;
         public static final int CATEGORY_OFF                   = 4;         
         public static final int CATEGORY_ACCROSS_DAY           = 5;           
         public static final int CATEGORY_DAYOFF_PAYMENT        = 6;
         public static final int CATEGORY_ANNUAL_LEAVE          = 7;
         public static final int CATEGORY_LONG_LEAVE            = 8;   
         public static final int CATEGORY_EXTRA_ON_DUTY         = 9;
         public static final int CATEGORY_NEAR_ACCROSS_DAY      = 10;  
         public static final int CATEGORY_SUPPOSED_TO_BE_OFF    = 11;  
         public static final int CATEGORY_SPECIAL_LEAVE         = 12;  
         public static final int CATEGORY_UNPAID_LEAVE          = 13;
         public static final int CATEGORY_PARTIAL_LEAVE_DAY     = 14;
         public static final int CATEGORY_UNPAID_EXCUSE         = 15;
         public static final int CATEGORY_STOCK_LEAVE           = 16;
	...
	private static void resultToObject(ResultSet rs, ScheduleCategory schedulecategory){
        ...
        public static Hashtable<String, Long> getScheduleCat() {
        DBResultSet dbrs = null;
        ...
        try {
            ...
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                long oid= rs.getLong(PstScheduleCategory.fieldNames[PstScheduleCategory.FLD_SCHEDULE_CATEGORY_ID]);
                scheduleSymbolMap.put("" + rs.getLong(PstScheduleCategory.fieldNames[PstScheduleCategory.FLD_CATEGORY_TYPE]), oid);
            }
