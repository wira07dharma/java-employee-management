 ...
 * @author Dimata 007
 */
public class AttendanceConfigYashoda implements I_Atendance {

    public int getConfigurasiInOut() {
        return I_Atendance.CONFIGURASI_II_SEARCH_BY_IN_OUT;
    }
    ...
    public boolean getConfigurasiWorkingDays(long syspropScheduleOff, long oidScheduleOff, int statusAbs) {
        if (syspropScheduleOff == oidScheduleOff || statusAbs == PstEmpSchedule.STATUS_PRESENCE_ABSENCE) {
            return false;
        } else {
            return true;
        }
