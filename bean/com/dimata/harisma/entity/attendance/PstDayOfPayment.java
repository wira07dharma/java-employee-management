...
public class PstDayOfPayment extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public static final  String TBL_HR_DAY_OF_PAYMENT ="hr_day_of_payment";// "HR_DAY_OF_PAYMENT";
	...
	public static DayOfPayment fetchExc(long oid) throws DBException{ 
		try{ 
			...
			dayofpayment.setDuration(pstDayOfPayment.getfloat(FLD_DURATION));
	...
	public static long insertExc(DayOfPayment dayofpayment) throws DBException{ 
		try{ 
			...
			pstDayOfPayment.setFloat(FLD_DURATION, dayofpayment.getDuration());
	...
	private static void resultToObject(ResultSet rs, DayOfPayment dayofpayment){
		try{
			...
			dayofpayment.setDuration(rs.getFloat(PstDayOfPayment.fieldNames[PstDayOfPayment.FLD_DURATION]));
    ...
    public static long deleteByEmployee(long emplOID)
    {
    	try{
        	...
        	System.out.println("error delete day off payment by employee "+exc.toString());
    	}
    	return emplOID;
    }
