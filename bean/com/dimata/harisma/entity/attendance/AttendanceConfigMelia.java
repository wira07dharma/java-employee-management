 ...
 * @author ramayu
 */
public class AttendanceConfigMelia implements I_Atendance {
    ...
    public int getConfigurationBirthDay() {
        return I_Atendance.CONFIGURASI_III_VIEW_BIRTHDAY_A_MONTH_NOT_SHOW_ANNYVERSARY_DATE_HAS_PASSED;
    }
