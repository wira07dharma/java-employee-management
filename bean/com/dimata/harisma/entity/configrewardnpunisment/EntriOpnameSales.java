 ...
 */
public class EntriOpnameSales extends Entity {

    public static final int STATUS_REWARD = 0;
    public static final int STATUS_PUNISMENT = 1;
    
    public static String[] fieldNamesStatus = {
        "REWARD",
        "PUNISMENT"
    };
    public static int[] fieldTypesStatus = {
        STATUS_REWARD, 
        STATUS_PUNISMENT
    };
    ...
    public String getStatusOpname() {
        if (prosentaseTolerance > barangHilang) {
            statusOpname = fieldNamesStatus[STATUS_REWARD];
        } else {
            statusOpname = fieldNamesStatus[STATUS_PUNISMENT];
        }
        return statusOpname;
    }
     ...
     */
    public int getStatusProses() {
        return statusProses;
    }

    /**
     * @param statusProses the statusProses to set
     */
    public void setStatusProses(int statusProses) {
