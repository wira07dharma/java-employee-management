...
public class CopyJava
    ...
    public void copyDirFiles(String sourceDir, String targetDir)
        ...
        if (checkDirSource.exists())
            ...
            {
            errMsg="<font color=\"red\">Unable to locate source directory..., please check source path directory !!!</font>";
        ...
        for (int i = 0; i < myList.length; i++)
            ...
            if (tmp.isFile())
                ...
                try
                    ...
                    errMsg = "<font color=\"red\">Cannot copy " + tmp.getName() + ". " + e.getMessage()+"</font>";
                    System.out.println(errMsg);
                    this.listErr.add(errMsg);
                    return;
                    }
