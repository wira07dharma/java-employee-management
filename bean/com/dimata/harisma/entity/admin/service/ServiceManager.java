...
import com.dimata.harisma.entity.admin.service.*;


//import com.dimata.harisma.entity.admin.service.objlock.ObjLocker;
...
public class ServiceManager
{
    ...
    /*public Vector getLog(int start,int limit) {
       String sql = "SELECT DATE_CREATED, TARGET1_NOTE, TARGET2_NOTE,TARGET3_NOTE FROM LOGGER LIMIT "+start+","+limit+"";

       Vector fieldNames = new Vector(1,1);
       fieldNames.add("DATE_CREATED");
       fieldNames.add("TARGET1_NOTE");
       fieldNames.add("TARGET2_NOTE");
       fieldNames.add("TARGET3_NOTE");

       Vector fieldTypes = new Vector(1,1);
       fieldTypes.add(new Integer(DBInfo.TYPE_DATE));
       fieldTypes.add(new Integer(DBInfo.TYPE_STRING));
       fieldTypes.add(new Integer(DBInfo.TYPE_STRING));
       fieldTypes.add(new Integer(DBInfo.TYPE_STRING));

       try{
            return DBHandler.execQueryRows(sql, fieldNames, fieldTypes);
       }catch(Exception e) {
       }
       return new Vector();
    } */
    ...
    public Vector getLog(int start,int limit) {
       String sql = "SELECT * FROM LOGGER LIMIT "+start+","+limit+"";
    ...
    public int getMaxLog() {
       ...
       Vector fieldTypes = new Vector(1,1);
       fieldTypes.add(new Integer(DBInfo.TYPE_INT));
       */
       int count =0;
       DBResultSet dbrs = null;
       try{
