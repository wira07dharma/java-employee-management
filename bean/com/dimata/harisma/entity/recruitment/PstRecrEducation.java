...
public class PstRecrEducation extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public static final  String TBL_HR_RECR_EDUCATION = "hr_recr_education";//"HR_RECR_EDUCATION";
	...
	public static final  int FLD_KATEGORI = 7;
	...
	public static RecrEducation fetchExc(long oid) throws DBException{ 
		try{ 
			...
			recreducation.setKategori(pstRecrEducation.getString(FLD_KATEGORI));
	...
	public static long insertExc(RecrEducation recreducation) throws DBException{ 
		try{ 
			...
			pstRecrEducation.setString(FLD_KATEGORI, recreducation.getKategori());
	...
	public static void resultToObject(ResultSet rs, RecrEducation recreducation){
		try{
			...
			recreducation.setKategori(rs.getString(PstRecrEducation.fieldNames[PstRecrEducation.FLD_KATEGORI]));
