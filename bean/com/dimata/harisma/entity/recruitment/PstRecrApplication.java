...
public class PstRecrApplication extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public static final  String TBL_HR_RECR_APPLICATION = "hr_recr_application";//"HR_RECR_APPLICATION";
	...
	public static final  int FLD_CHILD4_NAME = 60;
	public static final  int FLD_CHILD4_BIRTHDATE = 61;
	public static final  int FLD_CHILD4_SEX = 62;
	public static final  int FLD_CHILD5_NAME = 63;
	public static final  int FLD_CHILD5_BIRTHDATE = 64;
	public static final  int FLD_CHILD5_SEX = 65;
        
	public static final  int FLD_CHILD6_NAME = 66;
	public static final  int FLD_CHILD6_BIRTHDATE = 67;
	public static final  int FLD_CHILD6_SEX = 68;
        public static final  int FLD_CHILD7_NAME = 69;
	public static final  int FLD_CHILD7_BIRTHDATE = 70;
	public static final  int FLD_CHILD7_SEX = 71;
        
        public static final  int FLD_EMAIL_ADDRESS = 72;  
        public static final  int FLD_REFERENCE = 73; 
        public static final  int FLD_NAME_EMG = 74; 
        public static final  int FLD_PHONE_EMG = 75; 
        public static final  int FLD_ADDRESS_EMG = 76; 
        
        public static final  int FLD_SKILL = 77; 
	...
	public static RecrApplication fetchExc(long oid) throws DBException{ 
		try{ 
			...
			recrapplication.setChild4Name(pstRecrApplication.getString(FLD_CHILD4_NAME));
			recrapplication.setChild4Birthdate(pstRecrApplication.getDate(FLD_CHILD4_BIRTHDATE));
			recrapplication.setChild4Sex(pstRecrApplication.getInt(FLD_CHILD4_SEX));
			recrapplication.setChild5Name(pstRecrApplication.getString(FLD_CHILD5_NAME));
			recrapplication.setChild5Birthdate(pstRecrApplication.getDate(FLD_CHILD5_BIRTHDATE));
			recrapplication.setChild5Sex(pstRecrApplication.getInt(FLD_CHILD5_SEX));
			recrapplication.setChild6Name(pstRecrApplication.getString(FLD_CHILD6_NAME));
			recrapplication.setChild6Birthdate(pstRecrApplication.getDate(FLD_CHILD6_BIRTHDATE));
			recrapplication.setChild6Sex(pstRecrApplication.getInt(FLD_CHILD6_SEX));
			recrapplication.setChild7Name(pstRecrApplication.getString(FLD_CHILD7_NAME));
			recrapplication.setChild7Birthdate(pstRecrApplication.getDate(FLD_CHILD7_BIRTHDATE));
			recrapplication.setChild7Sex(pstRecrApplication.getInt(FLD_CHILD7_SEX));
                        
                        recrapplication.setEmailaddres(pstRecrApplication.getString(FLD_EMAIL_ADDRESS));
                        recrapplication.setReference(pstRecrApplication.getString(FLD_REFERENCE));
                        recrapplication.setNameemg(pstRecrApplication.getString(FLD_NAME_EMG));
                        recrapplication.setPhoneemg(pstRecrApplication.getString(FLD_PHONE_EMG));
                        recrapplication.setAddressemg(pstRecrApplication.getString(FLD_ADDRESS_EMG));
                        
                        recrapplication.setSkill(pstRecrApplication.getString(FLD_SKILL));
	...
	public static long insertExc(RecrApplication recrapplication) throws DBException{ 
		try{ 
			...
			pstRecrApplication.setString(FLD_FNL_PROBATION, recrapplication.getFnlProbation());
                        ...
                        //ADD BY priska 2015-02-01
			pstRecrApplication.setString(FLD_CHILD4_NAME, recrapplication.getChild4Name());
			pstRecrApplication.setDate(FLD_CHILD4_BIRTHDATE, recrapplication.getChild4Birthdate());
			pstRecrApplication.setInt(FLD_CHILD4_SEX, recrapplication.getChild4Sex());
                        
			pstRecrApplication.setString(FLD_CHILD5_NAME, recrapplication.getChild5Name());
			pstRecrApplication.setDate(FLD_CHILD5_BIRTHDATE, recrapplication.getChild5Birthdate());
			pstRecrApplication.setInt(FLD_CHILD5_SEX, recrapplication.getChild5Sex());
                        
			pstRecrApplication.setString(FLD_CHILD6_NAME, recrapplication.getChild6Name());
			pstRecrApplication.setDate(FLD_CHILD6_BIRTHDATE, recrapplication.getChild6Birthdate());
			pstRecrApplication.setInt(FLD_CHILD6_SEX, recrapplication.getChild6Sex());
                        
			pstRecrApplication.setString(FLD_CHILD7_NAME, recrapplication.getChild7Name());
			pstRecrApplication.setDate(FLD_CHILD7_BIRTHDATE, recrapplication.getChild7Birthdate());
			pstRecrApplication.setInt(FLD_CHILD7_SEX, recrapplication.getChild7Sex());
                        
                        pstRecrApplication.setString(FLD_EMAIL_ADDRESS, recrapplication.getEmailaddres());
                        pstRecrApplication.setString(FLD_REFERENCE, recrapplication.getReference());
                        pstRecrApplication.setString(FLD_NAME_EMG, recrapplication.getNameemg());
                        pstRecrApplication.setString(FLD_PHONE_EMG, recrapplication.getPhoneemg());
                        pstRecrApplication.setString(FLD_ADDRESS_EMG, recrapplication.getAddressemg());
                        
                        pstRecrApplication.setString(FLD_SKILL, recrapplication.getSkill());
...
public static long updateExcfamilly(RecrApplication recrapplication) throws DBException{ 
		try{ 
			if(recrapplication.getOID() != 0){ 
				PstRecrApplication pstRecrApplication = new PstRecrApplication(recrapplication.getOID());
...
public static long updateExcSkill(RecrApplication recrapplication) throws DBException{ 
		try{ 
			if(recrapplication.getOID() != 0){ 
				PstRecrApplication pstRecrApplication = new PstRecrApplication(recrapplication.getOID());
                                //UPDATE BY PRISKA 2015-01-31
                                pstRecrApplication.setString(FLD_POSITION, recrapplication.getPosition());
				pstRecrApplication.setString(FLD_OTHER_POSITION, recrapplication.getOtherPosition());
	...
	public static void resultToObject(ResultSet rs, RecrApplication recrapplication){
		try{
			...
			recrapplication.setChild4Name(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD4_NAME]));
			recrapplication.setChild4Birthdate(rs.getDate(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD4_BIRTHDATE]));
			recrapplication.setChild4Sex(rs.getInt(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD4_SEX]));
                        
                        
			recrapplication.setChild5Name(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD5_NAME]));
			recrapplication.setChild5Birthdate(rs.getDate(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD5_BIRTHDATE]));
			recrapplication.setChild5Sex(rs.getInt(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD5_SEX]));
                        
			recrapplication.setChild6Name(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD6_NAME]));
			recrapplication.setChild6Birthdate(rs.getDate(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD6_BIRTHDATE]));
			recrapplication.setChild6Sex(rs.getInt(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD6_SEX]));
                        
			recrapplication.setChild7Name(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD7_NAME]));
			recrapplication.setChild7Birthdate(rs.getDate(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD7_BIRTHDATE]));
			recrapplication.setChild7Sex(rs.getInt(PstRecrApplication.fieldNames[PstRecrApplication.FLD_CHILD7_SEX]));
                        
                        recrapplication.setEmailaddres(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_REFERENCE]));
                        recrapplication.setReference(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_NAME_EMG]));
                        recrapplication.setNameemg(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_NAME_EMG]));
                        recrapplication.setPhoneemg(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_PHONE_EMG]));
                        recrapplication.setAddressemg(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_ADDRESS_EMG]));
                        
                        recrapplication.setSkill(rs.getString(PstRecrApplication.fieldNames[PstRecrApplication.FLD_SKILL]));
