...
public class PstPerformanceEvaluation extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public static final  String TBL_HR_PERFORMANCE_EVALUATION = "hr_performance_evaluation";// "HR_PERFORMANCE_EVALUATION";
    ...
    public static Vector listPerfEvaluation(long empAppOID){
        return listPerfEvaluation(empAppOID,false);
    }
    public static Vector listPerfEvaluation(long empAppOID, boolean getCriteriaDesc){
		Vector lists = new Vector(); 
		DBResultSet dbrs = null;
		try {
			String sql = " SELECT PER."+PstPerformanceEvaluation.fieldNames[PstPerformanceEvaluation.FLD_PERFORMANCE_APPRAISAL_ID]+
                         ...
                         (getCriteriaDesc?
                             ( " , CC."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_1]+
                               " , CC."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_2]+
                               " , CC."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_3]+
                               " , CC."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_4]+
                               " , CC."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_5]
                             )                             
                             :"") +
			...
			while(rs.next()) {
                ...
                if(getCriteriaDesc){
                    categCriteria.setDesc1(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_1]));
                    categCriteria.setDesc2(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_2]));
                    categCriteria.setDesc3(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_3]));
                    categCriteria.setDesc4(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_4]));
                    categCriteria.setDesc5(rs.getString(PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_5]));
                }
    	...
    	try{
        	String sql = " SELECT CRI."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_CATEGORY_CRITERIA_ID]+
                		 ", CRI."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_CRITERIA]+
                            ( " , CRI."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_1]+
                               " , CRI."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_2]+
                               " , CRI."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_3]+
                               " , CRI."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_4]+
                               " , CRI."+PstCategoryCriteria.fieldNames[PstCategoryCriteria.FLD_DESC_5]
                             )                        +
