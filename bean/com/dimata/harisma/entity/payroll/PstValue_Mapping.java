...
public class PstValue_Mapping extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_SEX = 22;
    public static final int FLD_STATUS = 23;
    public static final int FLD_RELIGION_ID = 24;
    public static final int FLD_LOS_FROM_IN_DAY   = 25;
    public static final int FLD_LOS_FROM_IN_MONTH = 26;
    public static final int FLD_LOS_FROM_IN_YEAR  = 27;
    public static final int FLD_LOS_TO_IN_DAY     = 28;
    public static final int FLD_LOS_TO_IN_MONTH   = 29;
    public static final int FLD_LOS_TO_IN_YEAR    = 30;
    public static final int FLD_LOS_CURRENT_DATE  = 31;
    public static final int FLD_LOS_PER_CURRENT_DATE  = 32;
    public static final int FLD_RESIGN_STATUS  = 33;
	public static final int FLD_REMARK = 34;
    ...
    public static Value_Mapping fetchExc(long oid) throws DBException {
        try {
            ...
            value_Mapping.setGrade(pstValue_Mapping.getlong(FLD_GRADE));//"GRADE"
            value_Mapping.setSex(pstValue_Mapping.getInt(FLD_SEX));
            value_Mapping.setStatus(pstValue_Mapping.getInt(FLD_STATUS));
            value_Mapping.setReligion(pstValue_Mapping.getLong(FLD_RELIGION_ID));
             ...
             value_Mapping.setResignStatus(pstValue_Mapping.getInt(FLD_RESIGN_STATUS));
    ...
    public static long insertExc(Value_Mapping value_Mapping) throws DBException {
        try {
            ...
            pstValue_Mapping.setInt(FLD_SEX, value_Mapping.getSex());// "SEX"
            pstValue_Mapping.setInt(FLD_STATUS, value_Mapping.getStatus());
            pstValue_Mapping.setLong(FLD_RELIGION_ID, value_Mapping.getReligion());
            ...
            pstValue_Mapping.setInt(FLD_RESIGN_STATUS, value_Mapping.getResignStatus());
    ...
    public static long updateExc(Value_Mapping value_Mapping) throws DBException {
        try {
            if (value_Mapping.getOID() != 0) {
                ...
                pstValue_Mapping.setInt(FLD_SEX, value_Mapping.getSex());
                pstValue_Mapping.setInt(FLD_STATUS, value_Mapping.getStatus());
                pstValue_Mapping.setLong(FLD_RELIGION_ID, value_Mapping.getReligion());
                pstValue_Mapping.setInt(FLD_LOS_FROM_IN_DAY, value_Mapping.getLosFromInDay());
                pstValue_Mapping.setInt(FLD_LOS_FROM_IN_MONTH, value_Mapping.getLosFromInMonth());
    ...
    public static Vector listInnerJoin(int limitStart, int recordToGet, String whereClause, String order, long empId, int sType) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT * FROM " + TBL_VALUE_MAPPING +" vm ";
            if(sType == 1){
               sql = sql + " INNER JOIN " + PstEmployee.TBL_HR_EMPLOYEE  +" he ON (he.EMPLOYEE_ID = vm.EMPLOYEE_ID)"; 
            } else if (sType == 2){
               sql = sql + " INNER JOIN " + PstPaySlip.TBL_PAY_SLIP  +" pay ON (pay.EMPLOYEE_ID = vm.EMPLOYEE_ID)"; 
            }
    ...
    public static void resultToObject(ResultSet rs, Value_Mapping value_Mapping) {
        try {
            ...
            value_Mapping.setSex(rs.getInt(PstValue_Mapping.fieldNames[PstValue_Mapping.FLD_SEX]));
            value_Mapping.setStatus(rs.getInt(PstValue_Mapping.fieldNames[PstValue_Mapping.FLD_STATUS]));
            value_Mapping.setReligion(rs.getLong(PstValue_Mapping.fieldNames[PstValue_Mapping.FLD_RELIGION_ID]));
            ...
            value_Mapping.setResignStatus(rs.getInt(PstValue_Mapping.fieldNames[PstValue_Mapping.FLD_RESIGN_STATUS]));  
    ...
    //add by priska 20151214   
       public static String listUpdateStatusValue(String compCode, Date eDate) {
        DBResultSet dbrs = null;
        String result = "";
         ...
         try {
            String sql = " SELECT * FROM "+ PstValue_Mapping.TBL_VALUE_MAPPING +" WHERE ";
               ...
               //whereClause = whereClause+ " AND "+PstValue_Mapping.fieldNames[PstValue_Mapping.FLD_STATUS] + " = " + 0;   
               whereClause = whereClause+ " AND "+PstValue_Mapping.fieldNames[PstValue_Mapping.FLD_COMP_CODE] + " = \"" +compCode+"\"" ;      
         
          
           sql = sql + whereClause ;
           sql = sql + " ORDER BY "+PstValue_Mapping.fieldNames[PstValue_Mapping.FLD_START_DATE]+" ASC ";
            ...
            while(rs.next()) {
                Value_Mapping value_Mapping = new Value_Mapping();
                resultToObject(rs, value_Mapping);
                //value_Mapping.setStatus(1); //sdata history
                value_Mapping.setEnddate(eDate); //sdata history
                try{
                    
                long oid = PstValue_Mapping.updateExc(value_Mapping);
               
                result = "Data end date has been change" ;
                }catch (Exception e){}
