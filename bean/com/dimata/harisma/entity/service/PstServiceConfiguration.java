...
package com.dimata.harisma.entity.service;
...
public class PstServiceConfiguration  extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final  String TBL_SERVICE_CONF = "hr_service_conf";//"HR_SERVICE_CONF";
    ...
    public static int SERVICE_TYPE_MESSAGE = 5;
    public static int SERVICE_TYPE_BIRD_DAY = 6;
    public static int SERVICE_TYPE_EARLY = 7;
    public static int SERVICE_TYPE_DAY_PAYMENT = 8;
    
    public static String[][] resultText = {
        {"Kehadiran", "Absen", "Terlambat", "Cuti", "Backup Database","Mengirim Pesan","Ulang Tahun","Pulang Awal", "Pembayaran Day Off"},
        {"Presence", "Absence", "Lateness", "Leave", "Backup Database","Send Message","Birth Day","Early Home", "Day Off Payment"}
    };
...
//                    System.out.println("SQL Service conf : " + sql);
    ...
    public static void resultToObject(ResultSet rs, ServiceConfiguration serviceConfiguration){
            try{
                    ...
                    //Date date = TransferPresenceFromMdfText.                    
