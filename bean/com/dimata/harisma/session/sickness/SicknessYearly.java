 ...
 * @author khirayinnura
 */
public class SicknessYearly {
    private String empNum;
    private String empName;
    private Vector<SicknessMonthlyRekap> totalMonthly = new Vector();

    
    public SicknessYearly(String empNum, String empName){
        this.empName = empName;
        this.empNum = empNum;
        for(int i=0; i < 12; i++){
            totalMonthly.add(new SicknessMonthlyRekap());
        }
    ...
    public void setMonthlyRekap(SicknessMonthlyRekap monthlyRekap) {
    ...
    public SicknessMonthlyRekap getMonthlyRekap(int month){
        if(month < 0 || month > 12){
            return null;
        }
