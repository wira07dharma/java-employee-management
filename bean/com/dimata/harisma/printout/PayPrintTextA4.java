 ...
 * @author Gunadi
 */
public class PayPrintTextA4 extends HttpServlet {
            ...
            switch (MODEL_PAYSLIP) {
                ...
                case PaySlip.MODEL_UP_DOWN:
                    try {
                        ...
                        int m = enter;
                        obj.setLine(startCompany+m, getLeftMargin(), "Section", getMaxLeftgSiteLength());
                        obj.setLine(startCompany+m++, getLeftMargin() + getStartColHeaderValue()+5, ": "+section, getMaxLeftgSiteLength());
                        obj.setLine(startCompany+m, getLeftMargin(), "Employee No.", getMaxLeftgSiteLength());
                        obj.setLine(startCompany+m++, getLeftMargin() + getStartColHeaderValue()+5, ": "+employeeNum+"/"+employeeName, getMaxLeftgSiteLength()+9);
                        obj.setLine(startCompany+m, getLeftMargin(), "Position", getMaxLeftgSiteLength());
                        obj.setLine(startCompany+m++, getLeftMargin() + getStartColHeaderValue()+5, ": "+pos.getPosition(), getMaxLeftgSiteLength()+9);
                        int r = enter;
                        obj.setLine(startRowSlipComp+r, startColSlipComp+5, "Period", getMaxLeftgSiteLength());
                        obj.setLine(startRowSlipComp+r++, startColSlipValue+5, ": "+periodName, getMaxLeftgSiteLength());
                        obj.setLine(startRowSlipComp+r, startColSlipComp+5, "Status", getMaxLeftgSiteLength());
                        obj.setLine(startRowSlipComp+r++, startColSlipValue+5, ": "+TaxCalculator.STATUS_EMPLOYEE_CODE[mStatus.getMaritalStatusTax()], getMaxLeftgSiteLength());
                        ...
                        obj.setLine(startCompany+c, getLeftMargin(), payGen.getCompanyName(), getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin(), payGen.getCompAddress(), getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin(), payGen.getCity() + " " + payGen.getZipCode(), getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin(), "Telp. " + payGen.getTel() + " Fax. " + payGen.getFax(), getMaxLeftgSiteLength());

                        obj.setLine(startCompany + n++, getLeftMargin(), garis, getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin(), " ", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n, getLeftMargin(), "Period", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin() + getStartColHeaderValue()+5, ": "
                                + periodName + (detailSlipYN == 1 ? " / " + Formater.formatTimeLocale(endDatePeriod, "dd-MM-yyyy") : ""), getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n, getLeftMargin(), "Empl. Name ", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin() + getStartColHeaderValue()+5, ": " + employeeName, getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n, getLeftMargin(), "Empl. Number", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin() + getStartColHeaderValue()+5, ": " + employeeNum, getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n, getLeftMargin(), (detailSlipYN == 1 ? "Div. / Department" : "Department"), getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin() + getStartColHeaderValue()+5, (detailSlipYN == 1 ? (": " + division + " / " + department) : ": " + department), getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n, getLeftMargin(), "Comm. date", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin() + getStartColHeaderValue()+5, ": " + Formater.formatTimeLocale(commDate, "dd-MM-yyyy"), getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n, getLeftMargin(), "Bank Account", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin() + getStartColHeaderValue()+5, ": " + bankAcc, getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n, getLeftMargin(), "Bank Name", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin() + getStartColHeaderValue()+5, ": " + bankNameX, getMaxLeftgSiteLength());
                        ...
                        obj.setLine(startCompany + n, getLeftMargin(), "Note", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin() + getStartColHeaderValue()+5, ":", getMaxLeftgSiteLength());
                        obj.setLine(startCompany + n++, getLeftMargin(), " " + note, getMaxLeftgSiteLength(), 3);

                        drawListBenefit(obj, startRowSlipComp+enter+3, listPaySalary, employeeId, periodId, paySlipId, paidBySalary, codeUpahLembur, currencyType);

                        drawListDeduction(obj, startRowSlipComp+enter+3+ (listPaySalary != null ? listPaySalary.size() : 0), listPayDeduction, employeeId, periodId, paySlipId, codeTax_count, currencyType);
 
                        if (SignatureOnOff >0){
                        drawListSignature(obj, startRowSlipComp+enter+3+ (listPaySalary != null ? listPaySalary.size() : 0)+(listPayDeduction != null ? listPayDeduction.size() : 0),objEmployee);
                        }
                        // cari total benefit
                        ...
                        obj.setLine(startRowSlipComp+tempN + (listPaySalary != null ? listPaySalary.size() : 0)
                        ...
                        obj.setLine(startRowSlipComp+tempN+19, startColSlipComp,"", maxWidthSlipComp);
                        if (payslipOT == 0) {
                            /* obj.setLine((startRowSlipComp + (listPaySalary!=null? listPaySalary.size():0) + 
                        ...
                        //if(privNote!=null && privNote.length()>0 && !privNote.equalsIgnoreCase("null")){
                          /*  obj.setLine((startCompany + (listPaySalary!=null? listPaySalary.size():0) + 
                        ...
                        */
                        ...
                        obj.setLine(startCompany+ n, getLeftMargin(), "Tgl Cetak", getMaxLeftgSiteLength());
                        obj.setLine(startCompany+ n, getLeftMargin() + getStartColHeaderValue()+5, ": " + formatted, getMaxLeftgSiteLength()-2);
                        
                        if (ShowAttendance.equals("1")){
                            obj.setLine(startCompany+ n+1, getLeftMargin(), "Workdays", getMaxLeftgSiteLength());
                            obj.setLine(startCompany+ n+1, getLeftMargin() + getStartColHeaderValue()+5, ": " +nilaiWorkday, getMaxLeftgSiteLength()-2);
                            obj.setLine(startCompany+ n+2, getLeftMargin(), "Attendance", getMaxLeftgSiteLength());
                            obj.setLine(startCompany+ n+2, getLeftMargin() + getStartColHeaderValue()+5, ": " +nilaiPresence, getMaxLeftgSiteLength()-2);
