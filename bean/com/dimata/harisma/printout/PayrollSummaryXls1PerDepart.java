 ...
 * @author Yunny
 */
public class PayrollSummaryXls1PerDepart extends HttpServlet {
     ...
     */
    public PayrollSummaryXls1PerDepart() {
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int ip = 0; ip < listEmpPaySlip.size(); ip++) {
            ...
            if ((empSlip != null) && empSlip.size() > 0) {
                ...
                if (ip==0){
                   // tempdivision = paySlip.getDivision();
                    tempdepartment = paySlip.getDepartment();
                }
       ...
       double nTaxCountd=0.0d;
        ...
        // cari total benefit
            ...
            if ( ((empSlip2 != null) && (empSlip2.size() > 0) && (!tempdepartment.equals(paySlip2.getDepartment()))) || (ip ==listEmpPaySlip.size()-1) ){
            ...
            switch (MODEL_PAYSLIP) {
                ...
                case PaySlip.MODEL_UP_DOWN:
                    try {
                        ...
                        if ((ip==0) || (!tempdivision.equals(division)) ){
                        cell = row.createCell((short) col++);
                        cell.setCellValue("" + division);
                        cell.setCellStyle(style6);
            ...
            tempdepartment = paySlip2.getDepartment();
            ipnew++;
            }  
